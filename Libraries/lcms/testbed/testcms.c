...
int TestMultiprofile(void)
{
    ...
    hXForm = cmsCreateMultiprofileTransform(Profiles, 7, TYPE_RGBA_16, TYPE_RGBA_16, INTENT_RELATIVE_COLORIMETRIC, 0);
    
    printf("Checking multiprofile transforms (6 profiles):");

    nMaxErr = TestFullSpectrum(hXForm, 31);
...
int main(int argc, char *argv[])
{
       ...
       printf("little cms testbed. Ver 1.09 [build %s %s]\n\n", __DATE__, __TIME__);
