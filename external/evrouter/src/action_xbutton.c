...
$Id: action_xbutton.c,v 2.0 2004/09/07 22:57:39 alexios Exp $

$Log: action_xbutton.c,v $
...
const static char rcsinfo [] = "$Id: action_xbutton.c,v 2.0 2004/09/07 22:57:39 alexios Exp $";
