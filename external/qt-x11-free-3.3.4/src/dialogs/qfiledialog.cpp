/****************************************************************************
** $Id: qt/qfiledialog.cpp   3.3.4   edited Jan 7 14:21 $
**
				      ...
				      bool resolveSymlinks )
{
	...
	*workingDirectory = ::toRootIfNotExists( QDir::currentDirPath() );
	...
	return qt_mac_precomposeFileName(macGetOpenFileNames(filter, workingDirectory, parent, name, caption,
                                  selectedFilter, FALSE).first());
#endif
				      ...
				      bool resolveSymlinks)
{
	...
	*workingDirectory = ::toRootIfNotExists( QDir::currentDirPath() );
    ...
    if (qt_use_native_dialogs && (qApp->style().inherits(QMAC_DEFAULT_STYLE)
                                  || qApp->style().inherits("QMacStyle")))
	return qt_mac_precomposeFileName(macGetSaveFileName(initialSelection, filter, workingDirectory,
                                                     parent, name, caption, selectedFilter));
#endif
