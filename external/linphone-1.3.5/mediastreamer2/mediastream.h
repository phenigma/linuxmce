...
AudioStream *audio_stream_start_with_sndcards(RtpProfile * prof, int locport, const char *remip4, int remport, int profile, int jitt_comp, MSSndCard *playcard, MSSndCard *captcard);

AudioStream *audio_stream_start_with_files (RtpProfile * prof, int locport,
					    const char *remip4, int remport,
...
VideoStream *video_stream_start(RtpProfile *profile, int locport, const char *remip, int remport, int payload, int jitt_comp,
														const char *device);
