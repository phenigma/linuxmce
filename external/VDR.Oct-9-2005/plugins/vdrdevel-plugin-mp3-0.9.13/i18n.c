...
// start of MPlayer specific phrases
  ...
  { "Media replay via MPlayer",
    "Medien Wiedergabe über MPlayer",
    "", // TODO
    "", // TODO
    "", // TODO
    "", // TODO
