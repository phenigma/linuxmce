...
#define Lighting_Plugin_VERSION "testing"
...
int main( int argc, char* argv[] ) 
{
	...
	if ( bError )
	{
		cout << "Lighting_Plugin, v." << Lighting_Plugin_VERSION << endl
			<< "A Pluto DCE Device. See www.plutohome.com/dce for details." << endl
			<< "Usage: Lighting_Plugin [-r Router's IP] [-d My Device ID] [-l dce_router|stdout|null|filename]" << endl
