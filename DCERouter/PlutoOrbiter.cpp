...
{
	if( !bReacquireGrids )
		m_pRouter->DispatchMessage(new Message(DEVICEID_DCEROUTER, m_pDeviceData_Router->m_iPK_Device, PRIORITY_NORMAL, 
...
{
	m_pRouter->DispatchMessage(new Message(0,m_pDeviceData_Router->m_iPK_Device,PRIORITY_NORMAL,MESSAGETYPE_COMMAND,
...
{
	m_pRouter->DispatchMessage(new Message(0, m_pDeviceData_Router->m_iPK_Device, PRIORITY_NORMAL, 
