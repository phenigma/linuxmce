...
class DLL_EXPORT Table_psc_local_bathdr
{
private:
...
private:		
	...
	map<Table_psc_local_bathdr::Key, class Row_psc_local_bathdr*, Table_psc_local_bathdr::Key_Less> cachedRows;
	map<Table_psc_local_bathdr::Key, class Row_psc_local_bathdr*, Table_psc_local_bathdr::Key_Less> deleted_cachedRows;
	vector<class Row_psc_local_bathdr*> addedRows;
	vector<class Row_psc_local_bathdr*> deleted_addedRows;	
...
private:	
	...
	class Row_psc_local_bathdr* FetchRow(Key &key);
...
void Value_set(string val);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_psc_local_bathdr+ m_Value;
		}
	private:
