...
void psc_frozen_setNull(bool val);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_InfraredData+ m_Manufacturer+ m_Model+ m_Device+ m_Command+ m_Pronto+ m_Frequency+ m_Data+ m_DataRepeat+ m_Leadout+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod;
		}
	private:
