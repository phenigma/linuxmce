...
{
	map<Table_DesignObjType_DesignObjParameter::Key, class Row_DesignObjType_DesignObjParameter*, Table_DesignObjType_DesignObjParameter::Key_Less>::iterator it;
...
void Row_DesignObjType_DesignObjParameter::Delete()
{
	...
	if (!is_deleted)
		if (is_added)	
		{	
			vector<Row_DesignObjType_DesignObjParameter*>::iterator i;	
		...
		{
			Table_DesignObjType_DesignObjParameter::Key key(this);					
			map<Table_DesignObjType_DesignObjParameter::Key, Row_DesignObjType_DesignObjParameter*, Table_DesignObjType_DesignObjParameter::Key_Less>::iterator i = table->cachedRows.find(key);
...
string Row_DesignObjType_DesignObjParameter::Modification_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_Modification_RecordInfo;}
short int Row_DesignObjType_DesignObjParameter::IsNew_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsNew_RecordInfo;}
short int Row_DesignObjType_DesignObjParameter::IsDeleted_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsDeleted_RecordInfo;}
long int Row_DesignObjType_DesignObjParameter::FK_Users_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Row_DesignObjType_DesignObjParameter::Modification_RecordInfo_set(string val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_Modification_RecordInfo = val; is_modified=true; is_null[2]=false;}
void Row_DesignObjType_DesignObjParameter::IsNew_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsNew_RecordInfo = val; is_modified=true; is_null[3]=false;}
void Row_DesignObjType_DesignObjParameter::IsDeleted_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsDeleted_RecordInfo = val; is_modified=true; is_null[4]=false;}
void Row_DesignObjType_DesignObjParameter::FK_Users_RecordInfo_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_FK_Users_RecordInfo = val; is_modified=true; is_null[5]=false;}

		
bool Row_DesignObjType_DesignObjParameter::IsNew_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[3];}
bool Row_DesignObjType_DesignObjParameter::IsDeleted_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[4];}
bool Row_DesignObjType_DesignObjParameter::FK_Users_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[5];}

			
void Row_DesignObjType_DesignObjParameter::IsNew_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[3]=val;}
void Row_DesignObjType_DesignObjParameter::IsDeleted_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[4]=val;}
void Row_DesignObjType_DesignObjParameter::FK_Users_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DesignObjType_DesignObjParameter::Modification_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DesignObjType_DesignObjParameter::IsNew_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DesignObjType_DesignObjParameter::IsDeleted_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DesignObjType_DesignObjParameter::FK_Users_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
//insert added
	...
	{
		vector<Row_DesignObjType_DesignObjParameter*>::iterator i = addedRows.begin();
	
		Row_DesignObjType_DesignObjParameter *pRow = *i;
	
		
string values_list_comma_separated;
values_list_comma_separated = values_list_comma_separated + pRow->FK_DesignObjType_asSQL()+", "+pRow->FK_DesignObjParameter_asSQL()+", "+pRow->Modification_RecordInfo_asSQL()+", "+pRow->IsNew_RecordInfo_asSQL()+", "+pRow->IsDeleted_RecordInfo_asSQL()+", "+pRow->FK_Users_RecordInfo_asSQL();

	
		string query = "insert into DesignObjType_DesignObjParameter (FK_DesignObjType, FK_DesignObjParameter, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo) values ("+
...
//update modified
	...
	for (map<Key, Row_DesignObjType_DesignObjParameter*, Key_Less>::iterator i = cachedRows.begin(); i!= cachedRows.end(); i++)
		if	(((*i).second)->is_modified)
	{
		Row_DesignObjType_DesignObjParameter* pRow = (*i).second;	
		Key key(pRow);	

		char tmp_FK_DesignObjType[32];
sprintf(tmp_FK_DesignObjType, "%li", key.pk_FK_DesignObjType);
...
update_values_list = update_values_list + "FK_DesignObjType="+pRow->FK_DesignObjType_asSQL()+", FK_DesignObjParameter="+pRow->FK_DesignObjParameter_asSQL()+", Modification_RecordInfo="+pRow->Modification_RecordInfo_asSQL()+", IsNew_RecordInfo="+pRow->IsNew_RecordInfo_asSQL()+", IsDeleted_RecordInfo="+pRow->IsDeleted_RecordInfo_asSQL()+", FK_Users_RecordInfo="+pRow->FK_Users_RecordInfo_asSQL();
...
//delete deleted added
	...
	{	
		vector<Row_DesignObjType_DesignObjParameter*>::iterator i = deleted_addedRows.begin();
		delete (*i);
...
//delete deleted cached
	...
	{	
		map<Key, Row_DesignObjType_DesignObjParameter*, Key_Less>::iterator i = deleted_cachedRows.begin();
...
bool Table_DesignObjType_DesignObjParameter::GetRows(string where_statement,vector<class Row_DesignObjType_DesignObjParameter*> *rows)
{
	...
	string query = "select * from DesignObjType_DesignObjParameter where " + where_statement;
...
sscanf(row[5], "%li", &(pRow->m_FK_Users_RecordInfo));
		...
		Key key(pRow);
                ...
                map<Table_DesignObjType_DesignObjParameter::Key, Row_DesignObjType_DesignObjParameter*, Table_DesignObjType_DesignObjParameter::Key_Less>::iterator i = cachedRows.find(key);
...
Row_DesignObjType_DesignObjParameter* Table_DesignObjType_DesignObjParameter::GetRow(long int in_FK_DesignObjType, long int in_FK_DesignObjParameter)
{
	...
	Key row_key(in_FK_DesignObjType, in_FK_DesignObjParameter);

	map<Key, Row_DesignObjType_DesignObjParameter*, Key_Less>::iterator i;
...
Row_DesignObjType_DesignObjParameter* Table_DesignObjType_DesignObjParameter::FetchRow(Table_DesignObjType_DesignObjParameter::Key &key)
{
	PLUTO_SAFETY_LOCK(M, m_Mutex);
