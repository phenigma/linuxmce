...
void StyleVariation_FK_VertAlignment_getrows(vector <class Row_StyleVariation*> *rows);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_VertAlignment+ m_Description+ m_Define+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
