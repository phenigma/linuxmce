...
private:		
	...
	map<Table_Output::Key, class Row_Output*, Table_Output::Key_Less> cachedRows;
	map<Table_Output::Key, class Row_Output*, Table_Output::Key_Less> deleted_cachedRows;
	vector<class Row_Output*> addedRows;
	vector<class Row_Output*> deleted_addedRows;	
...
private:	
	...
	class Row_Output* FetchRow(Key &key);
...
void Device_Device_Pipe_FK_Output_getrows(vector <class Row_Device_Device_Pipe*> *rows);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_Output+ m_Description+ m_Define+ m_FK_Command+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
