...
class DLL_EXPORT Table_DesignObjParameter
{
private:
...
public:
	...
	Table_DesignObjParameter(Database_pluto_main *pDatabase):database(pDatabase), m_Mutex("DesignObjParameter")
	{
...
private:		
	...
	map<Table_DesignObjParameter::Key, class Row_DesignObjParameter*, Table_DesignObjParameter::Key_Less> cachedRows;
	map<Table_DesignObjParameter::Key, class Row_DesignObjParameter*, Table_DesignObjParameter::Key_Less> deleted_cachedRows;
	vector<class Row_DesignObjParameter*> addedRows;
	vector<class Row_DesignObjParameter*> deleted_addedRows;	
...
private:	
	...
	class Row_DesignObjParameter* FetchRow(Key &key);
...
void DesignObjVariation_DesignObjParameter_FK_DesignObjParameter_getrows(vector <class Row_DesignObjVariation_DesignObjParameter*> *rows);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_DesignObjParameter+ m_Define+ m_Comments+ m_Description+ m_FK_ParameterType+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
