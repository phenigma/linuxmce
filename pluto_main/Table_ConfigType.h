...
class DLL_EXPORT Table_ConfigType
{
private:
...
private:		
	...
	map<Table_ConfigType::Key, class Row_ConfigType*, Table_ConfigType::Key_Less> cachedRows;
	map<Table_ConfigType::Key, class Row_ConfigType*, Table_ConfigType::Key_Less> deleted_cachedRows;
	vector<class Row_ConfigType*> addedRows;
	vector<class Row_ConfigType*> deleted_addedRows;	
...
private:	
	...
	class Row_ConfigType* FetchRow(Key &key);
...
void ConfigType_Setting_FK_ConfigType_getrows(vector <class Row_ConfigType_Setting*> *rows);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_ConfigType+ m_Description+ m_Define+ m_FK_DeviceTemplate+ m_FK_DeviceCategory+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
