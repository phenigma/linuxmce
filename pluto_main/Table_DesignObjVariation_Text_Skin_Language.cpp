...
{
	map<Table_DesignObjVariation_Text_Skin_Language::Key, class Row_DesignObjVariation_Text_Skin_Language*, Table_DesignObjVariation_Text_Skin_Language::Key_Less>::iterator it;
...
void Row_DesignObjVariation_Text_Skin_Language::Delete()
{
	...
	if (!is_deleted)
		if (is_added)	
		{	
			vector<Row_DesignObjVariation_Text_Skin_Language*>::iterator i;	
		...
		{
			Table_DesignObjVariation_Text_Skin_Language::Key key(this);					
			map<Table_DesignObjVariation_Text_Skin_Language::Key, Row_DesignObjVariation_Text_Skin_Language*, Table_DesignObjVariation_Text_Skin_Language::Key_Less>::iterator i = table->cachedRows.find(key);
...
string Row_DesignObjVariation_Text_Skin_Language::Modification_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_Modification_RecordInfo;}
short int Row_DesignObjVariation_Text_Skin_Language::IsNew_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsNew_RecordInfo;}
short int Row_DesignObjVariation_Text_Skin_Language::IsDeleted_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsDeleted_RecordInfo;}
long int Row_DesignObjVariation_Text_Skin_Language::FK_Users_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Row_DesignObjVariation_Text_Skin_Language::Modification_RecordInfo_set(string val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_Modification_RecordInfo = val; is_modified=true; is_null[14]=false;}
void Row_DesignObjVariation_Text_Skin_Language::IsNew_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsNew_RecordInfo = val; is_modified=true; is_null[15]=false;}
void Row_DesignObjVariation_Text_Skin_Language::IsDeleted_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsDeleted_RecordInfo = val; is_modified=true; is_null[16]=false;}
void Row_DesignObjVariation_Text_Skin_Language::FK_Users_RecordInfo_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_FK_Users_RecordInfo = val; is_modified=true; is_null[17]=false;}
...
return is_null[13];}
bool Row_DesignObjVariation_Text_Skin_Language::IsNew_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[15];}
bool Row_DesignObjVariation_Text_Skin_Language::IsDeleted_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[16];}
bool Row_DesignObjVariation_Text_Skin_Language::FK_Users_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
is_null[13]=val;}
void Row_DesignObjVariation_Text_Skin_Language::IsNew_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[15]=val;}
void Row_DesignObjVariation_Text_Skin_Language::IsDeleted_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[16]=val;}
void Row_DesignObjVariation_Text_Skin_Language::FK_Users_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DesignObjVariation_Text_Skin_Language::Modification_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DesignObjVariation_Text_Skin_Language::IsNew_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DesignObjVariation_Text_Skin_Language::IsDeleted_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DesignObjVariation_Text_Skin_Language::FK_Users_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Table_DesignObjVariation_Text_Skin_Language::Commit()
{
...
//insert added
	...
	{
		vector<Row_DesignObjVariation_Text_Skin_Language*>::iterator i = addedRows.begin();
	
		Row_DesignObjVariation_Text_Skin_Language *pRow = *i;
	
		
string values_list_comma_separated;
values_list_comma_separated = values_list_comma_separated + pRow->PK_DesignObjVariation_Text_Skin_Language_asSQL()+", "+pRow->FK_DesignObjVariation_Text_asSQL()+", "+pRow->FK_Skin_asSQL()+", "+pRow->FK_Language_asSQL()+", "+pRow->X_asSQL()+", "+pRow->Y_asSQL()+", "+pRow->Width_asSQL()+", "+pRow->Height_asSQL()+", "+pRow->Rotate_asSQL()+", "+pRow->Opacity_asSQL()+", "+pRow->FK_HorizAlignment_asSQL()+", "+pRow->FK_VertAlignment_asSQL()+", "+pRow->FK_Style_asSQL()+", "+pRow->PlainBackgroundColor_asSQL()+", "+pRow->Modification_RecordInfo_asSQL()+", "+pRow->IsNew_RecordInfo_asSQL()+", "+pRow->IsDeleted_RecordInfo_asSQL()+", "+pRow->FK_Users_RecordInfo_asSQL();

	
		string query = "insert into DesignObjVariation_Text_Skin_Language (PK_DesignObjVariation_Text_Skin_Language, FK_DesignObjVariation_Text, FK_Skin, FK_Language, X, Y, Width, Height, Rotate, Opacity, FK_HorizAlignment, FK_VertAlignment, FK_Style, PlainBackgroundColor, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo) values ("+
...
//update modified
	...
	for (map<Key, Row_DesignObjVariation_Text_Skin_Language*, Key_Less>::iterator i = cachedRows.begin(); i!= cachedRows.end(); i++)
		if	(((*i).second)->is_modified)
	{
		Row_DesignObjVariation_Text_Skin_Language* pRow = (*i).second;	
		Key key(pRow);	

		char tmp_PK_DesignObjVariation_Text_Skin_Language[32];
sprintf(tmp_PK_DesignObjVariation_Text_Skin_Language, "%li", key.pk_PK_DesignObjVariation_Text_Skin_Language);
...
//delete deleted added
	...
	{	
		vector<Row_DesignObjVariation_Text_Skin_Language*>::iterator i = deleted_addedRows.begin();
		delete (*i);
...
//delete deleted cached
	...
	{	
		map<Key, Row_DesignObjVariation_Text_Skin_Language*, Key_Less>::iterator i = deleted_cachedRows.begin();
...
bool Table_DesignObjVariation_Text_Skin_Language::GetRows(string where_statement,vector<class Row_DesignObjVariation_Text_Skin_Language*> *rows)
{
	...
	string query = "select * from DesignObjVariation_Text_Skin_Language where " + where_statement;
...
pRow->m_Modification_RecordInfo = string(row[14],lengths[14]);
}
...
sscanf(row[15], "%hi", &(pRow->m_IsNew_RecordInfo));
}
...
sscanf(row[16], "%hi", &(pRow->m_IsDeleted_RecordInfo));
}
...
sscanf(row[17], "%li", &(pRow->m_FK_Users_RecordInfo));
}
		...
		Key key(pRow);
                ...
                map<Table_DesignObjVariation_Text_Skin_Language::Key, Row_DesignObjVariation_Text_Skin_Language*, Table_DesignObjVariation_Text_Skin_Language::Key_Less>::iterator i = cachedRows.find(key);
...
Row_DesignObjVariation_Text_Skin_Language* Table_DesignObjVariation_Text_Skin_Language::GetRow(long int in_PK_DesignObjVariation_Text_Skin_Language)
{
	...
	Key row_key(in_PK_DesignObjVariation_Text_Skin_Language);

	map<Key, Row_DesignObjVariation_Text_Skin_Language*, Key_Less>::iterator i;
...
Row_DesignObjVariation_Text_Skin_Language* Table_DesignObjVariation_Text_Skin_Language::FetchRow(Table_DesignObjVariation_Text_Skin_Language::Key &key)
{
	PLUTO_SAFETY_LOCK(M, m_Mutex);
