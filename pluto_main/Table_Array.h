...
class DLL_EXPORT Table_Array : public TableBase , SingleLongKeyBase
{
private:
...
void psc_frozen_setNull(bool val);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_Array+ m_Description+ m_Define+ m_CommandGroup+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod;
		}
	private:
