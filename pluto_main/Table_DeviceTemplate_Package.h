...
class Row_Package* FK_Package_getrow();
		...
		void SetupSerialization() {
			StartSerializeList() + m_FK_DeviceTemplate+ m_FK_Package+ m_DevelopmentOnly+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
