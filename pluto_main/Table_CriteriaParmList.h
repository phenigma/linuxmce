...
void CriteriaParm_D_FK_CriteriaParmList_getrows(vector <class Row_CriteriaParm_D*> *rows);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_CriteriaParmList+ m_FK_ParameterType+ m_Description+ m_Define+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
