...
class DLL_EXPORT Table_DesignObjVariation_Zone
{
private:
...
public:
	...
	Table_DesignObjVariation_Zone(Database_pluto_main *pDatabase):database(pDatabase), m_Mutex("DesignObjVariation_Zone")
	{
...
private:		
	...
	map<Table_DesignObjVariation_Zone::Key, class Row_DesignObjVariation_Zone*, Table_DesignObjVariation_Zone::Key_Less> cachedRows;
	map<Table_DesignObjVariation_Zone::Key, class Row_DesignObjVariation_Zone*, Table_DesignObjVariation_Zone::Key_Less> deleted_cachedRows;
	vector<class Row_DesignObjVariation_Zone*> addedRows;
	vector<class Row_DesignObjVariation_Zone*> deleted_addedRows;	
...
private:	
	...
	class Row_DesignObjVariation_Zone* FetchRow(Key &key);
...
class Row_DesignObj* FK_DesignObj_Goto_getrow();
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_DesignObjVariation_Zone+ m_FK_DesignObjVariation+ m_FK_Button+ m_FK_CommandGroup_D+ m_FK_DesignObj_Goto+ m_Description+ m_X+ m_Y+ m_Width+ m_Height+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
