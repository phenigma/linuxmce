...
void InfraredGroup_Input_FK_Input_getrows(vector <class Row_InfraredGroup_Input*> *rows);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_Input+ m_Description+ m_Define+ m_FK_Command+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
