...
class DLL_EXPORT Table_EntertainArea
{
private:
...
private:		
	...
	map<Table_EntertainArea::Key, class Row_EntertainArea*, Table_EntertainArea::Key_Less> cachedRows;
	map<Table_EntertainArea::Key, class Row_EntertainArea*, Table_EntertainArea::Key_Less> deleted_cachedRows;
	vector<class Row_EntertainArea*> addedRows;
	vector<class Row_EntertainArea*> deleted_addedRows;	
...
private:	
	...
	class Row_EntertainArea* FetchRow(Key &key);
...
void Orbiter_FK_EntertainArea_getrows(vector <class Row_Orbiter*> *rows);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_EntertainArea+ m_FK_Room+ m_Only1Stream+ m_Description+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
