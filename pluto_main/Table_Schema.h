...
private:		
	...
	map<Table_Schema::Key, class Row_Schema*, Table_Schema::Key_Less> cachedRows;
	map<Table_Schema::Key, class Row_Schema*, Table_Schema::Key_Less> deleted_cachedRows;
	vector<class Row_Schema*> addedRows;
	vector<class Row_Schema*> deleted_addedRows;	
...
private:	
	...
	class Row_Schema* FetchRow(Key &key);
...
void SQLCommands_setNull(bool val);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_Schema+ m_FK_Version+ m_SQLCommands;
		}
	private:
