...
{
	map<Table_Command_CommandParameter::Key, class Row_Command_CommandParameter*, Table_Command_CommandParameter::Key_Less>::iterator it;
...
void Row_Command_CommandParameter::Delete()
{
	...
	if (!is_deleted)
		if (is_added)	
		{	
			vector<Row_Command_CommandParameter*>::iterator i;	
		...
		{
			Table_Command_CommandParameter::Key key(this);					
			map<Table_Command_CommandParameter::Key, Row_Command_CommandParameter*, Table_Command_CommandParameter::Key_Less>::iterator i = table->cachedRows.find(key);
...
return m_IsOut;}
string Row_Command_CommandParameter::Modification_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_Modification_RecordInfo;}
short int Row_Command_CommandParameter::IsNew_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsNew_RecordInfo;}
short int Row_Command_CommandParameter::IsDeleted_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsDeleted_RecordInfo;}
long int Row_Command_CommandParameter::FK_Users_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Row_Command_CommandParameter::Modification_RecordInfo_set(string val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_Modification_RecordInfo = val; is_modified=true; is_null[4]=false;}
void Row_Command_CommandParameter::IsNew_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsNew_RecordInfo = val; is_modified=true; is_null[5]=false;}
void Row_Command_CommandParameter::IsDeleted_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsDeleted_RecordInfo = val; is_modified=true; is_null[6]=false;}
void Row_Command_CommandParameter::FK_Users_RecordInfo_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
return is_null[2];}
bool Row_Command_CommandParameter::IsNew_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[5];}
bool Row_Command_CommandParameter::IsDeleted_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[6];}
bool Row_Command_CommandParameter::FK_Users_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
is_null[2]=val;}
void Row_Command_CommandParameter::IsNew_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[5]=val;}
void Row_Command_CommandParameter::IsDeleted_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[6]=val;}
void Row_Command_CommandParameter::FK_Users_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_Command_CommandParameter::Modification_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_Command_CommandParameter::IsNew_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_Command_CommandParameter::IsDeleted_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_Command_CommandParameter::FK_Users_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
//insert added
	...
	{
		vector<Row_Command_CommandParameter*>::iterator i = addedRows.begin();
	
		Row_Command_CommandParameter *pRow = *i;
	
		
string values_list_comma_separated;
values_list_comma_separated = values_list_comma_separated + pRow->FK_Command_asSQL()+", "+pRow->FK_CommandParameter_asSQL()+", "+pRow->Description_asSQL()+", "+pRow->IsOut_asSQL()+", "+pRow->Modification_RecordInfo_asSQL()+", "+pRow->IsNew_RecordInfo_asSQL()+", "+pRow->IsDeleted_RecordInfo_asSQL()+", "+pRow->FK_Users_RecordInfo_asSQL();

	
		string query = "insert into Command_CommandParameter (FK_Command, FK_CommandParameter, Description, IsOut, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo) values ("+
...
//update modified
	...
	for (map<Key, Row_Command_CommandParameter*, Key_Less>::iterator i = cachedRows.begin(); i!= cachedRows.end(); i++)
		if	(((*i).second)->is_modified)
	{
		Row_Command_CommandParameter* pRow = (*i).second;	
		Key key(pRow);	
...
update_values_list = update_values_list + "FK_Command="+pRow->FK_Command_asSQL()+", FK_CommandParameter="+pRow->FK_CommandParameter_asSQL()+", Description="+pRow->Description_asSQL()+", IsOut="+pRow->IsOut_asSQL()+", Modification_RecordInfo="+pRow->Modification_RecordInfo_asSQL()+", IsNew_RecordInfo="+pRow->IsNew_RecordInfo_asSQL()+", IsDeleted_RecordInfo="+pRow->IsDeleted_RecordInfo_asSQL()+", FK_Users_RecordInfo="+pRow->FK_Users_RecordInfo_asSQL();
...
//delete deleted added
	...
	{	
		vector<Row_Command_CommandParameter*>::iterator i = deleted_addedRows.begin();
		delete (*i);
...
//delete deleted cached
	...
	{	
		map<Key, Row_Command_CommandParameter*, Key_Less>::iterator i = deleted_cachedRows.begin();
...
sscanf(row[7], "%li", &(pRow->m_FK_Users_RecordInfo));
		...
		Key key(pRow);
                ...
                map<Table_Command_CommandParameter::Key, Row_Command_CommandParameter*, Table_Command_CommandParameter::Key_Less>::iterator i = cachedRows.find(key);
...
Row_Command_CommandParameter* Table_Command_CommandParameter::GetRow(long int in_FK_Command, long int in_FK_CommandParameter)
{
	...
	Key row_key(in_FK_Command, in_FK_CommandParameter);

	map<Key, Row_Command_CommandParameter*, Key_Less>::iterator i;
...
Row_Command_CommandParameter* Table_Command_CommandParameter::FetchRow(Table_Command_CommandParameter::Key &key)
{
	PLUTO_SAFETY_LOCK(M, m_Mutex);
