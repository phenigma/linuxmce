...
class DLL_EXPORT Table_CommandGroup_D_Command_CommandParameter
{
private:
...
public:
	...
	Table_CommandGroup_D_Command_CommandParameter(Database_pluto_main *pDatabase):database(pDatabase), m_Mutex("CommandGroup_D_Command_CommandParameter")
	{
...
long int pk_FK_CommandParameter;
	...
	map<Table_CommandGroup_D_Command_CommandParameter::Key, class Row_CommandGroup_D_Command_CommandParameter*, Table_CommandGroup_D_Command_CommandParameter::Key_Less> cachedRows;
	map<Table_CommandGroup_D_Command_CommandParameter::Key, class Row_CommandGroup_D_Command_CommandParameter*, Table_CommandGroup_D_Command_CommandParameter::Key_Less> deleted_cachedRows;
	vector<class Row_CommandGroup_D_Command_CommandParameter*> addedRows;
	vector<class Row_CommandGroup_D_Command_CommandParameter*> deleted_addedRows;	
...
private:	
	...
	class Row_CommandGroup_D_Command_CommandParameter* FetchRow(Key &key);
		
			
};

class DLL_EXPORT Row_CommandGroup_D_Command_CommandParameter : public TableRow, public SerializeClass
	{
...
class Row_CommandParameter* FK_CommandParameter_getrow();
		...
		void SetupSerialization() {
			StartSerializeList() + m_FK_CommandGroup_D_Command+ m_FK_CommandParameter+ m_Value+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
