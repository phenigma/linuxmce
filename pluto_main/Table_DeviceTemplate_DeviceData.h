...
class DLL_EXPORT Table_DeviceTemplate_DeviceData
{
private:
...
public:
	...
	Table_DeviceTemplate_DeviceData(Database_pluto_main *pDatabase):database(pDatabase), m_Mutex("DeviceTemplate_DeviceData")
	{
...
long int pk_FK_DeviceData;
	...
	map<Table_DeviceTemplate_DeviceData::Key, class Row_DeviceTemplate_DeviceData*, Table_DeviceTemplate_DeviceData::Key_Less> cachedRows;
	map<Table_DeviceTemplate_DeviceData::Key, class Row_DeviceTemplate_DeviceData*, Table_DeviceTemplate_DeviceData::Key_Less> deleted_cachedRows;
	vector<class Row_DeviceTemplate_DeviceData*> addedRows;
	vector<class Row_DeviceTemplate_DeviceData*> deleted_addedRows;	
...
private:	
	...
	class Row_DeviceTemplate_DeviceData* FetchRow(Key &key);
		
			
};

class DLL_EXPORT Row_DeviceTemplate_DeviceData : public TableRow, public SerializeClass
	{
