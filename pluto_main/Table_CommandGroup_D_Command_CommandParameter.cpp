...
{
	map<Table_CommandGroup_D_Command_CommandParameter::Key, class Row_CommandGroup_D_Command_CommandParameter*, Table_CommandGroup_D_Command_CommandParameter::Key_Less>::iterator it;
...
void Row_CommandGroup_D_Command_CommandParameter::Delete()
{
	...
	if (!is_deleted)
		if (is_added)	
		{	
			vector<Row_CommandGroup_D_Command_CommandParameter*>::iterator i;	
		...
		{
			Table_CommandGroup_D_Command_CommandParameter::Key key(this);					
			map<Table_CommandGroup_D_Command_CommandParameter::Key, Row_CommandGroup_D_Command_CommandParameter*, Table_CommandGroup_D_Command_CommandParameter::Key_Less>::iterator i = table->cachedRows.find(key);
...
long int Row_CommandGroup_D_Command_CommandParameter::FK_CommandGroup_D_Command_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Table_CommandGroup_D_Command_CommandParameter::Commit()
{
...
//insert added
	...
	{
		vector<Row_CommandGroup_D_Command_CommandParameter*>::iterator i = addedRows.begin();
	
		Row_CommandGroup_D_Command_CommandParameter *pRow = *i;
...
//update modified
	...
	for (map<Key, Row_CommandGroup_D_Command_CommandParameter*, Key_Less>::iterator i = cachedRows.begin(); i!= cachedRows.end(); i++)
		if	(((*i).second)->is_modified)
	{
		Row_CommandGroup_D_Command_CommandParameter* pRow = (*i).second;	
		Key key(pRow);	

		char tmp_FK_CommandGroup_D_Command[32];
sprintf(tmp_FK_CommandGroup_D_Command, "%li", key.pk_FK_CommandGroup_D_Command);
...
//delete deleted added
	...
	{	
		vector<Row_CommandGroup_D_Command_CommandParameter*>::iterator i = deleted_addedRows.begin();
		delete (*i);
...
//delete deleted cached
	...
	{	
		map<Key, Row_CommandGroup_D_Command_CommandParameter*, Key_Less>::iterator i = deleted_cachedRows.begin();
...
bool Table_CommandGroup_D_Command_CommandParameter::GetRows(string where_statement,vector<class Row_CommandGroup_D_Command_CommandParameter*> *rows)
{
	...
	string query = "select * from CommandGroup_D_Command_CommandParameter where " + where_statement;
...
sscanf(row[6], "%li", &(pRow->m_FK_Users_RecordInfo));
		...
		Key key(pRow);
                ...
                map<Table_CommandGroup_D_Command_CommandParameter::Key, Row_CommandGroup_D_Command_CommandParameter*, Table_CommandGroup_D_Command_CommandParameter::Key_Less>::iterator i = cachedRows.find(key);
...
Row_CommandGroup_D_Command_CommandParameter* Table_CommandGroup_D_Command_CommandParameter::GetRow(long int in_FK_CommandGroup_D_Command, long int in_FK_CommandParameter)
{
	...
	Key row_key(in_FK_CommandGroup_D_Command, in_FK_CommandParameter);

	map<Key, Row_CommandGroup_D_Command_CommandParameter*, Key_Less>::iterator i;
...
Row_CommandGroup_D_Command_CommandParameter* Table_CommandGroup_D_Command_CommandParameter::FetchRow(Table_CommandGroup_D_Command_CommandParameter::Key &key)
{
	PLUTO_SAFETY_LOCK(M, m_Mutex);
