...
class DLL_EXPORT Table_DesignObjVariation
{
private:
...
private:		
	...
	map<Table_DesignObjVariation::Key, class Row_DesignObjVariation*, Table_DesignObjVariation::Key_Less> cachedRows;
	map<Table_DesignObjVariation::Key, class Row_DesignObjVariation*, Table_DesignObjVariation::Key_Less> deleted_cachedRows;
	vector<class Row_DesignObjVariation*> addedRows;
	vector<class Row_DesignObjVariation*> deleted_addedRows;	
...
private:	
	...
	class Row_DesignObjVariation* FetchRow(Key &key);
