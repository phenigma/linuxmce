...
class DLL_EXPORT Table_DeviceTemplate_AV
{
private:
...
private:		
	...
	map<Table_DeviceTemplate_AV::Key, class Row_DeviceTemplate_AV*, Table_DeviceTemplate_AV::Key_Less> cachedRows;
	map<Table_DeviceTemplate_AV::Key, class Row_DeviceTemplate_AV*, Table_DeviceTemplate_AV::Key_Less> deleted_cachedRows;
	vector<class Row_DeviceTemplate_AV*> addedRows;
	vector<class Row_DeviceTemplate_AV*> deleted_addedRows;	
...
private:	
	...
	class Row_DeviceTemplate_AV* FetchRow(Key &key);
