...
class DLL_EXPORT Table_Device_Device_Related : public TableBase , DoubleLongKeyBase
{
private:
...
class Row_Device* FK_Device_Related_getrow();
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_FK_Device+ m_FK_Device_Related+ m_Value+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod;
		}
	private:
