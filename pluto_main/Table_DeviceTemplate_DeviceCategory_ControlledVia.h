...
class Row_Input* FK_Input_Video_getrow();
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_DeviceTemplate_DeviceCategory_ControlledVia+ m_FK_DeviceTemplate+ m_FK_DeviceCategory+ m_Description+ m_RerouteMessagesToParent+ m_AutoCreateChildren+ m_FK_Input_Audio+ m_FK_Input_Video+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
