...
{
	map<Table_DeviceTemplate_Input::Key, class Row_DeviceTemplate_Input*, Table_DeviceTemplate_Input::Key_Less>::iterator it;
...
void Row_DeviceTemplate_Input::Delete()
{
	...
	if (!is_deleted)
		if (is_added)	
		{	
			vector<Row_DeviceTemplate_Input*>::iterator i;	
		...
		{
			Table_DeviceTemplate_Input::Key key(this);					
			map<Table_DeviceTemplate_Input::Key, Row_DeviceTemplate_Input*, Table_DeviceTemplate_Input::Key_Less>::iterator i = table->cachedRows.find(key);
...
string Row_DeviceTemplate_Input::Modification_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_Modification_RecordInfo;}
short int Row_DeviceTemplate_Input::IsNew_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsNew_RecordInfo;}
short int Row_DeviceTemplate_Input::IsDeleted_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsDeleted_RecordInfo;}
long int Row_DeviceTemplate_Input::FK_Users_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Row_DeviceTemplate_Input::Modification_RecordInfo_set(string val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_Modification_RecordInfo = val; is_modified=true; is_null[4]=false;}
void Row_DeviceTemplate_Input::IsNew_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsNew_RecordInfo = val; is_modified=true; is_null[5]=false;}
void Row_DeviceTemplate_Input::IsDeleted_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsDeleted_RecordInfo = val; is_modified=true; is_null[6]=false;}
void Row_DeviceTemplate_Input::FK_Users_RecordInfo_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_FK_Users_RecordInfo = val; is_modified=true; is_null[7]=false;}

		
bool Row_DeviceTemplate_Input::IsNew_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[5];}
bool Row_DeviceTemplate_Input::IsDeleted_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[6];}
bool Row_DeviceTemplate_Input::FK_Users_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[7];}

			
void Row_DeviceTemplate_Input::IsNew_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[5]=val;}
void Row_DeviceTemplate_Input::IsDeleted_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[6]=val;}
void Row_DeviceTemplate_Input::FK_Users_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceTemplate_Input::Modification_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceTemplate_Input::IsNew_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceTemplate_Input::IsDeleted_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceTemplate_Input::FK_Users_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Table_DeviceTemplate_Input::Commit()
{
...
//insert added
	...
	{
		vector<Row_DeviceTemplate_Input*>::iterator i = addedRows.begin();
	
		Row_DeviceTemplate_Input *pRow = *i;
	
		
string values_list_comma_separated;
values_list_comma_separated = values_list_comma_separated + pRow->PK_DeviceTemplate_Input_asSQL()+", "+pRow->FK_DeviceTemplate_asSQL()+", "+pRow->FK_Input_asSQL()+", "+pRow->FK_ConnectorType_asSQL()+", "+pRow->Modification_RecordInfo_asSQL()+", "+pRow->IsNew_RecordInfo_asSQL()+", "+pRow->IsDeleted_RecordInfo_asSQL()+", "+pRow->FK_Users_RecordInfo_asSQL();

	
		string query = "insert into DeviceTemplate_Input (PK_DeviceTemplate_Input, FK_DeviceTemplate, FK_Input, FK_ConnectorType, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo) values ("+
...
//update modified
	...
	for (map<Key, Row_DeviceTemplate_Input*, Key_Less>::iterator i = cachedRows.begin(); i!= cachedRows.end(); i++)
		if	(((*i).second)->is_modified)
	{
		Row_DeviceTemplate_Input* pRow = (*i).second;	
		Key key(pRow);	
...
//delete deleted added
	...
	{	
		vector<Row_DeviceTemplate_Input*>::iterator i = deleted_addedRows.begin();
		delete (*i);
...
//delete deleted cached
	...
	{	
		map<Key, Row_DeviceTemplate_Input*, Key_Less>::iterator i = deleted_cachedRows.begin();
...
sscanf(row[7], "%li", &(pRow->m_FK_Users_RecordInfo));
		...
		Key key(pRow);
                ...
                map<Table_DeviceTemplate_Input::Key, Row_DeviceTemplate_Input*, Table_DeviceTemplate_Input::Key_Less>::iterator i = cachedRows.find(key);
...
Row_DeviceTemplate_Input* Table_DeviceTemplate_Input::GetRow(long int in_FK_DeviceTemplate, long int in_FK_Input)
{
	...
	Key row_key(in_FK_DeviceTemplate, in_FK_Input);

	map<Key, Row_DeviceTemplate_Input*, Key_Less>::iterator i;
...
Row_DeviceTemplate_Input* Table_DeviceTemplate_Input::FetchRow(Table_DeviceTemplate_Input::Key &key)
{
	PLUTO_SAFETY_LOCK(M, m_Mutex);
