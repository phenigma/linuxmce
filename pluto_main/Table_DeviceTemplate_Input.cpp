...
long int Row_DeviceTemplate_Input::psc_id_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_psc_id;}
long int Row_DeviceTemplate_Input::psc_batch_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_psc_batch;}
long int Row_DeviceTemplate_Input::psc_user_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_psc_user;}
short int Row_DeviceTemplate_Input::psc_frozen_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_psc_frozen;}
string Row_DeviceTemplate_Input::psc_mod_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
values_list_comma_separated = values_list_comma_separated + pRow->PK_DeviceTemplate_Input_asSQL()+", "+pRow->FK_DeviceTemplate_asSQL()+", "+pRow->FK_Input_asSQL()+", "+pRow->FK_ConnectorType_asSQL()+", "+pRow->psc_id_asSQL()+", "+pRow->psc_batch_asSQL()+", "+pRow->psc_user_asSQL()+", "+pRow->psc_frozen_asSQL()+", "+pRow->psc_mod_asSQL();

	
		string query = "insert into DeviceTemplate_Input (PK_DeviceTemplate_Input, FK_DeviceTemplate, FK_Input, FK_ConnectorType, psc_id, psc_batch, psc_user, psc_frozen, psc_mod) values ("+
