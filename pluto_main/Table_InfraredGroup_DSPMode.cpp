...
{
	map<Table_InfraredGroup_DSPMode::Key, class Row_InfraredGroup_DSPMode*, Table_InfraredGroup_DSPMode::Key_Less>::iterator it;
...
void Row_InfraredGroup_DSPMode::Delete()
{
	...
	if (!is_deleted)
		if (is_added)	
		{	
			vector<Row_InfraredGroup_DSPMode*>::iterator i;	
		...
		{
			Table_InfraredGroup_DSPMode::Key key(this);					
			map<Table_InfraredGroup_DSPMode::Key, Row_InfraredGroup_DSPMode*, Table_InfraredGroup_DSPMode::Key_Less>::iterator i = table->cachedRows.find(key);
...
return m_FK_Command;}
string Row_InfraredGroup_DSPMode::Modification_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_Modification_RecordInfo;}
short int Row_InfraredGroup_DSPMode::IsNew_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsNew_RecordInfo;}
short int Row_InfraredGroup_DSPMode::IsDeleted_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsDeleted_RecordInfo;}
long int Row_InfraredGroup_DSPMode::FK_Users_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Row_InfraredGroup_DSPMode::Modification_RecordInfo_set(string val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_Modification_RecordInfo = val; is_modified=true; is_null[4]=false;}
void Row_InfraredGroup_DSPMode::IsNew_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsNew_RecordInfo = val; is_modified=true; is_null[5]=false;}
void Row_InfraredGroup_DSPMode::IsDeleted_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsDeleted_RecordInfo = val; is_modified=true; is_null[6]=false;}
void Row_InfraredGroup_DSPMode::FK_Users_RecordInfo_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_FK_Users_RecordInfo = val; is_modified=true; is_null[7]=false;}

		
bool Row_InfraredGroup_DSPMode::IsNew_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[5];}
bool Row_InfraredGroup_DSPMode::IsDeleted_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[6];}
bool Row_InfraredGroup_DSPMode::FK_Users_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[7];}

			
void Row_InfraredGroup_DSPMode::IsNew_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[5]=val;}
void Row_InfraredGroup_DSPMode::IsDeleted_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[6]=val;}
void Row_InfraredGroup_DSPMode::FK_Users_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_InfraredGroup_DSPMode::Modification_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_InfraredGroup_DSPMode::IsNew_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_InfraredGroup_DSPMode::IsDeleted_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_InfraredGroup_DSPMode::FK_Users_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
//insert added
	...
	{
		vector<Row_InfraredGroup_DSPMode*>::iterator i = addedRows.begin();
	
		Row_InfraredGroup_DSPMode *pRow = *i;
	
		
string values_list_comma_separated;
values_list_comma_separated = values_list_comma_separated + pRow->FK_InfraredGroup_asSQL()+", "+pRow->FK_DSPMode_asSQL()+", "+pRow->Description_asSQL()+", "+pRow->FK_Command_asSQL()+", "+pRow->Modification_RecordInfo_asSQL()+", "+pRow->IsNew_RecordInfo_asSQL()+", "+pRow->IsDeleted_RecordInfo_asSQL()+", "+pRow->FK_Users_RecordInfo_asSQL();

	
		string query = "insert into InfraredGroup_DSPMode (FK_InfraredGroup, FK_DSPMode, Description, FK_Command, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo) values ("+
...
//update modified
	...
	for (map<Key, Row_InfraredGroup_DSPMode*, Key_Less>::iterator i = cachedRows.begin(); i!= cachedRows.end(); i++)
		if	(((*i).second)->is_modified)
	{
		Row_InfraredGroup_DSPMode* pRow = (*i).second;	
		Key key(pRow);	
...
update_values_list = update_values_list + "FK_InfraredGroup="+pRow->FK_InfraredGroup_asSQL()+", FK_DSPMode="+pRow->FK_DSPMode_asSQL()+", Description="+pRow->Description_asSQL()+", FK_Command="+pRow->FK_Command_asSQL()+", Modification_RecordInfo="+pRow->Modification_RecordInfo_asSQL()+", IsNew_RecordInfo="+pRow->IsNew_RecordInfo_asSQL()+", IsDeleted_RecordInfo="+pRow->IsDeleted_RecordInfo_asSQL()+", FK_Users_RecordInfo="+pRow->FK_Users_RecordInfo_asSQL();
...
//delete deleted added
	...
	{	
		vector<Row_InfraredGroup_DSPMode*>::iterator i = deleted_addedRows.begin();
		delete (*i);
...
//delete deleted cached
	...
	{	
		map<Key, Row_InfraredGroup_DSPMode*, Key_Less>::iterator i = deleted_cachedRows.begin();
...
bool Table_InfraredGroup_DSPMode::GetRows(string where_statement,vector<class Row_InfraredGroup_DSPMode*> *rows)
{
	...
	string query = "select * from InfraredGroup_DSPMode where " + where_statement;
...
sscanf(row[7], "%li", &(pRow->m_FK_Users_RecordInfo));
		...
		Key key(pRow);
                ...
                map<Table_InfraredGroup_DSPMode::Key, Row_InfraredGroup_DSPMode*, Table_InfraredGroup_DSPMode::Key_Less>::iterator i = cachedRows.find(key);
...
Row_InfraredGroup_DSPMode* Table_InfraredGroup_DSPMode::GetRow(long int in_FK_InfraredGroup, long int in_FK_DSPMode)
{
	...
	Key row_key(in_FK_InfraredGroup, in_FK_DSPMode);

	map<Key, Row_InfraredGroup_DSPMode*, Key_Less>::iterator i;
...
Row_InfraredGroup_DSPMode* Table_InfraredGroup_DSPMode::FetchRow(Table_InfraredGroup_DSPMode::Key &key)
{
	PLUTO_SAFETY_LOCK(M, m_Mutex);
