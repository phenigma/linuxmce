...
class DLL_EXPORT Table_DeviceTemplate_DeviceTemplate_ControlledVia : public TableBase , SingleLongKeyBase
{
private:
...
class Row_Input* FK_Input_Video_getrow();
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_DeviceTemplate_DeviceTemplate_ControlledVia+ m_FK_DeviceTemplate+ m_FK_DeviceTemplate_ControlledVia+ m_Description+ m_RerouteMessagesToParent+ m_AutoCreateChildren+ m_FK_Input_Audio+ m_FK_Input_Video+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod;
		}
	private:
