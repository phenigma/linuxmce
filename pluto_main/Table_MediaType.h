...
class DLL_EXPORT Table_MediaType
{
private:
...
private:		
	...
	map<Table_MediaType::Key, class Row_MediaType*, Table_MediaType::Key_Less> cachedRows;
	map<Table_MediaType::Key, class Row_MediaType*, Table_MediaType::Key_Less> deleted_cachedRows;
	vector<class Row_MediaType*> addedRows;
	vector<class Row_MediaType*> deleted_addedRows;	
...
private:	
	...
	class Row_MediaType* FetchRow(Key &key);
