...
void CommandCategory_FK_CommandCategory_Parent_getrows(vector <class Row_CommandCategory*> *rows);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_CommandCategory+ m_FK_CommandCategory_Parent+ m_Description+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
