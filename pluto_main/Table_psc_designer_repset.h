...
class DLL_EXPORT Table_psc_designer_repset
{
private:
...
private:		
	...
	map<Table_psc_designer_repset::Key, class Row_psc_designer_repset*, Table_psc_designer_repset::Key_Less> cachedRows;
	map<Table_psc_designer_repset::Key, class Row_psc_designer_repset*, Table_psc_designer_repset::Key_Less> deleted_cachedRows;
	vector<class Row_psc_designer_repset*> addedRows;
	vector<class Row_psc_designer_repset*> deleted_addedRows;	
...
private:	
	...
	class Row_psc_designer_repset* FetchRow(Key &key);
...
void Value_set(string val);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_psc_designer_repset+ m_Value;
		}
	private:
