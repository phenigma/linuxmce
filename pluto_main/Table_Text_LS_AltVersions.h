...
class DLL_EXPORT Table_Text_LS_AltVersions : public TableBase , TripleLongKeyBase
{
private:
...
class Row_Language* FK_Language_getrow();
		...
		void SetupSerialization() {
			StartSerializeList() + m_FK_Text+ m_FK_Language+ m_Version+ m_Description+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod;
		}
	private:
