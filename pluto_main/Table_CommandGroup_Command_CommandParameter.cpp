...
string Row_CommandGroup_Command_CommandParameter::IK_CommandParameter_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Row_CommandGroup_Command_CommandParameter::IK_CommandParameter_set(string val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
bool Row_CommandGroup_Command_CommandParameter::IK_CommandParameter_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Row_CommandGroup_Command_CommandParameter::IK_CommandParameter_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
values_list_comma_separated = values_list_comma_separated + pRow->FK_CommandGroup_Command_asSQL()+", "+pRow->FK_CommandParameter_asSQL()+", "+pRow->IK_CommandParameter_asSQL()+", "+pRow->psc_id_asSQL()+", "+pRow->psc_batch_asSQL()+", "+pRow->psc_user_asSQL()+", "+pRow->psc_frozen_asSQL()+", "+pRow->psc_mod_asSQL();

	
		string query = "insert into CommandGroup_Command_CommandParameter (FK_CommandGroup_Command, FK_CommandParameter, IK_CommandParameter, psc_id, psc_batch, psc_user, psc_frozen, psc_mod) values ("+
