...
{
	map<Table_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::Key, class Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe*, Table_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::Key_Less>::iterator it;
...
void Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::Delete()
{
	...
	if (!is_deleted)
		if (is_added)	
		{	
			vector<Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe*>::iterator i;	
		...
		{
			Table_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::Key key(this);					
			map<Table_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::Key, Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe*, Table_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::Key_Less>::iterator i = table->cachedRows.find(key);
...
return m_ToChild;}
string Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::Modification_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_Modification_RecordInfo;}
short int Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::IsNew_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsNew_RecordInfo;}
short int Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::IsDeleted_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsDeleted_RecordInfo;}
long int Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::FK_Users_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::Modification_RecordInfo_set(string val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_Modification_RecordInfo = val; is_modified=true; is_null[5]=false;}
void Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::IsNew_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsNew_RecordInfo = val; is_modified=true; is_null[6]=false;}
void Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::IsDeleted_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsDeleted_RecordInfo = val; is_modified=true; is_null[7]=false;}
void Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::FK_Users_RecordInfo_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
return is_null[4];}
bool Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::IsNew_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[6];}
bool Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::IsDeleted_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[7];}
bool Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::FK_Users_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
is_null[4]=val;}
void Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::IsNew_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[6]=val;}
void Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::IsDeleted_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[7]=val;}
void Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::FK_Users_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::Modification_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::IsNew_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::IsDeleted_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::FK_Users_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
//insert added
	...
	{
		vector<Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe*>::iterator i = addedRows.begin();
	
		Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe *pRow = *i;
	
		
string values_list_comma_separated;
values_list_comma_separated = values_list_comma_separated + pRow->FK_DeviceTemplate_DeviceTemplate_ControlledVia_asSQL()+", "+pRow->FK_Pipe_asSQL()+", "+pRow->FK_Input_asSQL()+", "+pRow->FK_Output_asSQL()+", "+pRow->ToChild_asSQL()+", "+pRow->Modification_RecordInfo_asSQL()+", "+pRow->IsNew_RecordInfo_asSQL()+", "+pRow->IsDeleted_RecordInfo_asSQL()+", "+pRow->FK_Users_RecordInfo_asSQL();

	
		string query = "insert into DeviceTemplate_DeviceTemplate_ControlledVia_Pipe (FK_DeviceTemplate_DeviceTemplate_ControlledVia, FK_Pipe, FK_Input, FK_Output, ToChild, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo) values ("+
...
//update modified
	...
	for (map<Key, Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe*, Key_Less>::iterator i = cachedRows.begin(); i!= cachedRows.end(); i++)
		if	(((*i).second)->is_modified)
	{
		Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe* pRow = (*i).second;	
		Key key(pRow);	

		char tmp_FK_DeviceTemplate_DeviceTemplate_ControlledVia[32];
sprintf(tmp_FK_DeviceTemplate_DeviceTemplate_ControlledVia, "%li", key.pk_FK_DeviceTemplate_DeviceTemplate_ControlledVia);
...
update_values_list = update_values_list + "FK_DeviceTemplate_DeviceTemplate_ControlledVia="+pRow->FK_DeviceTemplate_DeviceTemplate_ControlledVia_asSQL()+", FK_Pipe="+pRow->FK_Pipe_asSQL()+", FK_Input="+pRow->FK_Input_asSQL()+", FK_Output="+pRow->FK_Output_asSQL()+", ToChild="+pRow->ToChild_asSQL()+", Modification_RecordInfo="+pRow->Modification_RecordInfo_asSQL()+", IsNew_RecordInfo="+pRow->IsNew_RecordInfo_asSQL()+", IsDeleted_RecordInfo="+pRow->IsDeleted_RecordInfo_asSQL()+", FK_Users_RecordInfo="+pRow->FK_Users_RecordInfo_asSQL();
...
//delete deleted added
	...
	{	
		vector<Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe*>::iterator i = deleted_addedRows.begin();
		delete (*i);
...
//delete deleted cached
	...
	{	
		map<Key, Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe*, Key_Less>::iterator i = deleted_cachedRows.begin();
...
bool Table_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::GetRows(string where_statement,vector<class Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe*> *rows)
{
	...
	string query = "select * from DeviceTemplate_DeviceTemplate_ControlledVia_Pipe where " + where_statement;
...
sscanf(row[8], "%li", &(pRow->m_FK_Users_RecordInfo));
		...
		Key key(pRow);
                ...
                map<Table_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::Key, Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe*, Table_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::Key_Less>::iterator i = cachedRows.find(key);
...
Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe* Table_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::GetRow(long int in_FK_DeviceTemplate_DeviceTemplate_ControlledVia, long int in_FK_Pipe)
{
	...
	Key row_key(in_FK_DeviceTemplate_DeviceTemplate_ControlledVia, in_FK_Pipe);

	map<Key, Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe*, Key_Less>::iterator i;
...
Row_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe* Table_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::FetchRow(Table_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe::Key &key)
{
	PLUTO_SAFETY_LOCK(M, m_Mutex);
