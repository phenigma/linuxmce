...
values_list_comma_separated = values_list_comma_separated + pRow->FK_DeviceTemplate_DeviceCategory_ControlledVia_asSQL()+", "+pRow->FK_Pipe_asSQL()+", "+pRow->FK_Command_Input_asSQL()+", "+pRow->FK_Command_Output_asSQL()+", "+pRow->ToChild_asSQL()+", "+pRow->psc_id_asSQL()+", "+pRow->psc_batch_asSQL()+", "+pRow->psc_user_asSQL()+", "+pRow->psc_frozen_asSQL()+", "+pRow->psc_mod_asSQL();

	
		string query = "insert into DeviceTemplate_DeviceCategory_ControlledVia_Pipe (FK_DeviceTemplate_DeviceCategory_ControlledVia, FK_Pipe, FK_Command_Input, FK_Command_Output, ToChild, psc_id, psc_batch, psc_user, psc_frozen, psc_mod) values ("+
...
update_values_list = update_values_list + "FK_DeviceTemplate_DeviceCategory_ControlledVia="+pRow->FK_DeviceTemplate_DeviceCategory_ControlledVia_asSQL()+", FK_Pipe="+pRow->FK_Pipe_asSQL()+", FK_Command_Input="+pRow->FK_Command_Input_asSQL()+", FK_Command_Output="+pRow->FK_Command_Output_asSQL()+", ToChild="+pRow->ToChild_asSQL()+", psc_id="+pRow->psc_id_asSQL()+", psc_batch="+pRow->psc_batch_asSQL()+", psc_user="+pRow->psc_user_asSQL()+", psc_frozen="+pRow->psc_frozen_asSQL()+", psc_mod="+pRow->psc_mod_asSQL();
...
bool Table_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::GetRows(string where_statement,vector<class Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe*> *rows)
{
	...
	if( StringUtils::StartsWith(where_statement,"where ",true) || StringUtils::StartsWith(where_statement,"join ",true) )
		query = "select * from DeviceTemplate_DeviceCategory_ControlledVia_Pipe " + where_statement;
	else if( StringUtils::StartsWith(where_statement,"select ",true) )
		query = where_statement;
	else
		query = "select * from DeviceTemplate_DeviceCategory_ControlledVia_Pipe where " + where_statement;
