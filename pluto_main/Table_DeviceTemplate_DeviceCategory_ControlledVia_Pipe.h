...
class Row_Output* FK_Output_getrow();
		...
		void SetupSerialization() {
			StartSerializeList() + m_FK_DeviceTemplate_DeviceCategory_ControlledVia+ m_FK_Pipe+ m_FK_Input+ m_FK_Output+ m_ToChild+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod;
		}
	private:
