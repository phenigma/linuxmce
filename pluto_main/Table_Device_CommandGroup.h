...
class DLL_EXPORT Table_Device_CommandGroup : public TableBase , DoubleLongKeyBase
{
private:
...
class Row_CommandGroup* FK_CommandGroup_getrow();
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_FK_Device+ m_FK_CommandGroup+ m_Sort+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod;
		}
	private:
