...
CreateTable_CommandGroup_EntGroup();
...
CreateTable_DeviceCategory_DeviceObj();
...
CreateTable_DeviceTemplate_Package();
...
CreateTable_Device_Package_Directory();
...
CreateTable_MobilePhoneVersion();
CreateTable_OperatingSystem();
CreateTable_OperatingSystem_Directory();
CreateTable_Orbiter();
...
DeleteTable_CommandGroup_EntGroup();
...
DeleteTable_DeviceCategory_DeviceObj();
...
DeleteTable_DeviceTemplate_Package();
...
DeleteTable_Device_Package_Directory();
...
DeleteTable_MobilePhoneVersion();
DeleteTable_OperatingSystem();
DeleteTable_OperatingSystem_Directory();
DeleteTable_Orbiter();
