...
class DLL_EXPORT Table_License
{
private:
...
private:		
	...
	map<Table_License::Key, class Row_License*, Table_License::Key_Less> cachedRows;
	map<Table_License::Key, class Row_License*, Table_License::Key_Less> deleted_cachedRows;
	vector<class Row_License*> addedRows;
	vector<class Row_License*> deleted_addedRows;	
...
private:	
	...
	class Row_License* FetchRow(Key &key);
