...
class Row_Event* FK_Event_getrow();
		...
		void SetupSerialization() {
			StartSerializeList() + m_FK_DeviceTemplate+ m_FK_Event+ m_Description+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
