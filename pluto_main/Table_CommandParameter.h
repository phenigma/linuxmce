...
class DLL_EXPORT Table_CommandParameter
{
private:
...
public:
	...
	Table_CommandParameter(Database_pluto_main *pDatabase):database(pDatabase), m_Mutex("CommandParameter")
	{
...
private:		
	...
	map<Table_CommandParameter::Key, class Row_CommandParameter*, Table_CommandParameter::Key_Less> cachedRows;
	map<Table_CommandParameter::Key, class Row_CommandParameter*, Table_CommandParameter::Key_Less> deleted_cachedRows;
	vector<class Row_CommandParameter*> addedRows;
	vector<class Row_CommandParameter*> deleted_addedRows;	
...
private:	
	...
	class Row_CommandParameter* FetchRow(Key &key);
		
			
};

class DLL_EXPORT Row_CommandParameter : public TableRow, public SerializeClass
	{
...
void Command_CommandParameter_FK_CommandParameter_getrows(vector <class Row_Command_CommandParameter*> *rows);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_CommandParameter+ m_Description+ m_Define+ m_Comments+ m_FK_ParameterType+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
