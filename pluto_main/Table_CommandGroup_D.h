...
class DLL_EXPORT Table_CommandGroup_D
{
private:
...
public:
	...
	Table_CommandGroup_D(Database_pluto_main *pDatabase):database(pDatabase), m_Mutex("CommandGroup_D")
	{
...
private:		
	...
	map<Table_CommandGroup_D::Key, class Row_CommandGroup_D*, Table_CommandGroup_D::Key_Less> cachedRows;
	map<Table_CommandGroup_D::Key, class Row_CommandGroup_D*, Table_CommandGroup_D::Key_Less> deleted_cachedRows;
	vector<class Row_CommandGroup_D*> addedRows;
	vector<class Row_CommandGroup_D*> deleted_addedRows;	
...
private:	
	...
	class Row_CommandGroup_D* FetchRow(Key &key);
...
void DesignObjVariation_Zone_FK_CommandGroup_D_getrows(vector <class Row_DesignObjVariation_Zone*> *rows);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_CommandGroup_D+ m_Description+ m_CanBeHidden+ m_FK_Criteria_Orbiter+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
