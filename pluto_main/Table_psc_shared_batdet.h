...
class DLL_EXPORT Table_psc_shared_batdet
{
private:
...
private:		
	...
	map<Table_psc_shared_batdet::Key, class Row_psc_shared_batdet*, Table_psc_shared_batdet::Key_Less> cachedRows;
	map<Table_psc_shared_batdet::Key, class Row_psc_shared_batdet*, Table_psc_shared_batdet::Key_Less> deleted_cachedRows;
	vector<class Row_psc_shared_batdet*> addedRows;
	vector<class Row_psc_shared_batdet*> deleted_addedRows;	
...
private:	
	...
	class Row_psc_shared_batdet* FetchRow(Key &key);
