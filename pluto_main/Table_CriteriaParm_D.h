...
class Row_CannedEvents_CriteriaParmList* FK_CannedEvents_CriteriaParmList_getrow();
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_CriteriaParm+ m_FK_CriteriaParmNesting_D+ m_FK_CriteriaParmList+ m_Operator+ m_Value+ m_FK_CannedEvents_CriteriaParmList+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
