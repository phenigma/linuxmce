...
values_list_comma_separated = values_list_comma_separated + pRow->PK_DesignObjCategory_asSQL()+", "+pRow->FK_DesignObjCategory_Parent_asSQL()+", "+pRow->Description_asSQL()+", "+pRow->psc_id_asSQL()+", "+pRow->psc_batch_asSQL()+", "+pRow->psc_user_asSQL()+", "+pRow->psc_frozen_asSQL()+", "+pRow->psc_mod_asSQL();

	
		string query = "insert into DesignObjCategory (PK_DesignObjCategory, FK_DesignObjCategory_Parent, Description, psc_id, psc_batch, psc_user, psc_frozen, psc_mod) values ("+
