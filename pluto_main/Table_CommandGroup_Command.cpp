...
{
	map<Table_CommandGroup_Command::Key, class Row_CommandGroup_Command*, Table_CommandGroup_Command::Key_Less>::iterator it;
...
void Row_CommandGroup_Command::Delete()
{
	...
	if (!is_deleted)
		if (is_added)	
		{	
			vector<Row_CommandGroup_Command*>::iterator i;	
		...
		{
			Table_CommandGroup_Command::Key key(this);					
			map<Table_CommandGroup_Command::Key, Row_CommandGroup_Command*, Table_CommandGroup_Command::Key_Less>::iterator i = table->cachedRows.find(key);
...
return m_OrderNum;}
string Row_CommandGroup_Command::Modification_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_Modification_RecordInfo;}
short int Row_CommandGroup_Command::IsNew_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsNew_RecordInfo;}
short int Row_CommandGroup_Command::IsDeleted_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsDeleted_RecordInfo;}
long int Row_CommandGroup_Command::FK_Users_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Row_CommandGroup_Command::Modification_RecordInfo_set(string val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_Modification_RecordInfo = val; is_modified=true; is_null[7]=false;}
void Row_CommandGroup_Command::IsNew_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsNew_RecordInfo = val; is_modified=true; is_null[8]=false;}
void Row_CommandGroup_Command::IsDeleted_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsDeleted_RecordInfo = val; is_modified=true; is_null[9]=false;}
void Row_CommandGroup_Command::FK_Users_RecordInfo_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
return is_null[6];}
bool Row_CommandGroup_Command::IsNew_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[8];}
bool Row_CommandGroup_Command::IsDeleted_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[9];}
bool Row_CommandGroup_Command::FK_Users_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
is_null[6]=val;}
void Row_CommandGroup_Command::IsNew_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[8]=val;}
void Row_CommandGroup_Command::IsDeleted_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[9]=val;}
void Row_CommandGroup_Command::FK_Users_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_CommandGroup_Command::Modification_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_CommandGroup_Command::IsNew_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_CommandGroup_Command::IsDeleted_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_CommandGroup_Command::FK_Users_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
//insert added
	...
	{
		vector<Row_CommandGroup_Command*>::iterator i = addedRows.begin();
	
		Row_CommandGroup_Command *pRow = *i;
...
values_list_comma_separated = values_list_comma_separated + pRow->PK_CommandGroup_Command_asSQL()+", "+pRow->FK_CommandGroup_asSQL()+", "+pRow->FK_Command_asSQL()+", "+pRow->FK_Device_asSQL()+", "+pRow->FK_DeviceGroup_asSQL()+", "+pRow->TurnOff_asSQL()+", "+pRow->OrderNum_asSQL()+", "+pRow->Modification_RecordInfo_asSQL()+", "+pRow->IsNew_RecordInfo_asSQL()+", "+pRow->IsDeleted_RecordInfo_asSQL()+", "+pRow->FK_Users_RecordInfo_asSQL();
		...
		string query = "insert into CommandGroup_Command (PK_CommandGroup_Command, FK_CommandGroup, FK_Command, FK_Device, FK_DeviceGroup, TurnOff, OrderNum, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo) values ("+
...
//update modified
	...
	for (map<Key, Row_CommandGroup_Command*, Key_Less>::iterator i = cachedRows.begin(); i!= cachedRows.end(); i++)
		if	(((*i).second)->is_modified)
	{
		Row_CommandGroup_Command* pRow = (*i).second;	
		Key key(pRow);	

		char tmp_PK_CommandGroup_Command[32];
sprintf(tmp_PK_CommandGroup_Command, "%li", key.pk_PK_CommandGroup_Command);
...
//delete deleted added
	...
	{	
		vector<Row_CommandGroup_Command*>::iterator i = deleted_addedRows.begin();
		delete (*i);
...
//delete deleted cached
	...
	{	
		map<Key, Row_CommandGroup_Command*, Key_Less>::iterator i = deleted_cachedRows.begin();
...
bool Table_CommandGroup_Command::GetRows(string where_statement,vector<class Row_CommandGroup_Command*> *rows)
{
	...
	string query = "select * from CommandGroup_Command where " + where_statement;
...
sscanf(row[10], "%li", &(pRow->m_FK_Users_RecordInfo));
		...
		Key key(pRow);
                ...
                map<Table_CommandGroup_Command::Key, Row_CommandGroup_Command*, Table_CommandGroup_Command::Key_Less>::iterator i = cachedRows.find(key);
...
Row_CommandGroup_Command* Table_CommandGroup_Command::GetRow(long int in_PK_CommandGroup_Command)
{
	...
	Key row_key(in_PK_CommandGroup_Command);

	map<Key, Row_CommandGroup_Command*, Key_Less>::iterator i;
...
Row_CommandGroup_Command* Table_CommandGroup_Command::FetchRow(Table_CommandGroup_Command::Key &key)
{
	PLUTO_SAFETY_LOCK(M, m_Mutex);
