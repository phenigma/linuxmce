...
class DLL_EXPORT Table_DeviceTemplate_InfraredGroup
{
private:
...
long int pk_FK_DeviceTemplate;
	...
	map<Table_DeviceTemplate_InfraredGroup::Key, class Row_DeviceTemplate_InfraredGroup*, Table_DeviceTemplate_InfraredGroup::Key_Less> cachedRows;
	map<Table_DeviceTemplate_InfraredGroup::Key, class Row_DeviceTemplate_InfraredGroup*, Table_DeviceTemplate_InfraredGroup::Key_Less> deleted_cachedRows;
	vector<class Row_DeviceTemplate_InfraredGroup*> addedRows;
	vector<class Row_DeviceTemplate_InfraredGroup*> deleted_addedRows;	
...
private:	
	...
	class Row_DeviceTemplate_InfraredGroup* FetchRow(Key &key);
...
class Row_DeviceTemplate* FK_DeviceTemplate_getrow();
		...
		void SetupSerialization() {
			StartSerializeList() + m_FK_InfraredGroup+ m_FK_DeviceTemplate+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
