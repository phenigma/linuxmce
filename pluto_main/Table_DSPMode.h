...
class DLL_EXPORT Table_DSPMode
{
private:
...
private:		
	...
	map<Table_DSPMode::Key, class Row_DSPMode*, Table_DSPMode::Key_Less> cachedRows;
	map<Table_DSPMode::Key, class Row_DSPMode*, Table_DSPMode::Key_Less> deleted_cachedRows;
	vector<class Row_DSPMode*> addedRows;
	vector<class Row_DSPMode*> deleted_addedRows;	
...
private:	
	...
	class Row_DSPMode* FetchRow(Key &key);
...
void InfraredGroup_DSPMode_FK_DSPMode_getrows(vector <class Row_InfraredGroup_DSPMode*> *rows);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_DSPMode+ m_Description+ m_Define+ m_FK_Command+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
