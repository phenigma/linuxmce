...
class DLL_EXPORT Table_ConnectorType
{
private:
...
public:
	...
	Table_ConnectorType(Database_pluto_main *pDatabase):database(pDatabase), m_Mutex("ConnectorType")
	{
...
private:		
	...
	map<Table_ConnectorType::Key, class Row_ConnectorType*, Table_ConnectorType::Key_Less> cachedRows;
	map<Table_ConnectorType::Key, class Row_ConnectorType*, Table_ConnectorType::Key_Less> deleted_cachedRows;
	vector<class Row_ConnectorType*> addedRows;
	vector<class Row_ConnectorType*> deleted_addedRows;	
...
private:	
	...
	class Row_ConnectorType* FetchRow(Key &key);
		
			
};

class DLL_EXPORT Row_ConnectorType : public TableRow, public SerializeClass
	{
...
void FK_Users_RecordInfo_setNull(bool val);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_ConnectorType+ m_Description+ m_Define+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
