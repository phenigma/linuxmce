...
values_list_comma_separated = values_list_comma_separated + pRow->PK_psc_ir_bathdr_asSQL()+", "+pRow->date_asSQL()+", "+pRow->comments_asSQL();

	
		string query = "insert into psc_ir_bathdr (PK_psc_ir_bathdr, date, comments) values ("+
...
update_values_list = update_values_list + "PK_psc_ir_bathdr="+pRow->PK_psc_ir_bathdr_asSQL()+", date="+pRow->date_asSQL()+", comments="+pRow->comments_asSQL();
