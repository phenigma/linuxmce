...
class DLL_EXPORT Table_psc_dce_batdet
{
private:
...
private:		
	...
	map<Table_psc_dce_batdet::Key, class Row_psc_dce_batdet*, Table_psc_dce_batdet::Key_Less> cachedRows;
	map<Table_psc_dce_batdet::Key, class Row_psc_dce_batdet*, Table_psc_dce_batdet::Key_Less> deleted_cachedRows;
	vector<class Row_psc_dce_batdet*> addedRows;
	vector<class Row_psc_dce_batdet*> deleted_addedRows;	
...
private:	
	...
	class Row_psc_dce_batdet* FetchRow(Key &key);
