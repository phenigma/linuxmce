...
values_list_comma_separated = values_list_comma_separated + pRow->PK_psc_document_bathdr_asSQL()+", "+pRow->date_asSQL()+", "+pRow->comments_asSQL();

	
		string query = "insert into psc_document_bathdr (PK_psc_document_bathdr, date, comments) values ("+
...
update_values_list = update_values_list + "PK_psc_document_bathdr="+pRow->PK_psc_document_bathdr_asSQL()+", date="+pRow->date_asSQL()+", comments="+pRow->comments_asSQL();
