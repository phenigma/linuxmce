...
{
	map<Table_DeviceCommandGroup_Command::Key, class Row_DeviceCommandGroup_Command*, Table_DeviceCommandGroup_Command::Key_Less>::iterator it;
...
void Row_DeviceCommandGroup_Command::Delete()
{
	...
	if (!is_deleted)
		if (is_added)	
		{	
			vector<Row_DeviceCommandGroup_Command*>::iterator i;	
		...
		{
			Table_DeviceCommandGroup_Command::Key key(this);					
			map<Table_DeviceCommandGroup_Command::Key, Row_DeviceCommandGroup_Command*, Table_DeviceCommandGroup_Command::Key_Less>::iterator i = table->cachedRows.find(key);
...
string Row_DeviceCommandGroup_Command::Modification_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_Modification_RecordInfo;}
short int Row_DeviceCommandGroup_Command::IsNew_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsNew_RecordInfo;}
short int Row_DeviceCommandGroup_Command::IsDeleted_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsDeleted_RecordInfo;}
long int Row_DeviceCommandGroup_Command::FK_Users_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Row_DeviceCommandGroup_Command::Modification_RecordInfo_set(string val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_Modification_RecordInfo = val; is_modified=true; is_null[3]=false;}
void Row_DeviceCommandGroup_Command::IsNew_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsNew_RecordInfo = val; is_modified=true; is_null[4]=false;}
void Row_DeviceCommandGroup_Command::IsDeleted_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsDeleted_RecordInfo = val; is_modified=true; is_null[5]=false;}
void Row_DeviceCommandGroup_Command::FK_Users_RecordInfo_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
return is_null[2];}
bool Row_DeviceCommandGroup_Command::IsNew_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[4];}
bool Row_DeviceCommandGroup_Command::IsDeleted_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[5];}
bool Row_DeviceCommandGroup_Command::FK_Users_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
is_null[2]=val;}
void Row_DeviceCommandGroup_Command::IsNew_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[4]=val;}
void Row_DeviceCommandGroup_Command::IsDeleted_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[5]=val;}
void Row_DeviceCommandGroup_Command::FK_Users_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceCommandGroup_Command::Modification_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceCommandGroup_Command::IsNew_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceCommandGroup_Command::IsDeleted_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceCommandGroup_Command::FK_Users_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
//insert added
	...
	{
		vector<Row_DeviceCommandGroup_Command*>::iterator i = addedRows.begin();
	
		Row_DeviceCommandGroup_Command *pRow = *i;
	
		
string values_list_comma_separated;
values_list_comma_separated = values_list_comma_separated + pRow->FK_DeviceCommandGroup_asSQL()+", "+pRow->FK_Command_asSQL()+", "+pRow->Description_asSQL()+", "+pRow->Modification_RecordInfo_asSQL()+", "+pRow->IsNew_RecordInfo_asSQL()+", "+pRow->IsDeleted_RecordInfo_asSQL()+", "+pRow->FK_Users_RecordInfo_asSQL();

	
		string query = "insert into DeviceCommandGroup_Command (FK_DeviceCommandGroup, FK_Command, Description, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo) values ("+
...
//update modified
	...
	for (map<Key, Row_DeviceCommandGroup_Command*, Key_Less>::iterator i = cachedRows.begin(); i!= cachedRows.end(); i++)
		if	(((*i).second)->is_modified)
	{
		Row_DeviceCommandGroup_Command* pRow = (*i).second;	
		Key key(pRow);	
...
update_values_list = update_values_list + "FK_DeviceCommandGroup="+pRow->FK_DeviceCommandGroup_asSQL()+", FK_Command="+pRow->FK_Command_asSQL()+", Description="+pRow->Description_asSQL()+", Modification_RecordInfo="+pRow->Modification_RecordInfo_asSQL()+", IsNew_RecordInfo="+pRow->IsNew_RecordInfo_asSQL()+", IsDeleted_RecordInfo="+pRow->IsDeleted_RecordInfo_asSQL()+", FK_Users_RecordInfo="+pRow->FK_Users_RecordInfo_asSQL();
...
//delete deleted added
	...
	{	
		vector<Row_DeviceCommandGroup_Command*>::iterator i = deleted_addedRows.begin();
		delete (*i);
...
//delete deleted cached
	...
	{	
		map<Key, Row_DeviceCommandGroup_Command*, Key_Less>::iterator i = deleted_cachedRows.begin();
...
bool Table_DeviceCommandGroup_Command::GetRows(string where_statement,vector<class Row_DeviceCommandGroup_Command*> *rows)
{
	...
	string query = "select * from DeviceCommandGroup_Command where " + where_statement;
...
sscanf(row[6], "%li", &(pRow->m_FK_Users_RecordInfo));
		...
		Key key(pRow);
                ...
                map<Table_DeviceCommandGroup_Command::Key, Row_DeviceCommandGroup_Command*, Table_DeviceCommandGroup_Command::Key_Less>::iterator i = cachedRows.find(key);
...
Row_DeviceCommandGroup_Command* Table_DeviceCommandGroup_Command::GetRow(long int in_FK_DeviceCommandGroup, long int in_FK_Command)
{
	...
	Key row_key(in_FK_DeviceCommandGroup, in_FK_Command);

	map<Key, Row_DeviceCommandGroup_Command*, Key_Less>::iterator i;
...
Row_DeviceCommandGroup_Command* Table_DeviceCommandGroup_Command::FetchRow(Table_DeviceCommandGroup_Command::Key &key)
{
	PLUTO_SAFETY_LOCK(M, m_Mutex);
