...
void EventParameter_FK_ParameterType_getrows(vector <class Row_EventParameter*> *rows);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_ParameterType+ m_Description+ m_Define+ m_CPPType+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
