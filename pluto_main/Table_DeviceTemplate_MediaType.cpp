...
{
	map<Table_DeviceTemplate_MediaType::Key, class Row_DeviceTemplate_MediaType*, Table_DeviceTemplate_MediaType::Key_Less>::iterator it;
...
void Row_DeviceTemplate_MediaType::Delete()
{
	...
	if (!is_deleted)
		if (is_added)	
		{	
			vector<Row_DeviceTemplate_MediaType*>::iterator i;	
		...
		{
			Table_DeviceTemplate_MediaType::Key key(this);					
			map<Table_DeviceTemplate_MediaType::Key, Row_DeviceTemplate_MediaType*, Table_DeviceTemplate_MediaType::Key_Less>::iterator i = table->cachedRows.find(key);
...
long int Row_DeviceTemplate_MediaType::PK_DeviceTemplate_MediaType_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_PK_DeviceTemplate_MediaType;}
long int Row_DeviceTemplate_MediaType::FK_DeviceTemplate_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_FK_DeviceTemplate;}
long int Row_DeviceTemplate_MediaType::FK_MediaType_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_FK_MediaType;}
short int Row_DeviceTemplate_MediaType::CanPlayFromDiskDrive_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_CanPlayFromDiskDrive;}
short int Row_DeviceTemplate_MediaType::CanStoreOnServer_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_CanStoreOnServer;}
short int Row_DeviceTemplate_MediaType::CanSetPosition_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_CanSetPosition;}
short int Row_DeviceTemplate_MediaType::StopOtherMediaInEntArea_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_StopOtherMediaInEntArea;}
string Row_DeviceTemplate_MediaType::Extensions_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_Extensions;}
string Row_DeviceTemplate_MediaType::Modification_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_Modification_RecordInfo;}
short int Row_DeviceTemplate_MediaType::IsNew_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsNew_RecordInfo;}
short int Row_DeviceTemplate_MediaType::IsDeleted_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsDeleted_RecordInfo;}
long int Row_DeviceTemplate_MediaType::FK_Users_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_FK_Users_RecordInfo;}

		
void Row_DeviceTemplate_MediaType::PK_DeviceTemplate_MediaType_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_PK_DeviceTemplate_MediaType = val; is_modified=true; is_null[0]=false;}
void Row_DeviceTemplate_MediaType::FK_DeviceTemplate_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_FK_DeviceTemplate = val; is_modified=true; is_null[1]=false;}
void Row_DeviceTemplate_MediaType::FK_MediaType_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_FK_MediaType = val; is_modified=true; is_null[2]=false;}
void Row_DeviceTemplate_MediaType::CanPlayFromDiskDrive_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_CanPlayFromDiskDrive = val; is_modified=true; is_null[3]=false;}
void Row_DeviceTemplate_MediaType::CanStoreOnServer_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_CanStoreOnServer = val; is_modified=true; is_null[4]=false;}
void Row_DeviceTemplate_MediaType::CanSetPosition_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_CanSetPosition = val; is_modified=true; is_null[5]=false;}
void Row_DeviceTemplate_MediaType::StopOtherMediaInEntArea_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_StopOtherMediaInEntArea = val; is_modified=true; is_null[6]=false;}
void Row_DeviceTemplate_MediaType::Extensions_set(string val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_Extensions = val; is_modified=true; is_null[7]=false;}
void Row_DeviceTemplate_MediaType::Modification_RecordInfo_set(string val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_Modification_RecordInfo = val; is_modified=true; is_null[8]=false;}
void Row_DeviceTemplate_MediaType::IsNew_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsNew_RecordInfo = val; is_modified=true; is_null[9]=false;}
void Row_DeviceTemplate_MediaType::IsDeleted_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsDeleted_RecordInfo = val; is_modified=true; is_null[10]=false;}
void Row_DeviceTemplate_MediaType::FK_Users_RecordInfo_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_FK_Users_RecordInfo = val; is_modified=true; is_null[11]=false;}

		
bool Row_DeviceTemplate_MediaType::Extensions_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[7];}
bool Row_DeviceTemplate_MediaType::IsNew_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[9];}
bool Row_DeviceTemplate_MediaType::IsDeleted_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[10];}
bool Row_DeviceTemplate_MediaType::FK_Users_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
is_null[7]=val;}
void Row_DeviceTemplate_MediaType::IsNew_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[9]=val;}
void Row_DeviceTemplate_MediaType::IsDeleted_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[10]=val;}
void Row_DeviceTemplate_MediaType::FK_Users_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceTemplate_MediaType::Modification_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceTemplate_MediaType::IsNew_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceTemplate_MediaType::IsDeleted_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceTemplate_MediaType::FK_Users_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Table_DeviceTemplate_MediaType::Commit()
{
...
//insert added
	...
	{
		vector<Row_DeviceTemplate_MediaType*>::iterator i = addedRows.begin();
	
		Row_DeviceTemplate_MediaType *pRow = *i;
...
values_list_comma_separated = values_list_comma_separated + pRow->PK_DeviceTemplate_MediaType_asSQL()+", "+pRow->FK_DeviceTemplate_asSQL()+", "+pRow->FK_MediaType_asSQL()+", "+pRow->CanPlayFromDiskDrive_asSQL()+", "+pRow->CanStoreOnServer_asSQL()+", "+pRow->CanSetPosition_asSQL()+", "+pRow->StopOtherMediaInEntArea_asSQL()+", "+pRow->Extensions_asSQL()+", "+pRow->Modification_RecordInfo_asSQL()+", "+pRow->IsNew_RecordInfo_asSQL()+", "+pRow->IsDeleted_RecordInfo_asSQL()+", "+pRow->FK_Users_RecordInfo_asSQL();
		...
		string query = "insert into DeviceTemplate_MediaType (PK_DeviceTemplate_MediaType, FK_DeviceTemplate, FK_MediaType, CanPlayFromDiskDrive, CanStoreOnServer, CanSetPosition, StopOtherMediaInEntArea, Extensions, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo) values ("+
...
//update modified
	...
	for (map<Key, Row_DeviceTemplate_MediaType*, Key_Less>::iterator i = cachedRows.begin(); i!= cachedRows.end(); i++)
		if	(((*i).second)->is_modified)
	{
		Row_DeviceTemplate_MediaType* pRow = (*i).second;	
		Key key(pRow);	

		char tmp_PK_DeviceTemplate_MediaType[32];
sprintf(tmp_PK_DeviceTemplate_MediaType, "%li", key.pk_PK_DeviceTemplate_MediaType);
...
//delete deleted added
	...
	{	
		vector<Row_DeviceTemplate_MediaType*>::iterator i = deleted_addedRows.begin();
		delete (*i);
...
//delete deleted cached
	...
	{	
		map<Key, Row_DeviceTemplate_MediaType*, Key_Less>::iterator i = deleted_cachedRows.begin();
...
bool Table_DeviceTemplate_MediaType::GetRows(string where_statement,vector<class Row_DeviceTemplate_MediaType*> *rows)
{
	...
	string query = "select * from DeviceTemplate_MediaType where " + where_statement;
...
sscanf(row[6], "%hi", &(pRow->m_StopOtherMediaInEntArea));
}
...
pRow->m_Extensions = string(row[7],lengths[7]);
}
...
sscanf(row[11], "%li", &(pRow->m_FK_Users_RecordInfo));
		...
		Key key(pRow);
                ...
                map<Table_DeviceTemplate_MediaType::Key, Row_DeviceTemplate_MediaType*, Table_DeviceTemplate_MediaType::Key_Less>::iterator i = cachedRows.find(key);
...
Row_DeviceTemplate_MediaType* Table_DeviceTemplate_MediaType::GetRow(long int in_PK_DeviceTemplate_MediaType)
{
	...
	Key row_key(in_PK_DeviceTemplate_MediaType);

	map<Key, Row_DeviceTemplate_MediaType*, Key_Less>::iterator i;
...
Row_DeviceTemplate_MediaType* Table_DeviceTemplate_MediaType::FetchRow(Table_DeviceTemplate_MediaType::Key &key)
{
	PLUTO_SAFETY_LOCK(M, m_Mutex);
