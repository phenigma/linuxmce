...
class DLL_EXPORT Table_psc_local_schema : public TableBase , SingleLongKeyBase
{
private:
...
public:
	...
	Table_psc_local_schema(Database_pluto_main *pDatabase):database(pDatabase), m_Mutex("psc_local_schema")
	{
...
class DLL_EXPORT Row_psc_local_schema : public TableRow, public SerializeClass
	{
