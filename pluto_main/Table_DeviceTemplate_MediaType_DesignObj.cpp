...
{
	map<Table_DeviceTemplate_MediaType_DesignObj::Key, class Row_DeviceTemplate_MediaType_DesignObj*, Table_DeviceTemplate_MediaType_DesignObj::Key_Less>::iterator it;
...
void Row_DeviceTemplate_MediaType_DesignObj::Delete()
{
	...
	if (!is_deleted)
		if (is_added)	
		{	
			vector<Row_DeviceTemplate_MediaType_DesignObj*>::iterator i;	
		...
		{
			Table_DeviceTemplate_MediaType_DesignObj::Key key(this);					
			map<Table_DeviceTemplate_MediaType_DesignObj::Key, Row_DeviceTemplate_MediaType_DesignObj*, Table_DeviceTemplate_MediaType_DesignObj::Key_Less>::iterator i = table->cachedRows.find(key);
...
string Row_DeviceTemplate_MediaType_DesignObj::Modification_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_Modification_RecordInfo;}
short int Row_DeviceTemplate_MediaType_DesignObj::IsNew_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsNew_RecordInfo;}
short int Row_DeviceTemplate_MediaType_DesignObj::IsDeleted_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsDeleted_RecordInfo;}
long int Row_DeviceTemplate_MediaType_DesignObj::FK_Users_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Row_DeviceTemplate_MediaType_DesignObj::Modification_RecordInfo_set(string val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_Modification_RecordInfo = val; is_modified=true; is_null[3]=false;}
void Row_DeviceTemplate_MediaType_DesignObj::IsNew_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsNew_RecordInfo = val; is_modified=true; is_null[4]=false;}
void Row_DeviceTemplate_MediaType_DesignObj::IsDeleted_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsDeleted_RecordInfo = val; is_modified=true; is_null[5]=false;}
void Row_DeviceTemplate_MediaType_DesignObj::FK_Users_RecordInfo_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
return is_null[2];}
bool Row_DeviceTemplate_MediaType_DesignObj::IsNew_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[4];}
bool Row_DeviceTemplate_MediaType_DesignObj::IsDeleted_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[5];}
bool Row_DeviceTemplate_MediaType_DesignObj::FK_Users_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
is_null[2]=val;}
void Row_DeviceTemplate_MediaType_DesignObj::IsNew_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[4]=val;}
void Row_DeviceTemplate_MediaType_DesignObj::IsDeleted_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[5]=val;}
void Row_DeviceTemplate_MediaType_DesignObj::FK_Users_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceTemplate_MediaType_DesignObj::Modification_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceTemplate_MediaType_DesignObj::IsNew_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceTemplate_MediaType_DesignObj::IsDeleted_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceTemplate_MediaType_DesignObj::FK_Users_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Table_DeviceTemplate_MediaType_DesignObj::Commit()
{
...
//insert added
	...
	{
		vector<Row_DeviceTemplate_MediaType_DesignObj*>::iterator i = addedRows.begin();
	
		Row_DeviceTemplate_MediaType_DesignObj *pRow = *i;
	
		
string values_list_comma_separated;
values_list_comma_separated = values_list_comma_separated + pRow->FK_DeviceTemplate_MediaType_asSQL()+", "+pRow->FK_DesignObj_asSQL()+", "+pRow->Description_asSQL()+", "+pRow->Modification_RecordInfo_asSQL()+", "+pRow->IsNew_RecordInfo_asSQL()+", "+pRow->IsDeleted_RecordInfo_asSQL()+", "+pRow->FK_Users_RecordInfo_asSQL();

	
		string query = "insert into DeviceTemplate_MediaType_DesignObj (FK_DeviceTemplate_MediaType, FK_DesignObj, Description, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo) values ("+
...
//update modified
	...
	for (map<Key, Row_DeviceTemplate_MediaType_DesignObj*, Key_Less>::iterator i = cachedRows.begin(); i!= cachedRows.end(); i++)
		if	(((*i).second)->is_modified)
	{
		Row_DeviceTemplate_MediaType_DesignObj* pRow = (*i).second;	
		Key key(pRow);	

		char tmp_FK_DeviceTemplate_MediaType[32];
sprintf(tmp_FK_DeviceTemplate_MediaType, "%li", key.pk_FK_DeviceTemplate_MediaType);
...
update_values_list = update_values_list + "FK_DeviceTemplate_MediaType="+pRow->FK_DeviceTemplate_MediaType_asSQL()+", FK_DesignObj="+pRow->FK_DesignObj_asSQL()+", Description="+pRow->Description_asSQL()+", Modification_RecordInfo="+pRow->Modification_RecordInfo_asSQL()+", IsNew_RecordInfo="+pRow->IsNew_RecordInfo_asSQL()+", IsDeleted_RecordInfo="+pRow->IsDeleted_RecordInfo_asSQL()+", FK_Users_RecordInfo="+pRow->FK_Users_RecordInfo_asSQL();
...
//delete deleted added
	...
	{	
		vector<Row_DeviceTemplate_MediaType_DesignObj*>::iterator i = deleted_addedRows.begin();
		delete (*i);
...
//delete deleted cached
	...
	{	
		map<Key, Row_DeviceTemplate_MediaType_DesignObj*, Key_Less>::iterator i = deleted_cachedRows.begin();
...
bool Table_DeviceTemplate_MediaType_DesignObj::GetRows(string where_statement,vector<class Row_DeviceTemplate_MediaType_DesignObj*> *rows)
{
	...
	string query = "select * from DeviceTemplate_MediaType_DesignObj where " + where_statement;
...
sscanf(row[6], "%li", &(pRow->m_FK_Users_RecordInfo));
		...
		Key key(pRow);
                ...
                map<Table_DeviceTemplate_MediaType_DesignObj::Key, Row_DeviceTemplate_MediaType_DesignObj*, Table_DeviceTemplate_MediaType_DesignObj::Key_Less>::iterator i = cachedRows.find(key);
...
Row_DeviceTemplate_MediaType_DesignObj* Table_DeviceTemplate_MediaType_DesignObj::GetRow(long int in_FK_DeviceTemplate_MediaType, long int in_FK_DesignObj)
{
	...
	Key row_key(in_FK_DeviceTemplate_MediaType, in_FK_DesignObj);

	map<Key, Row_DeviceTemplate_MediaType_DesignObj*, Key_Less>::iterator i;
...
Row_DeviceTemplate_MediaType_DesignObj* Table_DeviceTemplate_MediaType_DesignObj::FetchRow(Table_DeviceTemplate_MediaType_DesignObj::Key &key)
{
	PLUTO_SAFETY_LOCK(M, m_Mutex);
