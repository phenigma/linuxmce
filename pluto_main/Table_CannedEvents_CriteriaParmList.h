...
public:
	...
	Table_CannedEvents_CriteriaParmList(Database_pluto_main *pDatabase):database(pDatabase), m_Mutex("CannedEvents_CriteriaParmList")
	{
...
class DLL_EXPORT Row_CannedEvents_CriteriaParmList : public TableRow, public SerializeClass
	{
