...
class DLL_EXPORT Table_DeviceCategory_DeviceObj : public TableBase , DoubleLongKeyBase
{
private:
...
private:	
	...
	class Row_DeviceCategory_DeviceObj* FetchRow(DoubleLongKey &key);
...
class Row_DesignObj* FK_DesignObj_getrow();
		...
		void SetupSerialization() {
			StartSerializeList() + m_FK_DeviceCategory+ m_FK_DesignObj+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod;
		}
	private:
