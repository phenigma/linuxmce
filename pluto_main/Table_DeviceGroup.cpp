...
long int Row_DeviceGroup::Type_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Row_DeviceGroup::Type_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
return is_null[2];}
bool Row_DeviceGroup::Type_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
is_null[2]=val;}
void Row_DeviceGroup::Type_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceGroup::Type_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
