...
{
	map<Table_DeviceCategory::Key, class Row_DeviceCategory*, Table_DeviceCategory::Key_Less>::iterator it;
...
void Row_DeviceCategory::Delete()
{
	...
	if (!is_deleted)
		if (is_added)	
		{	
			vector<Row_DeviceCategory*>::iterator i;	
		...
		{
			Table_DeviceCategory::Key key(this);					
			map<Table_DeviceCategory::Key, Row_DeviceCategory*, Table_DeviceCategory::Key_Less>::iterator i = table->cachedRows.find(key);
...
return m_IsAV;}
string Row_DeviceCategory::Modification_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_Modification_RecordInfo;}
short int Row_DeviceCategory::IsNew_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsNew_RecordInfo;}
short int Row_DeviceCategory::IsDeleted_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IsDeleted_RecordInfo;}
long int Row_DeviceCategory::FK_Users_RecordInfo_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Row_DeviceCategory::Modification_RecordInfo_set(string val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_Modification_RecordInfo = val; is_modified=true; is_null[5]=false;}
void Row_DeviceCategory::IsNew_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsNew_RecordInfo = val; is_modified=true; is_null[6]=false;}
void Row_DeviceCategory::IsDeleted_RecordInfo_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IsDeleted_RecordInfo = val; is_modified=true; is_null[7]=false;}
void Row_DeviceCategory::FK_Users_RecordInfo_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
return is_null[3];}
bool Row_DeviceCategory::IsNew_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[6];}
bool Row_DeviceCategory::IsDeleted_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[7];}
bool Row_DeviceCategory::FK_Users_RecordInfo_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
is_null[3]=val;}
void Row_DeviceCategory::IsNew_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[6]=val;}
void Row_DeviceCategory::IsDeleted_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[7]=val;}
void Row_DeviceCategory::FK_Users_RecordInfo_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceCategory::Modification_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceCategory::IsNew_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceCategory::IsDeleted_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
string Row_DeviceCategory::FK_Users_RecordInfo_asSQL()
{
PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Table_DeviceCategory::Commit()
{
...
//insert added
	...
	{
		vector<Row_DeviceCategory*>::iterator i = addedRows.begin();
	
		Row_DeviceCategory *pRow = *i;
	
		
string values_list_comma_separated;
values_list_comma_separated = values_list_comma_separated + pRow->PK_DeviceCategory_asSQL()+", "+pRow->FK_DeviceCategory_Parent_asSQL()+", "+pRow->Description_asSQL()+", "+pRow->Define_asSQL()+", "+pRow->IsAV_asSQL()+", "+pRow->Modification_RecordInfo_asSQL()+", "+pRow->IsNew_RecordInfo_asSQL()+", "+pRow->IsDeleted_RecordInfo_asSQL()+", "+pRow->FK_Users_RecordInfo_asSQL();

	
		string query = "insert into DeviceCategory (PK_DeviceCategory, FK_DeviceCategory_Parent, Description, Define, IsAV, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo) values ("+
...
//update modified
	...
	for (map<Key, Row_DeviceCategory*, Key_Less>::iterator i = cachedRows.begin(); i!= cachedRows.end(); i++)
		if	(((*i).second)->is_modified)
	{
		Row_DeviceCategory* pRow = (*i).second;	
		Key key(pRow);	

		char tmp_PK_DeviceCategory[32];
sprintf(tmp_PK_DeviceCategory, "%li", key.pk_PK_DeviceCategory);
...
update_values_list = update_values_list + "PK_DeviceCategory="+pRow->PK_DeviceCategory_asSQL()+", FK_DeviceCategory_Parent="+pRow->FK_DeviceCategory_Parent_asSQL()+", Description="+pRow->Description_asSQL()+", Define="+pRow->Define_asSQL()+", IsAV="+pRow->IsAV_asSQL()+", Modification_RecordInfo="+pRow->Modification_RecordInfo_asSQL()+", IsNew_RecordInfo="+pRow->IsNew_RecordInfo_asSQL()+", IsDeleted_RecordInfo="+pRow->IsDeleted_RecordInfo_asSQL()+", FK_Users_RecordInfo="+pRow->FK_Users_RecordInfo_asSQL();
...
//delete deleted added
	...
	{	
		vector<Row_DeviceCategory*>::iterator i = deleted_addedRows.begin();
		delete (*i);
...
//delete deleted cached
	...
	{	
		map<Key, Row_DeviceCategory*, Key_Less>::iterator i = deleted_cachedRows.begin();
...
bool Table_DeviceCategory::GetRows(string where_statement,vector<class Row_DeviceCategory*> *rows)
{
	...
	string query = "select * from DeviceCategory where " + where_statement;
...
sscanf(row[8], "%li", &(pRow->m_FK_Users_RecordInfo));
		...
		Key key(pRow);
                ...
                map<Table_DeviceCategory::Key, Row_DeviceCategory*, Table_DeviceCategory::Key_Less>::iterator i = cachedRows.find(key);
...
Row_DeviceCategory* Table_DeviceCategory::GetRow(long int in_PK_DeviceCategory)
{
	...
	Key row_key(in_PK_DeviceCategory);

	map<Key, Row_DeviceCategory*, Key_Less>::iterator i;
...
Row_DeviceCategory* Table_DeviceCategory::FetchRow(Table_DeviceCategory::Key &key)
{
	PLUTO_SAFETY_LOCK(M, m_Mutex);
