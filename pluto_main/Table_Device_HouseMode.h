...
class DLL_EXPORT Table_Device_HouseMode
{
private:
...
long int pk_FK_HouseMode;
	...
	map<Table_Device_HouseMode::Key, class Row_Device_HouseMode*, Table_Device_HouseMode::Key_Less> cachedRows;
	map<Table_Device_HouseMode::Key, class Row_Device_HouseMode*, Table_Device_HouseMode::Key_Less> deleted_cachedRows;
	vector<class Row_Device_HouseMode*> addedRows;
	vector<class Row_Device_HouseMode*> deleted_addedRows;	
...
private:	
	...
	class Row_Device_HouseMode* FetchRow(Key &key);
...
class Row_Event* FK_Event_getrow();
		...
		void SetupSerialization() {
			StartSerializeList() + m_FK_Device+ m_FK_HouseMode+ m_FK_Event+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
