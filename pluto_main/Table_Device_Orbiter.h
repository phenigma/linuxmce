...
class DLL_EXPORT Table_Device_Orbiter
{
private:
...
public:
	...
	Table_Device_Orbiter(Database_pluto_main *pDatabase):database(pDatabase), m_Mutex("Device_Orbiter")
	{
...
long int pk_FK_Orbiter;
	...
	map<Table_Device_Orbiter::Key, class Row_Device_Orbiter*, Table_Device_Orbiter::Key_Less> cachedRows;
	map<Table_Device_Orbiter::Key, class Row_Device_Orbiter*, Table_Device_Orbiter::Key_Less> deleted_cachedRows;
	vector<class Row_Device_Orbiter*> addedRows;
	vector<class Row_Device_Orbiter*> deleted_addedRows;	
...
private:	
	...
	class Row_Device_Orbiter* FetchRow(Key &key);
		
			
};

class DLL_EXPORT Row_Device_Orbiter : public TableRow, public SerializeClass
	{
...
class Row_Orbiter* FK_Orbiter_getrow();
		...
		void SetupSerialization() {
			StartSerializeList() + m_FK_Device+ m_FK_Orbiter+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
