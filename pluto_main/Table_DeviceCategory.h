...
class DLL_EXPORT Table_DeviceCategory
{
private:
...
private:		
	...
	map<Table_DeviceCategory::Key, class Row_DeviceCategory*, Table_DeviceCategory::Key_Less> cachedRows;
	map<Table_DeviceCategory::Key, class Row_DeviceCategory*, Table_DeviceCategory::Key_Less> deleted_cachedRows;
	vector<class Row_DeviceCategory*> addedRows;
	vector<class Row_DeviceCategory*> deleted_addedRows;	
...
private:	
	...
	class Row_DeviceCategory* FetchRow(Key &key);
...
void InfraredGroup_FK_DeviceCategory_getrows(vector <class Row_InfraredGroup*> *rows);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_DeviceCategory+ m_FK_DeviceCategory_Parent+ m_Description+ m_Define+ m_IsAV+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
