...
class DLL_EXPORT Table_HouseMode
{
private:
...
public:
	...
	Table_HouseMode(Database_pluto_main *pDatabase):database(pDatabase), m_Mutex("HouseMode")
	{
...
private:		
	...
	map<Table_HouseMode::Key, class Row_HouseMode*, Table_HouseMode::Key_Less> cachedRows;
	map<Table_HouseMode::Key, class Row_HouseMode*, Table_HouseMode::Key_Less> deleted_cachedRows;
	vector<class Row_HouseMode*> addedRows;
	vector<class Row_HouseMode*> deleted_addedRows;	
...
private:	
	...
	class Row_HouseMode* FetchRow(Key &key);
		
			
};

class DLL_EXPORT Row_HouseMode : public TableRow, public SerializeClass
	{
...
void FK_Users_RecordInfo_setNull(bool val);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_HouseMode+ m_Description+ m_Define+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
