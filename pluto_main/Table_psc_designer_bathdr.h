...
class DLL_EXPORT Table_psc_designer_bathdr
{
private:
...
public:
	...
	Table_psc_designer_bathdr(Database_pluto_main *pDatabase):database(pDatabase), m_Mutex("psc_designer_bathdr")
	{
...
private:		
	...
	map<Table_psc_designer_bathdr::Key, class Row_psc_designer_bathdr*, Table_psc_designer_bathdr::Key_Less> cachedRows;
	map<Table_psc_designer_bathdr::Key, class Row_psc_designer_bathdr*, Table_psc_designer_bathdr::Key_Less> deleted_cachedRows;
	vector<class Row_psc_designer_bathdr*> addedRows;
	vector<class Row_psc_designer_bathdr*> deleted_addedRows;	
...
private:	
	...
	class Row_psc_designer_bathdr* FetchRow(Key &key);
		
			
};

class DLL_EXPORT Row_psc_designer_bathdr : public TableRow, public SerializeClass
	{
