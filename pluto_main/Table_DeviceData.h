...
class DLL_EXPORT Table_DeviceData : public TableBase , SingleLongKeyBase
{
private:
...
void Device_DeviceData_FK_DeviceData_getrows(vector <class Row_Device_DeviceData*> *rows);
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_PK_DeviceData+ m_Description+ m_Define+ m_FK_ParameterType+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod;
		}
	private:
