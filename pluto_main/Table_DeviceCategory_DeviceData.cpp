...
values_list_comma_separated = values_list_comma_separated + pRow->FK_DeviceCategory_asSQL()+", "+pRow->FK_DeviceData_asSQL()+", "+pRow->IK_DeviceData_asSQL()+", "+pRow->Required_asSQL()+", "+pRow->SetByDevice_asSQL()+", "+pRow->AllowedToModify_asSQL()+", "+pRow->Description_asSQL()+", "+pRow->psc_id_asSQL()+", "+pRow->psc_batch_asSQL()+", "+pRow->psc_user_asSQL()+", "+pRow->psc_frozen_asSQL();

	
		string query = "insert into DeviceCategory_DeviceData (FK_DeviceCategory, FK_DeviceData, IK_DeviceData, Required, SetByDevice, AllowedToModify, Description, psc_id, psc_batch, psc_user, psc_frozen) values ("+
