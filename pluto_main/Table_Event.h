...
private:		
	...
	map<Table_Event::Key, class Row_Event*, Table_Event::Key_Less> cachedRows;
	map<Table_Event::Key, class Row_Event*, Table_Event::Key_Less> deleted_cachedRows;
	vector<class Row_Event*> addedRows;
	vector<class Row_Event*> deleted_addedRows;	
...
private:	
	...
	class Row_Event* FetchRow(Key &key);
...
void Event_EventParameter_FK_Event_getrows(vector <class Row_Event_EventParameter*> *rows);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_Event+ m_FK_EventCategory+ m_Description+ m_Define+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
