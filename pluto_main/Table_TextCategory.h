...
class DLL_EXPORT Table_TextCategory
{
private:
...
public:
	...
	Table_TextCategory(Database_pluto_main *pDatabase):database(pDatabase), m_Mutex("TextCategory")
	{
...
private:		
	...
	map<Table_TextCategory::Key, class Row_TextCategory*, Table_TextCategory::Key_Less> cachedRows;
	map<Table_TextCategory::Key, class Row_TextCategory*, Table_TextCategory::Key_Less> deleted_cachedRows;
	vector<class Row_TextCategory*> addedRows;
	vector<class Row_TextCategory*> deleted_addedRows;	
...
private:	
	...
	class Row_TextCategory* FetchRow(Key &key);
...
void TextCategory_FK_TextCategory_Parent_getrows(vector <class Row_TextCategory*> *rows);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_TextCategory+ m_FK_TextCategory_Parent+ m_Description+ m_Modification_RecordInfo+ m_IsNew_RecordInfo+ m_IsDeleted_RecordInfo+ m_FK_Users_RecordInfo;
		}
	private:
