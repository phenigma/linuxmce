...
class DLL_EXPORT Table_psc_local_batdet
{
private:
...
public:
	...
	Table_psc_local_batdet(Database_pluto_main *pDatabase):database(pDatabase), m_Mutex("psc_local_batdet")
	{
...
private:		
	...
	map<Table_psc_local_batdet::Key, class Row_psc_local_batdet*, Table_psc_local_batdet::Key_Less> cachedRows;
	map<Table_psc_local_batdet::Key, class Row_psc_local_batdet*, Table_psc_local_batdet::Key_Less> deleted_cachedRows;
	vector<class Row_psc_local_batdet*> addedRows;
	vector<class Row_psc_local_batdet*> deleted_addedRows;	
...
private:	
	...
	class Row_psc_local_batdet* FetchRow(Key &key);
		
			
};

class DLL_EXPORT Row_psc_local_batdet : public TableRow, public SerializeClass
	{
...
void Value_set(string val);
		...
		void SetupSerialization() {
			StartSerializeList() + m_PK_psc_local_batdet+ m_Value;
		}
	private:
