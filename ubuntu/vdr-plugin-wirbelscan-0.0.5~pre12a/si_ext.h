...
enum table_codes {
  TABLE_ID_PAT                                 = 0x00, // program allocation table                                  (mandatory)
  TABLE_ID_CAT                                 = 0x01, // conditional access section                                (mandatory)
  TABLE_ID_PMT                                 = 0x02, // program map section                                       (mandatory)
  TABLE_ID_TSDT                                = 0x03, // transport stream description section                      (mandatory)
...
enum _stream_type {
  STREAMTYPE_UNDEFINED                         = 0x00, // ITU-T | ISO/IEC Reserved
  STREAMTYPE_11172_VIDEO                       = 0x01, // ISO/IEC 11172 Video
  STREAMTYPE_13818_VIDEO                       = 0x02, // ITU-T Rec. H.262 | ISO/IEC 13818-2 Video or ISO/IEC 11172-2 constrained parameter video stream
  STREAMTYPE_11172_AUDIO                       = 0x03, // ISO/IEC 11172 Audio
  STREAMTYPE_13818_AUDIO                       = 0x04, // ISO/IEC 13818-3 Audio
  STREAMTYPE_13818_PRIVATE                     = 0x05, // ITU-T Rec. H.222.0 | ISO/IEC 13818-1 private_sections
  STREAMTYPE_13818_PES_PRIVATE                 = 0x06, // ITU-T Rec. H.222.0 | ISO/IEC 13818-1 PES packets containing private data
  STREAMTYPE_13522_MHEG                        = 0x07, // ISO/IEC 13522 MHEG
  STREAMTYPE_H222_0_DSMCC                      = 0x08, // ITU-T Rec. H.222.0 | ISO/IEC 13818-1 Annex A DSM CC
  STREAMTYPE_H222_1                            = 0x09, // ITU-T Rec. H.222.1
  STREAMTYPE_13818_6_TYPE_A                    = 0x0A, // ISO/IEC 13818-6 type A
  STREAMTYPE_13818_6_TYPE_B                    = 0x0B, // ISO/IEC 13818-6 type B
  STREAMTYPE_13818_6_TYPE_C                    = 0x0C, // ISO/IEC 13818-6 type C
  STREAMTYPE_13818_6_TYPE_D                    = 0x0D, // ISO/IEC 13818-6 type D
  STREAMTYPE_13818_1_AUX                       = 0x0E, // ITU-T Rec. H.222.0 | ISO/IEC 13818-1 auxiliary
  STREAMTYPE_13818_AUDIO_ADTS                  = 0x0F, // ISO/IEC 13818-7 Audio with ADTS transport syntax
...
enum stream_content_code {
  MPEG_2_video                                 = 0x01, 
  MPEG_1_Layer_2_audio                         = 0x02, 
  VBI_data                                     = 0x03, 
  AC3_audio_modes                              = 0x04, 
  H264_AVC_video                               = 0x05, 
  HE_AAC_audio                                 = 0x06, 
  DTS_audio                                    = 0x07,
  };
enum service_type_code {
  ...
  digital_television_NVOD_reference_service    = 0x04,
  digital_television_NVOD_timeshifted_service  = 0x05,
  mosaic_service                               = 0x06,
  advanced_codec_digital_radio_sound_service   = 0x0A,
  advanced_codec_mosaic_service                = 0x0B,
  data_broadcast_service                       = 0x0C,
  reserved_Common_Interface_Usage_EN50221      = 0x0D,
  RCS_Map_EN301790                             = 0x0E,
  RCS_FLS_EN301790                             = 0x0F,
