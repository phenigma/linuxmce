...
/* Define this if Nosefart is being built. */
#define HAVE_NOSEFART 1
...
#define XINE_PLUGINDIR "/usr/local/lib/xine/plugins/1.1.10"
...
#define XINE_REL_PLUGINDIR "lib/xine/plugins/1.1.10"
