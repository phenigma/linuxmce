...
/* work handler */
#if LINUX_VERSION_CODE < KERNEL_VERSION(2, 6, 20)
static void dm1105_dmx_buffer(void *_dm1105_dev)
#else
static void dm1105_dmx_buffer(struct work_struct *work)
#endif
{
#if LINUX_VERSION_CODE < KERNEL_VERSION(2, 6, 20)
	struct dm1105_dev *dev = _dm1105_dev;
#else
...
static irqreturn_t dm1105_irq(int irq, void *dev_id, struct pt_regs *regs)
#else
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(2, 6, 20)
	INIT_WORK(&dev->work, dm1105_dmx_buffer, dev);
#else
