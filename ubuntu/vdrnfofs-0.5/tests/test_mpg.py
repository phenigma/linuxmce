...
class TestMpg(unittest.TestCase):
    ...
    def test_not_existing(self):
        node = self.fs.get_node('/does_not_exist_2008-03-28.20.13.99.99.rec.mpg')
        self.assertEqual(None, node)

    def test_mpg(self):
        node = self.fs.get_node('/sample_2008-03-28.20.13.99.99.rec.mpg')
    ...
    def test_mpg_new(self):
        node = self.fs.get_node('/sample-vdr1.7_2008-03-28.20.13.99.99.rec.mpg')
        self.assertEqual(40, node.size())
        self.assertEqual('1234567890abcdefghij1234567890abcdefghij', node.read(0, 4096))
