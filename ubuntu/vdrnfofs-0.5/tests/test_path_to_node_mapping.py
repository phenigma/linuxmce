...
class TestPathToNodeMapping(unittest.TestCase):
    ...
    def test_root(self):
        ...
        self.assertEqual(self.fs.video, node.path)

    def test_subdir(self):
        node = self.fs.get_node('/folder')
        self.assertEqual('folder', node.file_system_name)
        self.assertEqual(self.fs.video + '/folder', node.path)
    ...
    def test_mpg(self):
        ...
        self.assertEqual(self.fs.video + '/sample/2008-03-28.20.13.99.99.rec', node.path)
