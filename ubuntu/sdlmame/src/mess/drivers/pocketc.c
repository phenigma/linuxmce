...
static ADDRESS_MAP_START( pc1421_readmem , AS_PROGRAM, 8, pc1403_state )
	AM_RANGE( 0x0000, 0x1fff) AM_READ_LEGACY(SMH_ROM )
	AM_RANGE( 0x3800, 0x47ff) AM_READ_LEGACY(SMH_RAM )
	AM_RANGE( 0x8000, 0xffff) AM_READ_LEGACY(SMH_ROM )
ADDRESS_MAP_END

static ADDRESS_MAP_START( pc1421_writemem , AS_PROGRAM, 8, pc1403_state )
	AM_RANGE( 0x0000, 0x1fff) AM_WRITE_LEGACY(SMH_ROM )
	AM_RANGE( 0x2000, 0x37ff) AM_WRITE_LEGACY(SMH_RAM )
	AM_RANGE( 0x3800, 0x47ff) AM_WRITE_LEGACY(SMH_RAM )
	AM_RANGE( 0x8000, 0xffff) AM_WRITE_LEGACY(SMH_ROM )
ADDRESS_MAP_END
#endif
