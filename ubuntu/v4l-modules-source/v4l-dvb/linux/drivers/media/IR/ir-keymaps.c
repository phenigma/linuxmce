...
static struct ir_scancode ir_codes_tt_3200[] = {
	{ 0x03, KEY_1 },
	{ 0x04, KEY_2 },
	{ 0x05, KEY_3 },
	{ 0x06, KEY_4 },
...
struct ir_scancode_table ir_codes_tt_3200_table = {
	.scan = ir_codes_tt_3200,
	.size = ARRAY_SIZE(ir_codes_tt_3200),
};
EXPORT_SYMBOL_GPL(ir_codes_tt_3200_table);
...
/* Twinhan CAB-CI 2033 */
static struct ir_scancode ir_codes_mantis_vp2033[] = {
	{ 0x29, KEY_POWER},
	{ 0x28, KEY_FAVORITES},
	{ 0x30, KEY_TEXT},
...
struct ir_scancode_table ir_codes_mantis_vp2033_table = {
	.scan = ir_codes_mantis_vp2033,
	.size = ARRAY_SIZE(ir_codes_mantis_vp2033),
};
EXPORT_SYMBOL_GPL(ir_codes_mantis_vp2033_table);

/* Twinhan mantis vp2040 - terratec cinergy c */
static struct ir_scancode ir_codes_mantis_vp2040[] = {
	{ 0x3e, KEY_POWER},
	{ 0x3d, KEY_1},
	{ 0x3c, KEY_2},
	{ 0x3b, KEY_3},
