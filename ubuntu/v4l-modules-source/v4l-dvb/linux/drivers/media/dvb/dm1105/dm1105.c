...
{
	dm1105dvb->ts_buf = pci_alloc_consistent(dm1105dvb->pdev, 11*DM1105_DMA_BYTES, &dm1105dvb->dma_addr);
...
{
	pci_free_consistent(dm1105dvb->pdev, 11*DM1105_DMA_BYTES, dm1105dvb->ts_buf, dm1105dvb->dma_addr);
}
...
static int __devinit dm1105dvb_hw_init(struct dm1105dvb *dm1105dvb)
{
	...
	/* big buffer */
	outl(10*DM1105_DMA_BYTES, dm_io_mem(DM1105_RLEN));
				  ...
				  const struct pci_device_id *ent)
{
	...
	dm1105_devcount++;
	dm1105dvb->pdev = pdev;
	dm1105dvb->buffer_size = 10 * DM1105_DMA_BYTES;
	dm1105dvb->PacketErrorCount = 0;
	dm1105dvb->dmarst = 0;
