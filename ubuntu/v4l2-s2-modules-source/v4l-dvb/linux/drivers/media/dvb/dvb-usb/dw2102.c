...
#ifndef USB_PID_TEVII_S651
#define USB_PID_TEVII_S651 0xd651
#endif
...
static int su3000_i2c_xfer(struct i2c_adapter *adap, struct i2c_msg msg[],
								int num)
{
	struct dvb_usb_device *d = i2c_get_adapdata(adap);
...
static struct dvb_usb_rc_key ir_codes_su3000_table[] = {
};
...
static struct ir_codes_dvb_usb_table_table keys_tables[] = {
	...
	{ ir_codes_su3000_table, ARRAY_SIZE(ir_codes_su3000_table) },
};
...
static struct usb_device_id dw2102_table[] = {
	...
	{USB_DEVICE(0x9022, USB_PID_TEVII_S651)},
			...
			const struct firmware *frmwr)
{
	...
	const char *fw_s650a = "dvb-usb-s650a.fw";
	...
	case 0x2101:
		...
		break;
	case 0xd651:
		ret = request_firmware(&fw, fw_s650a, &dev->dev);
		if (ret != 0) {
			err(err_str, fw_s650a);
			return ret;
		}
		break;
	default:
...
static struct dvb_usb_device_properties su3000_properties = {
	...
	.rc_key_map = ir_codes_su3000_table,
	.rc_key_map_size = ARRAY_SIZE(ir_codes_su3000_table),
	.rc_interval = 150,
	.rc_query = dw2102_rc_query,
		...
		const struct usb_device_id *id)
{
	...
	p1100->rc_key_map = ir_codes_tbs_table;
	p1100->rc_key_map_size = ARRAY_SIZE(ir_codes_tbs_table);
