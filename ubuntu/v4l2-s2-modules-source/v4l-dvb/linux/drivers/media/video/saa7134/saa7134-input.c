...
#endif
{
	...
	case SAA7134_BOARD_PINNACLE_PCTV_310i:
		...
		if (pinnacle_remote == 0) {
			...
			ir->ir_codes = RC_MAP_PINNACLE_COLOR;
#else
			...
			ir->ir_codes = RC_MAP_PINNACLE_GREY;
#else
	...
	case SAA7134_BOARD_MSI_TVATANYWHERE_PLUS:
		...
		ir->ir_codes = RC_MAP_MSI_TVANYWHERE_PLUS;
#else
