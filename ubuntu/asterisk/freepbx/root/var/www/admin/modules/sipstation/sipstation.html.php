...
// TODO: will want to switch this to bootstrap and also something other than json.inc.php which is on its way out
//
if (! @include_once("common/json.inc.php")) {
  ...
  $amp_conf = parse_amportal_conf("/etc/amportal.conf");
	...
	if (!$amp_conf["ASTMANAGERPROXYPORT"] || !$res = $astman->connect("127.0.0.1:".$amp_conf["ASTMANAGERPROXYPORT"], $amp_conf["AMPMGRUSER"] , $amp_conf["AMPMGRPASS"], 'off')) {
