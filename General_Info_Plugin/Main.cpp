...
#define  General_Info_Plugin_VERSION "testing"
...
int main(int argc, char* argv[]) 
{
	...
	if (bError)
	{
		cout << "General_Info_Plugin, v." << General_Info_Plugin_VERSION << endl
			<< "A Pluto DCE Device.  See www.plutohome.com/dce for details." << endl
			<< "Usage: General_Info_Plugin [-r Router's IP] [-d My Device ID] [-l dce_router|stdout|null|filename]" << endl
	...
	try
	{
		...
		if ( pGeneral_Info_Plugin->Connect() ) 
		{
