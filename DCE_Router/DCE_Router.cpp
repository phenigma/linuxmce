...
//<-dceag-const-b->
DCE_Router::DCE_Router(int DeviceID, string ServerAddress,bool bConnectEventHandler,bool bLocalMode,class Router *pRouter)
	: DCE_Router_Command(DeviceID, ServerAddress,bConnectEventHandler,bLocalMode,pRouter)
//<-dceag-const-e->
{
}

//<-dceag-dest-b->
DCE_Router::~DCE_Router()
//<-dceag-dest-e->
{
}
