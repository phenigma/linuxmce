...
//#ifdef CENET
//#  define _STLP_NATIVE_C_HEADER(x) <C:\Program Files\Windows CE Tools\wce420\STANDARDSDK_420\Include\X86/##x>
#  define _STLP_NATIVE_C_HEADER(x) <C:\Program Files\Windows CE Tools\wce420\POCKET PC 2003\Include\Armv4/##x>
//#else
