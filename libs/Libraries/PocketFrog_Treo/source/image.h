...
Surface* LoadImage( unsigned resourceID, const TCHAR* resclass = _T("image"), HINSTANCE hModule = 0 );
...
inline Surface* LoadImage( Display* display, const TCHAR* filename )
    { return LoadImage( filename ); }

inline Surface* LoadImage( Display* display, unsigned resourceID, const TCHAR* resclass = _T("image"), HINSTANCE hModule = 0 )
    { return LoadImage( resourceID, resclass, hModule ); }

inline Surface* LoadImage( Display* display, const uint8_t* pBegin, const uint8_t* pEnd )
    { return LoadImage( pBegin, pEnd ); }
