...
#define GRValue(rgb)      (mng_uint8)((rgb & RED_MASK) >> 8)
#define GGValue(rgb)      (mng_uint8)((rgb & GREEN_MASK) >> 3) 
#define GBValue(rgb)      (mng_uint8)((rgb & BLUE_MASK) << 3)
...
mng_uint16 mng_16bcolor( mng_uint8 red, mng_uint8 green, mng_uint8 blue )
{
...
mng_retcode mng_display_rgb565(mng_datap pData)
{
  ...
  mng_uint16 iFGr16, iFGg16, iFGb16;
  mng_uint16 iBGr16, iBGg16, iBGb16;
  mng_uint8  iA8, iFGr8, iFGg8, iFGb8;
  mng_uint8  iBGr8, iBGg8, iBGb8;
  ...
  {                                    /* address destination row */
    ...
    if (pData->bIsOpaque)              /* forget about transparency ? */
    {
      if (pData->bIsRGBA16)            /* 16-bit input row ? */
      {
        for (iX = pData->iSourcel + pData->iCol; iX < pData->iSourcer; iX += pData->iColinc)
        {                              /* scale down by dropping the LSB */
          *((mng_uint16p)pScanline) = mng_16bcolor(*(pDataline), *(pDataline+2), *(pDataline+4));
          pScanline += (pData->iColinc * 2);
          pDataline += 8;
        }
      }
      else
      {
        for (iX = pData->iSourcel + pData->iCol; iX < pData->iSourcer; iX += pData->iColinc)
        {                              
			*((mng_uint16p)pScanline)     = mng_16bcolor(*(pDataline), *(pDataline+1), *(pDataline+2));
			pScanline += (pData->iColinc * 2);
			pDataline += 4;
        }
      }
        ...
        {                              /* get alpha value */
          ...
          if (iA16)                    /* any opacity at all ? */
          {
            ...
            {                          /* get the proper values */
              ...
              iFGb16 = mng_get_uint16 (pDataline+4);
                                       /* scale background up */
              iBGr16 = (mng_uint16)GRValue(*(mng_uint16p)pScanline);
              iBGg16 = (mng_uint16)GGValue(*(mng_uint16p)pScanline);
              iBGb16 = (mng_uint16)GBValue(*(mng_uint16p)pScanline);
              iBGr16 = (mng_uint16)((mng_uint32)iBGr16 << 8) | iBGr16;
              iBGg16 = (mng_uint16)((mng_uint32)iBGg16 << 8) | iBGg16;
              iBGb16 = (mng_uint16)((mng_uint32)iBGb16 << 8) | iBGb16;
                                       /* now compose */
              ...
              MNG_COMPOSE16(iFGb16, iFGb16, iA16, iBGb16);
                                       /* and return the composed values */
				*((mng_uint16p)pScanline)= mng_16bcolor(iFGr16 >> 8, iFGg16 >> 8, iFGb16 >> 8);
            }
          }
      ...
      else
      {
        for (iX = pData->iSourcel + pData->iCol; iX < pData->iSourcer; iX += pData->iColinc)
        {
          ...
          if (iA8)                     /* any opacity at all ? */
          {
            ...
            {
				iBGr8 = (mng_uint8)GRValue(*(mng_uint16p)pScanline);
				iBGg8 = (mng_uint8)GGValue(*(mng_uint16p)pScanline);
				iBGb8 = (mng_uint8)GBValue(*(mng_uint16p)pScanline);
				iFGr8 = *pDataline;
				iFGg8 = *(pDataline+1);
				iFGb8 = *(pDataline+2);

	            MNG_COMPOSE8(iFGr8, iFGr8, iA8, iBGr8);
				MNG_COMPOSE8(iFGg8, iFGg8, iA8, iBGg8);
			    MNG_COMPOSE8(iFGb8, iFGb8, iA8, iBGb8);
				*((mng_uint16p)pScanline) = mng_16bcolor(iFGr8, iFGg8, iFGb8);
            }
          }
          pScanline += (pData->iColinc * 2);
          pDataline += 4;
...
mng_retcode mng_restore_bkgd_rgb565(mng_datap pData)
{
  ...
  {                                    /* point to the right pixel then */
    ...
    for (iX = pData->iSourcel; iX < pData->iSourcer; iX++)
    {
      *pWork     = GRValue(*(mng_uint16p)pBkgd);         /* ok; copy the pixel */
      *(pWork+1) = GGValue(*(mng_uint16p)pBkgd);
      *(pWork+2) = GBValue(*(mng_uint16p)pBkgd);
      *(pWork+3) = 0x00;               /* transparant for alpha-canvasses */
