...
*/
	virtual void CMD_Tune_to_channel(int iValue) { string sCMD_Result; CMD_Tune_to_channel(iValue,sCMD_Result,NULL);};
	virtual void CMD_Tune_to_channel(int iValue,string &sCMD_Result,Message *pMessage);
