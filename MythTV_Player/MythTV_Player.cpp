...
//     m_pMythMainWindow->setMaximumSize(100, 100);
//     m_pMythMainWindow->resize(QSize(100, 100));
...
//<-dceag-c84-e->
{
    ...
    VideoFrame *videoFrame = m_pMythTV->activenvp->GetCurrentFrame(nFrameWidth, nFrameHeight);

    g_pPlutoLogger->Write(LV_STATUS, "Got frame size %dx%d (%p))", nFrameWidth, nFrameHeight, videoFrame);
