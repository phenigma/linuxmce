...
int main(int argc, char* argv[]) 
{
	cout << "Climate_Plugin, v." << VERSION << endl
		<< "Visit www.plutohome.com for source code and license information" << endl << endl << endl << endl << endl << endl;
	...
	if (bError)
	{
		cout << "A Pluto DCE Device.  See www.plutohome.com/dce for details." << endl
			<< "Usage: Climate_Plugin [-r Router's IP] [-d My Device ID] [-l dce_router|stdout|null|filename]" << endl
