...
// XXXX-XX-XX  Marcus Svensson, Janåke Rönnblom, Bruce and Jakob Persson             - orginal translation to Swedish 
// 2003-07-11  Virtuality aka Jonathan Gulbrandsen (virtuality@carlssonplanet.com)   - updated the translation to phpBB version 2.0.6 and fixed grammars
...
$faq[] = array("Hur ändrar jag mina inställningar?", "Alla dina inställningar (om du har registrerat dig) är lagrade i databasen. För att ändra dom klicka på <u>Profil<u> länken (visas oftast högst upp på sidan). Detta låter dig ändra alla dina inställningar.");
