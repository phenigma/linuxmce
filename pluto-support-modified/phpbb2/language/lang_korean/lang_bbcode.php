...
$faq[] = array("답변에 문장 인용하기", "문장 인용에는 두가지 방법이 있는데, 참조 와 비참조이다.<ul><li>게시판의 게시물에 대한 답글을 하기위해 인용 기능을 이용할때 게시글이 <b>[quote=\"\"][/quote]</b> 블럭내에 들어가는 메시지 창에 첨부된다는 것을 알아야한다. 이 방법으로 타인이나 기타 올리고자 하는것들에 대한 참조를 이용한 인용을 할 수 있다! 예를 들어, 홍길동이 보내온 글의 일부를 인용하려면 :<br /><br /><b>[quote=\"홍길동\"]</b>홍길동이 작성한 글<b>[/quote]</b><br /><br />결과적인 출력은 홍길동 작성:  뒤에 나오며 실제 문장 앞에 온다. 인용하는 이름 주변에 \"\" 를 사용하는 것을 잊지 말아야 한다.</li><li>두번째 방법은 맹목적 인용이다. 이 기능을 이용하려면 문자를 <b>[quote][/quote]</b> 태그 안에 넣는다. 메시지를 보면 단순히, 실제 문장 앞에 인용: 이라고 나온다</li></ul>");
