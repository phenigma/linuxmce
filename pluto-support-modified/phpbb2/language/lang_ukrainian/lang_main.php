...
// please add it here.
$lang['TRANSLATION_INFO'] = '<a class="copyright" target="_blank" href="http://andriy.lviv.ua/?phpbb2">Ukrainian translation</a>';
...
$lang['Page_of'] = 'Сторінка <b>%d</b> з <b>%d</b>'; // Replaces with: Page 1 of 2 for example
...
$lang['Reply_with_quote'] = 'Відповісти цитуючи';
...
$lang['Online_users_zero_total'] = 'Всього в on-line <b>0</b> учасників :: ';
$lang['Online_users_total'] = 'Всього в on-line <b>%d</b> учасників :: ';
$lang['Online_user_total'] = 'Всього в on-line <b>%d</b> учасників :: ';
...
$lang['Record_online_users'] = 'Рекордна відвідуваність форуму (<b>%s</b> одночасно) відбулась %s'; // first %s = number of users, second %s is the date.

$lang['Admin_online_color'] = '%sАдміністратор%s';
$lang['Mod_online_color'] = '%sМодератор%s';

$lang['You_last_visit'] = 'Ваш попередній візит відбувся %s'; // %s replaced by date/time
$lang['Current_time'] = 'Cьогодні: %s'; // %s replaced by time

$lang['Search_new'] = 'Переглянути повідомлення з часу вашого попереднього відвідування';
$lang['Search_your_posts'] = 'Переглянути ваші повідомлення';
$lang['Search_unanswered'] = 'Переглянути теми без відповідей';
...
$lang['Last_Post'] = 'Останнє';
$lang['Moderator'] = 'Модерує:';
$lang['Moderators'] = 'Модерують:';


//
// Stats block text
//
$lang['Posted_articles_zero_total'] = 'У нашому форумі поки-що немає повідомлень'; // Number of posts
$lang['Posted_articles_total'] = 'Всього учасники форуму написали <b>%d</b> повідомлень'; // Number of posts
$lang['Posted_article_total'] = 'Всього учасники форуму написали <b>%d</b> повідомлення'; // Number of posts
$lang['Registered_users_zero_total'] = 'На форумі <b>0</b> зареєстрованих учасників'; // # registered users
$lang['Registered_users_total'] = 'На форумі <b>%d</b> зареєстрованих учасників'; // # registered users
$lang['Registered_user_total'] = 'На форумі <b>%d</b> зареєстрований учасник'; // # registered users
$lang['Newest_user'] = 'Останній зареєстрований учасник: <b>%s%s%s</b>'; // a href, username, /a
...
$lang['No_new_posts_locked'] = 'Немає нових повідомлень [ Закриті ]';
$lang['New_posts_locked'] = 'Нові повідомлення [ Закриті ]';
$lang['Forum_is_locked'] = 'Форум закрито';
...
$lang['Mark_all_forums'] = 'Позначити всі форуми проглянутими';
$lang['Forums_marked_read'] = 'Всі форуми позначено проглянутими';
...
$lang['Topic_Announcement'] = '<b>Анонс:</b>';
$lang['Topic_Sticky'] = '<b>Зверніть увагу:</b>';
$lang['Topic_Moved'] = '<b>Переміщено:</b>';
$lang['Topic_Poll'] = '<b>[ Голосування ]</b>';

$lang['Mark_all_topics'] = 'Позначити всі теми прочитаними';
$lang['Topics_marked_read'] = 'Всі теми цього форуму були позначені як прочитані';

$lang['Rules_post_can'] = 'Ви <b>можете</b> писати нові повідомлення в цю тему';
$lang['Rules_post_cannot'] = 'Ви <b>не можете</b> писати нові повідомлення в цю тему';
$lang['Rules_reply_can'] = 'Ви <b>можете</b> відповідати на теми у цьому форумі';
$lang['Rules_reply_cannot'] = 'Ви <b>не можете</b> відповідати на теми у цьому форумі';
$lang['Rules_edit_can'] = 'Ви <b>можете</b> редагувати ваші повідомлення у цьому форумі';
$lang['Rules_edit_cannot'] = 'Ви <b>не можете</b> редагувати ваші повідомлення у цьому форумі';
$lang['Rules_delete_can'] = 'Ви <b>можете</b> витирати ваші повідомлення у цьому форумі';
$lang['Rules_delete_cannot'] = 'Ви <b>не можете</b> витирати ваші повідомлення у цьому форумі';
$lang['Rules_vote_can'] = 'Ви <b>можете</b> голосувати у цьому форумі';
$lang['Rules_vote_cannot'] = 'Ви <b>не можете</b> голосувати у цьому форумі';
$lang['Rules_moderate'] = 'Ви <b>можете</b> %sмодерувати цей форум%s'; // %s replaced by a href links, do not remove!
...
$lang['Edited_time_total'] = 'Редаговано: %s (%s)'; // Last edited by me on 12 Oct 2001, edited 1 time in total
$lang['Edited_times_total'] = 'Востаннє редаговано: %s (%s), редаговано %d раз'; // Last edited by me on 12 Oct 2001, edited 2 times in total

$lang['Lock_topic'] = 'Закрити цю тему';
$lang['Unlock_topic'] = 'Відкрити цю тему';
$lang['Move_topic'] = 'Перемістити цю тему';
$lang['Delete_topic'] = 'Знищити цю тему';
$lang['Split_topic'] = 'Розділити цю тему';

$lang['Stop_watching_topic'] = 'Зупинити стеження за даною темою';
$lang['Start_watching_topic'] = 'Стежити за даною темою';
$lang['No_longer_watching'] = 'Тепер форум не буде повідомляти вас про нові повідомлення у цій темі';
$lang['You_are_watching'] = 'Тепер форум буде повідомляти вас про нові повідомлення у цій темі';
...
$lang['No_post_mode'] = 'Не задано потрібних параметрів!<br><br><a href="index.php">Перейти до головної сторінки</a>'; // If posting.php is called without a mode (newtopic/reply/delete/etc, shouldn't be shown normaly)
...
$lang['Confirm_delete'] = 'Ви впевнені, що хочете знищити це повідомлення?';
...
$lang['Forum_locked'] = 'Цей форум закрито';
$lang['Topic_locked'] = 'Цю тему заблоковано';
$lang['No_post_id'] = 'Потрібно вибрати, яке повідомлення редагувати';
$lang['No_topic_id'] = 'Потрібно вибрати тему, на яку хочете відповісти';
$lang['No_valid_mode'] = 'Ви можете лише писати, редагувати чи цитувати повідомлення; можливо, спробуйте ще раз';
...
$lang['To_few_poll_options'] = 'потрібно ввести як мінімум 2 варіанти';
$lang['To_many_poll_options'] = 'Ви ввели надто багато варіантів';
...
$lang['No_vote_option'] = 'При голосуванні потрібно вибрати варіант';

$lang['Add_poll'] = 'Додати голосування';
$lang['Add_poll_explain'] = 'Не бажаєте створювати голосування - залиште поля пустими';
...
$lang['HTML_is_ON'] = 'HTML <u>дозволений</u>';
$lang['HTML_is_OFF'] = 'HTML <u>заборонений</u>';
$lang['BBCode_is_ON'] = '%sBBCode%s <u>дозволений</u>'; // %s are replaced with URI pointing to FAQ
$lang['BBCode_is_OFF'] = '%sBBCode%s <u>заборонений</u>';
$lang['Smilies_are_ON'] = 'Смайлики <u>дозволені</u>';
$lang['Smilies_are_OFF'] = 'Смайлики <u>заборонені</u>';
...
$lang['Vote_cast'] = 'Ваш голос прийнято';
...
$lang['New_pms'] = 'У вас %d нових повідомлень'; // You have 2 new messages
...
$lang['You_new_pm'] = 'Вам надійшло нове приватне повідомлення';
$lang['You_new_pms'] = 'Вам надійшли нові приватні повідомлення';
...
$lang['Disable_HTML_pm'] = 'Вимкнути HTML у цьому повідомленні';
$lang['Disable_BBCode_pm'] = 'Вимкнути BBCode у цьому повідомленні';
$lang['Disable_Smilies_pm'] = 'Вимкнути Смайлики у цьому повідомленні';

$lang['Message_sent'] = 'Ваше повідомлення відіслане';

$lang['Click_return_inbox'] = '%sПовернутися у папку "вхідні"%s';
...
$lang['Incomplete_URL'] = 'Заданий вами URL неправильний';
...
$lang['Always_notify'] = 'Завжди повідомляти вас про відповіді на мої повідомлення';
$lang['Always_notify_explain'] = 'Якщо на ваше повідомлення приходить відповідь, форум відсилає на ваш e-mail повідомлення про це';
...
$lang['Date_format_explain'] = 'синтаксис ідентичний до PHP-функції <a href=\'http://www.php.net/date\' target=\'_other\'>date()</a>';
...
$lang['Public_view_email'] = 'Зробити ваш e-mail публічно доступним';
...
$lang['Avatar'] = 'Аватар';
$lang['Avatar_explain'] = 'Маленька картинка, яка допоможе краще вас охарактеризувати. За один раз можна використовувати лише один Аватар, його ширина не може бути більшою за %d пікселів, а висота - за %d пікселів, а розмір файла не може бути більшим за %dkB.';
$lang['Upload_Avatar_file'] = 'Завантажити Аватар з вашого комп\'ютера';
$lang['Upload_Avatar_URL'] = 'Завантажити Аватар з URL';
$lang['Upload_Avatar_URL_explain'] = 'Введіть URL вашого Аватара - він буде скопійований на цей сайт.';
$lang['Pick_local_Avatar'] = 'Виберіть Аватар з галереї';
$lang['Link_remote_Avatar'] = 'Завантажувати Аватар щоразу з певного сайту';
...
$lang['Notify_on_privmsg'] = 'Повідомлення по email про надходження приватного повідомлення';
$lang['Popup_on_privmsg'] = 'Відкривати pop-up вікно при отриманні нового приватного повідомлення';
$lang['Popup_on_privmsg_explain'] = 'Під час того, як ви знаходитесь у форумі, і отримуєте нове приватне повідомлення, вискочить нове вікно з повідомленням про це';
$lang['Hide_user'] = 'Приховати ваш on-line статус';

$lang['Profile_updated'] = 'Ваші налаштування збережено';
$lang['Profile_updated_inactive'] = 'Ваші налаштування збережено, але ваш аккаунт деактивовано. Переактивуйте його';

$lang['Password_mismatch'] = 'Введений вами пароль недійсний';
$lang['Current_password_mismatch'] = 'Пароль, який ви ввели не відповідає тому, що є у базі даних';
$lang['Password_long'] = 'Пароль повинен бути меншим за 32 символи';
...
$lang['Account_inactive'] = 'Ваш аккаунт було створено, але його потрібно активувати: активаційний ключ було вислано на ваш e-mail';
$lang['Account_inactive_admin'] = 'Ваш аккаунт створено, але його потрібно активувати: незабаром адміністрація розгляне вашу реєстраційну заяву і повідомить вас про прийняте рішення';
$lang['Account_active'] = 'Ваш аккаунт активовано. Дякуємо за реєстрацію';
$lang['Account_active_admin'] = 'Ваш аккаунт активовано';
$lang['Reactivate'] = 'Переактивуйте ваш аккаунт!';
$lang['Already_activated'] = 'Ваш аккаунт було активовано';
$lang['COPPA'] = 'Ваш аккаунт було створено, але він повинен бути схвалений адміністрацією, вам вислано лист з деталями на e-mail.';

$lang['Registration'] = 'Правила Реєстрації Нового Учасника';

//agreement
$lang['Reg_agreement'] = 'Реєструючись на форумі ви зобов\'язуєтесь:<br><br>Не вживати нецензурних висловів<br>Не ображати інших учасників форуму<br>Не подавати оголошень, які суперечать чинному законодавству України чи правилам етики<br>Не пропагувати у форумі політичні, релігійні погляди, насильство і тому подібне';
$lang['Agree_under_13'] = '';
$lang['Agree_over_13'] = 'Я уважно прочитав(ла) правила і згоден(на) з ними';
$lang['Agree_not'] = 'Я не згоден(на) з правилами';

$lang['Wrong_activation'] = 'Ваш активаційний ключ недійсний';
$lang['Send_password'] = 'Вишліть мені новий пароль';
$lang['Password_updated'] = 'Новий пароль створено; подальші дії описані в листі, який було відіслано на ваш e-mail';
...
$lang['Email_message_desc'] = 'Це повідомлення буде відіслане як простий текст, не вставляйте в нього HTML чи BBCode. Зворотня адреса буде вашою.';
$lang['Flood_email_limit'] = 'Спрацював захист від флудингу!<bR><bR>Ви не можете так швидко відсилати інший лист - спробуйте пізніше';
$lang['Recipient'] = 'Адресат';
$lang['Email_sent'] = 'e-mail відіслано';
$lang['Send_email'] = 'Відіслати e-mail';
$lang['Empty_subject_email'] = 'Тема листа';
$lang['Empty_message_email'] = 'Повідомлення';
...
// Group control panel
//
$lang['Group_Control_Panel'] = 'Керування групою';
$lang['Group_member_details'] = 'Список груп форуму';
...
$lang['Group_joined'] = 'Ви підписалися на вступ у цю групу<br>Коли ваш запит перегляне модератор групи - вам дадуть знати';
...
$lang['Search_keywords_explain'] = 'Використовуйте <u>AND</u> якщо хочете знайти всі слова підряд, <u>OR</u> для того, щоб знайти одне з них, <u>NOT</u> щоб визначити слова, яких не має бути у результатах пошуку. Використовуйте * як будь-які заміни в словах';
...
$lang['Auth_Anonymous_Users'] = '<b>анонімні учасники</b>';
$lang['Auth_Registered_Users'] = '<b>зареєстровані учасники</b>';
$lang['Auth_Users_granted_access'] = '<b>учасники зі спеціальним рівнем доступу</b>';
$lang['Auth_Moderators'] = '<b>модератори</b>';
$lang['Auth_Administrators'] = '<b>адміністратори</b>';

$lang['Not_Moderator'] = 'У вас немає доступу для виконання цієї процедури';
$lang['Not_Authorised'] = 'Відмовлено у доступі';
...
//
$lang['Mod_CP'] = 'Сторінка модератора';
$lang['Mod_CP_explain'] = 'Використовуючи цю сторінку ви можете виконувати наступні операції з форумом: закривати, відкривати, переміщувати і витирати будь яку тему.';
...
$lang['Topics_Removed'] = 'Вибрані теми витерто з бази даних.';
$lang['Topics_Locked'] = 'Вибрані теми закрито';
$lang['Topics_Moved'] = 'Вибрані теми переміщено';
$lang['Topics_Unlocked'] = 'Вибрані теми відкрито';
$lang['No_Topics_Moved'] = 'Жодну тему не переміщено';

$lang['Confirm_delete_topic'] = 'Ви справді бажаєте витерти вибрану(і) тему(и)?';
$lang['Confirm_lock_topic'] = 'Ви справді бажаєте закрити вибрану(і) тему(и)?';
$lang['Confirm_unlock_topic'] = 'Ви справді бажаєте відкрити вибрану(і) тему(и)?';
...
$lang['Split_Topic'] = 'Розділення теми';
$lang['Split_Topic_explain'] = 'Використовуючи цю сторінку, ви можете розділити одну тему на дві, вибираючи повідомлення в кожну з них';
$lang['Split_title'] = 'Назва нової теми';
$lang['Split_forum'] = 'Форум нової теми';
$lang['Split_posts'] = 'Перемістити вибрані повідомлення';
$lang['Split_after'] = 'Перемістити всі повідомлпння, що йдуть за першим обраним';
$lang['Topic_split'] = 'Вибрана тема була розділена';

$lang['Too_many_error'] = 'Ви обрали надто багато повідомлень. Ви можете обрати лише одне повідомлення для подальшого поділу на теми!';
...
$lang['This_posts_IP'] = 'IP цього повідомлення';
...
$lang['Lookup_IP'] = 'Переглянути чий IP';
