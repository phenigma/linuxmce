O1="UPDATE Version SET VersionName='$(date +%g%m%d%H)' WHERE PK_Version=0;"
...
MakeRelease -o 1 -r 2,9,10,11 -m 1 -s /home/MakeRelease/trunk -n / -v 0 | tee /home/MakeRelease/MakeRelease.log
