...
namespace DCE
{
	...
	public:
		CMD_Set_House_Mode_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,string sValue_To_Assign,string sErrors) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,19,2,5,sValue_To_Assign.c_str(),18,sErrors.c_str()); }
	};
	...
	class CMD_Set_User_Mode_DT : public PreformedCommand {
	public:
		CMD_Set_User_Mode_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,string sValue_To_Assign,int iPK_Users) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,26,2,5,sValue_To_Assign.c_str(),17,StringUtils::itos(iPK_Users).c_str()); }
	};
	...
	public:
		CMD_Stop_Media(long DeviceIDFrom, long DeviceIDTo,int iStreamID,int *iMediaPosition) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,38,1,41,StringUtils::itos(iStreamID).c_str(),42,StringUtils::itos(*iMediaPosition).c_str());		m_pcResponse = new RESP_Stop_Media(iMediaPosition); }
	};
	class CMD_Stop_Media_DL : public PreformedCommand {
	public:
		CMD_Stop_Media_DL(long DeviceIDFrom, string DeviceIDTo,int iStreamID,int *iMediaPosition) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,38,1,41,StringUtils::itos(iStreamID).c_str());		m_pcResponse = new RESP_Stop_Media(iMediaPosition); }
	};
	class CMD_Stop_Media_DT : public PreformedCommand {
	public:
		CMD_Stop_Media_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,int iStreamID,int *iMediaPosition) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,38,1,41,StringUtils::itos(iStreamID).c_str());		m_pcResponse = new RESP_Stop_Media(iMediaPosition); }
	};
	class CMD_Stop_Media_Cat : public PreformedCommand {
	public:
		CMD_Stop_Media_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB,int iStreamID,int *iMediaPosition) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,38,1,41,StringUtils::itos(iStreamID).c_str());		m_pcResponse = new RESP_Stop_Media(iMediaPosition); }
	};
	...
	public:
		CMD_MH_Play_Media_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,int iPK_Device,string sPK_DesignObj,string sFilename,int iPK_MediaType,int iPK_DeviceTemplate,int iPK_EntertainArea) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,43,6,2,StringUtils::itos(iPK_Device).c_str(),3,sPK_DesignObj.c_str(),13,sFilename.c_str(),29,StringUtils::itos(iPK_MediaType).c_str(),44,StringUtils::itos(iPK_DeviceTemplate).c_str(),45,StringUtils::itos(iPK_EntertainArea).c_str()); }
	};
	...
	public:
		CMD_MH_Stop_Media_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,int iPK_Device,int iPK_MediaType,int iPK_DeviceTemplate,int iPK_EntertainArea) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,44,4,2,StringUtils::itos(iPK_Device).c_str(),29,StringUtils::itos(iPK_MediaType).c_str(),44,StringUtils::itos(iPK_DeviceTemplate).c_str(),45,StringUtils::itos(iPK_EntertainArea).c_str()); }
	};
	...
	public:
		CMD_Mount_Disk_Image(long DeviceIDFrom, long DeviceIDTo,string sFilename,string *sMediaURL) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,54,1,13,sFilename.c_str(),59,(*sMediaURL).c_str());		m_pcResponse = new RESP_Mount_Disk_Image(sMediaURL); }
	};
	...
	public:
		CMD_Mount_Disk_Image_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,string sFilename,string *sMediaURL) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,54,1,13,sFilename.c_str());		m_pcResponse = new RESP_Mount_Disk_Image(sMediaURL); }
	};
	...
	public:
		CMD_Set_Entertainment_Area_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,int iPK_EntertainArea) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,59,1,45,StringUtils::itos(iPK_EntertainArea).c_str()); }
	};
	...
	public:
		CMD_Get_Signal_Strength(long DeviceIDFrom, long DeviceIDTo,string sMac_address,int *iValue) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,61,1,47,sMac_address.c_str(),48,StringUtils::itos(*iValue).c_str());		m_pcResponse = new RESP_Get_Signal_Strength(iValue); }
	};
	...
	public:
		CMD_Get_Signal_Strength_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,string sMac_address,int *iValue) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,61,1,47,sMac_address.c_str());		m_pcResponse = new RESP_Get_Signal_Strength(iValue); }
	};
	...
	public:
		CMD_Select_Object_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,string sPK_DesignObj) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,66,1,3,sPK_DesignObj.c_str()); }
	};
	...
	public:
		CMD_Spawn_Application_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,string sFilename,string sName,string sArguments) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,67,3,13,sFilename.c_str(),50,sName.c_str(),51,sArguments.c_str()); }
	};
	...
	public:
		CMD_Request_File(long DeviceIDFrom, long DeviceIDTo,string sFilename,char **pData,int *iData_Size) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,71,1,13,sFilename.c_str(),-19,*pData,*iData_Size);		m_pcResponse = new RESP_Request_File(pData,iData_Size); }
	};
	...
	public:
		CMD_Request_File_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,string sFilename,char **pData,int *iData_Size) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,71,1,13,sFilename.c_str());		m_pcResponse = new RESP_Request_File(pData,iData_Size); }
	};
	...
	public:
		CMD_MH_Send_Me_To_Remote_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,73,0); }
	};
	...
	public:
		CMD_Bind_to_Media_Remote_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,int iPK_Device,string sPK_DesignObj,string sOnOff,string sPK_DesignObj_CurrentScreen,int iPK_Text,string sOptions,int iPK_EntertainArea,int iPK_Text_Timecode,int iPK_Text_SectionDesc,int iPK_Text_Synopsis) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,74,10,2,StringUtils::itos(iPK_Device).c_str(),3,sPK_DesignObj.c_str(),8,sOnOff.c_str(),16,sPK_DesignObj_CurrentScreen.c_str(),25,StringUtils::itos(iPK_Text).c_str(),39,sOptions.c_str(),45,StringUtils::itos(iPK_EntertainArea).c_str(),56,StringUtils::itos(iPK_Text_Timecode).c_str(),62,StringUtils::itos(iPK_Text_SectionDesc).c_str(),63,StringUtils::itos(iPK_Text_Synopsis).c_str()); }
	};
	...
	public:
		CMD_Input_Select_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,91,0); }
	};
	...
	public:
		CMD_Get_Floorplan_Layout(long DeviceIDFrom, long DeviceIDTo,string *sValue_To_Assign) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,183,0,5,(*sValue_To_Assign).c_str());		m_pcResponse = new RESP_Get_Floorplan_Layout(sValue_To_Assign); }
	};
	...
	public:
		CMD_Get_Floorplan_Layout_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,string *sValue_To_Assign) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,183,0);		m_pcResponse = new RESP_Get_Floorplan_Layout(sValue_To_Assign); }
	};
	...
	public:
		CMD_Set_Level(long DeviceIDFrom, long DeviceIDTo,int iAbsolute_Level) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,184,1,76,StringUtils::itos(iAbsolute_Level).c_str()); }
	};
	class CMD_Set_Level_DL : public PreformedCommand {
	public:
		CMD_Set_Level_DL(long DeviceIDFrom, string DeviceIDTo,int iAbsolute_Level) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,184,1,76,StringUtils::itos(iAbsolute_Level).c_str()); }
	};
	class CMD_Set_Level_DT : public PreformedCommand {
	public:
		CMD_Set_Level_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,int iAbsolute_Level) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,184,1,76,StringUtils::itos(iAbsolute_Level).c_str()); }
	};
	class CMD_Set_Level_Cat : public PreformedCommand {
	public:
		CMD_Set_Level_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB,int iAbsolute_Level) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,184,1,76,StringUtils::itos(iAbsolute_Level).c_str()); }
	};
	...
	public:
		CMD_Get_Current_Floorplan(long DeviceIDFrom, long DeviceIDTo,int iPK_FloorplanType,string *sValue_To_Assign) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,186,1,46,StringUtils::itos(iPK_FloorplanType).c_str(),5,(*sValue_To_Assign).c_str());		m_pcResponse = new RESP_Get_Current_Floorplan(sValue_To_Assign); }
	};
	...
	public:
		CMD_Get_Current_Floorplan_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,int iPK_FloorplanType,string *sValue_To_Assign) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,186,1,46,StringUtils::itos(iPK_FloorplanType).c_str());		m_pcResponse = new RESP_Get_Current_Floorplan(sValue_To_Assign); }
	};
	...
	public:
		CMD_NOREP_Get_Current_Floorplan_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,int iPK_FloorplanType) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,186,1,46,StringUtils::itos(iPK_FloorplanType).c_str()); }
	};
	...
	public:
		CMD_On_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,192,0); }
	};
	...
	public:
		CMD_Power_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,194,0); }
	};
	...
	public:
		CMD_Save_playlist(long DeviceIDFrom, long DeviceIDTo,int iPK_Users,int iPK_EntertainArea,string sName,bool bSave_as_new) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,214,4,17,StringUtils::itos(iPK_Users).c_str(),45,StringUtils::itos(iPK_EntertainArea).c_str(),50,sName.c_str(),77,(bSave_as_new ? "1" : "0")); }
	};
	class CMD_Save_playlist_DL : public PreformedCommand {
	public:
		CMD_Save_playlist_DL(long DeviceIDFrom, string DeviceIDTo,int iPK_Users,int iPK_EntertainArea,string sName,bool bSave_as_new) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,214,4,17,StringUtils::itos(iPK_Users).c_str(),45,StringUtils::itos(iPK_EntertainArea).c_str(),50,sName.c_str(),77,(bSave_as_new ? "1" : "0")); }
	};
	class CMD_Save_playlist_DT : public PreformedCommand {
	public:
		CMD_Save_playlist_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,int iPK_Users,int iPK_EntertainArea,string sName,bool bSave_as_new) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,214,4,17,StringUtils::itos(iPK_Users).c_str(),45,StringUtils::itos(iPK_EntertainArea).c_str(),50,sName.c_str(),77,(bSave_as_new ? "1" : "0")); }
	};
	class CMD_Save_playlist_Cat : public PreformedCommand {
	public:
		CMD_Save_playlist_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB,int iPK_Users,int iPK_EntertainArea,string sName,bool bSave_as_new) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,214,4,17,StringUtils::itos(iPK_Users).c_str(),45,StringUtils::itos(iPK_EntertainArea).c_str(),50,sName.c_str(),77,(bSave_as_new ? "1" : "0")); }
	};
	...
	public:
		CMD_Load_Playlist(long DeviceIDFrom, long DeviceIDTo,int iPK_EntertainArea,int iEK_Playlist) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,231,2,45,StringUtils::itos(iPK_EntertainArea).c_str(),78,StringUtils::itos(iEK_Playlist).c_str()); }
	};
	class CMD_Load_Playlist_DL : public PreformedCommand {
	public:
		CMD_Load_Playlist_DL(long DeviceIDFrom, string DeviceIDTo,int iPK_EntertainArea,int iEK_Playlist) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,231,2,45,StringUtils::itos(iPK_EntertainArea).c_str(),78,StringUtils::itos(iEK_Playlist).c_str()); }
	};
	class CMD_Load_Playlist_DT : public PreformedCommand {
	public:
		CMD_Load_Playlist_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,int iPK_EntertainArea,int iEK_Playlist) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,231,2,45,StringUtils::itos(iPK_EntertainArea).c_str(),78,StringUtils::itos(iEK_Playlist).c_str()); }
	};
	class CMD_Load_Playlist_Cat : public PreformedCommand {
	public:
		CMD_Load_Playlist_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB,int iPK_EntertainArea,int iEK_Playlist) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,231,2,45,StringUtils::itos(iPK_EntertainArea).c_str(),78,StringUtils::itos(iEK_Playlist).c_str()); }
	};
	...
	class CMD_Light_ON : public PreformedCommand {
	public:
		CMD_Light_ON(long DeviceIDFrom, long DeviceIDTo) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,238,0); }
	};
	class CMD_Light_ON_DL : public PreformedCommand {
	public:
		CMD_Light_ON_DL(long DeviceIDFrom, string DeviceIDTo) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,238,0); }
	};
	class CMD_Light_ON_DT : public PreformedCommand {
	public:
		CMD_Light_ON_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,238,0); }
	};
	class CMD_Light_ON_Cat : public PreformedCommand {
	public:
		CMD_Light_ON_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,238,0); }
	};
