...
namespace DCE
{
	...
	public:
		CMD_Info_MD(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,string sText) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,123,1,9,sText.c_str()); }
	};
