...
using namespace DCE;
#include "Xine_PlayerBase.h"
extern Xine_Player_Command *Create_Xine_Player(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter);
...
Event_Impl *Xine_Player_Event::CreateEvent( unsigned long dwPK_DeviceTemplate, ClientSocket *pOCClientSocket, unsigned long dwDevice )
{
	switch(dwPK_DeviceTemplate) {
		case 5:
			return (Event_Impl *) new Xine_Player_Event(pOCClientSocket, dwDevice);
	};
