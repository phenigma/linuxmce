...
using namespace DCE;
#include "../MythTV_Player/MythTV_Player.h"
...
Event_Impl *MythTV_Player_Event::CreateEvent( unsigned long dwPK_DeviceTemplate, ClientSocket *pOCClientSocket, unsigned long dwDevice )
{
	switch(dwPK_DeviceTemplate) {
		case 35:
			return (Event_Impl *) new MythTV_Player_Event(pOCClientSocket, dwDevice);
	};
