...
Event_Impl *CM11A_Event::CreateEvent( unsigned long dwPK_DeviceTemplate, ClientSocket *pOCClientSocket, unsigned long dwDevice )
{
	switch(dwPK_DeviceTemplate) {
		case 48:
			return (Event_Impl *) new CM11A_Event(pOCClientSocket, dwDevice);
	};
