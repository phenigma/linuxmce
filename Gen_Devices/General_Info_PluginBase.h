...
{
public:
	General_Info_Plugin_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) : Event_Impl(DeviceID, ServerAddress, bConnectEventHandler) {};
...
public:
	...
	static int PK_DeviceTemplate_get() { return 27; };
