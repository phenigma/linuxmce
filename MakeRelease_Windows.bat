...
%MAKERELEASE_PATH%\bin\MakeRelease.exe -h 10.0.0.150 -o 7 -s %INPUT_PATH% -n / -c -k 192,193,213,212,201,237,255,254,277,278,116,135,126,145,226,227,119,138,124,143,241,242,154,155,159,160,202,203,289,290
