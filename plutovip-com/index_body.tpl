...
<table boder="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <td background="templates/subSilver/images/f_index.jpg" width=780 height=15></td>
  </tr>
  <tr>
    <td>
...
<table cellpadding="0" cellspacing="0" border="0" width="780" class="forumline">
  <tr><td colspan="2"><a href="{U_VIEWONLINE}"><img src="templates/subSilver/images/f_online.jpg" border="0" width="780"></a></td></tr>
  <tr> 
