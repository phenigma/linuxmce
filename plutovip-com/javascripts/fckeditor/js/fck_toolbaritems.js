...
TBI.prototype.Print			= new TBButton("Print"			, "##Print"					, "Print"					, TBCMD_DOC, "returnParam( false )") ;
TBI.prototype.Find			= new TBButton("Find"			, lang["Find"]				, DECMD_FINDTEXT) ;
TBI.prototype.Replace		= new TBButton("Replace"		, "##Replace"				, "replace()"				, TBCMD_CUSTOM, "checkDecCommand(DECMD_FINDTEXT)") ;
...
TBI.prototype.Anchor		= new TBButton("Anchor"			, "##Anchor"				, "anchor()"				, TBCMD_CUSTOM);
...
TBI.prototype.UniversalKey	= new TBButton("UniversalKey"	, "##UniversalKeyboard"		, "insertUniversalKey()"	, TBCMD_CUSTOM) ;
...
TBI.prototype.InsertUnorderedList	= new TBButton("InsertUnorderedList", lang["BulletedList"], "insertList('ul')"	, TBCMD_CUSTOM, "checkDecCommand(DECMD_UNORDERLIST)") ;
...
TBI.prototype.Preview			= new TBButton("Preview"			, "##Preview"			, "preview()"				, TBCMD_CUSTOM) ;
TBI.prototype.NewPage			= new TBButton("NewPage"			, "##NewPage"			, "newPage()" , TBCMD_CUSTOM) ;
TBI.prototype.Save				= new TBButton("Save"				, "##Save"				, "save()" , TBCMD_CUSTOM) ;
...
TBI.prototype.FontStyleAdv	= new TBButton("FontStyleAdv"	, "##FontStyleAdv"			, DECMD_FONT) ;
...
// Form
TBI.prototype.Form			= new TBButton("Form"		, "##Form"			, "form()"		, TBCMD_CUSTOM) ;
TBI.prototype.Checkbox		= new TBButton("Checkbox"	, "##Checkbox"		, "checkbox()"	, TBCMD_CUSTOM) ;
TBI.prototype.Radio			= new TBButton("Radio"		, "##RadioButton"	, "radio()"		, TBCMD_CUSTOM) ;
TBI.prototype.Input			= new TBButton("Input"		, "##TextField"		, "textfield()"	, TBCMD_CUSTOM) ;
TBI.prototype.Textarea		= new TBButton("Textarea"	, "##Textarea"		, "textarea()"	, TBCMD_CUSTOM) ;
TBI.prototype.Hidden		= new TBButton("Hidden"		, "##HiddenField"	, "hidden()"	, TBCMD_CUSTOM) ;
TBI.prototype.Button		= new TBButton("Button"		, "##Button"		, "button()"	, TBCMD_CUSTOM) ;
TBI.prototype.Select		= new TBButton("Select"		, "##SelectionField", "selectField()", TBCMD_CUSTOM) ;
TBI.prototype.ImageButton	= new TBButton("ImageButton", "##ImageButton"	, "imageButton()", TBCMD_CUSTOM) ;
