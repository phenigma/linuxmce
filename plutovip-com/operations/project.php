...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="maintable">
  ...
  <tr>
    ...
    <p><img src="images/submenus/project_txt.gif" width="222" height="13"></p>
      ...
      <p>With the purchase of every Pluto system, we automatically include 8 hours of project management at no charge (2 with the purchase of a hybrid only). Use the time however you want. Additional project management services are available for $75/hour. We will even send a skilled project manager to supervise any work for the standard rate, plus actual out-of-pocket travel expenses.</p>
    </td>
  </tr>
</table>
