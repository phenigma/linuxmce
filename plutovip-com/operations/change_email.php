...
function change_email($output)
{
	...
	if(isset($_POST['change_email'])){
		...
		$display='Invalid e-mail entered<br><a href="index.php?section=change_email">Go back</a>';
		else{
   ...
   <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0" class="maintable">
	  <tr>
	    ...
	    <form action="index.php?section=change_email" method="POST" name="form1">		
	      ...
	      <tr>
	        <td align="left">
	         <img src="images/submenu_txt/change_email_txt.gif" width="211" height="14">
				...
				<tr><td colspan="2" align="center"><input type="submit" name="change_email" value="Change E-mail"/></td></tr>
			</table>
			</td>
		   </tr>
		  </table>
