...
#define Security_Plugin_VERSION "testing"
...
int main( int argc, char* argv[] ) 
{
	...
	if ( bError )
	{
		cout << "Security_Plugin, v." << Security_Plugin_VERSION << endl
			<< "A Pluto DCE Device. See www.plutohome.com/dce for details." << endl
			<< "Usage: Security_Plugin [-r Router's IP] [-d My Device ID] [-l dce_router|stdout|null|filename]" << endl
