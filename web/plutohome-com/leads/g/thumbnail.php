...
class thumbnail
{
	...
	function thumbnail($imgfile)
	{
		...
		$this->fn_imagecreate = $this->gd2() ? 'ImageCreateTrueColor' : 'ImageCreate'; // PLUTO
		// $this->fn_imagecreate = in_array('imagecreatetruecolor',get_extension_funcs('gd')) ? 'ImageCreateTrueColor' : 'ImageCreate'; // PLUTO
	}

	function gd2() // PLUTO
	{
		return !in_array('imagegd2',get_extension_funcs('gd'));	
	}
	...
	function show()
	{
		...
		$fn_imagecreate = $this->fn_imagecreate; // PLUTO
		$this->img["des"] = $fn_imagecreate($this->img["lebar_thumb"],$this->img["tinggi_thumb"]);
