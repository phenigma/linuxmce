<?
	...
	$GLOBALS['rootGenericMediaDirector']=28;	// Generic Media Director
	...
	$GLOBALS['rootDisklessBoot']=9;				// Diskless Boot
	...
	$GLOBALS['rootDevelopment']=8;				// description Development
