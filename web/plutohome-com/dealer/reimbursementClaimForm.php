...
if($action=='form'){
	...
	<table>
		<tr>
			<td align="center" class="titletable"><B>Pluto Marketing Reimbursement Claim Form</B></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<table>
				...
				<tr>
					...
					<td colspan="4" align="left" class="normaltext"><input type="text" name="companyName" value=""></td>
				</tr>
				<tr>
					<td colspan="2" align="right" class="normaltext"><B>Your name:</B></td>
					<td colspan="4" align="left" class="normaltext"><input type="text" name="individualName" value=""></td>
				</tr>
				<tr>
					<td colspan="2" align="right" class="normaltext"><B>Approved Reimbursement Total:$:</B></td>
					<td colspan="4" align="left" class="normaltext"><input type="text" name="approvedReimbursement" value=""></td>
				</tr>	
				<tr>
					...
					<td align="left" class="normaltext"><input type="text" name="asignedActivity" value=""></td>
				</tr>
				<tr>
