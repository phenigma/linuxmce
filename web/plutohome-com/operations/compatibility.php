<?php
 function compatibility($output) {
		...
		$out = '';
		$progGuideUrl=$wikiHost.'index.php/'.wikiLink('Programmer\'s Guide');
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="maintable">
  ...
  <tr>
    <td align="left" class="insidetable2">
        ...
        <p>If you are a programmer, you can easily make your own DCE Devices to do almost anything.  We even have a wizard for programmers that will build the whole project for you automatically.  <a href="$progGuideUrl">Introduction for programmers and developers</a>
