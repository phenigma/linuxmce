  ...
  <tr>
    <td valign="top" class="insidetable2"><a name="mobile"><img src="images/bullet_1.gif" width="11" height="11" border="0" align="absmiddle" /></a> <span class="title">How to use the mobile phone </span><br />
      ...
      <p><a name="orbiter"><img src="images/bullet_1.gif" width="11" height="11" border="0" align="absmiddle" /></a> <span class="title">How to use the orbiter</span><br />
        ...
        The 'lighting' buttons are all your lighting scenarios or moods. A mood can do more than just control lights. For example, 'Intimate' could play some background music and set your status to 'do not disturb'. The 'media' buttons are all the media choices in this room. The 'climate' buttons are your scenarios which control the climate equipments and 'environment', like pool and sprinkler. Touch the 'Phone' button to make a phone call. You will see your personal phone book and speed dials right on the tablet for easy browsing and when you touch someone to call, Pluto will make the call for you and put it through on the nearest phone. The other 'telecom' buttons are the current status of each family member, including the voice messages. The 'blue' security button lets you set the alarm mode and the various camera buttons are shortcuts to view surveillance cameras on the tablet - either quad view or single view. You can add miscellaneous options for each room.</p>
