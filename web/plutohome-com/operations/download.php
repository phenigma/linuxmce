...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="maintable">
  ...
  <tr>
    <td class="insidetable"><table border="0" align="left" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><a href="index.php?section=download"><img src="images/submenus/Support/download_on.gif" width="207" height="17" border="0"></a></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td colspan="2"><img src="images/spacer.gif" width="3" height="3"></td>
    ...
    <p><img src="images/submenus/download_txt.gif" width="77" height="13"><br>
        <br>
        The easiest way to get Pluto's software is to register or login and choose the "New Installation" button on your My Pluto homepage.  A web-based installation wizard will just ask a few questions about what type of equipment you have and what you want to do with Pluto.  This will automatically all Pluto's software and 3rd party software that you need for your particular system.
        <br><br>
        You can also visit <a href="/support/index.php">Pluto's support site</a> for other download options.</p>
</td>
  </tr>
</table>
