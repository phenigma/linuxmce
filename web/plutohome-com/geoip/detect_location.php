...
$query="select c.City,r.Region,co.Description AS Country,PK_City,FK_Region,c.FK_Country from City c
...
$city=mysql_fetch_array($res,MYSQL_ASSOC);
echo $city['City'],",",$city['Region'],",",$city['Country'],",",$city['PK_City'],",",$city['FK_Region'],",",$city['FK_Country'];
geoip_close($gi);
?>
