...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $entertainarea->PK_EntertainArea],
                ['confirm' => __('Are you sure you want to delete # {0}?', $entertainarea->PK_EntertainArea)]
            )
        ?></li>
...
<div class="entertainarea form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Entertainarea') ?></legend>
        <?php
