...
{
	$redirectUrl='right.php?section='.$section;
	...
	if ($actionX=='form') {
		...
		*/
		...
		<form action="right.php" method="POST" name="'.$formName.'">
							...
							<script>
								function checkEdit() {
									if(document.'.$formName.'.model.selectedIndex!=0){							
										self.location=\'right.php?section=operations/editMasterDevice&model=\'+document.'.$formName.'.model[document.'.$formName.'.model.selectedIndex].value;
									}
								}
