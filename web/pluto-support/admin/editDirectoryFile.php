<?php
	...
	$resPackage_Directory_File=$publicADO->Execute($queryPackage_Directory_File,$PK_Package_Directory_File);
	...
	if ($action=='form') {		
		...
		if ($File!='') {
			...
			$publicADO->Execute($updateDirectoryFile,array($File,$Search,$PK_Package_Directory_File));
