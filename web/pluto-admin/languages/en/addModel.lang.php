...
$TEXT_Q2_TITLE_CONST='Question 2 of 8- What Delays?';
...
$TEXT_Q2_POWER_DELAY_TEXT_CONST='Number of <B>miliseconds*</B> to wait for the device to warm up after sending a code to turn the power on';
$TEXT_Q2_MODE_DELAY_DELAY_TEXT_CONST='Number of <B>miliseconds*</B> to wait before sending other codes after changing inputs or modes on this device';
$TEXT_Q2_DIGIT_DELAY_DELAY_TEXT_CONST='Number of <B>miliseconds*</B> between commands when sending a series of codes, such as a sequence of digits to tune to a channel';
...
$TEXT_Q3_TITLE_CONST='Question 3 of 8 - How to tune?';
$TEXT_Q4_TITLE_CONST='Question 4 of 8 - Toggle power or discrete?';
...
$TEXT_Q5_TITLE_CONST='Question 5 of 8 - What Inputs?';
...
$TEXT_Q5_ORDER_TITLE_CONST='Question 5 of 8 - What Order?';
$TEXT_Q6_TITLE_CONST='Question 6 of 8 - DSP mode?';
...
$TEXT_Q6_ORDER_TITLE_CONST='Question 6 of 8 - DSP mode order?';
...
$TEXT_Q7_TITLE_CONST='Question 7 of 8 - How many times to repeat IR commands?';
$TEXT_Q7_INFO_CONST='IR is a very lossy communication method. IR Codes are often repeated several times to help ensure message delivery. If you find that channel numbers are repeating, then you may need to lower the value for General IR commands. If you find that channel numbers sometimes get missed, you may need to increase the value for General IR commands. The same goes for volume, and the repeat value acts as a sensitivity for volume commands.';
$TEXT_Q7_GENERAL_REPEAT_TEXT_CONST='Number of times to repeat General IR Codes';
$TEXT_Q7_VOLUME_REPEAT_TEXT_CONST='Number of times to repeat Volume IR Codes';
$TEXT_Q7_NOTE_CONST='The greater the number the more times the IR code will be repeated to the device. But if the number is too large codes may be sent too many times causing the repeats not to be filtered out by the device. For example, you try to tune to channel 125. That means three codes, or buttons, are sent: 1, 2 and 5, and each one is sent multiple times (depending on the values you enter here). But if your device goes to channel 112255, then codes are probably repeating too many times, so you\'ll need to come back and decrease these settings.';
$TEXT_Q8_TITLE_CONST='Question 8 of 8 - Use or create IR group';
$TEXT_Q8_HAS_GROUPS_1_CONST='Chances are you will <B>not need to learn or enter i/r codes</B> because we have';
$TEXT_Q8_HAS_GROUPS_2_CONST='Groups (codesets) for manufacturer';
$TEXT_Q8_HAS_GROUPS_3_CONST='device category';
$TEXT_Q8_HAS_GROUPS_4_CONST='Likely one of them works your model too.  Here are a few common commands for each i/r group. Click the "V" button to view the code in a new window, or the "T" button to test it using the above transmit device. If you find an i/r group that works your device, click "this works". Then you\'ll see all the codes for that group, and you can add more codes or replace certain codes that don"t work.';
$TEXT_Q8_ONE_GROUP_CONST='If this infrared group doesn\'t work, please type in a description for a new infrared group and click Add i/r group.';
$TEXT_Q8_MANY_GROUPS_CONST='More than 1 group may have codes that work.	If so, click the Infrared Group to see and test all the codes in that group, and pick the group that most closely matches your device. If none of these codes work, please type in a description for a new infrared group and click Add i/r group.';
$TEXT_Q8_NO_GROUPS_1_CONST='Sorry that we don"t already have codes for manufacturer';
$TEXT_Q8_NO_GROUPS_2_CONST='device category';
$TEXT_Q8_NO_GROUPS_3_CONST='Please take a moment to add them so other users can benefit from your efforts.  Thanks!';
$TEXT_Q8_ADD_GROUP_CONST='Type in a description for the infrared group and click Add i/r group:';
$TEXT_Q8_NOTE_1_CONST='Note:';
$TEXT_Q8_NOTE_2_CONST='when adding a i/r new group, if you know the codeset as used in a universal remote control, please use that as the description.  Example: "Pronto Codeset – 9999", or "OFA Codeset – 999".  For GSD devices, an example would be: "Denon AVR/AVC protocol".';
