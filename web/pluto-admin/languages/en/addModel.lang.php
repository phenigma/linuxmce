...
$TEXT_Q2_POWER_DELAY_TEXT_CONST='Number of miliseconds to wait for the device to warm up after sending a code to turn the power on';
$TEXT_Q2_MODE_DELAY_DELAY_TEXT_CONST='Number of miliseconds to wait before sending other codes after changing inputs or modes on this device';
$TEXT_Q2_DIGIT_DELAY_DELAY_TEXT_CONST='Number of miliseconds* between commands (up to 3 decimal places) when sending a series of codes, such as a sequence of digits to tune to a channel';
