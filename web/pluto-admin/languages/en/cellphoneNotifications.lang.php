...
$TEXT_CELLPHONE_NOTIFICATION_INFO_CONST='How should Pluto try to contact you when there is a security alert?';
$TEXT_MOBILE_ORBITER_NOTIFICATIONS_CONST='Mobile Orbiter Notifications';
$TEXT_MOBILE_ORBITER_NOTIFICATIONS_INFO_CONST='List the phone numbers for any mobile orbiters (ie mobile phones running Pluto\'s software) that you want to be notified.  The phone will beep, show you a live video, and let you control the house.';
...
$TEXT_OTHER_PHONE_NOTIFICATIONS_INFO_CONST='Here you can specify any phone number you want Pluto to call in the event of a security alert.  Pluto will call the number and play a recorded message.';
...
$TEXT_NEIGHBOURS_TO_CALL_INFO_CONST='List your neighbours and their phone numbers here.  If there is a problem at your house, you can hit the "notify neighbours" option and Pluto will make a call to all these neighbors simultaneously, alert them of the problem, and patch everyone together so you can talk to them.';
