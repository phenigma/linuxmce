...
$TEXT_COMMIT_INFO_CONST='Note: If you have sqlCVS credentials use them to commit your changes as authorised, otherwise your commits will be submitted for review and only after this will they be accepted into the main database.';
$TEXT_SQLCVS_COMMENT='A comment must be sent along with all sqlCVS checkins, please type it below.<BR>(For example, a reference to a Trac Ticket number or the reason for this change)';
...
$TEST_SQLCVS_ALERT_COMMENT='Sorry, you cannot check in changes without a comment describing what the checkin is for. Please add a comment and try again.';
?>
