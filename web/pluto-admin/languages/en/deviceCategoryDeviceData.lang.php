...
$TEXT_DEVICE_DATA_DELETED_FROM_DEVICE_CATEGORY_CONST='Device data deleted from device category.';
$TEXT_CONFIRM_DELETE_DEVICE_DATA_FROM_DEVICE_CATEGORY_CONST='Are you sure you want to delete this device data from device category?';
?>