...
$TEXT_PLEASE_SELECT_A_CATEGORY_CONST='Please select a category!';
$TEXT_VALIDATE_EVENT_NAME_CONST='Please enter a name for this Event List!';
$TEXT_EVENT_LIST_ADDED_CONST='Event List added!';
?>
