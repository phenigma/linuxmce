...
function sqlcvs_update($output,$dbADO) {
	...
	<div align="center"><h3>sqlCVS Update</h3></div>
	...
	';
		...
		if (!$canModifyInstallation){
			header("Location: index.php?section=sqlcvs_update&error=You are not authorised to change the installation.");
			exit(0);
		}
	...
	$output->setBody($out);
	$output->setTitle(APPLICATION_NAME.' :: sqlCVS Update');
	$output->output();
}
?>
