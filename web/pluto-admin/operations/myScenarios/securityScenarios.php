...
if($action=='form') {
	...
	while($rowRooms=$resRooms->FetchRow()){
		...
		$resArmDisarm=$dbADO->Execute($queryCG_T.' AND IK_CommandParameter='.$GLOBALS['mnuSecurityPanel'],array($rowRooms['PK_Room'],$GLOBALS['SecurityArmDisarmTemplate'],$installationID));
		...
		<tr bgcolor="#D1D9EA">
			...
			<tr>
				<td align="center" colspan="2">'.autogeneratedScenarios($arrayID,0,$dbADO,2,'securityScenarios',$rowRooms['PK_Room']).'</td>
			</tr>		
		<tr>
			<td width="20">&nbsp;</td>
...
';
	...
	if(isset($_POST['updateScenario']) || $action=='externalSubmit'){
		...
		$resArmDisarm=$dbADO->Execute($selectArmDisarm,array($GLOBALS['SecurityArmDisarmTemplate'],$installationID,$GLOBALS['mnuSecurityPanel']));
