...
if($action=='form') {
	...
	if(count($displayedCommandGroups)>0){
		$out.='
		<tr>
			<td colspan="2" align="center"><input type="submit" class="button" name="updateCG" value="'.$TEXT_UPDATE_CONST.'"  ></td>
			<td>&nbsp;</td>
		</tr>';
	}
	$out.='
