 ...
 function faq_presentation($output) {
   ...
   <table border="0" align="left" cellpadding="0" cellspacing="0">
    ...
    <td class="titletable"><img src="images/meniuri/plutovip_support_txt.gif" width="131" height="13"></td>
      ...
      <tr>
        <td><a href="index.php?section=faq_presentation"><img src="images/submeniuri/faqs_on.jpg" width="138" height="17" border="0"></a></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td colspan="2"><img src="../images/spacer.gif" width="3" height="3"></td>
      ...
      <td width="100%" align="left" class="insidetable">
        <p><img src="images/submeniuri/faqs_txt.gif" width="40" height="13"><br>';
   ...
   <table border="0" align="left" cellpadding="0" cellspacing="0">
    ...
    <td class="titletable"><img src="images/meniuri/plutovip_support_txt.gif" width="131" height="13"></td>
      ...
      <td class="insidetable" valign="top">';
