...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="maintable">
  ...
  <tr>
    <td class="insidetable"><table border="0" align="left" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><a href="index.php?section=dvd_remote"><img src="images/submenus/How%20Pluto%20works/dvd_remote_on.gif" width="230" height="17" border="0"></a></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td colspan="2"><img src="../images/spacer.gif" width="3" height="3"></td>
    ...
    <p><img src="images/submenus/dvd_remote_txt.gif" width="196" height="13"><br>
        <br>
      The DVD remote is very straightforward.  Touch 'advanced remote' to see all the languages, subtitles, audio tracks and angles.  This is another first for Pluto because we are not merely a remote control sending commands to a third party dvd player.  The dvd player is built-in to Pluto.  This also means that we detect when a dvd menu appears on the screen, and feed it through directly to the tablet so you can just touch your selection on screen.</p>
    <p><center><a href="javascript:open_popup('operations/poza10.html','532','465')"><img src="images/img%20how%20to/04/04_1_m.jpg" width="141" height="112" border="0"></a> <a href="javascript:open_popup('operations/poza11.html','532','465')"><img src="images/img%20how%20to/04/04_2_m.jpg" width="141" height="112" border="0"></a>
    </center><br>
      </p></td>
  </tr>
</table>
...
TEXT;
        ...
        $output->setPageID(2); //butonul selectat
 		...
 		$output->setTitle(APPLICATION_NAME."::How to Use the Dvd Remote");			//page title
