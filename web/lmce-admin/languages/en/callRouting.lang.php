...
$TEXT_USER_MODE_CONST='User Mode';
$TEXT_CALLER_TYPE_CONST='Caller type';
$TEXT_RING_EXTENSION_CONST='Ring extension(s)';
$TEXT_TRANSFER_TO_ANOTHER_USER_CONST='Transfer to another user';
$TEXT_GOTO_VOICEMAIL_CONST='Go to voicemail';
$TEXT_TRANSFER_TO_AN_OUTSIDE_NUMBER_CONST='Transfer to an outside number';
$TEXT_VOICEMAIL_INFO_CONST='For more details about your voicemail please dial "*98" followed by your user extension and your voicemail password, then follow voice menu.<br>There you can record your greetings, check for voicemail and so on.';
?>