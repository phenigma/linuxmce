...
$TEXT_PROVIDE_PASSWORD_AND_INSTALLATION_CONST='Remote assistance active.  Give the following code to the developer investigating your problem:';
$TEXT_SEND_ERRORS_TO_PLUTO_CONST='Send errors to LinuxMCE';
$TEXT_OUTSIDE_ACCESS_NOTES_CONST='LinuxMCE monitors itself and prepares reports if there are any software bugs or crashes. There is no confidential information in these reports--just technical stuff about the cause of the crash (core dumps). By sharing this information LinuxMCE developers, they can make the product better and more stable.';
...
$TEXT_REMOTE_ASSISTANCE_CONST='Remote assistance';
$TEXT_FAILED_OPENING_REMOTE_ACCESS_CONST='Enabling remote acces failed.';
?>
