...
$AxisYName = "";
$graphName = "";
/*$query2 = mysql_query("select Description,Unit from Unit where PK_Unit = ".$unit);
while ($unit = mysql_fetch_array($query2)){
      $AxisYName = $unit[1];
      $graphName = $graphName." - ".$unit[0];
}
*/
...
$Graph->add(
    Image_Graph::vertical(
        Image_Graph::factory('title', array($graphName, 12)),  
     //   Image_Graph::vertical(
