...
function followLog($output,$dbADO) {
	...
	if ($action == 'form') {
		...
		$logName=(isset($_REQUEST['system_log']))?'/var/log/syslog':getLogName($dbADO,$deviceID,$rowDevice['FK_DeviceTemplate'],$rowDevice['Template'],(int)@$_REQUEST['parentID'],(int)@$_REQUEST['orbiter'],$isGSD,$rowDevice['CommandLine']);;
