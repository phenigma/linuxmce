...
<form method="post" action="{S_POST_DAYS_ACTION}">
  <table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
	...
	<tr> 
	  ...
	  <td align="left" valign="middle" width="100%"><span class="nav">&nbsp;&nbsp;&nbsp;<a href="{U_INDEX}" class="nav">{L_INDEX}</a> {CATEGORY_GROUP}-> <a class="nav" href="{U_VIEW_FORUM}">{FORUM_NAME}</a></span></td>
