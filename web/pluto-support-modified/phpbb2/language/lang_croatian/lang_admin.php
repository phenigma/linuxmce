...
$lang['Ban_explain'] = 'Ovdje možete iskljuèiti [zabraniti pristup] korisnika/cu sa foruma.<br />Možete iskljuèiti korisnika/cu, IP adresu pristupa, adresu pružatelja usluga...<br />Ovime se iskljuèenoj osobi može zabraniti pristup èak i na Poèetnu stranicu foruma.<br />Da biste sprijeèili iskljuèenu osobu da se ponovo registrira, možete iskljuèiti i odreðenu e-mail adresu [iskljuèivanje samo e-mail adrese neæe sprijeèiti osobu da se loginira i posta].';
...
$lang['Allow_remote_explain'] = '<i>Avatari koji su smješteni na drugim i pozivaju se sa tih stranica.</i>';
...
$lang['Delete_disallow_explain'] = 'Korisnièko ime možete izbrisati tako da ga izaberete sa liste i kliknete na gumb Izbrišite.';
...
$lang['continue_upgrade'] = 'Kada downloadirate konfiguracijsku datoteku, možete kliknuti na gumb \'Nastavite nadogradnju\' kako biste nastavili sa nadogradnjom.<br />Prièekajte s uploadiranjem konfiguracijske datoteke dok proces nadogradnje ne završi.';
