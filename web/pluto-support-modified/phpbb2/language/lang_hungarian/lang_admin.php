...
$lang['Select_template'] = 'Válassz ki egy stílus-témát';
...
$lang['Export_explain'] = 'Ezzel az oldallal egy adott témát menthetsz ki. Válaszd ki a témát az alábbi listából, és az oldal elkészíti a téma konfigurációs fileját. Utána mentsd el a kiválasztott téma könyvtárába. Ha nem lehet elmenteni (nem írható a könyvtár; ezt a webszerveren tudod beállítani), akkor töltsd le, és kézzel másold be.';

$lang['Theme_installed'] = 'A kiválaszott téma telepítése sikeresen megtörtént!';
...
$lang['Theme_info_saved'] = 'A kiválasztott témához tartozó konfigurációs file (theme_info.cfg) el lett mentve. Változtasd meg a jogosultságát csak-olvashatóra (ajánlott az egész stílus könyvtárát is csak-olvashatóra átállítani).';
...
$lang['No_themes'] = 'A kiválasztott téma nem installálható, mivel nem szabályos stílus-téma. Új téma készítéséhez kattints a bal oldali menü Új menüpontjára';
...
// Install Process
//
$lang['Welcome_install'] = 'Üdvözölünk a phpBB 2 Telepítõjében!';
$lang['Initial_config'] = 'Alap konfiguráció';
$lang['DB_config'] = 'Adatbázis konfiguráció';
$lang['Admin_config'] = 'Adminisztrátor konfiguráció';
$lang['continue_upgrade'] = 'Miután letöltötted a konfigurációs filet, kattints a \'Telepítés folytatása\' gombra, hogy továbbléphess a frissítésben. A konfigurációs file feltöltésével várj a frissítés befejezéséig.';
...
$lang['Inst_Step_2'] = 'A telepítés sikeresen befejezõdött, és az Adminisztrátor azonosító is elkészült. Miután a Telepítés befejezése gombra kattintottál, zárd be a böngészõt, és töröld le a phpBB könyvtárból a \"contrib\" és az \"install\" könyvtárakat. Indítsd újra a böngészõt és a fórumot, ahol a belépés után az Adminisztrációs felületen keresztül beállíthatod a fórumot, elsõsorban az Általános beállításokra ügyelve. Köszönjük, hogy a phpBB 2-t választottad.';

$lang['Unwriteable_config'] = 'A konfigurációs filet jelenleg nem lehet írni, valószínûleg írás-olvasási jogosultság probléma miatt. A file egy másolata letölthetõ, ha az alábbi linkre kattintasz. Ezt kézzel töltsd fel a phpbb 2 gyökérkönyvtárába. Ezután lépj be az elõbb megadott Adminisztrátor felhasználónévvel és jelszóval a Fórumba, ahol az Adminisztrációs felületre kattintva beállíthatod a Fórum többi fontos elemét, elsõsorban az Általános beállítást. Köszönjük, hogy a phpBB 2-t választottad.';
...
$lang['Attempt_ftp'] = 'Konfigurációs file FTP-n keresztüli feltöltése';
