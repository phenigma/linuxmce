 ...
 *
 *     $Id: lang_main.php,v 2.0 2003/04/24 14:10:00 JuniorZ Exp $
 *
 ****************************************************************************/
...
$lang['Record_online_users'] = 'Recorde de Usuários Online foi de <b>%s</b> em %s'; // first %s = number of users, second %s is the date.
...
$lang['Rules_post_cannot'] = 'Enviar Mensagens Novas: <b>Proibído</b>.';
$lang['Rules_reply_can'] = 'Responder Tópicos: <b>Permitido</b>.';
$lang['Rules_reply_cannot'] = 'Responder Tópicos <b>Proibído</b.>';
$lang['Rules_edit_can'] = 'Editar Mensagens: <b>Permitido</b>.';
$lang['Rules_edit_cannot'] = 'Editar Mensagens: <b>Proibído</b>.';
$lang['Rules_delete_can'] = 'Excluir Mensagens: <b>Permitido</b>.';
$lang['Rules_delete_cannot'] = 'Excluir Mensagens: <b>Proibído</b>.';
$lang['Rules_vote_can'] = 'Votar em Enquetes: <b>Permitido</b>.';
$lang['Rules_vote_cannot'] = 'Votar em Enquetes: <b>Proibído</b>.';
$lang['Rules_moderate'] = 'Moderar Fórum: <b>%sPermitido%s</b>.'; // %s replaced by a href links, do not remove!

$lang['No_topics_post_one'] = 'Não há mensagens neste fórum<br />Clique em <b>Novo Tópico</b> nesta página para adicionar uma Mensagem Nova';
...
$lang['Date_format_explain'] = 'A sintaxe usada é idêntica à função PHP <a href="http://www.php.net/date" target="_other">date()</a> ';
...
$lang["Group_joined"] = 'Você inscreveu-se neste Grupo com sucesso.<br />Você será notificado quando a sua inscrição for aprovada pelo Moderador de Grupo';
...
$lang['You_been_banned'] = 'Você foi expulso deste fórum<br />Contacte o webmaster ou o administrador para mais informação';
