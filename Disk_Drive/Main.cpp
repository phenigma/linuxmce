...
#define  Disk_Drive_VERSION "testing"
...
int main(int argc, char* argv[])
{
    ...
    if (bError)
    {
        cout << "Disk_Drive, v." << Disk_Drive_VERSION << endl
            << "A Pluto DCE Device.  See www.plutohome.com/dce for details." << endl
            << "Usage: Disk_Drive [-r Router's IP] [-d My Device ID] [-l dce_router|stdout|null|filename]" << endl
