<?php
 function mobile_orbiter($output) {
		$out = '';
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="maintable">
  ...
  <tr>
    <td class="insidetable"><table border="0" align="left" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><a href="index.php?section=mobile_orbiter"><img src="images/submenus/Pluto%20system/mobile_orbiter_on.gif" width="154" height="17" border="0"></a></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td colspan="2"><img src="../images/spacer.gif" width="3" height="3"></td>
    ...
    <p><img src="images/submenus/mobile_orbiter_txt.gif" width="108" height="13"><br>
        <br>
      Pluto makes your mobile phone the most simple and convenient universal remote for everything regardless of the brand&mdash;lights, tv, stereo, security, climate, etc. Carry your phone and Pluto will always know what room you&rsquo;re in and your personal choices for tv, music, phone calls, lighting, climate, etc. follow you through the house automatically.</p>
    <p>When you&rsquo;re away, the instant someone approaches your home your phone alerts you with a live video feed. 1 button turns on tv&rsquo;s and stereo&rsquo;s, turning the whole house into a speaker phone, so you can speak to the person. If it&rsquo;s a delivery, you can lock &amp; unlock the door. If it&rsquo;s an intruder, let him know you&rsquo;re watching as you call the police. There's even a baby-sitter mode.</p>
    <p><center><a href="javascript:open_popup('operations/poza33.html','532','465')"><img src="images/img%20system/telefon/t_01_m.jpg" width="141" height="112" border="0"></a> <a href="javascript:open_popup('operations/poza34.html','532','465')"><img src="images/img%20system/telefon/t_02_m.jpg" width="141" height="112" border="0"></a>    
    </center></p></td>
  </tr>
</table>
...
TEXT;
        ...
        $output->setPageID(1); //butonul selectat
 		...
 		$output->setTitle(APPLICATION_NAME."::Mobile Orbiter");			//page title
