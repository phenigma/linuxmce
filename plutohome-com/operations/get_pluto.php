...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="maintable">
  ...
  <tr>
    ...
    <p><img src="images/submenus/pluto_for_my_home_txt.gif" width="165" height="13"><br>
      <p>At this moment Pluto 2 has not yet been released for retail distribution.  You are welcome to download a preview version of the Pluto software and build your own Pluto system using your existing personal computers.</p>
      <p>When the retail version is released, you will be able to get Pluto four different ways:</p>
      <p><strong>Pluto Pro</strong> &ndash; is our high line, made from the finest materials, available in a variety of finishes and colors to complement any d&eacute;cor. Pluto Pro dealers also sell compatible lighting control systems, security, climate and pool controls. Most also sell high-end audio/video equipment, and work with contractors to offer built-in solutions, such as in-wall Orbiters. Your Pluto Pro dealer offers a complete, custom installed, turn-key solution.</p>
      <p><strong>Pluto</strong> &ndash; The standard Pluto system runs on personal computers&rsquo;s, and will be available through a variety of traditional retailers. It has the same features as Pluto Pro and works the same way, but in a lower cost package.</p>
