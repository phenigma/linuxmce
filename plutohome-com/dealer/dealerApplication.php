...
';
	...
	if(isset($_POST['submitDealer'])){
		...
		$insertDealer="
			INSERT INTO Dealer
				(CompanyName, CurrentAddress, City, State, Zip, Phone, Fax, Country, EmployeesNo, StoreFront, IndividualName, Title, IndividualPhone, IndividualEmail, CoreBusiness, OtherBusiness, MarketFocus, OtherMarketFocus,OtherProducts, EstimatedRevenue, Reference1, Reference2, Reference3, ReturnPolicy)
			VALUES
				('$companyName', '$currentAddress', '$city', '$state', '$zip', '$phone', '$fax', '$country', '$employees', '$storeFront', '$individualName', '$title', '$individualPhone', '$individualEmail', '$coreBusiness', '$otherBusiness', '$marketFocus', '$otherMarketFocus','$otherProducts', '$estimatedRevenue', '$reference1', '$reference2', '$reference3', '$returnPolicy')";
