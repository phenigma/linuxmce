...
class DLL_EXPORT Table_Picture_Attribute
{
private:
...
long int pk_FK_Attribute;
	...
	map<Table_Picture_Attribute::Key, class Row_Picture_Attribute*, Table_Picture_Attribute::Key_Less> cachedRows;
	map<Table_Picture_Attribute::Key, class Row_Picture_Attribute*, Table_Picture_Attribute::Key_Less> deleted_cachedRows;
	vector<class Row_Picture_Attribute*> addedRows;
	vector<class Row_Picture_Attribute*> deleted_addedRows;	
...
private:	
	...
	class Row_Picture_Attribute* FetchRow(Key &key);
...
class Row_Attribute* FK_Attribute_getrow();
		...
		void SetupSerialization() {
			StartSerializeList() + m_FK_Picture+ m_FK_Attribute;
		}
	private:
