...
class DLL_EXPORT Table_File_Attribute
{
private:
...
long int pk_FK_Attribute;
	...
	map<Table_File_Attribute::Key, class Row_File_Attribute*, Table_File_Attribute::Key_Less> cachedRows;
	map<Table_File_Attribute::Key, class Row_File_Attribute*, Table_File_Attribute::Key_Less> deleted_cachedRows;
	vector<class Row_File_Attribute*> addedRows;
	vector<class Row_File_Attribute*> deleted_addedRows;	
...
private:	
	...
	class Row_File_Attribute* FetchRow(Key &key);
...
class Row_Attribute* FK_Attribute_getrow();
		...
		void SetupSerialization() {
			StartSerializeList() + m_FK_File+ m_FK_Attribute;
		}
	private:
