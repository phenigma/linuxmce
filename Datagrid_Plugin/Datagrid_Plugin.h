...
typedef class DataGridTable *(DataGridGeneratorPlugIn::*DCEDataGridGeneratorFn)(string GridID,string Parms,void *pExtraData,int *iPK_Variable,string *sValue_To_Assign,Message *pMessage);
