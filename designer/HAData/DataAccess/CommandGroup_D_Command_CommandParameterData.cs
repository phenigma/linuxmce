namespace HAData.DataAccess {
	...
	public class CommandGroup_D_Command_CommandParameterData : MyDataSet {
		...
		public const String MODIFICATION_RECORDINFO_TABLE_FIELD = "CommandGroup_D_Command_CommandParameter.Modification_RecordInfo";
		public const String ISNEW_RECORDINFO_TABLE_FIELD = "CommandGroup_D_Command_CommandParameter.IsNew_RecordInfo";
		public const String ISDELETED_RECORDINFO_TABLE_FIELD = "CommandGroup_D_Command_CommandParameter.IsDeleted_RecordInfo";
		public const String FK_USERS_RECORDINFO_TABLE_FIELD = "CommandGroup_D_Command_CommandParameter.FK_Users_RecordInfo";
		...
		protected static void CreateParameters(OdbcParameterCollection Params, bool IsInsert) {
			...
			Params[MODIFICATION_RECORDINFO_PARM].SourceColumn = CommandGroup_D_Command_CommandParameterData.MODIFICATION_RECORDINFO_FIELD;
			Params[ISNEW_RECORDINFO_PARM].SourceColumn = CommandGroup_D_Command_CommandParameterData.ISNEW_RECORDINFO_FIELD;
			Params[ISDELETED_RECORDINFO_PARM].SourceColumn = CommandGroup_D_Command_CommandParameterData.ISDELETED_RECORDINFO_FIELD;
			Params[FK_USERS_RECORDINFO_PARM].SourceColumn = CommandGroup_D_Command_CommandParameterData.FK_USERS_RECORDINFO_FIELD;
		}
		...
		public static DataRowCollection LoadCommandGroup_D_Command_CommandParameterWithWhere(ref MyDataSet ds, OdbcConnection conn, OdbcTransaction trans, string WhereClause) // marker:2
		{
			...
			string sSQL = "SELECT FK_CommandGroup_D_Command, FK_CommandParameter, Value, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo FROM CommandGroup_D_Command_CommandParameter WHERE " + WhereClause;
