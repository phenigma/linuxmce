namespace HAData.DataAccess {
	...
	public class Text_LS_AltVersionsData : MyDataSet {
		...
		public const String MODIFICATION_RECORDINFO_TABLE_FIELD = "Text_LS_AltVersions.Modification_RecordInfo";
		public const String ISNEW_RECORDINFO_TABLE_FIELD = "Text_LS_AltVersions.IsNew_RecordInfo";
		public const String ISDELETED_RECORDINFO_TABLE_FIELD = "Text_LS_AltVersions.IsDeleted_RecordInfo";
		public const String FK_USERS_RECORDINFO_TABLE_FIELD = "Text_LS_AltVersions.FK_Users_RecordInfo";
		...
		protected static void CreateParameters(OdbcParameterCollection Params, bool IsInsert) {
			...
			Params[MODIFICATION_RECORDINFO_PARM].SourceColumn = Text_LS_AltVersionsData.MODIFICATION_RECORDINFO_FIELD;
			Params[ISNEW_RECORDINFO_PARM].SourceColumn = Text_LS_AltVersionsData.ISNEW_RECORDINFO_FIELD;
			Params[ISDELETED_RECORDINFO_PARM].SourceColumn = Text_LS_AltVersionsData.ISDELETED_RECORDINFO_FIELD;
			Params[FK_USERS_RECORDINFO_PARM].SourceColumn = Text_LS_AltVersionsData.FK_USERS_RECORDINFO_FIELD;
		}
		...
		public static DataRowCollection LoadText_LS_AltVersionsWithWhere(ref MyDataSet ds, OdbcConnection conn, OdbcTransaction trans, string WhereClause) // marker:2
		{
			...
			string sSQL = "SELECT FK_Text, FK_Language, Version, Description, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo FROM Text_LS_AltVersions WHERE " + WhereClause;
