namespace HAData.DataAccess {
	...
	public class DesignObjVariation_DesignObjParameterData : MyDataSet {
		...
		public const String MODIFICATION_RECORDINFO_TABLE_FIELD = "DesignObjVariation_DesignObjParameter.Modification_RecordInfo";
		public const String ISNEW_RECORDINFO_TABLE_FIELD = "DesignObjVariation_DesignObjParameter.IsNew_RecordInfo";
		public const String ISDELETED_RECORDINFO_TABLE_FIELD = "DesignObjVariation_DesignObjParameter.IsDeleted_RecordInfo";
		public const String FK_USERS_RECORDINFO_TABLE_FIELD = "DesignObjVariation_DesignObjParameter.FK_Users_RecordInfo";
		...
		protected static void CreateParameters(OdbcParameterCollection Params, bool IsInsert) {
			...
			Params[MODIFICATION_RECORDINFO_PARM].SourceColumn = DesignObjVariation_DesignObjParameterData.MODIFICATION_RECORDINFO_FIELD;
			Params[ISNEW_RECORDINFO_PARM].SourceColumn = DesignObjVariation_DesignObjParameterData.ISNEW_RECORDINFO_FIELD;
			Params[ISDELETED_RECORDINFO_PARM].SourceColumn = DesignObjVariation_DesignObjParameterData.ISDELETED_RECORDINFO_FIELD;
			Params[FK_USERS_RECORDINFO_PARM].SourceColumn = DesignObjVariation_DesignObjParameterData.FK_USERS_RECORDINFO_FIELD;
		}
		...
		public static DataRowCollection LoadDesignObjVariation_DesignObjParameterWithWhere(ref MyDataSet ds, OdbcConnection conn, OdbcTransaction trans, string WhereClause) // marker:2
		{
			...
			string sSQL = "SELECT FK_DesignObjVariation, FK_DesignObjParameter, Value, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo FROM DesignObjVariation_DesignObjParameter WHERE " + WhereClause;
