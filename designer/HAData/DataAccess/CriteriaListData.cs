namespace HAData.DataAccess {
	...
	public class CriteriaListData : MyDataSet {
		...
		public const String MODIFICATION_RECORDINFO_TABLE_FIELD = "CriteriaList.Modification_RecordInfo";
		public const String ISNEW_RECORDINFO_TABLE_FIELD = "CriteriaList.IsNew_RecordInfo";
		public const String ISDELETED_RECORDINFO_TABLE_FIELD = "CriteriaList.IsDeleted_RecordInfo";
		public const String FK_USERS_RECORDINFO_TABLE_FIELD = "CriteriaList.FK_Users_RecordInfo";
		...
		protected static void CreateParameters(OdbcParameterCollection Params, bool IsInsert) {
			...
			Params[MODIFICATION_RECORDINFO_PARM].SourceColumn = CriteriaListData.MODIFICATION_RECORDINFO_FIELD;
			Params[ISNEW_RECORDINFO_PARM].SourceColumn = CriteriaListData.ISNEW_RECORDINFO_FIELD;
			Params[ISDELETED_RECORDINFO_PARM].SourceColumn = CriteriaListData.ISDELETED_RECORDINFO_FIELD;
			Params[FK_USERS_RECORDINFO_PARM].SourceColumn = CriteriaListData.FK_USERS_RECORDINFO_FIELD;
		}
		...
		public static DataRowCollection LoadCriteriaListWithWhere(ref MyDataSet ds, OdbcConnection conn, OdbcTransaction trans, string WhereClause) // marker:2
		{
			...
			string sSQL = "SELECT PK_CriteriaList, Description, Define, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo FROM CriteriaList WHERE " + WhereClause;
