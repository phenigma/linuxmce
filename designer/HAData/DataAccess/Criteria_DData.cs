namespace HAData.DataAccess {
	...
	public class Criteria_DData : MyDataSet {
		...
		public const String MODIFICATION_RECORDINFO_TABLE_FIELD = "Criteria_D.Modification_RecordInfo";
		public const String ISNEW_RECORDINFO_TABLE_FIELD = "Criteria_D.IsNew_RecordInfo";
		public const String ISDELETED_RECORDINFO_TABLE_FIELD = "Criteria_D.IsDeleted_RecordInfo";
		public const String FK_USERS_RECORDINFO_TABLE_FIELD = "Criteria_D.FK_Users_RecordInfo";
		...
		protected static void CreateParameters(OdbcParameterCollection Params, bool IsInsert) {
			...
			Params[MODIFICATION_RECORDINFO_PARM].SourceColumn = Criteria_DData.MODIFICATION_RECORDINFO_FIELD;
			Params[ISNEW_RECORDINFO_PARM].SourceColumn = Criteria_DData.ISNEW_RECORDINFO_FIELD;
			Params[ISDELETED_RECORDINFO_PARM].SourceColumn = Criteria_DData.ISDELETED_RECORDINFO_FIELD;
			Params[FK_USERS_RECORDINFO_PARM].SourceColumn = Criteria_DData.FK_USERS_RECORDINFO_FIELD;
		}
		...
		public static DataRowCollection LoadCriteria_DWithWhere(ref MyDataSet ds, OdbcConnection conn, OdbcTransaction trans, string WhereClause) // marker:2
		{
			...
			string sSQL = "SELECT PK_Criteria_D, FK_CriteriaParmNesting_D, FK_CriteriaList, Description, Define, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo FROM Criteria_D WHERE " + WhereClause;
