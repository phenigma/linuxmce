namespace HAData.DataAccess {
	...
	public class ParameterTypeData : MyDataSet {
		...
		public const String MODIFICATION_RECORDINFO_TABLE_FIELD = "ParameterType.Modification_RecordInfo";
		public const String ISNEW_RECORDINFO_TABLE_FIELD = "ParameterType.IsNew_RecordInfo";
		public const String ISDELETED_RECORDINFO_TABLE_FIELD = "ParameterType.IsDeleted_RecordInfo";
		public const String FK_USERS_RECORDINFO_TABLE_FIELD = "ParameterType.FK_Users_RecordInfo";
		...
		protected static void CreateParameters(OdbcParameterCollection Params, bool IsInsert) {
			...
			Params[MODIFICATION_RECORDINFO_PARM].SourceColumn = ParameterTypeData.MODIFICATION_RECORDINFO_FIELD;
			Params[ISNEW_RECORDINFO_PARM].SourceColumn = ParameterTypeData.ISNEW_RECORDINFO_FIELD;
			Params[ISDELETED_RECORDINFO_PARM].SourceColumn = ParameterTypeData.ISDELETED_RECORDINFO_FIELD;
			Params[FK_USERS_RECORDINFO_PARM].SourceColumn = ParameterTypeData.FK_USERS_RECORDINFO_FIELD;
		}
		...
		public static DataRowCollection LoadParameterTypeWithWhere(ref MyDataSet ds, OdbcConnection conn, OdbcTransaction trans, string WhereClause) // marker:2
		{
			...
			string sSQL = "SELECT PK_ParameterType, Description, Define, CPPType, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo FROM ParameterType WHERE " + WhereClause;
