namespace HAData.DataAccess {
	...
	public class ArrayData : MyDataSet {
		...
		public const String MODIFICATION_RECORDINFO_TABLE_FIELD = "Array.Modification_RecordInfo";
		public const String ISNEW_RECORDINFO_TABLE_FIELD = "Array.IsNew_RecordInfo";
		public const String ISDELETED_RECORDINFO_TABLE_FIELD = "Array.IsDeleted_RecordInfo";
		public const String FK_USERS_RECORDINFO_TABLE_FIELD = "Array.FK_Users_RecordInfo";
		...
		protected static void CreateParameters(OdbcParameterCollection Params, bool IsInsert) {
			...
			Params[MODIFICATION_RECORDINFO_PARM].SourceColumn = ArrayData.MODIFICATION_RECORDINFO_FIELD;
			Params[ISNEW_RECORDINFO_PARM].SourceColumn = ArrayData.ISNEW_RECORDINFO_FIELD;
			Params[ISDELETED_RECORDINFO_PARM].SourceColumn = ArrayData.ISDELETED_RECORDINFO_FIELD;
			Params[FK_USERS_RECORDINFO_PARM].SourceColumn = ArrayData.FK_USERS_RECORDINFO_FIELD;
		}
		...
		public static DataRowCollection LoadArrayWithWhere(ref MyDataSet ds, OdbcConnection conn, OdbcTransaction trans, string WhereClause) // marker:2
		{
			...
			string sSQL = "SELECT PK_Array, Description, Define, CommandGroup, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo FROM Array WHERE " + WhereClause;
