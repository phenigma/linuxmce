namespace HAData.DataAccess {
	...
	public class DesignObjVariation_TextData : MyDataSet {
		...
		public const String MODIFICATION_RECORDINFO_TABLE_FIELD = "DesignObjVariation_Text.Modification_RecordInfo";
		public const String ISNEW_RECORDINFO_TABLE_FIELD = "DesignObjVariation_Text.IsNew_RecordInfo";
		public const String ISDELETED_RECORDINFO_TABLE_FIELD = "DesignObjVariation_Text.IsDeleted_RecordInfo";
		public const String FK_USERS_RECORDINFO_TABLE_FIELD = "DesignObjVariation_Text.FK_Users_RecordInfo";
		...
		protected static void CreateParameters(OdbcParameterCollection Params, bool IsInsert) {
			...
			Params[MODIFICATION_RECORDINFO_PARM].SourceColumn = DesignObjVariation_TextData.MODIFICATION_RECORDINFO_FIELD;
			Params[ISNEW_RECORDINFO_PARM].SourceColumn = DesignObjVariation_TextData.ISNEW_RECORDINFO_FIELD;
			Params[ISDELETED_RECORDINFO_PARM].SourceColumn = DesignObjVariation_TextData.ISDELETED_RECORDINFO_FIELD;
			Params[FK_USERS_RECORDINFO_PARM].SourceColumn = DesignObjVariation_TextData.FK_USERS_RECORDINFO_FIELD;
		}
		...
		public static DataRowCollection LoadDesignObjVariation_TextWithWhere(ref MyDataSet ds, OdbcConnection conn, OdbcTransaction trans, string WhereClause) // marker:2
		{
			...
			string sSQL = "SELECT PK_DesignObjVariation_Text, FK_DesignObjVariation, FK_Text, FK_Text_OverrideFromHeader, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo FROM DesignObjVariation_Text WHERE " + WhereClause;
