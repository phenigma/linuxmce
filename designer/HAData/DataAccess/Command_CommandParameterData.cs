namespace HAData.DataAccess {
	...
	public class Command_CommandParameterData : MyDataSet {
		...
		public const String MODIFICATION_RECORDINFO_TABLE_FIELD = "Command_CommandParameter.Modification_RecordInfo";
		public const String ISNEW_RECORDINFO_TABLE_FIELD = "Command_CommandParameter.IsNew_RecordInfo";
		public const String ISDELETED_RECORDINFO_TABLE_FIELD = "Command_CommandParameter.IsDeleted_RecordInfo";
		public const String FK_USERS_RECORDINFO_TABLE_FIELD = "Command_CommandParameter.FK_Users_RecordInfo";
		...
		protected static void CreateParameters(OdbcParameterCollection Params, bool IsInsert) {
			...
			Params[MODIFICATION_RECORDINFO_PARM].SourceColumn = Command_CommandParameterData.MODIFICATION_RECORDINFO_FIELD;
			Params[ISNEW_RECORDINFO_PARM].SourceColumn = Command_CommandParameterData.ISNEW_RECORDINFO_FIELD;
			Params[ISDELETED_RECORDINFO_PARM].SourceColumn = Command_CommandParameterData.ISDELETED_RECORDINFO_FIELD;
			Params[FK_USERS_RECORDINFO_PARM].SourceColumn = Command_CommandParameterData.FK_USERS_RECORDINFO_FIELD;
		}
		...
		public static DataRowCollection LoadCommand_CommandParameterWithWhere(ref MyDataSet ds, OdbcConnection conn, OdbcTransaction trans, string WhereClause) // marker:2
		{
			...
			string sSQL = "SELECT FK_Command, FK_CommandParameter, Description, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo FROM Command_CommandParameter WHERE " + WhereClause;
