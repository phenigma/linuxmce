namespace HAData.DataAccess {
	...
	public class CriteriaParmListData : MyDataSet {
		...
		public const String MODIFICATION_RECORDINFO_TABLE_FIELD = "CriteriaParmList.Modification_RecordInfo";
		public const String ISNEW_RECORDINFO_TABLE_FIELD = "CriteriaParmList.IsNew_RecordInfo";
		public const String ISDELETED_RECORDINFO_TABLE_FIELD = "CriteriaParmList.IsDeleted_RecordInfo";
		public const String FK_USERS_RECORDINFO_TABLE_FIELD = "CriteriaParmList.FK_Users_RecordInfo";
		...
		protected static void CreateParameters(OdbcParameterCollection Params, bool IsInsert) {
			...
			Params[MODIFICATION_RECORDINFO_PARM].SourceColumn = CriteriaParmListData.MODIFICATION_RECORDINFO_FIELD;
			Params[ISNEW_RECORDINFO_PARM].SourceColumn = CriteriaParmListData.ISNEW_RECORDINFO_FIELD;
			Params[ISDELETED_RECORDINFO_PARM].SourceColumn = CriteriaParmListData.ISDELETED_RECORDINFO_FIELD;
			Params[FK_USERS_RECORDINFO_PARM].SourceColumn = CriteriaParmListData.FK_USERS_RECORDINFO_FIELD;
		}
		...
		public static DataRowCollection LoadCriteriaParmListWithWhere(ref MyDataSet ds, OdbcConnection conn, OdbcTransaction trans, string WhereClause) // marker:2
		{
			...
			string sSQL = "SELECT PK_CriteriaParmList, FK_ParameterType, Description, Define, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo FROM CriteriaParmList WHERE " + WhereClause;
