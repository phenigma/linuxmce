namespace HAData.DataAccess {
	...
	public class SystemData : MyDataSet {
		...
		public const String MODIFICATION_RECORDINFO_TABLE_FIELD = "System.Modification_RecordInfo";
		public const String ISNEW_RECORDINFO_TABLE_FIELD = "System.IsNew_RecordInfo";
		public const String ISDELETED_RECORDINFO_TABLE_FIELD = "System.IsDeleted_RecordInfo";
		public const String FK_USERS_RECORDINFO_TABLE_FIELD = "System.FK_Users_RecordInfo";
		...
		protected static void CreateParameters(OdbcParameterCollection Params, bool IsInsert) {
			...
			Params[MODIFICATION_RECORDINFO_PARM].SourceColumn = SystemData.MODIFICATION_RECORDINFO_FIELD;
			Params[ISNEW_RECORDINFO_PARM].SourceColumn = SystemData.ISNEW_RECORDINFO_FIELD;
			Params[ISDELETED_RECORDINFO_PARM].SourceColumn = SystemData.ISDELETED_RECORDINFO_FIELD;
			Params[FK_USERS_RECORDINFO_PARM].SourceColumn = SystemData.FK_USERS_RECORDINFO_FIELD;
		}
		...
		public static DataRowCollection LoadSystemWithWhere(ref MyDataSet ds, OdbcConnection conn, OdbcTransaction trans, string WhereClause) // marker:2
		{
			...
			string sSQL = "SELECT PK_System, Description, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo FROM System WHERE " + WhereClause;
