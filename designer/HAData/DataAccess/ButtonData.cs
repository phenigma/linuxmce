namespace HAData.DataAccess {
	...
	public class ButtonData : MyDataSet {
		//
		// Button table constants
		//
		public const String BUTTON_TABLE = "Button";
		public const String PK_BUTTON_FIELD = "PK_Button";
		...
		public const String PK_BUTTON_TABLE_FIELD = "Button.PK_Button";
		public const String DESCRIPTION_TABLE_FIELD = "Button.Description";
		public const String DEFINE_TABLE_FIELD = "Button.Define";
		public const String MODIFICATION_RECORDINFO_TABLE_FIELD = "Button.Modification_RecordInfo";
		public const String ISNEW_RECORDINFO_TABLE_FIELD = "Button.IsNew_RecordInfo";
		public const String ISDELETED_RECORDINFO_TABLE_FIELD = "Button.IsDeleted_RecordInfo";
		public const String FK_USERS_RECORDINFO_TABLE_FIELD = "Button.FK_Users_RecordInfo";
		...
		private ButtonData(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context) {
			CreateCommands(m_Connection, m_Transaction, ref m_LoadCommand, ref m_InsertCommand, ref m_UpdateCommand, ref m_DeleteCommand);
		...
		public static DataTable BuildDataTables() {
			return (DataTable) BuildButtonTable();
		}
		public static ButtonTable BuildButtonTable() {
			//
			...
			DataColumn Column = Columns.Add(PK_BUTTON_FIELD, typeof(System.Int32));
		...
		protected static void CreateParameters(OdbcParameterCollection Params, bool IsInsert) {
			...
			Params[PK_BUTTON_PARM].SourceColumn = ButtonData.PK_BUTTON_FIELD;
			if(IsInsert) {
				Params[PK_BUTTON_PARM].Direction = ParameterDirection.Output;
			}

			Params[DESCRIPTION_PARM].SourceColumn = ButtonData.DESCRIPTION_FIELD;
			Params[DEFINE_PARM].SourceColumn = ButtonData.DEFINE_FIELD;
			Params[MODIFICATION_RECORDINFO_PARM].SourceColumn = ButtonData.MODIFICATION_RECORDINFO_FIELD;
			Params[ISNEW_RECORDINFO_PARM].SourceColumn = ButtonData.ISNEW_RECORDINFO_FIELD;
			Params[ISDELETED_RECORDINFO_PARM].SourceColumn = ButtonData.ISDELETED_RECORDINFO_FIELD;
			Params[FK_USERS_RECORDINFO_PARM].SourceColumn = ButtonData.FK_USERS_RECORDINFO_FIELD;
		}
		...
		public ButtonData LoadButton(System.Int32 PK_Button)
		{
			m_DSCommand.SelectCommand = m_LoadCommand;
			m_DSCommand.SelectCommand.Parameters[PK_BUTTON_PARM].Value = PK_Button;
		...
		public static DataRowCollection LoadButtonWithWhere(ref MyDataSet ds, OdbcConnection conn, OdbcTransaction trans, string WhereClause) // marker:2
		{
			...
			string sSQL = "SELECT PK_Button, Description, Define, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo FROM Button WHERE " + WhereClause;
			...
			sqlda.Fill(dsTemp,"Button");
			
			dr=dsTemp.Tables["Button"].Rows;
		...
		public static DataRow LoadNoCacheButton(ref MyDataSet ds, OdbcConnection conn, OdbcTransaction trans, System.Int32 PK_Button)
		{
			...
			if( trans!=null )
				LoadCommand.Transaction = trans;
			sqlda.SelectCommand = LoadCommand;
			sqlda.Fill(ds,"Button");
				dr = ds.Tables["Button"].Rows.Find(PK_Button);
			return dr;
		}
		...
		public static DataRowCollection LoadAll(ref MyDataSet ds, OdbcConnection conn, OdbcTransaction trans) {
			...
			sqlda.SelectCommand = LoadCommand;
			if( sqlda.Fill(ds,"Button")==0 )
				return null;
			else
				return ds.Tables["Button"].Rows;

		}

		public ButtonData ExecuteQuery(String sSQL) {
			return ExecuteQuery(sSQL,BUTTON_TABLE);
		}
		...
		public bool UpdateButton(int CurUserID) {
			...
			m_DSCommand.Update(this, ButtonData.BUTTON_TABLE);
			return true;
		}
	...
	public class ButtonDataRow
	{
		...
		public ButtonDataRow(DataRow d)
		{
			dr=d;
		}
		...
		public System.Int32 fPK_Button
		{
			get
			{
	...
	public class ButtonTable : DataTable
	{
		public ButtonTable() : base("Button") {}

		public ButtonDataRow this [System.Int32 PK_Button]
		{
			get
			{
		...
		public DataRowCollection LoadAll(OdbcConnection conn, OdbcTransaction trans)
		{
			...
			sqlda.SelectCommand = LoadCommand;
			if( sqlda.Fill(this.DataSet,"Button")==0 )
				return null;
			else
				return Rows;
		}
