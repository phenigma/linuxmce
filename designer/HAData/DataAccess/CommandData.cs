namespace HAData.DataAccess {
	...
	public class CommandData : MyDataSet {
		...
		public const String MODIFICATION_RECORDINFO_TABLE_FIELD = "Command.Modification_RecordInfo";
		public const String ISNEW_RECORDINFO_TABLE_FIELD = "Command.IsNew_RecordInfo";
		public const String ISDELETED_RECORDINFO_TABLE_FIELD = "Command.IsDeleted_RecordInfo";
		public const String FK_USERS_RECORDINFO_TABLE_FIELD = "Command.FK_Users_RecordInfo";
		...
		protected static void CreateParameters(OdbcParameterCollection Params, bool IsInsert) {
			...
			Params[MODIFICATION_RECORDINFO_PARM].SourceColumn = CommandData.MODIFICATION_RECORDINFO_FIELD;
			Params[ISNEW_RECORDINFO_PARM].SourceColumn = CommandData.ISNEW_RECORDINFO_FIELD;
			Params[ISDELETED_RECORDINFO_PARM].SourceColumn = CommandData.ISDELETED_RECORDINFO_FIELD;
			Params[FK_USERS_RECORDINFO_PARM].SourceColumn = CommandData.FK_USERS_RECORDINFO_FIELD;
		}
		...
		public static DataRowCollection LoadCommandWithWhere(ref MyDataSet ds, OdbcConnection conn, OdbcTransaction trans, string WhereClause) // marker:2
		{
			...
			string sSQL = "SELECT PK_Command, Description, Define, FK_CommandCategory, AVCommand, Modification_RecordInfo, IsNew_RecordInfo, IsDeleted_RecordInfo, FK_Users_RecordInfo FROM Command WHERE " + WhereClause;
