...
namespace MYTHTV {
	...
	int ProxyPeerThread::replData(bool fromsrc)
	{
		/* read fromsockfd */
		int
	...
	int ProxyPeerThread::readData(int sockfd, std::string& data)
	{
		/* read data size */
	...
	int ProxyPeerThread::writeData(int sockfd, const std::string& data)
	{
		char tmpbuff[12];
