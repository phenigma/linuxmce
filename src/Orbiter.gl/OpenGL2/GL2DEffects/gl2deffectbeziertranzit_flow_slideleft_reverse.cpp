...
GL2DBezierEffectTransit_Flow_SlideLeft_Reverse::~GL2DBezierEffectTransit_Flow_SlideLeft_Reverse() {
	Effects->Widgets->DeleteWidget(ButonTop);	

	ButonTop = NULL;
}

void GL2DBezierEffectTransit_Flow_SlideLeft_Reverse::Configure(PlutoRectangle* EffectSourceSize)
{
