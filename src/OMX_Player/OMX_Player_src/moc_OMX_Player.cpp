...
**
** Created: Wed May 21 01:04:37 2014
...
static const char qt_meta_stringdata_DCE__OMX_Player[] = {
    "DCE::OMX_Player\0"
};
...
const QMetaObjectExtraData DCE::OMX_Player::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DCE::OMX_Player::staticMetaObject = {
    { &OMX_Player_Command::staticMetaObject, qt_meta_stringdata_DCE__OMX_Player,
      qt_meta_data_DCE__OMX_Player, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DCE::OMX_Player::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DCE__OMX_Player))
        return static_cast<void*>(const_cast< OMX_Player*>(this));
    return OMX_Player_Command::qt_metacast(_clname);
}

int DCE::OMX_Player::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = OMX_Player_Command::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
