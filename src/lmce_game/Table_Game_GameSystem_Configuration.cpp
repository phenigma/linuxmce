...
long int Row_Game_GameSystem_Configuration::FK_Game_get(){PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_DBMutex);

return m_FK_Game;}
long int Row_Game_GameSystem_Configuration::FK_GameSystem_get(){PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_DBMutex);
...
void Row_Game_GameSystem_Configuration::FK_Game_set(long int val){PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_DBMutex);

m_FK_Game = val; is_modified=true; is_null[1]=false;}
void Row_Game_GameSystem_Configuration::FK_GameSystem_set(long int val){PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_DBMutex);
...
m_FK_Configuration = val; is_modified=true; is_null[3]=false;}
...
string Row_Game_GameSystem_Configuration::FK_Game_asSQL()
{
PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_DBMutex);
...
string Row_Game_GameSystem_Configuration::FK_GameSystem_asSQL()
{
PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_DBMutex);
...
values_list_comma_separated = values_list_comma_separated + pRow->PK_Game_GameSystem_Configuration_asSQL()+", "+pRow->FK_Game_asSQL()+", "+pRow->FK_GameSystem_asSQL()+", "+pRow->FK_Configuration_asSQL();

	
		string query = "insert into Game_GameSystem_Configuration (`PK_Game_GameSystem_Configuration`, `FK_Game`, `FK_GameSystem`, `FK_Configuration`) values ("+
...
update_values_list = update_values_list + "`PK_Game_GameSystem_Configuration`="+pRow->PK_Game_GameSystem_Configuration_asSQL()+", `FK_Game`="+pRow->FK_Game_asSQL()+", `FK_GameSystem`="+pRow->FK_GameSystem_asSQL()+", `FK_Configuration`="+pRow->FK_Configuration_asSQL();
...
sscanf(row[3], "%li", &(pRow->m_FK_Configuration));
}
...
class Row_Game* Row_Game_GameSystem_Configuration::FK_Game_getrow()
{
PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_DBMutex);
...
class Row_GameSystem* Row_Game_GameSystem_Configuration::FK_GameSystem_getrow()
{
PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_DBMutex);
