...
db_wrapper_real_escape_string(table->database->m_pDB, buf, m_Define.c_str(), (unsigned long) min((size_t)192,m_Define.size()));
string s=string()+"\""+buf+"\"";
delete[] buf;
return s;
}
...
db_wrapper_real_escape_string(table->database->m_pDB, buf, m_Description.c_str(), (unsigned long) min((size_t)384,m_Description.size()));
string s=string()+"\""+buf+"\"";
delete[] buf;
return s;
}
...
void Row_GameSystem::GameSystem_Picture_FK_GameSystem_getrows(vector <class Row_GameSystem_Picture*> *rows)
{
PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_DBMutex);
...
void Row_GameSystem::Game_GameSystem_FK_GameSystem_getrows(vector <class Row_Game_GameSystem*> *rows)
{
PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_DBMutex);
...
void Row_GameSystem::Game_GameSystem_Configuration_FK_GameSystem_getrows(vector <class Row_Game_GameSystem_Configuration*> *rows)
{
PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_DBMutex);
...
void Row_GameSystem::Game_GameSystem_Picture_FK_GameSystem_getrows(vector <class Row_Game_GameSystem_Picture*> *rows)
{
PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_DBMutex);
...
void Row_GameSystem::Game_GameSystem_Rom_FK_GameSystem_getrows(vector <class Row_Game_GameSystem_Rom*> *rows)
{
PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_DBMutex);
...
void Row_GameSystem::Game_GameSystem_Rom_Configuration_FK_GameSystem_getrows(vector <class Row_Game_GameSystem_Rom_Configuration*> *rows)
{
PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_DBMutex);
