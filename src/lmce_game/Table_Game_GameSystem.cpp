...
values_list_comma_separated = values_list_comma_separated + pRow->PK_Game_GameSystem_asSQL()+", "+pRow->FK_Game_asSQL()+", "+pRow->FK_GameSystem_asSQL();

	
		string query = "insert into Game_GameSystem (`PK_Game_GameSystem`, `FK_Game`, `FK_GameSystem`) values ("+
...
update_values_list = update_values_list + "`PK_Game_GameSystem`="+pRow->PK_Game_GameSystem_asSQL()+", `FK_Game`="+pRow->FK_Game_asSQL()+", `FK_GameSystem`="+pRow->FK_GameSystem_asSQL();
