...
Generic_PC_Workstation::Generic_PC_Workstation(int DeviceID, string ServerAddress,bool bConnectEventHandler,bool bLocalMode,class Router *pRouter)
...
Generic_PC_Workstation::Generic_PC_Workstation(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter)
	: Generic_PC_Workstation_Command(pPrimaryDeviceCommand, pData, pEvent, pRouter)
//<-dceag-const2-e->
{
}
...
//<-dceag-getconfig-b->
bool Generic_PC_Workstation::GetConfig()
{
	if( !Generic_PC_Workstation_Command::GetConfig() )
		return false;
//<-dceag-getconfig-e->
...
bool Generic_PC_Workstation::Register()
//<-dceag-reg-e->
{
...
//<-dceag-createinst-b->
Generic_PC_Workstation_Command *Create_Generic_PC_Workstation(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter)
{
	return new Generic_PC_Workstation(pPrimaryDeviceCommand, pData, pEvent, pRouter);
}
//<-dceag-createinst-e->
...
*/
//<-dceag-cmdch-b->
void Generic_PC_Workstation::ReceivedCommandForChild(DeviceData_Impl *pDeviceData_Impl,string &sCMD_Result,Message *pMessage)
//<-dceag-cmdch-e->
{
...
*/
//<-dceag-cmduk-b->
void Generic_PC_Workstation::ReceivedUnknownCommand(string &sCMD_Result,Message *pMessage)
//<-dceag-cmduk-e->
{
...
void Generic_PC_Workstation::SomeFunction()
{
