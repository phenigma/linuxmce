...
## Copy local deb-cache for diskless
build_arch="amd64"
CopyCrossoverDebcache "${build_arch}"
echo "select VersionName from Version" | mysql -A -N pluto_main_build  | head -1 > "/var/plutobuild/DisklessSync/${build_arch}/version"
