...
if( pDesignObj_Generator->m_ObjectID.find("5362")!=string::npos || pDesignObj_Generator->m_ObjectID.find("5363")!=string::npos || pDesignObj_Generator->m_ObjectID.find("5270")!=string::npos )
{
