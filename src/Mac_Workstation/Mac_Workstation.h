...
*/
//<-dceag-d-b->
#ifndef Mac_Workstation_h
#define Mac_Workstation_h

//	DCE Implemenation for #2244 Mac Workstation

#include "Gen_Devices/Mac_WorkstationBase.h"
//<-dceag-d-e->

//<-dceag-decl-b->
namespace DCE
{
	class Mac_Workstation : public Mac_Workstation_Command
	{
//<-dceag-decl-e->
...
public:
		...
		Mac_Workstation(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL);
		virtual ~Mac_Workstation();
...
//<-dceag-const2-b->
		...
		Mac_Workstation(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter);
//<-dceag-const2-e->
...
//<-dceag-h-b->
	...
	*/
	...
	string DATA_Get_Available_Sound_Cards();
