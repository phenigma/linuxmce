...
#define PNP_DEVICE_WAITING 2
#define PNP_DEVICE_PROMPT_FOR_TEMPLATE 3
#define PNP_DEVICE_PROMPT_FOR_PARAMETERS 4
#define PNP_DEVICE_ADD_DEVICE 5
#define PNP_DEVICE_ADD_SOFTWARE 6
#define PNP_DEVICE_START_DEVICE 7
#define PNP_DEVICE_DONE 8
