#ifndef OMX_PluginBase_h
#define OMX_PluginBase_h
...
class OMX_Plugin_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	OMX_Plugin_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_OMX_Plugin_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT_PLUGIN) {};
	OMX_Plugin_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class OMX_Plugin_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_OMX_Plugin_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "OMX_Plugin"; } ;
...
class OMX_Plugin_Command : public Command_Impl
{
public:
	OMX_Plugin_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new OMX_Plugin_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_OMX_Plugin_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	OMX_Plugin_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~OMX_Plugin_Command() {};
	OMX_Plugin_Event *GetEvents() { return (OMX_Plugin_Event *) m_pEvent; };
	OMX_Plugin_Data *GetData() { return (OMX_Plugin_Data *) m_pData; };
	const char *GetClassName() { return "OMX_Plugin_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_OMX_Plugin_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_OMX_Plugin_CONST; };
