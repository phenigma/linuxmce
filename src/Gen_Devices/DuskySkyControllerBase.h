#ifndef DuskySkyControllerBase_h
#define DuskySkyControllerBase_h
...
class DuskySkyController_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	DuskySkyController_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_DuskySkyController_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT_PLUGIN) {};
	DuskySkyController_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class DuskySkyController_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual ~DuskySkyController_Data() {};
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_DuskySkyController_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "DuskySkyController"; } ;
...
class DuskySkyController_Command : public Command_Impl
{
public:
	DuskySkyController_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new DuskySkyController_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new DuskySkyController_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_DuskySkyController_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	DuskySkyController_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~DuskySkyController_Command() {};
	DuskySkyController_Event *GetEvents() { return (DuskySkyController_Event *) m_pEvent; };
	DuskySkyController_Data *GetData() { return (DuskySkyController_Data *) m_pData; };
	const char *GetClassName() { return "DuskySkyController_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_DuskySkyController_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_DuskySkyController_CONST; };
