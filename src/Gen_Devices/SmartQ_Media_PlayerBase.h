#ifndef SmartQ_Media_PlayerBase_h
#define SmartQ_Media_PlayerBase_h
...
class SmartQ_Media_Player_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	SmartQ_Media_Player_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_SmartQ_Media_Player_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	SmartQ_Media_Player_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class SmartQ_Media_Player_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual ~SmartQ_Media_Player_Data() {};
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_SmartQ_Media_Player_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "SmartQ_Media_Player"; } ;
...
class SmartQ_Media_Player_Command : public Command_Impl
{
public:
	SmartQ_Media_Player_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new SmartQ_Media_Player_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new SmartQ_Media_Player_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_SmartQ_Media_Player_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	SmartQ_Media_Player_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~SmartQ_Media_Player_Command() {};
	SmartQ_Media_Player_Event *GetEvents() { return (SmartQ_Media_Player_Event *) m_pEvent; };
	SmartQ_Media_Player_Data *GetData() { return (SmartQ_Media_Player_Data *) m_pData; };
	const char *GetClassName() { return "SmartQ_Media_Player_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_SmartQ_Media_Player_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_SmartQ_Media_Player_CONST; };
