#ifndef qMediaPlayer_PluginBase_h
#define qMediaPlayer_PluginBase_h
...
class qMediaPlayer_Plugin_Event : public Event_Impl
{
public:
...
class qMediaPlayer_Plugin_Data : public DeviceData_Impl
{
public:
...
class qMediaPlayer_Plugin_Command : public Command_Impl
{
public:
	qMediaPlayer_Plugin_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new qMediaPlayer_Plugin_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new qMediaPlayer_Plugin_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_qMediaPlayer_Plugin_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	qMediaPlayer_Plugin_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~qMediaPlayer_Plugin_Command() {};
	qMediaPlayer_Plugin_Event *GetEvents() { return (qMediaPlayer_Plugin_Event *) m_pEvent; };
	qMediaPlayer_Plugin_Data *GetData() { return (qMediaPlayer_Plugin_Data *) m_pData; };
	const char *GetClassName() { return "qMediaPlayer_Plugin_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_qMediaPlayer_Plugin_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_qMediaPlayer_Plugin_CONST; };
