...
public:
	...
	* @brief Constructors
	*/
	IRTrans_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_IRTrans_IRTUSB_TransmReceive_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
...
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_IRTrans_IRTUSB_TransmReceive_CONST; } ;
	...
	*/
	...
	void Set_COM_Port_on_PC(string Value)
	{
...
public:
	...
	virtual bool GetConfig()
	{
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_IRTrans_IRTUSB_TransmReceive_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_IRTrans_IRTUSB_TransmReceive_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_IRTrans_IRTUSB_TransmReceive_CONST; };
