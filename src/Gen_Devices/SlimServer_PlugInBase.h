...
public:
	...
	* @brief Constructors
	*/
	SlimServer_PlugIn_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_SlimServer_PlugIn_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT_PLUGIN) {};
...
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_SlimServer_PlugIn_CONST; } ;
...
public:
	...
	virtual bool GetConfig()
	{
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_SlimServer_PlugIn_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_SlimServer_PlugIn_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_SlimServer_PlugIn_CONST; };
