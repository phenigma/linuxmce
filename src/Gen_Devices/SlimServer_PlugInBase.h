#ifndef SlimServer_PlugInBase_h
#define SlimServer_PlugInBase_h
...
class SlimServer_PlugIn_Data : public DeviceData_Impl
{
public:
	virtual ~SlimServer_PlugIn_Data() {};
...
class SlimServer_PlugIn_Command : public Command_Impl
{
public:
	SlimServer_PlugIn_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	virtual bool GetConfig()
	{
		if( m_bLocalMode )
			return true;
		m_pData=NULL;
		m_pEvent = new SlimServer_PlugIn_Event(m_dwPK_Device, m_sHostName);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, 1695,m_sHostName);
		return true;
	};
	SlimServer_PlugIn_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~SlimServer_PlugIn_Command() {};
	SlimServer_PlugIn_Event *GetEvents() { return (SlimServer_PlugIn_Event *) m_pEvent; };
	SlimServer_PlugIn_Data *GetData() { return (SlimServer_PlugIn_Data *) m_pData; };
	const char *GetClassName() { return "SlimServer_PlugIn_Command"; };
	virtual int PK_DeviceTemplate_get() { return 1695; };
	static int PK_DeviceTemplate_get_static() { return 1695; };
