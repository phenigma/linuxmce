#ifndef Rain8NetBase_h
#define Rain8NetBase_h
...
class Rain8Net_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	Rain8Net_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Rain8Net_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	Rain8Net_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class Rain8Net_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Rain8Net_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "Rain8Net"; } ;
...
class Rain8Net_Command : public Command_Impl
{
public:
	Rain8Net_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new Rain8Net_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Rain8Net_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	Rain8Net_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Rain8Net_Command() {};
	Rain8Net_Event *GetEvents() { return (Rain8Net_Event *) m_pEvent; };
	Rain8Net_Data *GetData() { return (Rain8Net_Data *) m_pData; };
	const char *GetClassName() { return "Rain8Net_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Rain8Net_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Rain8Net_CONST; };
