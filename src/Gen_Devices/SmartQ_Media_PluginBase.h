#ifndef SmartQ_Media_PluginBase_h
#define SmartQ_Media_PluginBase_h
...
class SmartQ_Media_Plugin_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	SmartQ_Media_Plugin_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_SmartQ_Media_Plugin_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT_PLUGIN) {};
	SmartQ_Media_Plugin_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class SmartQ_Media_Plugin_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual ~SmartQ_Media_Plugin_Data() {};
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_SmartQ_Media_Plugin_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "SmartQ_Media_Plugin"; } ;
...
class SmartQ_Media_Plugin_Command : public Command_Impl
{
public:
	SmartQ_Media_Plugin_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new SmartQ_Media_Plugin_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new SmartQ_Media_Plugin_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_SmartQ_Media_Plugin_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	SmartQ_Media_Plugin_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~SmartQ_Media_Plugin_Command() {};
	SmartQ_Media_Plugin_Event *GetEvents() { return (SmartQ_Media_Plugin_Event *) m_pEvent; };
	SmartQ_Media_Plugin_Data *GetData() { return (SmartQ_Media_Plugin_Data *) m_pData; };
	const char *GetClassName() { return "SmartQ_Media_Plugin_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_SmartQ_Media_Plugin_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_SmartQ_Media_Plugin_CONST; };
