#ifndef YouTube_PlayerBase_h
#define YouTube_PlayerBase_h
...
class YouTube_Player_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	YouTube_Player_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_YouTube_Player_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	YouTube_Player_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class YouTube_Player_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_YouTube_Player_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "YouTube_Player"; } ;
...
class YouTube_Player_Command : public Command_Impl
{
public:
	YouTube_Player_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new YouTube_Player_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new YouTube_Player_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_YouTube_Player_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	YouTube_Player_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~YouTube_Player_Command() {};
	YouTube_Player_Event *GetEvents() { return (YouTube_Player_Event *) m_pEvent; };
	YouTube_Player_Data *GetData() { return (YouTube_Player_Data *) m_pData; };
	const char *GetClassName() { return "YouTube_Player_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_YouTube_Player_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_YouTube_Player_CONST; };
