#ifndef Sound_BridgeBase_h
#define Sound_BridgeBase_h
...
class Sound_Bridge_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	Sound_Bridge_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Sound_Bridge_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	Sound_Bridge_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class Sound_Bridge_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Sound_Bridge_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "Sound_Bridge"; } ;
	...
	*/
	...
	int Get_FK_Device_Capture_Card_Port()
	{
		if( m_bRunningWithoutDeviceData )
			...
			return atoi(m_mapParameters_Find(DEVICEDATA_FK_Device_Capture_Card_Port_CONST).c_str());
	}
	...
	string Get_AV_Adjustment_Rules()
	{
		if( m_bRunningWithoutDeviceData )
			...
			return m_mapParameters_Find(DEVICEDATA_AV_Adjustment_Rules_CONST);
	}
	...
	bool Get_Dont_Consolidate_Media()
	{
		if( m_bRunningWithoutDeviceData )
			...
			return (m_mapParameters_Find(DEVICEDATA_Dont_Consolidate_Media_CONST)=="1" ? true : false);
	}
...
class Sound_Bridge_Command : public Command_Impl
{
public:
	Sound_Bridge_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new Sound_Bridge_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Sound_Bridge_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	Sound_Bridge_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Sound_Bridge_Command() {};
	Sound_Bridge_Event *GetEvents() { return (Sound_Bridge_Event *) m_pEvent; };
	Sound_Bridge_Data *GetData() { return (Sound_Bridge_Data *) m_pData; };
	const char *GetClassName() { return "Sound_Bridge_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Sound_Bridge_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Sound_Bridge_CONST; };
