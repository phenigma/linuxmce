...
{
public:
	ZWave_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) : Event_Impl(DeviceID,1754, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	...
	{
		SendMessage(new Message(m_dwPK_Device, DEVICEID_EVENTMANAGER, PRIORITY_NORMAL, MESSAGETYPE_EVENT, 48,1,10,(bOnOff ? "1" : "0")));
	}
...
public:
	...
	virtual void CMD_HD(string &sCMD_Result,class Message *pMessage) {};
	virtual void CMD_AV_4(string &sCMD_Result,class Message *pMessage) {};
	virtual void CMD_Reset(string sArguments,string &sCMD_Result,class Message *pMessage) {};
	virtual void CMD_Open(string &sCMD_Result,class Message *pMessage) {};
		...
		for(int s=-1;s<(int) pMessageOriginal->m_vectExtraMessages.size(); ++s)
		{
			...
			if (pMessage->m_dwPK_Device_To==m_dwPK_Device && pMessage->m_dwMessage_Type == MESSAGETYPE_COMMAND)
			{
				...
				case 760:
					...
					string sParameters=pMessage->m_mapParameters[202];
