#ifndef Shared_JSON_Data_Provider_PlugBase_h
#define Shared_JSON_Data_Provider_PlugBase_h
...
class Shared_JSON_Data_Provider_Plug_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	Shared_JSON_Data_Provider_Plug_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Shared_JSON_Data_Provider_Plug_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT_PLUGIN) {};
	Shared_JSON_Data_Provider_Plug_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class Shared_JSON_Data_Provider_Plug_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual ~Shared_JSON_Data_Provider_Plug_Data() {};
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Shared_JSON_Data_Provider_Plug_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "Shared_JSON_Data_Provider_Plug"; } ;
...
class Shared_JSON_Data_Provider_Plug_Command : public Command_Impl
{
public:
	Shared_JSON_Data_Provider_Plug_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new Shared_JSON_Data_Provider_Plug_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new Shared_JSON_Data_Provider_Plug_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Shared_JSON_Data_Provider_Plug_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	Shared_JSON_Data_Provider_Plug_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Shared_JSON_Data_Provider_Plug_Command() {};
	Shared_JSON_Data_Provider_Plug_Event *GetEvents() { return (Shared_JSON_Data_Provider_Plug_Event *) m_pEvent; };
	Shared_JSON_Data_Provider_Plug_Data *GetData() { return (Shared_JSON_Data_Provider_Plug_Data *) m_pData; };
	const char *GetClassName() { return "Shared_JSON_Data_Provider_Plug_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Shared_JSON_Data_Provider_Plug_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Shared_JSON_Data_Provider_Plug_CONST; };
