#ifndef CEC_AdaptorBase_h
#define CEC_AdaptorBase_h
...
class CEC_Adaptor_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	CEC_Adaptor_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_CEC_Adaptor_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	CEC_Adaptor_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class CEC_Adaptor_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_CEC_Adaptor_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "CEC_Adaptor"; } ;
...
class CEC_Adaptor_Command : public Command_Impl
{
public:
	CEC_Adaptor_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new CEC_Adaptor_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_CEC_Adaptor_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	CEC_Adaptor_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~CEC_Adaptor_Command() {};
	CEC_Adaptor_Event *GetEvents() { return (CEC_Adaptor_Event *) m_pEvent; };
	CEC_Adaptor_Data *GetData() { return (CEC_Adaptor_Data *) m_pData; };
	const char *GetClassName() { return "CEC_Adaptor_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_CEC_Adaptor_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_CEC_Adaptor_CONST; };
