...
class DIAL_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	DIAL_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_DIAL_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	DIAL_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class DIAL_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_DIAL_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "DIAL"; } ;
...
class DIAL_Command : public Command_Impl
{
public:
	DIAL_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new DIAL_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_DIAL_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	DIAL_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~DIAL_Command() {};
	DIAL_Event *GetEvents() { return (DIAL_Event *) m_pEvent; };
	DIAL_Data *GetData() { return (DIAL_Data *) m_pData; };
	const char *GetClassName() { return "DIAL_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_DIAL_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_DIAL_CONST; };
