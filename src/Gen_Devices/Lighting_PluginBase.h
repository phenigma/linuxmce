...
{
public:
	Lighting_Plugin_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) : Event_Impl(DeviceID,32, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT_PLUGIN) {};
