#ifndef Chromoflex_USP3Base_h
#define Chromoflex_USP3Base_h
...
class Chromoflex_USP3_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	Chromoflex_USP3_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Chromoflex_USP3_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	Chromoflex_USP3_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class Chromoflex_USP3_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Chromoflex_USP3_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "Chromoflex_USP3"; } ;
...
class Chromoflex_USP3_Command : public Command_Impl
{
public:
	Chromoflex_USP3_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new Chromoflex_USP3_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new Chromoflex_USP3_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Chromoflex_USP3_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	Chromoflex_USP3_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Chromoflex_USP3_Command() {};
	Chromoflex_USP3_Event *GetEvents() { return (Chromoflex_USP3_Event *) m_pEvent; };
	Chromoflex_USP3_Data *GetData() { return (Chromoflex_USP3_Data *) m_pData; };
	const char *GetClassName() { return "Chromoflex_USP3_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Chromoflex_USP3_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Chromoflex_USP3_CONST; };
