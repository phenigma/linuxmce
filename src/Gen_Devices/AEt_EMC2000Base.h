#ifndef AEt_EMC2000Base_h
#define AEt_EMC2000Base_h
...
class AEt_EMC2000_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	AEt_EMC2000_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_AEt_EMC2000_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	AEt_EMC2000_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class AEt_EMC2000_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_AEt_EMC2000_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "AEt_EMC2000"; } ;
...
class AEt_EMC2000_Command : public Command_Impl
{
public:
	AEt_EMC2000_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new AEt_EMC2000_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_AEt_EMC2000_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	AEt_EMC2000_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~AEt_EMC2000_Command() {};
	AEt_EMC2000_Event *GetEvents() { return (AEt_EMC2000_Event *) m_pEvent; };
	AEt_EMC2000_Data *GetData() { return (AEt_EMC2000_Data *) m_pData; };
	const char *GetClassName() { return "AEt_EMC2000_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_AEt_EMC2000_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_AEt_EMC2000_CONST; };
