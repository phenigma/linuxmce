...
{
public:
	VideoLan_PlugIn_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) : Event_Impl(DeviceID,1696, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT_PLUGIN) {};
...
public:
	...
	{
		m_pData=NULL;
		m_pEvent = new VideoLan_PlugIn_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
