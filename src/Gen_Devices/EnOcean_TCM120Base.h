#ifndef EnOcean_TCM120Base_h
#define EnOcean_TCM120Base_h
...
class EnOcean_TCM120_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	EnOcean_TCM120_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_EnOcean_TCM120_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	EnOcean_TCM120_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class EnOcean_TCM120_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_EnOcean_TCM120_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "EnOcean_TCM120"; } ;
...
class EnOcean_TCM120_Command : public Command_Impl
{
public:
	EnOcean_TCM120_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new EnOcean_TCM120_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new EnOcean_TCM120_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_EnOcean_TCM120_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	EnOcean_TCM120_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~EnOcean_TCM120_Command() {};
	EnOcean_TCM120_Event *GetEvents() { return (EnOcean_TCM120_Event *) m_pEvent; };
	EnOcean_TCM120_Data *GetData() { return (EnOcean_TCM120_Data *) m_pData; };
	const char *GetClassName() { return "EnOcean_TCM120_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_EnOcean_TCM120_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_EnOcean_TCM120_CONST; };
