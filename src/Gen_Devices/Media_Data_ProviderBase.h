#ifndef Media_Data_ProviderBase_h
#define Media_Data_ProviderBase_h
...
class Media_Data_Provider_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	Media_Data_Provider_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Media_Data_Provider_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	Media_Data_Provider_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class Media_Data_Provider_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual ~Media_Data_Provider_Data() {};
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Media_Data_Provider_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "Media_Data_Provider"; } ;
...
class Media_Data_Provider_Command : public Command_Impl
{
public:
	Media_Data_Provider_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new Media_Data_Provider_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new Media_Data_Provider_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Media_Data_Provider_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	Media_Data_Provider_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Media_Data_Provider_Command() {};
	Media_Data_Provider_Event *GetEvents() { return (Media_Data_Provider_Event *) m_pEvent; };
	Media_Data_Provider_Data *GetData() { return (Media_Data_Provider_Data *) m_pData; };
	const char *GetClassName() { return "Media_Data_Provider_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Media_Data_Provider_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Media_Data_Provider_CONST; };
