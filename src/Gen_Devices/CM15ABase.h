...
class CM15A_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	CM15A_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_CM15A_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	CM15A_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class CM15A_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_CM15A_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "CM15A"; } ;
...
class CM15A_Command : public Command_Impl
{
public:
	CM15A_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new CM15A_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_CM15A_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	CM15A_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~CM15A_Command() {};
	CM15A_Event *GetEvents() { return (CM15A_Event *) m_pEvent; };
	CM15A_Data *GetData() { return (CM15A_Data *) m_pData; };
	const char *GetClassName() { return "CM15A_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_CM15A_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_CM15A_CONST; };
