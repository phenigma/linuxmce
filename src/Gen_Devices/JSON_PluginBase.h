#ifndef JSON_PluginBase_h
#define JSON_PluginBase_h
...
class JSON_Plugin_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	JSON_Plugin_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_JSON_Plugin_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT_PLUGIN) {};
	JSON_Plugin_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class JSON_Plugin_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_JSON_Plugin_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "JSON_Plugin"; } ;
...
class JSON_Plugin_Command : public Command_Impl
{
public:
	JSON_Plugin_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new JSON_Plugin_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_JSON_Plugin_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	JSON_Plugin_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~JSON_Plugin_Command() {};
	JSON_Plugin_Event *GetEvents() { return (JSON_Plugin_Event *) m_pEvent; };
	JSON_Plugin_Data *GetData() { return (JSON_Plugin_Data *) m_pData; };
	const char *GetClassName() { return "JSON_Plugin_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_JSON_Plugin_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_JSON_Plugin_CONST; };
