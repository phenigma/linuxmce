#ifndef OpenLightingArchitectureBase_h
#define OpenLightingArchitectureBase_h
...
class OpenLightingArchitecture_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	OpenLightingArchitecture_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_OpenLightingArchitecture_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	OpenLightingArchitecture_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class OpenLightingArchitecture_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual ~OpenLightingArchitecture_Data() {};
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_OpenLightingArchitecture_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "OpenLightingArchitecture"; } ;
...
class OpenLightingArchitecture_Command : public Command_Impl
{
public:
	OpenLightingArchitecture_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new OpenLightingArchitecture_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new OpenLightingArchitecture_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_OpenLightingArchitecture_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	OpenLightingArchitecture_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~OpenLightingArchitecture_Command() {};
	OpenLightingArchitecture_Event *GetEvents() { return (OpenLightingArchitecture_Event *) m_pEvent; };
	OpenLightingArchitecture_Data *GetData() { return (OpenLightingArchitecture_Data *) m_pData; };
	const char *GetClassName() { return "OpenLightingArchitecture_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_OpenLightingArchitecture_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_OpenLightingArchitecture_CONST; };
