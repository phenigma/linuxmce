#ifndef Basic_XML_Data_Source_PluginBase_h
#define Basic_XML_Data_Source_PluginBase_h
...
class Basic_XML_Data_Source_Plugin_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	Basic_XML_Data_Source_Plugin_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Basic_XML_Data_Source_Plugin_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT_PLUGIN) {};
	Basic_XML_Data_Source_Plugin_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class Basic_XML_Data_Source_Plugin_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual ~Basic_XML_Data_Source_Plugin_Data() {};
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Basic_XML_Data_Source_Plugin_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "Basic_XML_Data_Source_Plugin"; } ;
	...
	*/
	...
	string Get_PortChannel_Number()
	{
		if( m_bRunningWithoutDeviceData )
			...
			return m_mapParameters_Find(DEVICEDATA_PortChannel_Number_CONST);
	}
...
class Basic_XML_Data_Source_Plugin_Command : public Command_Impl
{
public:
	Basic_XML_Data_Source_Plugin_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new Basic_XML_Data_Source_Plugin_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new Basic_XML_Data_Source_Plugin_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Basic_XML_Data_Source_Plugin_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	Basic_XML_Data_Source_Plugin_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Basic_XML_Data_Source_Plugin_Command() {};
	Basic_XML_Data_Source_Plugin_Event *GetEvents() { return (Basic_XML_Data_Source_Plugin_Event *) m_pEvent; };
	Basic_XML_Data_Source_Plugin_Data *GetData() { return (Basic_XML_Data_Source_Plugin_Data *) m_pData; };
	const char *GetClassName() { return "Basic_XML_Data_Source_Plugin_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Basic_XML_Data_Source_Plugin_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Basic_XML_Data_Source_Plugin_CONST; };
