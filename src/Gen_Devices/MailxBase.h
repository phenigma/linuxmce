...
class Mailx_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	Mailx_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Mailx_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	Mailx_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class Mailx_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Mailx_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "Mailx"; } ;
...
class Mailx_Command : public Command_Impl
{
public:
	Mailx_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new Mailx_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Mailx_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	Mailx_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Mailx_Command() {};
	Mailx_Event *GetEvents() { return (Mailx_Event *) m_pEvent; };
	Mailx_Data *GetData() { return (Mailx_Data *) m_pData; };
	const char *GetClassName() { return "Mailx_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Mailx_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Mailx_CONST; };
