#ifndef Crystal_Fontz_USBRS232Base_h
#define Crystal_Fontz_USBRS232Base_h
...
class Crystal_Fontz_USBRS232_Event : public Event_Impl
{
public:
	Crystal_Fontz_USBRS232_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) : Event_Impl(DeviceID,1722, ServerAddress, bConnectEventHandler) {};
	Crystal_Fontz_USBRS232_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
	//Events
...
class Crystal_Fontz_USBRS232_Data : public DeviceData_Impl
{
public:
	virtual ~Crystal_Fontz_USBRS232_Data() {};
	class DeviceData_Impl *CreateData(DeviceData_Impl *Parent,char *pDataBlock,unsigned long AllocatedSize,char *CurrentPosition);
	virtual int GetPK_DeviceList() { return 1722; } ;
	virtual const char *GetDeviceDescription() { return "Crystal_Fontz_USBRS232"; } ;
	string Get_COM_Port_on_PC() { return m_mapParameters[37];}
	string Get_COM_Port_ParityBitStop() { return m_mapParameters[76];}
...
class Crystal_Fontz_USBRS232_Command : public Command_Impl
{
public:
	Crystal_Fontz_USBRS232_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	virtual bool GetConfig()
	{
		...
		m_pData=NULL;
		m_pEvent = new Crystal_Fontz_USBRS232_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new Crystal_Fontz_USBRS232_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, 1722,m_sHostName);
		if( m_iInstanceID )
		{
	...
	Crystal_Fontz_USBRS232_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Crystal_Fontz_USBRS232_Command() {};
	Crystal_Fontz_USBRS232_Event *GetEvents() { return (Crystal_Fontz_USBRS232_Event *) m_pEvent; };
	Crystal_Fontz_USBRS232_Data *GetData() { return (Crystal_Fontz_USBRS232_Data *) m_pData; };
	const char *GetClassName() { return "Crystal_Fontz_USBRS232_Command"; };
	virtual int PK_DeviceTemplate_get() { return 1722; };
	static int PK_DeviceTemplate_get_static() { return 1722; };
