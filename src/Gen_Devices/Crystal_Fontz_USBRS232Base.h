...
public:
	...
	* @brief Constructors
	*/
	Crystal_Fontz_USBRS232_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Crystal_Fontz_USBRS232_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
...
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Crystal_Fontz_USBRS232_CONST; } ;
	...
	*/
	...
	string Get_COM_Port_ParityBitStop()
	{
...
public:
	...
	virtual bool GetConfig()
	{
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Crystal_Fontz_USBRS232_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Crystal_Fontz_USBRS232_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Crystal_Fontz_USBRS232_CONST; };
