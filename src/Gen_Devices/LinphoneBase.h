...
public:
	...
	* @brief Constructors
	*/
	Linphone_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Linphone_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
...
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Linphone_CONST; } ;
...
public:
	...
	{
		m_pData=NULL;
		m_pEvent = new Linphone_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Linphone_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Linphone_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Linphone_CONST; };
