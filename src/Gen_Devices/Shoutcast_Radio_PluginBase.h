#ifndef Shoutcast_Radio_PluginBase_h
#define Shoutcast_Radio_PluginBase_h
...
class Shoutcast_Radio_Plugin_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	Shoutcast_Radio_Plugin_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Shoutcast_Radio_Plugin_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT_PLUGIN) {};
	Shoutcast_Radio_Plugin_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class Shoutcast_Radio_Plugin_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual ~Shoutcast_Radio_Plugin_Data() {};
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Shoutcast_Radio_Plugin_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "Shoutcast_Radio_Plugin"; } ;
...
class Shoutcast_Radio_Plugin_Command : public Command_Impl
{
public:
	Shoutcast_Radio_Plugin_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new Shoutcast_Radio_Plugin_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new Shoutcast_Radio_Plugin_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Shoutcast_Radio_Plugin_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	Shoutcast_Radio_Plugin_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Shoutcast_Radio_Plugin_Command() {};
	Shoutcast_Radio_Plugin_Event *GetEvents() { return (Shoutcast_Radio_Plugin_Event *) m_pEvent; };
	Shoutcast_Radio_Plugin_Data *GetData() { return (Shoutcast_Radio_Plugin_Data *) m_pData; };
	const char *GetClassName() { return "Shoutcast_Radio_Plugin_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Shoutcast_Radio_Plugin_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Shoutcast_Radio_Plugin_CONST; };
