...
{
public:
	SimplePhone_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) : Event_Impl(DeviceID,1759, ServerAddress, bConnectEventHandler) {};
...
public:
	...
	virtual int GetPK_DeviceList() { return 1759; } ;
	...
	bool Get_Speak_in_the_House() { return (m_mapParameters[124]=="1" ? true : false);}
};
...
public:
	...
	virtual bool GetConfig()
	{
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, 1759,m_sHostName);
		if( m_iInstanceID )
		{
	...
	virtual int PK_DeviceTemplate_get() { return 1759; };
	static int PK_DeviceTemplate_get_static() { return 1759; };
