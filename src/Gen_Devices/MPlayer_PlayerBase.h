#ifndef MPlayer_PlayerBase_h
#define MPlayer_PlayerBase_h
...
class MPlayer_Player_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	MPlayer_Player_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_MPlayer_Player_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	MPlayer_Player_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class MPlayer_Player_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_MPlayer_Player_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "MPlayer_Player"; } ;
...
class MPlayer_Player_Command : public Command_Impl
{
public:
	MPlayer_Player_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new MPlayer_Player_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new MPlayer_Player_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_MPlayer_Player_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	MPlayer_Player_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~MPlayer_Player_Command() {};
	MPlayer_Player_Event *GetEvents() { return (MPlayer_Player_Event *) m_pEvent; };
	MPlayer_Player_Data *GetData() { return (MPlayer_Player_Data *) m_pData; };
	const char *GetClassName() { return "MPlayer_Player_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_MPlayer_Player_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_MPlayer_Player_CONST; };
