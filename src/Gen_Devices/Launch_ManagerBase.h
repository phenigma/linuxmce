#ifndef Launch_ManagerBase_h
#define Launch_ManagerBase_h
...
class Launch_Manager_Event : public Event_Impl
{
public:
...
class Launch_Manager_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual const char *GetDeviceDescription() { return "Launch_Manager"; } ;
...
class Launch_Manager_Command : public Command_Impl
{
public:
	Launch_Manager_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new Launch_Manager_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new Launch_Manager_Data();
			return true;
		}
	...
	Launch_Manager_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Launch_Manager_Command() {};
