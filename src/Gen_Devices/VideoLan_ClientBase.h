#ifndef VideoLan_ClientBase_h
#define VideoLan_ClientBase_h
...
class VideoLan_Client_Event : public Event_Impl
{
public:
	VideoLan_Client_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) : Event_Impl(DeviceID,1698, ServerAddress, bConnectEventHandler) {};
	VideoLan_Client_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
	//Events
...
class VideoLan_Client_Data : public DeviceData_Impl
{
public:
	virtual ~VideoLan_Client_Data() {};
	class DeviceData_Impl *CreateData(DeviceData_Impl *Parent,char *pDataBlock,unsigned long AllocatedSize,char *CurrentPosition);
	virtual int GetPK_DeviceList() { return 1698; } ;
	virtual const char *GetDeviceDescription() { return "VideoLan_Client"; } ;
};
...
class VideoLan_Client_Command : public Command_Impl
{
public:
	VideoLan_Client_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	virtual bool GetConfig()
	{
		...
		m_pData=NULL;
		m_pEvent = new VideoLan_Client_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new VideoLan_Client_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, 1698,m_sHostName);
		if( m_iInstanceID )
		{
	...
	VideoLan_Client_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~VideoLan_Client_Command() {};
	VideoLan_Client_Event *GetEvents() { return (VideoLan_Client_Event *) m_pEvent; };
	VideoLan_Client_Data *GetData() { return (VideoLan_Client_Data *) m_pData; };
	const char *GetClassName() { return "VideoLan_Client_Command"; };
	virtual int PK_DeviceTemplate_get() { return 1698; };
	static int PK_DeviceTemplate_get_static() { return 1698; };
