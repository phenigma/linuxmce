...
class RFID_Interface_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	RFID_Interface_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_RFID_Interface_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	RFID_Interface_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class RFID_Interface_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_RFID_Interface_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "RFID_Interface"; } ;
...
class RFID_Interface_Command : public Command_Impl
{
public:
	RFID_Interface_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new RFID_Interface_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
	...
	RFID_Interface_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~RFID_Interface_Command() {};
	RFID_Interface_Event *GetEvents() { return (RFID_Interface_Event *) m_pEvent; };
	RFID_Interface_Data *GetData() { return (RFID_Interface_Data *) m_pData; };
	const char *GetClassName() { return "RFID_Interface_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_RFID_Interface_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_RFID_Interface_CONST; };
