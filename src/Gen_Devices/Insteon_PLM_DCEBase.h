#ifndef Insteon_PLM_DCEBase_h
#define Insteon_PLM_DCEBase_h
...
class Insteon_PLM_DCE_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	Insteon_PLM_DCE_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Insteon_PLM_DCE_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	Insteon_PLM_DCE_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class Insteon_PLM_DCE_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Insteon_PLM_DCE_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "Insteon_PLM_DCE"; } ;
...
class Insteon_PLM_DCE_Command : public Command_Impl
{
public:
	Insteon_PLM_DCE_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new Insteon_PLM_DCE_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new Insteon_PLM_DCE_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Insteon_PLM_DCE_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	Insteon_PLM_DCE_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Insteon_PLM_DCE_Command() {};
	Insteon_PLM_DCE_Event *GetEvents() { return (Insteon_PLM_DCE_Event *) m_pEvent; };
	Insteon_PLM_DCE_Data *GetData() { return (Insteon_PLM_DCE_Data *) m_pData; };
	const char *GetClassName() { return "Insteon_PLM_DCE_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Insteon_PLM_DCE_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Insteon_PLM_DCE_CONST; };
