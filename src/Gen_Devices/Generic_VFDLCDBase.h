#ifndef Generic_VFDLCDBase_h
#define Generic_VFDLCDBase_h
...
class Generic_VFDLCD_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	Generic_VFDLCD_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Generic_VFDLCD_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	Generic_VFDLCD_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class Generic_VFDLCD_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Generic_VFDLCD_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "Generic_VFDLCD"; } ;
...
class Generic_VFDLCD_Command : public Command_Impl
{
public:
	Generic_VFDLCD_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new Generic_VFDLCD_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new Generic_VFDLCD_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Generic_VFDLCD_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	Generic_VFDLCD_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Generic_VFDLCD_Command() {};
	Generic_VFDLCD_Event *GetEvents() { return (Generic_VFDLCD_Event *) m_pEvent; };
	Generic_VFDLCD_Data *GetData() { return (Generic_VFDLCD_Data *) m_pData; };
	const char *GetClassName() { return "Generic_VFDLCD_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Generic_VFDLCD_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Generic_VFDLCD_CONST; };
