#ifndef Activate_Orbiter_PlasmoidBase_h
#define Activate_Orbiter_PlasmoidBase_h
...
class Activate_Orbiter_Plasmoid_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	Activate_Orbiter_Plasmoid_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Activate_Orbiter_Plasmoid_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	Activate_Orbiter_Plasmoid_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class Activate_Orbiter_Plasmoid_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual ~Activate_Orbiter_Plasmoid_Data() {};
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Activate_Orbiter_Plasmoid_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "Activate_Orbiter_Plasmoid"; } ;
...
class Activate_Orbiter_Plasmoid_Command : public Command_Impl
{
public:
	Activate_Orbiter_Plasmoid_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new Activate_Orbiter_Plasmoid_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new Activate_Orbiter_Plasmoid_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Activate_Orbiter_Plasmoid_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	Activate_Orbiter_Plasmoid_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Activate_Orbiter_Plasmoid_Command() {};
	Activate_Orbiter_Plasmoid_Event *GetEvents() { return (Activate_Orbiter_Plasmoid_Event *) m_pEvent; };
	Activate_Orbiter_Plasmoid_Data *GetData() { return (Activate_Orbiter_Plasmoid_Data *) m_pData; };
	const char *GetClassName() { return "Activate_Orbiter_Plasmoid_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Activate_Orbiter_Plasmoid_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Activate_Orbiter_Plasmoid_CONST; };
