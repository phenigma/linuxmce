...
class CTX35_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	CTX35_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_CTX35_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	CTX35_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class CTX35_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_CTX35_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "CTX35"; } ;
...
class CTX35_Command : public Command_Impl
{
public:
	CTX35_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new CTX35_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_CTX35_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	CTX35_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~CTX35_Command() {};
	CTX35_Event *GetEvents() { return (CTX35_Event *) m_pEvent; };
	CTX35_Data *GetData() { return (CTX35_Data *) m_pData; };
	const char *GetClassName() { return "CTX35_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_CTX35_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_CTX35_CONST; };
