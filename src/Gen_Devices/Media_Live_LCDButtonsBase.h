...
class Media_Live_LCDButtons_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	Media_Live_LCDButtons_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Media_Live_LCDButtons_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	Media_Live_LCDButtons_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class Media_Live_LCDButtons_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual ~Media_Live_LCDButtons_Data() {};
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Media_Live_LCDButtons_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "Media_Live_LCDButtons"; } ;

	/**
	* @brief Device data access methods:
	*/

	string Get_Block_Device()
	{
...
class Media_Live_LCDButtons_Command : public Command_Impl
{
public:
	Media_Live_LCDButtons_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new Media_Live_LCDButtons_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new Media_Live_LCDButtons_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Media_Live_LCDButtons_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	Media_Live_LCDButtons_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Media_Live_LCDButtons_Command() {};
	Media_Live_LCDButtons_Event *GetEvents() { return (Media_Live_LCDButtons_Event *) m_pEvent; };
	Media_Live_LCDButtons_Data *GetData() { return (Media_Live_LCDButtons_Data *) m_pData; };
	const char *GetClassName() { return "Media_Live_LCDButtons_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Media_Live_LCDButtons_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Media_Live_LCDButtons_CONST; };
	virtual void ReceivedCommandForChild(DeviceData_Impl *pDeviceData_Impl,string &sCMD_Result,Message *pMessage) { };
	virtual void ReceivedUnknownCommand(string &sCMD_Result,Message *pMessage) { };
	Command_Impl *CreateCommand(int PK_DeviceTemplate, Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent);
	//Data accessors
	string DATA_Get_Block_Device() { return GetData()->Get_Block_Device(); }
