...
{
public:
	gc100_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) : Event_Impl(DeviceID,40, ServerAddress, bConnectEventHandler) {};
...
public:
	...
	virtual bool GetConfig()
	{
		...
		m_pData=NULL;
		m_pEvent = new gc100_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, 40,m_sHostName);
		if( m_iInstanceID )
		{
