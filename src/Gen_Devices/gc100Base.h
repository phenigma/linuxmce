...
public:
	...
	* @brief Constructors
	*/
	gc100_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_gc100_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
...
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_gc100_CONST; } ;
...
public:
	...
	virtual bool GetConfig()
	{
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_gc100_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_gc100_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_gc100_CONST; };
