#ifndef MAME_PlayerBase_h
#define MAME_PlayerBase_h
...
class MAME_Player_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	MAME_Player_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_MAME_Player_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	MAME_Player_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class MAME_Player_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_MAME_Player_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "MAME_Player"; } ;
...
class MAME_Player_Command : public Command_Impl
{
public:
	MAME_Player_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new MAME_Player_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_MAME_Player_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	MAME_Player_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~MAME_Player_Command() {};
	MAME_Player_Event *GetEvents() { return (MAME_Player_Event *) m_pEvent; };
	MAME_Player_Data *GetData() { return (MAME_Player_Data *) m_pData; };
	const char *GetClassName() { return "MAME_Player_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_MAME_Player_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_MAME_Player_CONST; };
