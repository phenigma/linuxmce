#ifndef LMCE_Launch_ManagerBase_h
#define LMCE_Launch_ManagerBase_h
...
class LMCE_Launch_Manager_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	LMCE_Launch_Manager_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_LMCE_Launch_Manager_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	LMCE_Launch_Manager_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class LMCE_Launch_Manager_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual ~LMCE_Launch_Manager_Data() {};
	...
	*/
	virtual const char *GetDeviceDescription() { return "LMCE_Launch_Manager"; } ;
...
class LMCE_Launch_Manager_Command : public Command_Impl
{
public:
	LMCE_Launch_Manager_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new LMCE_Launch_Manager_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new LMCE_Launch_Manager_Data();
			return true;
		}
	...
	LMCE_Launch_Manager_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~LMCE_Launch_Manager_Command() {};
	LMCE_Launch_Manager_Event *GetEvents() { return (LMCE_Launch_Manager_Event *) m_pEvent; };
	LMCE_Launch_Manager_Data *GetData() { return (LMCE_Launch_Manager_Data *) m_pData; };
	const char *GetClassName() { return "LMCE_Launch_Manager_Command"; };
