...
public:
	...
	* @brief Constructors
	*/
	VideoLan_Server_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_VideoLan_Server_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
...
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_VideoLan_Server_CONST; } ;
	...
	*/
	...
	string Get_Network_Interfaces()
	{
		if( m_bRunningWithoutDeviceData )
			...
			return m_mapParameters[DEVICEDATA_IPv4_Network_Interfaces_CONST];
	}
...
public:
	...
	virtual bool GetConfig()
	{
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_VideoLan_Server_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_VideoLan_Server_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_VideoLan_Server_CONST; };
