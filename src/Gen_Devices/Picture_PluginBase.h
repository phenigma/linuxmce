#ifndef Picture_PluginBase_h
#define Picture_PluginBase_h
...
class Picture_Plugin_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	Picture_Plugin_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Picture_Plugin_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT_PLUGIN) {};
	Picture_Plugin_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class Picture_Plugin_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Picture_Plugin_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "Picture_Plugin"; } ;
...
class Picture_Plugin_Command : public Command_Impl
{
public:
	Picture_Plugin_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new Picture_Plugin_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new Picture_Plugin_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Picture_Plugin_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	Picture_Plugin_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Picture_Plugin_Command() {};
	Picture_Plugin_Event *GetEvents() { return (Picture_Plugin_Event *) m_pEvent; };
	Picture_Plugin_Data *GetData() { return (Picture_Plugin_Data *) m_pData; };
	const char *GetClassName() { return "Picture_Plugin_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Picture_Plugin_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Picture_Plugin_CONST; };
