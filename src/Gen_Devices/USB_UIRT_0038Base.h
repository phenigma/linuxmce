...
public:
	...
	* @brief Constructors
	*/
	USB_UIRT_0038_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_USB_UIRT_0038_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
...
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_USB_UIRT_0038_CONST; } ;
	...
	*/
	...
	string Get_UID()
	{
		if( m_bRunningWithoutDeviceData )
			return m_pEvent_Impl->GetDeviceDataFromDatabase(m_dwPK_Device,DEVICEDATA_UID_CONST);
		else
			return m_mapParameters[DEVICEDATA_UID_CONST];
	}

	string Get_HAL_Model()
	{
		if( m_bRunningWithoutDeviceData )
			return m_pEvent_Impl->GetDeviceDataFromDatabase(m_dwPK_Device,DEVICEDATA_HAL_Model_CONST);
		else
			return m_mapParameters[DEVICEDATA_HAL_Model_CONST];
	}
...
public:
	...
	virtual bool GetConfig()
	{
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_USB_UIRT_0038_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_USB_UIRT_0038_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_USB_UIRT_0038_CONST; };
		...
		for(int s=-1;s<(int) pMessageOriginal->m_vectExtraMessages.size(); ++s)
		{
			...
			if (pMessage->m_dwPK_Device_To==m_dwPK_Device && pMessage->m_dwMessage_Type == MESSAGETYPE_COMMAND)
			{
				...
				case COMMAND_Learn_IR_CONST:
					...
					iHandled++;
					continue;
				case COMMAND_Set_Screen_Type_CONST:
					{
						string sCMD_Result="OK";
