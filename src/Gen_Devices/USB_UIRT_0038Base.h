#ifndef USB_UIRT_0038Base_h
#define USB_UIRT_0038Base_h
...
class USB_UIRT_0038_Event : public Event_Impl
{
public:
	USB_UIRT_0038_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) : Event_Impl(DeviceID,1783, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	USB_UIRT_0038_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
	//Events
...
class USB_UIRT_0038_Data : public DeviceData_Impl
{
public:
	virtual ~USB_UIRT_0038_Data() {};
...
class USB_UIRT_0038_Command : public Command_Impl
{
public:
	USB_UIRT_0038_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new USB_UIRT_0038_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new USB_UIRT_0038_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, 1783,m_sHostName);
		if( m_iInstanceID )
		{
	...
	USB_UIRT_0038_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~USB_UIRT_0038_Command() {};
	USB_UIRT_0038_Event *GetEvents() { return (USB_UIRT_0038_Event *) m_pEvent; };
	USB_UIRT_0038_Data *GetData() { return (USB_UIRT_0038_Data *) m_pData; };
	const char *GetClassName() { return "USB_UIRT_0038_Command"; };
	virtual int PK_DeviceTemplate_get() { return 1783; };
	static int PK_DeviceTemplate_get_static() { return 1783; };
