#ifndef KwikwaiBase_h
#define KwikwaiBase_h
...
class Kwikwai_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	Kwikwai_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Kwikwai_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	Kwikwai_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class Kwikwai_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Kwikwai_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "Kwikwai"; } ;
...
class Kwikwai_Command : public Command_Impl
{
public:
	Kwikwai_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new Kwikwai_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Kwikwai_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	Kwikwai_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Kwikwai_Command() {};
	Kwikwai_Event *GetEvents() { return (Kwikwai_Event *) m_pEvent; };
	Kwikwai_Data *GetData() { return (Kwikwai_Data *) m_pData; };
	const char *GetClassName() { return "Kwikwai_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Kwikwai_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Kwikwai_CONST; };
