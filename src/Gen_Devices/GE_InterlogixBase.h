...
{
public:
	GE_Interlogix_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) : Event_Impl(DeviceID,44, ServerAddress, bConnectEventHandler) {};
...
public:
	...
	virtual int GetPK_DeviceList() { return 44; } ;
...
public:
	...
	virtual bool GetConfig()
	{
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, 44,m_sHostName);
		if( m_iInstanceID )
		{
