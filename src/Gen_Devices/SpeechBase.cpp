...
Event_Impl *Speech_Event::CreateEvent( unsigned long dwPK_DeviceTemplate, ClientSocket *pOCClientSocket, unsigned long dwDevice )
{
	switch(dwPK_DeviceTemplate) {
		case 59:
			return (Event_Impl *) new Speech_Event(pOCClientSocket, dwDevice);
	};
