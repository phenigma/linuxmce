#ifndef Hulu_PlugInBase_h
#define Hulu_PlugInBase_h
...
class Hulu_PlugIn_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	Hulu_PlugIn_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Hulu_PlugIn_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT_PLUGIN) {};
	Hulu_PlugIn_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class Hulu_PlugIn_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Hulu_PlugIn_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "Hulu_PlugIn"; } ;
...
class Hulu_PlugIn_Command : public Command_Impl
{
public:
	Hulu_PlugIn_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new Hulu_PlugIn_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Hulu_PlugIn_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	Hulu_PlugIn_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Hulu_PlugIn_Command() {};
	Hulu_PlugIn_Event *GetEvents() { return (Hulu_PlugIn_Event *) m_pEvent; };
	Hulu_PlugIn_Data *GetData() { return (Hulu_PlugIn_Data *) m_pData; };
	const char *GetClassName() { return "Hulu_PlugIn_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Hulu_PlugIn_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Hulu_PlugIn_CONST; };
