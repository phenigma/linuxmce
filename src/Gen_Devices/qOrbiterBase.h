#ifndef qOrbiterBase_h
#define qOrbiterBase_h
...
class qOrbiter_Event : public Event_Impl
{
public:
...
class qOrbiter_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_qOrbiter_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "qOrbiter"; } ;
...
public:
    ...
    qOrbiter_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter, QObject*parent) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	...
	const char *GetClassName() { return "qOrbiter_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_qOrbiter_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_qOrbiter_CONST; };
