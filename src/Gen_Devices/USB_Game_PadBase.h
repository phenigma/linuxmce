#ifndef USB_Game_PadBase_h
#define USB_Game_PadBase_h
...
class USB_Game_Pad_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	USB_Game_Pad_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_USB_Game_Pad_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	USB_Game_Pad_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class USB_Game_Pad_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_USB_Game_Pad_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "USB_Game_Pad"; } ;
...
class USB_Game_Pad_Command : public Command_Impl
{
public:
	USB_Game_Pad_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new USB_Game_Pad_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_USB_Game_Pad_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	USB_Game_Pad_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~USB_Game_Pad_Command() {};
	USB_Game_Pad_Event *GetEvents() { return (USB_Game_Pad_Event *) m_pEvent; };
	USB_Game_Pad_Data *GetData() { return (USB_Game_Pad_Data *) m_pData; };
	const char *GetClassName() { return "USB_Game_Pad_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_USB_Game_Pad_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_USB_Game_Pad_CONST; };
