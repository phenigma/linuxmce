...
public:
	...
	* @brief Constructors
	*/
	File_Grids_Plugin_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_File_Grids_Plugin_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT_PLUGIN) {};
...
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_File_Grids_Plugin_CONST; } ;
...
public:
	...
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_File_Grids_Plugin_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_File_Grids_Plugin_CONST; };
