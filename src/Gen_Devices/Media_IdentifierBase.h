#ifndef Media_IdentifierBase_h
#define Media_IdentifierBase_h
...
class Media_Identifier_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	Media_Identifier_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Media_Identifier_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	Media_Identifier_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class Media_Identifier_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Media_Identifier_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "Media_Identifier"; } ;
...
class Media_Identifier_Command : public Command_Impl
{
public:
	Media_Identifier_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new Media_Identifier_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new Media_Identifier_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Media_Identifier_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	Media_Identifier_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Media_Identifier_Command() {};
	Media_Identifier_Event *GetEvents() { return (Media_Identifier_Event *) m_pEvent; };
	Media_Identifier_Data *GetData() { return (Media_Identifier_Data *) m_pData; };
	const char *GetClassName() { return "Media_Identifier_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Media_Identifier_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Media_Identifier_CONST; };
