#ifndef VLC_PluginBase_h
#define VLC_PluginBase_h
...
class VLC_Plugin_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	VLC_Plugin_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_VLC_Plugin_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT_PLUGIN) {};
	VLC_Plugin_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class VLC_Plugin_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_VLC_Plugin_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "VLC_Plugin"; } ;
...
class VLC_Plugin_Command : public Command_Impl
{
public:
	VLC_Plugin_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new VLC_Plugin_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_VLC_Plugin_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	VLC_Plugin_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~VLC_Plugin_Command() {};
	VLC_Plugin_Event *GetEvents() { return (VLC_Plugin_Event *) m_pEvent; };
	VLC_Plugin_Data *GetData() { return (VLC_Plugin_Data *) m_pData; };
	const char *GetClassName() { return "VLC_Plugin_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_VLC_Plugin_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_VLC_Plugin_CONST; };
