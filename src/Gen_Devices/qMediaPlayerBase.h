#ifndef qMediaPlayerBase_h
#define qMediaPlayerBase_h
...
class qMediaPlayer_Event : public Event_Impl
{
public:
...
class qMediaPlayer_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_qMediaPlayer_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "qMediaPlayer"; } ;
	...
	*/
	...
	void Set_No_Effects(bool Value)
	{
		SetParm(DEVICEDATA_No_Effects_CONST,(Value ? "1" : "0"));
	}
	string Get_TCP_Address()
	{
		if( m_bRunningWithoutDeviceData )
			return m_pEvent_Impl->GetDeviceDataFromDatabase(m_dwPK_Device,DEVICEDATA_TCP_Address_CONST);
		else
			return m_mapParameters[DEVICEDATA_TCP_Address_CONST];
	}

	void Set_TCP_Address(string Value)
	{
		SetParm(DEVICEDATA_TCP_Address_CONST,Value.c_str());
	}
	string Get_Mount_Point()
	{
		if( m_bRunningWithoutDeviceData )
			return m_pEvent_Impl->GetDeviceDataFromDatabase(m_dwPK_Device,DEVICEDATA_Mount_Point_CONST);
		else
			return m_mapParameters[DEVICEDATA_Mount_Point_CONST];
	}

	void Set_Mount_Point(string Value)
	{
		SetParm(DEVICEDATA_Mount_Point_CONST,Value.c_str());
	}
	int Get_Port()
	{
		if( m_bRunningWithoutDeviceData )
	...
	{
		SetParm(DEVICEDATA_Port_CONST,StringUtils::itos(Value).c_str());
	}
};
...
{
public:
    qMediaPlayer_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL, QObject *parent=0)
	...
	{
		m_pData=NULL;
		m_pEvent = new qMediaPlayer_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_qMediaPlayer_CONST,m_sHostName);
		if( m_iInstanceID )
		{
    ...
    qMediaPlayer_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~qMediaPlayer_Command() {};
	qMediaPlayer_Event *GetEvents() { return (qMediaPlayer_Event *) m_pEvent; };
	qMediaPlayer_Data *GetData() { return (qMediaPlayer_Data *) m_pData; };
	const char *GetClassName() { return "qMediaPlayer_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_qMediaPlayer_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_qMediaPlayer_CONST; };
	virtual void ReceivedCommandForChild(DeviceData_Impl *pDeviceData_Impl,string &sCMD_Result,Message *pMessage) { };
	virtual void ReceivedUnknownCommand(string &sCMD_Result,Message *pMessage) { };
	Command_Impl *CreateCommand(int PK_DeviceTemplate, Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent);
	//Data accessors
	bool DATA_Get_No_Effects() { return GetData()->Get_No_Effects(); }
	void DATA_Set_No_Effects(bool Value,bool bUpdateDatabase=false) { GetData()->Set_No_Effects(Value); if( bUpdateDatabase ) SetDeviceDataInDB(m_dwPK_Device,20,Value); }
	string DATA_Get_TCP_Address() { return GetData()->Get_TCP_Address(); }
	void DATA_Set_TCP_Address(string Value,bool bUpdateDatabase=false) { GetData()->Set_TCP_Address(Value); if( bUpdateDatabase ) SetDeviceDataInDB(m_dwPK_Device,117,Value); }
	string DATA_Get_Mount_Point() { return GetData()->Get_Mount_Point(); }
	void DATA_Set_Mount_Point(string Value,bool bUpdateDatabase=false) { GetData()->Set_Mount_Point(Value); if( bUpdateDatabase ) SetDeviceDataInDB(m_dwPK_Device,129,Value); }
	int DATA_Get_Port() { return GetData()->Get_Port(); }
	void DATA_Set_Port(int Value,bool bUpdateDatabase=false) { GetData()->Set_Port(Value); if( bUpdateDatabase ) SetDeviceDataInDB(m_dwPK_Device,171,Value); }
	//Event accessors
	...
	virtual void CMD_Green(string &sCMD_Result,class Message *pMessage) {};
	...
	virtual void CMD_Game_1P_Start(string &sCMD_Result,class Message *pMessage) {};
	virtual void CMD_Game_2P_Start(string &sCMD_Result,class Message *pMessage) {};
	virtual void CMD_Game_3P_Start(string &sCMD_Result,class Message *pMessage) {};
	virtual void CMD_Game_4P_Start(string &sCMD_Result,class Message *pMessage) {};
	virtual void CMD_Game_Insert_Coin(string &sCMD_Result,class Message *pMessage) {};
	virtual void CMD_Game_Service(string &sCMD_Result,class Message *pMessage) {};
	virtual void CMD_Game_Start(string &sCMD_Result,class Message *pMessage) {};
		...
		for(int s=-1;s<(int) pMessageOriginal->m_vectExtraMessages.size(); ++s)
		{
			...
			if (pMessage->m_dwPK_Device_To==m_dwPK_Device && pMessage->m_dwMessage_Type == MESSAGETYPE_COMMAND)
			{
				...
				case COMMAND_Green_CONST:
					{
						string sCMD_Result="OK";
						CMD_Green(sCMD_Result,pMessage);
						if( pMessage->m_eExpectedResponse==ER_ReplyMessage && !pMessage->m_bRespondedToMessage )
						{
							pMessage->m_bRespondedToMessage=true;
							Message *pMessageOut=new Message(m_dwPK_Device,pMessage->m_dwPK_Device_From,PRIORITY_NORMAL,MESSAGETYPE_REPLY,0,0);
				...
				case COMMAND_Get_Ripping_Status_CONST:
					...
					iHandled++;
					continue;
				case COMMAND_Game_1P_Start_CONST:
					{
						string sCMD_Result="OK";
						CMD_Game_1P_Start(sCMD_Result,pMessage);
						if( pMessage->m_eExpectedResponse==ER_ReplyMessage && !pMessage->m_bRespondedToMessage )
						{
							pMessage->m_bRespondedToMessage=true;
							Message *pMessageOut=new Message(m_dwPK_Device,pMessage->m_dwPK_Device_From,PRIORITY_NORMAL,MESSAGETYPE_REPLY,0,0);
					...
					iHandled++;
					continue;
				case COMMAND_Game_2P_Start_CONST:
					{
						string sCMD_Result="OK";
						CMD_Game_2P_Start(sCMD_Result,pMessage);
						if( pMessage->m_eExpectedResponse==ER_ReplyMessage && !pMessage->m_bRespondedToMessage )
						{
							pMessage->m_bRespondedToMessage=true;
							Message *pMessageOut=new Message(m_dwPK_Device,pMessage->m_dwPK_Device_From,PRIORITY_NORMAL,MESSAGETYPE_REPLY,0,0);
					...
					iHandled++;
					continue;
				case COMMAND_Game_3P_Start_CONST:
					{
						string sCMD_Result="OK";
						CMD_Game_3P_Start(sCMD_Result,pMessage);
						if( pMessage->m_eExpectedResponse==ER_ReplyMessage && !pMessage->m_bRespondedToMessage )
						{
							pMessage->m_bRespondedToMessage=true;
							Message *pMessageOut=new Message(m_dwPK_Device,pMessage->m_dwPK_Device_From,PRIORITY_NORMAL,MESSAGETYPE_REPLY,0,0);
					...
					iHandled++;
					continue;
				case COMMAND_Game_4P_Start_CONST:
					{
						string sCMD_Result="OK";
						CMD_Game_4P_Start(sCMD_Result,pMessage);
						if( pMessage->m_eExpectedResponse==ER_ReplyMessage && !pMessage->m_bRespondedToMessage )
						{
							pMessage->m_bRespondedToMessage=true;
							Message *pMessageOut=new Message(m_dwPK_Device,pMessage->m_dwPK_Device_From,PRIORITY_NORMAL,MESSAGETYPE_REPLY,0,0);
					...
					iHandled++;
					continue;
				case COMMAND_Game_Insert_Coin_CONST:
					{
						string sCMD_Result="OK";
						CMD_Game_Insert_Coin(sCMD_Result,pMessage);
						if( pMessage->m_eExpectedResponse==ER_ReplyMessage && !pMessage->m_bRespondedToMessage )
						{
							pMessage->m_bRespondedToMessage=true;
							Message *pMessageOut=new Message(m_dwPK_Device,pMessage->m_dwPK_Device_From,PRIORITY_NORMAL,MESSAGETYPE_REPLY,0,0);
					...
					iHandled++;
					continue;
				case COMMAND_Game_Service_CONST:
					{
						string sCMD_Result="OK";
						CMD_Game_Service(sCMD_Result,pMessage);
						if( pMessage->m_eExpectedResponse==ER_ReplyMessage && !pMessage->m_bRespondedToMessage )
						{
							pMessage->m_bRespondedToMessage=true;
							Message *pMessageOut=new Message(m_dwPK_Device,pMessage->m_dwPK_Device_From,PRIORITY_NORMAL,MESSAGETYPE_REPLY,0,0);
					...
					iHandled++;
					continue;
				case COMMAND_Game_Start_CONST:
					{
						string sCMD_Result="OK";
						CMD_Game_Start(sCMD_Result,pMessage);
						if( pMessage->m_eExpectedResponse==ER_ReplyMessage && !pMessage->m_bRespondedToMessage )
						{
							pMessage->m_bRespondedToMessage=true;
							Message *pMessageOut=new Message(m_dwPK_Device,pMessage->m_dwPK_Device_From,PRIORITY_NORMAL,MESSAGETYPE_REPLY,0,0);
					...
					iHandled++;
					continue;
				case COMMAND_Game_Select_CONST:
					{
						string sCMD_Result="OK";
						CMD_Game_Select(sCMD_Result,pMessage);
						if( pMessage->m_eExpectedResponse==ER_ReplyMessage && !pMessage->m_bRespondedToMessage )
						{
							pMessage->m_bRespondedToMessage=true;
							Message *pMessageOut=new Message(m_dwPK_Device,pMessage->m_dwPK_Device_From,PRIORITY_NORMAL,MESSAGETYPE_REPLY,0,0);
					...
					iHandled++;
					continue;
				case COMMAND_Game_Option_CONST:
					{
						string sCMD_Result="OK";
						CMD_Game_Option(sCMD_Result,pMessage);
						if( pMessage->m_eExpectedResponse==ER_ReplyMessage && !pMessage->m_bRespondedToMessage )
						{
							pMessage->m_bRespondedToMessage=true;
							Message *pMessageOut=new Message(m_dwPK_Device,pMessage->m_dwPK_Device_From,PRIORITY_NORMAL,MESSAGETYPE_REPLY,0,0);
					...
					iHandled++;
					continue;
				case COMMAND_Game_Reset_CONST:
					{
						string sCMD_Result="OK";
						CMD_Game_Reset(sCMD_Result,pMessage);
						if( pMessage->m_eExpectedResponse==ER_ReplyMessage && !pMessage->m_bRespondedToMessage )
						{
							pMessage->m_bRespondedToMessage=true;
							Message *pMessageOut=new Message(m_dwPK_Device,pMessage->m_dwPK_Device_From,PRIORITY_NORMAL,MESSAGETYPE_REPLY,0,0);
					...
					iHandled++;
					continue;
				case COMMAND_Set_Game_Options_CONST:
					{
						string sCMD_Result="OK";
						string sValue_To_Assign=pMessage->m_mapParameters[COMMANDPARAMETER_Value_To_Assign_CONST];
					...
					iHandled++;
					continue;
				case COMMAND_Get_Game_Options_CONST:
					{
						string sCMD_Result="OK";
						string sPath=pMessage->m_mapParameters[COMMANDPARAMETER_Path_CONST];
						string sValue_To_Assign=pMessage->m_mapParameters[COMMANDPARAMETER_Value_To_Assign_CONST];
						CMD_Get_Game_Options(sPath.c_str(),&sValue_To_Assign,sCMD_Result,pMessage);
						if( pMessage->m_eExpectedResponse==ER_ReplyMessage && !pMessage->m_bRespondedToMessage )
						{
							pMessage->m_bRespondedToMessage=true;
							Message *pMessageOut=new Message(m_dwPK_Device,pMessage->m_dwPK_Device_From,PRIORITY_NORMAL,MESSAGETYPE_REPLY,0,0);
