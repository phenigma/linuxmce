...
class DLNA_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	DLNA_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_DLNA_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	DLNA_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class DLNA_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_DLNA_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "DLNA"; } ;
...
class DLNA_Command : public Command_Impl
{
public:
	DLNA_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new DLNA_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_DLNA_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	DLNA_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~DLNA_Command() {};
	DLNA_Event *GetEvents() { return (DLNA_Event *) m_pEvent; };
	DLNA_Data *GetData() { return (DLNA_Data *) m_pData; };
	const char *GetClassName() { return "DLNA_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_DLNA_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_DLNA_CONST; };
