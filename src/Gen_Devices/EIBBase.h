...
public:
	...
	* @brief Constructors
	*/
	EIB_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_EIB_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
...
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_EIB_CONST; } ;
...
public:
	...
	virtual bool GetConfig()
	{
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_EIB_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_EIB_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_EIB_CONST; };
	...
	virtual void CMD_EIB_Write(string sAddress,string sData_String,int iDataType,string &sCMD_Result,class Message *pMessage) {};
	...
	virtual ReceivedMessageResult ReceivedMessage(class Message *pMessageOriginal)
	{
		...
		for(int s=-1;s<(int) pMessageOriginal->m_vectExtraMessages.size(); ++s)
		{
			...
			if (pMessage->m_dwPK_Device_To==m_dwPK_Device && pMessage->m_dwMessage_Type == MESSAGETYPE_COMMAND)
			{
				...
				{
				case COMMAND_EIB_Write_CONST:
					{
						string sCMD_Result="OK";
						string sAddress=pMessage->m_mapParameters[COMMANDPARAMETER_Address_CONST];
						string sData_String=pMessage->m_mapParameters[COMMANDPARAMETER_Data_String_CONST];
						int iDataType=atoi(pMessage->m_mapParameters[COMMANDPARAMETER_DataType_CONST].c_str());
						CMD_EIB_Write(sAddress.c_str(),sData_String.c_str(),iDataType,sCMD_Result,pMessage);
