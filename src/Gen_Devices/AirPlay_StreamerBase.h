#ifndef AirPlay_StreamerBase_h
#define AirPlay_StreamerBase_h
...
class AirPlay_Streamer_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	AirPlay_Streamer_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_AirPlay_Streamer_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	AirPlay_Streamer_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class AirPlay_Streamer_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_AirPlay_Streamer_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "AirPlay_Streamer"; } ;
...
class AirPlay_Streamer_Command : public Command_Impl
{
public:
	AirPlay_Streamer_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new AirPlay_Streamer_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new AirPlay_Streamer_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_AirPlay_Streamer_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	AirPlay_Streamer_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~AirPlay_Streamer_Command() {};
	AirPlay_Streamer_Event *GetEvents() { return (AirPlay_Streamer_Event *) m_pEvent; };
	AirPlay_Streamer_Data *GetData() { return (AirPlay_Streamer_Data *) m_pData; };
	const char *GetClassName() { return "AirPlay_Streamer_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_AirPlay_Streamer_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_AirPlay_Streamer_CONST; };
		...
		for(int s=-1;s<(int) pMessageOriginal->m_vectExtraMessages.size(); ++s)
		{
			...
			if (pMessage->m_dwPK_Device_To==m_dwPK_Device && pMessage->m_dwMessage_Type == MESSAGETYPE_COMMAND)
			{
				...
				case COMMAND_Report_Playback_Position_CONST:
					...
					iHandled++;
					continue;
				case COMMAND_Stop_Streaming_CONST:
					{
						string sCMD_Result="OK";
						int iStreamID=atoi(pMessage->m_mapParameters[COMMANDPARAMETER_StreamID_CONST].c_str());
						string sStreamingTargets=pMessage->m_mapParameters[COMMANDPARAMETER_StreamingTargets_CONST];
