#ifndef Pandora_PluginBase_h
#define Pandora_PluginBase_h
...
class Pandora_Plugin_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	Pandora_Plugin_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Pandora_Plugin_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT_PLUGIN) {};
	Pandora_Plugin_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class Pandora_Plugin_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Pandora_Plugin_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "Pandora_Plugin"; } ;
...
class Pandora_Plugin_Command : public Command_Impl
{
public:
	Pandora_Plugin_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new Pandora_Plugin_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new Pandora_Plugin_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Pandora_Plugin_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	Pandora_Plugin_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Pandora_Plugin_Command() {};
	Pandora_Plugin_Event *GetEvents() { return (Pandora_Plugin_Event *) m_pEvent; };
	Pandora_Plugin_Data *GetData() { return (Pandora_Plugin_Data *) m_pData; };
	const char *GetClassName() { return "Pandora_Plugin_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Pandora_Plugin_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Pandora_Plugin_CONST; };
