#ifndef THX_BlackbirdBase_h
#define THX_BlackbirdBase_h
...
class THX_Blackbird_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	THX_Blackbird_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_THX_Blackbird_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	THX_Blackbird_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class THX_Blackbird_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_THX_Blackbird_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "THX_Blackbird"; } ;
...
class THX_Blackbird_Command : public Command_Impl
{
public:
	THX_Blackbird_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new THX_Blackbird_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new THX_Blackbird_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_THX_Blackbird_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	THX_Blackbird_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~THX_Blackbird_Command() {};
	THX_Blackbird_Event *GetEvents() { return (THX_Blackbird_Event *) m_pEvent; };
	THX_Blackbird_Data *GetData() { return (THX_Blackbird_Data *) m_pData; };
	const char *GetClassName() { return "THX_Blackbird_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_THX_Blackbird_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_THX_Blackbird_CONST; };
