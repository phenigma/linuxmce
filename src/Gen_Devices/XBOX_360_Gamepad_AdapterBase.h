#ifndef XBOX_360_Gamepad_AdapterBase_h
#define XBOX_360_Gamepad_AdapterBase_h
...
class XBOX_360_Gamepad_Adapter_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	XBOX_360_Gamepad_Adapter_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_XBOX_360_Gamepad_Adapter_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	XBOX_360_Gamepad_Adapter_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class XBOX_360_Gamepad_Adapter_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual ~XBOX_360_Gamepad_Adapter_Data() {};
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_XBOX_360_Gamepad_Adapter_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "XBOX_360_Gamepad_Adapter"; } ;
...
class XBOX_360_Gamepad_Adapter_Command : public Command_Impl
{
public:
	XBOX_360_Gamepad_Adapter_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new XBOX_360_Gamepad_Adapter_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new XBOX_360_Gamepad_Adapter_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_XBOX_360_Gamepad_Adapter_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	XBOX_360_Gamepad_Adapter_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~XBOX_360_Gamepad_Adapter_Command() {};
	XBOX_360_Gamepad_Adapter_Event *GetEvents() { return (XBOX_360_Gamepad_Adapter_Event *) m_pEvent; };
	XBOX_360_Gamepad_Adapter_Data *GetData() { return (XBOX_360_Gamepad_Adapter_Data *) m_pData; };
	const char *GetClassName() { return "XBOX_360_Gamepad_Adapter_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_XBOX_360_Gamepad_Adapter_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_XBOX_360_Gamepad_Adapter_CONST; };
