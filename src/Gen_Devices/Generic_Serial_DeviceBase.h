...
public:
	...
	*/
	Generic_Serial_Device_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Insteon_PLM_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
...
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Insteon_PLM_CONST; } ;
	...
	*/
	...
	void Set_COM_Port_BaudRate(string Value)
	{
		SetParm(DEVICEDATA_COM_Port_BaudRate_CONST,Value.c_str());
	}
};
...
public:
	...
	virtual bool GetConfig()
	{
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Insteon_PLM_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Insteon_PLM_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Insteon_PLM_CONST; };
	...
	void DATA_Set_COM_Port_BaudRate(string Value,bool bUpdateDatabase=false) { GetData()->Set_COM_Port_BaudRate(Value); if( bUpdateDatabase ) SetDeviceDataInDB(m_dwPK_Device,78,Value); }
	//Event accessors
