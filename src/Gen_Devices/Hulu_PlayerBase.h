#ifndef Hulu_PlayerBase_h
#define Hulu_PlayerBase_h
...
class Hulu_Player_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	Hulu_Player_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Hulu_Player_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	Hulu_Player_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class Hulu_Player_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Hulu_Player_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "Hulu_Player"; } ;
...
class Hulu_Player_Command : public Command_Impl
{
public:
	Hulu_Player_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new Hulu_Player_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Hulu_Player_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	Hulu_Player_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Hulu_Player_Command() {};
	Hulu_Player_Event *GetEvents() { return (Hulu_Player_Event *) m_pEvent; };
	Hulu_Player_Data *GetData() { return (Hulu_Player_Data *) m_pData; };
	const char *GetClassName() { return "Hulu_Player_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Hulu_Player_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Hulu_Player_CONST; };
