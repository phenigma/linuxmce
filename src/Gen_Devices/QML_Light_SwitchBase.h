...
class QML_Light_Switch_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	QML_Light_Switch_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_QML_Light_Switch_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	QML_Light_Switch_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class QML_Light_Switch_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_QML_Light_Switch_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "QML_Light_Switch"; } ;
...
class QML_Light_Switch_Command : public Command_Impl
{
public:
	QML_Light_Switch_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new QML_Light_Switch_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new QML_Light_Switch_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_QML_Light_Switch_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	QML_Light_Switch_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~QML_Light_Switch_Command() {};
	QML_Light_Switch_Event *GetEvents() { return (QML_Light_Switch_Event *) m_pEvent; };
	QML_Light_Switch_Data *GetData() { return (QML_Light_Switch_Data *) m_pData; };
	const char *GetClassName() { return "QML_Light_Switch_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_QML_Light_Switch_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_QML_Light_Switch_CONST; };
