#ifndef Mac_WorkstationBase_h
#define Mac_WorkstationBase_h
...
class Mac_Workstation_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	Mac_Workstation_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Mac_Workstation_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	Mac_Workstation_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class Mac_Workstation_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Mac_Workstation_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "Mac_Workstation"; } ;
	...
	*/
	...
	string Get_Available_Sound_Cards()
	{
		if( m_bRunningWithoutDeviceData )
			return m_pEvent_Impl->GetDeviceDataFromDatabase(m_dwPK_Device,DEVICEDATA_Available_Sound_Cards_CONST);
		else
			return m_mapParameters[DEVICEDATA_Available_Sound_Cards_CONST];
	}
...
class Mac_Workstation_Command : public Command_Impl
{
public:
	Mac_Workstation_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new Mac_Workstation_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new Mac_Workstation_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Mac_Workstation_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	Mac_Workstation_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Mac_Workstation_Command() {};
	Mac_Workstation_Event *GetEvents() { return (Mac_Workstation_Event *) m_pEvent; };
	Mac_Workstation_Data *GetData() { return (Mac_Workstation_Data *) m_pData; };
	const char *GetClassName() { return "Mac_Workstation_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Mac_Workstation_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Mac_Workstation_CONST; };
	...
	string DATA_Get_Available_Sound_Cards() { return GetData()->Get_Available_Sound_Cards(); }
	//Event accessors
