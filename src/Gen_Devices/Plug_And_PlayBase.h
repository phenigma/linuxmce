...
{
public:
	Plug_And_Play_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) : Event_Impl(DeviceID,1794, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
...
public:
	...
	virtual int GetPK_DeviceList() { return 1794; } ;
...
public:
	...
	virtual bool GetConfig()
	{
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, 1794,m_sHostName);
		if( m_iInstanceID )
		{
	...
	virtual int PK_DeviceTemplate_get() { return 1794; };
	static int PK_DeviceTemplate_get_static() { return 1794; };
