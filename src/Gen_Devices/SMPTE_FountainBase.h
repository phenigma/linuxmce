...
class SMPTE_Fountain_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	SMPTE_Fountain_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_SMPTE_Fountain_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	SMPTE_Fountain_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class SMPTE_Fountain_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_SMPTE_Fountain_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "SMPTE_Fountain"; } ;
...
class SMPTE_Fountain_Command : public Command_Impl
{
public:
	SMPTE_Fountain_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new SMPTE_Fountain_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new SMPTE_Fountain_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_SMPTE_Fountain_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	SMPTE_Fountain_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~SMPTE_Fountain_Command() {};
	SMPTE_Fountain_Event *GetEvents() { return (SMPTE_Fountain_Event *) m_pEvent; };
	SMPTE_Fountain_Data *GetData() { return (SMPTE_Fountain_Data *) m_pData; };
	const char *GetClassName() { return "SMPTE_Fountain_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_SMPTE_Fountain_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_SMPTE_Fountain_CONST; };
