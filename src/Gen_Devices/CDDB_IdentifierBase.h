...
{
public:
	CDDB_Identifier_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) : Event_Impl(DeviceID,72, ServerAddress, bConnectEventHandler) {};
...
public:
	...
	virtual int PK_DeviceTemplate_get() { return 72; };
	static int PK_DeviceTemplate_get_static() { return 72; };
