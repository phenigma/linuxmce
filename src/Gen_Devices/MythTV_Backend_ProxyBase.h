...
public:
	...
	* @brief Constructors
	*/
	MythTV_Backend_Proxy_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_MythTV_Backend_Proxy_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	...
	*/
	...
	virtual void MythTV_Channel_Changed(int iPK_Device,int iMythTV_ChannelID)
	{
		SendMessage(new Message(m_dwPK_Device, DEVICEID_EVENTMANAGER, PRIORITY_NORMAL, MESSAGETYPE_EVENT, 
			EVENT_MythTV_Channel_Changed_CONST,
...
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_MythTV_Backend_Proxy_CONST; } ;
...
public:
	...
	virtual bool GetConfig()
	{
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_MythTV_Backend_Proxy_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_MythTV_Backend_Proxy_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_MythTV_Backend_Proxy_CONST; };
	...
	virtual ReceivedMessageResult ReceivedMessage(class Message *pMessageOriginal)
	{
		...
		for(int s=-1;s<(int) pMessageOriginal->m_vectExtraMessages.size(); ++s)
		{
			...
			if (pMessage->m_dwPK_Device_To==m_dwPK_Device && pMessage->m_dwMessage_Type == MESSAGETYPE_COMMAND)
			{
				...
				{
				case COMMAND_Track_Frontend_At_IP_CONST:
					{
