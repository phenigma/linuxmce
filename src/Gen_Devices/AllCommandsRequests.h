...
namespace DCE
{
	...
	public:
		CMD_Add_GC100(long DeviceIDFrom, long DeviceIDTo,int iPK_Device) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,276,1,2,StringUtils::itos(iPK_Device).c_str()); }
	};
	class CMD_Add_GC100_DL : public PreformedCommand {
	public:
		CMD_Add_GC100_DL(long DeviceIDFrom, string DeviceIDTo,int iPK_Device) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,276,1,2,StringUtils::itos(iPK_Device).c_str()); }
	};
	class CMD_Add_GC100_DT : public PreformedCommand {
	public:
		CMD_Add_GC100_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,int iPK_Device) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,276,1,2,StringUtils::itos(iPK_Device).c_str()); }
	};
	class CMD_Add_GC100_Cat : public PreformedCommand {
	public:
		CMD_Add_GC100_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB,int iPK_Device) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,276,1,2,StringUtils::itos(iPK_Device).c_str()); }
	};
}
#endif
