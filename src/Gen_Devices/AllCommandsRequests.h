...
namespace DCE
{
	...
	public:
		CMD_MH_Play_Media(long DeviceIDFrom, long DeviceIDTo,int iPK_Device,string sPK_DesignObj,string sFilename,int iPK_MediaType,int iPK_DeviceTemplate,string sPK_EntertainArea,bool bResume,int iRepeat) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,43,8,2,StringUtils::itos(iPK_Device).c_str(),3,sPK_DesignObj.c_str(),13,sFilename.c_str(),29,StringUtils::itos(iPK_MediaType).c_str(),44,StringUtils::itos(iPK_DeviceTemplate).c_str(),45,sPK_EntertainArea.c_str(),116,(bResume ? "1" : "0"),117,StringUtils::itos(iRepeat).c_str()); }
	};
	class CMD_MH_Play_Media_DL : public PreformedCommand {
	public:
		CMD_MH_Play_Media_DL(long DeviceIDFrom, string DeviceIDTo,int iPK_Device,string sPK_DesignObj,string sFilename,int iPK_MediaType,int iPK_DeviceTemplate,string sPK_EntertainArea,bool bResume,int iRepeat) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,43,8,2,StringUtils::itos(iPK_Device).c_str(),3,sPK_DesignObj.c_str(),13,sFilename.c_str(),29,StringUtils::itos(iPK_MediaType).c_str(),44,StringUtils::itos(iPK_DeviceTemplate).c_str(),45,sPK_EntertainArea.c_str(),116,(bResume ? "1" : "0"),117,StringUtils::itos(iRepeat).c_str()); }
	};
	class CMD_MH_Play_Media_DT : public PreformedCommand {
	public:
		CMD_MH_Play_Media_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,int iPK_Device,string sPK_DesignObj,string sFilename,int iPK_MediaType,int iPK_DeviceTemplate,string sPK_EntertainArea,bool bResume,int iRepeat) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,43,8,2,StringUtils::itos(iPK_Device).c_str(),3,sPK_DesignObj.c_str(),13,sFilename.c_str(),29,StringUtils::itos(iPK_MediaType).c_str(),44,StringUtils::itos(iPK_DeviceTemplate).c_str(),45,sPK_EntertainArea.c_str(),116,(bResume ? "1" : "0"),117,StringUtils::itos(iRepeat).c_str()); }
	};
	class CMD_MH_Play_Media_Cat : public PreformedCommand {
	public:
		CMD_MH_Play_Media_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB,int iPK_Device,string sPK_DesignObj,string sFilename,int iPK_MediaType,int iPK_DeviceTemplate,string sPK_EntertainArea,bool bResume,int iRepeat) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,43,8,2,StringUtils::itos(iPK_Device).c_str(),3,sPK_DesignObj.c_str(),13,sFilename.c_str(),29,StringUtils::itos(iPK_MediaType).c_str(),44,StringUtils::itos(iPK_DeviceTemplate).c_str(),45,sPK_EntertainArea.c_str(),116,(bResume ? "1" : "0"),117,StringUtils::itos(iRepeat).c_str()); }
	};
	...
	public:
		CMD_Link_with_mobile_orbiter(long DeviceIDFrom, long DeviceIDTo,int iMediaPosition,string sMac_address,string sVMC_File) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,60,3,42,StringUtils::itos(iMediaPosition).c_str(),47,sMac_address.c_str(),118,sVMC_File.c_str()); }
	};
	class CMD_Link_with_mobile_orbiter_DL : public PreformedCommand {
	public:
		CMD_Link_with_mobile_orbiter_DL(long DeviceIDFrom, string DeviceIDTo,int iMediaPosition,string sMac_address,string sVMC_File) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,60,3,42,StringUtils::itos(iMediaPosition).c_str(),47,sMac_address.c_str(),118,sVMC_File.c_str()); }
	};
	class CMD_Link_with_mobile_orbiter_DT : public PreformedCommand {
	public:
		CMD_Link_with_mobile_orbiter_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,int iMediaPosition,string sMac_address,string sVMC_File) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,60,3,42,StringUtils::itos(iMediaPosition).c_str(),47,sMac_address.c_str(),118,sVMC_File.c_str()); }
	};
	class CMD_Link_with_mobile_orbiter_Cat : public PreformedCommand {
	public:
		CMD_Link_with_mobile_orbiter_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB,int iMediaPosition,string sMac_address,string sVMC_File) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,60,3,42,StringUtils::itos(iMediaPosition).c_str(),47,sMac_address.c_str(),118,sVMC_File.c_str()); }
	};
	...
	public:
		CMD_Set_Now_Playing(long DeviceIDFrom, long DeviceIDTo,int iPK_Device,string sValue_To_Assign,int iValue) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,242,3,2,StringUtils::itos(iPK_Device).c_str(),5,sValue_To_Assign.c_str(),48,StringUtils::itos(iValue).c_str()); }
	};
	class CMD_Set_Now_Playing_DL : public PreformedCommand {
	public:
		CMD_Set_Now_Playing_DL(long DeviceIDFrom, string DeviceIDTo,int iPK_Device,string sValue_To_Assign,int iValue) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,242,3,2,StringUtils::itos(iPK_Device).c_str(),5,sValue_To_Assign.c_str(),48,StringUtils::itos(iValue).c_str()); }
	};
	class CMD_Set_Now_Playing_DT : public PreformedCommand {
	public:
		CMD_Set_Now_Playing_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,int iPK_Device,string sValue_To_Assign,int iValue) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,242,3,2,StringUtils::itos(iPK_Device).c_str(),5,sValue_To_Assign.c_str(),48,StringUtils::itos(iValue).c_str()); }
	};
	class CMD_Set_Now_Playing_Cat : public PreformedCommand {
	public:
		CMD_Set_Now_Playing_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB,int iPK_Device,string sValue_To_Assign,int iValue) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,242,3,2,StringUtils::itos(iPK_Device).c_str(),5,sValue_To_Assign.c_str(),48,StringUtils::itos(iValue).c_str()); }
	};
	...
	public:
		CMD_Disconnect_From_Mobile_Orbiter(long DeviceIDFrom, long DeviceIDTo,string sMac_address,string sVMC_File,int iDeviceToLink) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,333,3,47,sMac_address.c_str(),118,sVMC_File.c_str(),124,StringUtils::itos(iDeviceToLink).c_str()); }
	};
	class CMD_Disconnect_From_Mobile_Orbiter_DL : public PreformedCommand {
	public:
		CMD_Disconnect_From_Mobile_Orbiter_DL(long DeviceIDFrom, string DeviceIDTo,string sMac_address,string sVMC_File,int iDeviceToLink) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,333,3,47,sMac_address.c_str(),118,sVMC_File.c_str(),124,StringUtils::itos(iDeviceToLink).c_str()); }
	};
	class CMD_Disconnect_From_Mobile_Orbiter_DT : public PreformedCommand {
	public:
		CMD_Disconnect_From_Mobile_Orbiter_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,string sMac_address,string sVMC_File,int iDeviceToLink) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,333,3,47,sMac_address.c_str(),118,sVMC_File.c_str(),124,StringUtils::itos(iDeviceToLink).c_str()); }
	};
	class CMD_Disconnect_From_Mobile_Orbiter_Cat : public PreformedCommand {
	public:
		CMD_Disconnect_From_Mobile_Orbiter_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB,string sMac_address,string sVMC_File,int iDeviceToLink) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,333,3,47,sMac_address.c_str(),118,sVMC_File.c_str(),124,StringUtils::itos(iDeviceToLink).c_str()); }
	};
	...
	public:
		CMD_Rip_Disk(long DeviceIDFrom, long DeviceIDTo,int iPK_Users,string sName,string sTracks) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,337,3,17,StringUtils::itos(iPK_Users).c_str(),50,sName.c_str(),121,sTracks.c_str()); }
	};
	class CMD_Rip_Disk_DL : public PreformedCommand {
	public:
		CMD_Rip_Disk_DL(long DeviceIDFrom, string DeviceIDTo,int iPK_Users,string sName,string sTracks) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,337,3,17,StringUtils::itos(iPK_Users).c_str(),50,sName.c_str(),121,sTracks.c_str()); }
	};
	class CMD_Rip_Disk_DT : public PreformedCommand {
	public:
		CMD_Rip_Disk_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,int iPK_Users,string sName,string sTracks) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,337,3,17,StringUtils::itos(iPK_Users).c_str(),50,sName.c_str(),121,sTracks.c_str()); }
	};
	class CMD_Rip_Disk_Cat : public PreformedCommand {
	public:
		CMD_Rip_Disk_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB,int iPK_Users,string sName,string sTracks) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,337,3,17,StringUtils::itos(iPK_Users).c_str(),50,sName.c_str(),121,sTracks.c_str()); }
	};
	...
	class RESP_Get_Default_Ripping_Name : public PreformedCommandResponse {
		string *m_sFilename;
	public:
		RESP_Get_Default_Ripping_Name(string *sFilename) { 
		m_sFilename=sFilename; }
		void ParseResponse(Message *pMessage) {
			*m_sFilename=pMessage->m_mapParameters[13]; };
	};
	class CMD_Get_Default_Ripping_Name : public PreformedCommand {
	public:
		CMD_Get_Default_Ripping_Name(long DeviceIDFrom, long DeviceIDTo,string sPK_EntertainArea,string *sFilename) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,390,2,45,sPK_EntertainArea.c_str(),13,(*sFilename).c_str());		m_pcResponse = new RESP_Get_Default_Ripping_Name(sFilename); }
	};
	class CMD_Get_Default_Ripping_Name_DL : public PreformedCommand {
	public:
		CMD_Get_Default_Ripping_Name_DL(long DeviceIDFrom, string DeviceIDTo,string sPK_EntertainArea,string *sFilename) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,390,2,45,sPK_EntertainArea.c_str(),13,(*sFilename).c_str());		m_pcResponse = new RESP_Get_Default_Ripping_Name(sFilename); }
	};
	class CMD_Get_Default_Ripping_Name_DT : public PreformedCommand {
	public:
		CMD_Get_Default_Ripping_Name_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,string sPK_EntertainArea,string *sFilename) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,390,2,45,sPK_EntertainArea.c_str(),13,(*sFilename).c_str());		m_pcResponse = new RESP_Get_Default_Ripping_Name(sFilename); }
	};
	class CMD_Get_Default_Ripping_Name_Cat : public PreformedCommand {
	public:
		CMD_Get_Default_Ripping_Name_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB,string sPK_EntertainArea,string *sFilename) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,390,2,45,sPK_EntertainArea.c_str(),13,(*sFilename).c_str());		m_pcResponse = new RESP_Get_Default_Ripping_Name(sFilename); }
	};
	class CMD_NOREP_Get_Default_Ripping_Name : public PreformedCommand {
	public:
		CMD_NOREP_Get_Default_Ripping_Name(long DeviceIDFrom, long DeviceIDTo,string sPK_EntertainArea) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,390,1,45,sPK_EntertainArea.c_str()); }
	};
	class CMD_NOREP_Get_Default_Ripping_Name_DL : public PreformedCommand {
	public:
		CMD_NOREP_Get_Default_Ripping_Name_DL(long DeviceIDFrom, string DeviceIDTo,string sPK_EntertainArea) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,390,1,45,sPK_EntertainArea.c_str()); }
	};
	class CMD_NOREP_Get_Default_Ripping_Name_DT : public PreformedCommand {
	public:
		CMD_NOREP_Get_Default_Ripping_Name_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,string sPK_EntertainArea) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,390,1,45,sPK_EntertainArea.c_str()); }
	};
	class CMD_NOREP_Get_Default_Ripping_Name_Cat : public PreformedCommand {
	public:
		CMD_NOREP_Get_Default_Ripping_Name_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB,string sPK_EntertainArea) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,390,1,45,sPK_EntertainArea.c_str()); }
	};
	...
	public:
		CMD_Show_Popup(long DeviceIDFrom, long DeviceIDTo,string sPK_DesignObj,int iPosition_X,int iPosition_Y,string sName) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,397,4,3,sPK_DesignObj.c_str(),11,StringUtils::itos(iPosition_X).c_str(),12,StringUtils::itos(iPosition_Y).c_str(),50,sName.c_str()); }
	};
	class CMD_Show_Popup_DL : public PreformedCommand {
	public:
		CMD_Show_Popup_DL(long DeviceIDFrom, string DeviceIDTo,string sPK_DesignObj,int iPosition_X,int iPosition_Y,string sName) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,397,4,3,sPK_DesignObj.c_str(),11,StringUtils::itos(iPosition_X).c_str(),12,StringUtils::itos(iPosition_Y).c_str(),50,sName.c_str()); }
	};
	class CMD_Show_Popup_DT : public PreformedCommand {
	public:
		CMD_Show_Popup_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,string sPK_DesignObj,int iPosition_X,int iPosition_Y,string sName) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,397,4,3,sPK_DesignObj.c_str(),11,StringUtils::itos(iPosition_X).c_str(),12,StringUtils::itos(iPosition_Y).c_str(),50,sName.c_str()); }
	};
	class CMD_Show_Popup_Cat : public PreformedCommand {
	public:
		CMD_Show_Popup_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB,string sPK_DesignObj,int iPosition_X,int iPosition_Y,string sName) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,397,4,3,sPK_DesignObj.c_str(),11,StringUtils::itos(iPosition_X).c_str(),12,StringUtils::itos(iPosition_Y).c_str(),50,sName.c_str()); }
	};
	class CMD_Hide_Popup : public PreformedCommand {
	public:
		CMD_Hide_Popup(long DeviceIDFrom, long DeviceIDTo,string sPK_DesignObj) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,398,1,3,sPK_DesignObj.c_str()); }
	};
	class CMD_Hide_Popup_DL : public PreformedCommand {
	public:
		CMD_Hide_Popup_DL(long DeviceIDFrom, string DeviceIDTo,string sPK_DesignObj) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,398,1,3,sPK_DesignObj.c_str()); }
	};
	class CMD_Hide_Popup_DT : public PreformedCommand {
	public:
		CMD_Hide_Popup_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,string sPK_DesignObj) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,398,1,3,sPK_DesignObj.c_str()); }
	};
	class CMD_Hide_Popup_Cat : public PreformedCommand {
	public:
