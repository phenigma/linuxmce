...
namespace DCE
{
	...
	public:
		CMD_New_Orbiter_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,string sType,int iPK_Users,int iPK_DeviceTemplate,string sMac_address,int iPK_Room,int iWidth,int iHeight,int iPK_Skin,int iPK_Language,int iPK_Size,int iUses_Wifi_connection,int iNo_Effects,int iPK_DesignObj_MainMenu,int *iPK_Device) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,78,14,14,sType.c_str(),17,StringUtils::itos(iPK_Users).c_str(),44,StringUtils::itos(iPK_DeviceTemplate).c_str(),47,sMac_address.c_str(),57,StringUtils::itos(iPK_Room).c_str(),60,StringUtils::itos(iWidth).c_str(),61,StringUtils::itos(iHeight).c_str(),141,StringUtils::itos(iPK_Skin).c_str(),142,StringUtils::itos(iPK_Language).c_str(),143,StringUtils::itos(iPK_Size).c_str(),147,StringUtils::itos(iUses_Wifi_connection).c_str(),148,StringUtils::itos(iNo_Effects).c_str(),149,StringUtils::itos(iPK_DesignObj_MainMenu).c_str(),2,StringUtils::itos(*iPK_Device).c_str());		m_pcResponse = new RESP_New_Orbiter(iPK_Device); }
	};
	class CMD_New_Orbiter_Cat : public PreformedCommand {
	public:
		CMD_New_Orbiter_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB,string sType,int iPK_Users,int iPK_DeviceTemplate,string sMac_address,int iPK_Room,int iWidth,int iHeight,int iPK_Skin,int iPK_Language,int iPK_Size,int iUses_Wifi_connection,int iNo_Effects,int iPK_DesignObj_MainMenu,int *iPK_Device) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,78,14,14,sType.c_str(),17,StringUtils::itos(iPK_Users).c_str(),44,StringUtils::itos(iPK_DeviceTemplate).c_str(),47,sMac_address.c_str(),57,StringUtils::itos(iPK_Room).c_str(),60,StringUtils::itos(iWidth).c_str(),61,StringUtils::itos(iHeight).c_str(),141,StringUtils::itos(iPK_Skin).c_str(),142,StringUtils::itos(iPK_Language).c_str(),143,StringUtils::itos(iPK_Size).c_str(),147,StringUtils::itos(iUses_Wifi_connection).c_str(),148,StringUtils::itos(iNo_Effects).c_str(),149,StringUtils::itos(iPK_DesignObj_MainMenu).c_str(),2,StringUtils::itos(*iPK_Device).c_str());		m_pcResponse = new RESP_New_Orbiter(iPK_Device); }
	};
	class CMD_NOREP_New_Orbiter : public PreformedCommand {
	public:
		CMD_NOREP_New_Orbiter(long DeviceIDFrom, long DeviceIDTo,string sType,int iPK_Users,int iPK_DeviceTemplate,string sMac_address,int iPK_Room,int iWidth,int iHeight,int iPK_Skin,int iPK_Language,int iPK_Size,int iUses_Wifi_connection,int iNo_Effects,int iPK_DesignObj_MainMenu) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,78,13,14,sType.c_str(),17,StringUtils::itos(iPK_Users).c_str(),44,StringUtils::itos(iPK_DeviceTemplate).c_str(),47,sMac_address.c_str(),57,StringUtils::itos(iPK_Room).c_str(),60,StringUtils::itos(iWidth).c_str(),61,StringUtils::itos(iHeight).c_str(),141,StringUtils::itos(iPK_Skin).c_str(),142,StringUtils::itos(iPK_Language).c_str(),143,StringUtils::itos(iPK_Size).c_str(),147,StringUtils::itos(iUses_Wifi_connection).c_str(),148,StringUtils::itos(iNo_Effects).c_str(),149,StringUtils::itos(iPK_DesignObj_MainMenu).c_str()); }
	};
	...
	public:
		CMD_NOREP_New_Orbiter_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,string sType,int iPK_Users,int iPK_DeviceTemplate,string sMac_address,int iPK_Room,int iWidth,int iHeight,int iPK_Skin,int iPK_Language,int iPK_Size,int iUses_Wifi_connection,int iNo_Effects,int iPK_DesignObj_MainMenu) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,78,13,14,sType.c_str(),17,StringUtils::itos(iPK_Users).c_str(),44,StringUtils::itos(iPK_DeviceTemplate).c_str(),47,sMac_address.c_str(),57,StringUtils::itos(iPK_Room).c_str(),60,StringUtils::itos(iWidth).c_str(),61,StringUtils::itos(iHeight).c_str(),141,StringUtils::itos(iPK_Skin).c_str(),142,StringUtils::itos(iPK_Language).c_str(),143,StringUtils::itos(iPK_Size).c_str(),147,StringUtils::itos(iUses_Wifi_connection).c_str(),148,StringUtils::itos(iNo_Effects).c_str(),149,StringUtils::itos(iPK_DesignObj_MainMenu).c_str()); }
	};
	class CMD_NOREP_New_Orbiter_Cat : public PreformedCommand {
	public:
		CMD_NOREP_New_Orbiter_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB,string sType,int iPK_Users,int iPK_DeviceTemplate,string sMac_address,int iPK_Room,int iWidth,int iHeight,int iPK_Skin,int iPK_Language,int iPK_Size,int iUses_Wifi_connection,int iNo_Effects,int iPK_DesignObj_MainMenu) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,78,13,14,sType.c_str(),17,StringUtils::itos(iPK_Users).c_str(),44,StringUtils::itos(iPK_DeviceTemplate).c_str(),47,sMac_address.c_str(),57,StringUtils::itos(iPK_Room).c_str(),60,StringUtils::itos(iWidth).c_str(),61,StringUtils::itos(iHeight).c_str(),141,StringUtils::itos(iPK_Skin).c_str(),142,StringUtils::itos(iPK_Language).c_str(),143,StringUtils::itos(iPK_Size).c_str(),147,StringUtils::itos(iUses_Wifi_connection).c_str(),148,StringUtils::itos(iNo_Effects).c_str(),149,StringUtils::itos(iPK_DesignObj_MainMenu).c_str()); }
	};
