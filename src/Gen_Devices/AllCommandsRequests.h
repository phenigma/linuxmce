...
namespace DCE
{
	...
	public:
		CMD_Get_Jukebox_Status(long DeviceIDFrom, long DeviceIDTo,string *sJukebox_Status) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,703,1,153,(*sJukebox_Status).c_str());		m_pcResponse = new RESP_Get_Jukebox_Status(sJukebox_Status); }
	};
	class CMD_Get_Jukebox_Status_DL : public PreformedCommand {
	public:
		CMD_Get_Jukebox_Status_DL(long DeviceIDFrom, string DeviceIDTo,string *sJukebox_Status) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,703,1,153,(*sJukebox_Status).c_str());		m_pcResponse = new RESP_Get_Jukebox_Status(sJukebox_Status); }
	};
	class CMD_Get_Jukebox_Status_DT : public PreformedCommand {
	public:
		CMD_Get_Jukebox_Status_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,string *sJukebox_Status) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,703,1,153,(*sJukebox_Status).c_str());		m_pcResponse = new RESP_Get_Jukebox_Status(sJukebox_Status); }
	};
	class CMD_Get_Jukebox_Status_Cat : public PreformedCommand {
	public:
		CMD_Get_Jukebox_Status_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB,string *sJukebox_Status) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,703,1,153,(*sJukebox_Status).c_str());		m_pcResponse = new RESP_Get_Jukebox_Status(sJukebox_Status); }
	};
	class CMD_NOREP_Get_Jukebox_Status : public PreformedCommand {
	public:
		CMD_NOREP_Get_Jukebox_Status(long DeviceIDFrom, long DeviceIDTo) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,703,0); }
	};
	class CMD_NOREP_Get_Jukebox_Status_DL : public PreformedCommand {
	public:
		CMD_NOREP_Get_Jukebox_Status_DL(long DeviceIDFrom, string DeviceIDTo) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,703,0); }
	};
	class CMD_NOREP_Get_Jukebox_Status_DT : public PreformedCommand {
	public:
		CMD_NOREP_Get_Jukebox_Status_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,703,0); }
	};
	class CMD_NOREP_Get_Jukebox_Status_Cat : public PreformedCommand {
	public:
		CMD_NOREP_Get_Jukebox_Status_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,703,0); }
	};
	class CMD_Component_1 : public PreformedCommand {
	public:
		CMD_Component_1(long DeviceIDFrom, long DeviceIDTo) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,704,0); }
	};
	class CMD_Component_1_DL : public PreformedCommand {
	public:
		CMD_Component_1_DL(long DeviceIDFrom, string DeviceIDTo) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,704,0); }
	};
	class CMD_Component_1_DT : public PreformedCommand {
	public:
		CMD_Component_1_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,704,0); }
	};
	class CMD_Component_1_Cat : public PreformedCommand {
	public:
		CMD_Component_1_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,704,0); }
	};
	class CMD_Component_2 : public PreformedCommand {
	public:
		CMD_Component_2(long DeviceIDFrom, long DeviceIDTo) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,705,0); }
	};
	class CMD_Component_2_DL : public PreformedCommand {
	public:
		CMD_Component_2_DL(long DeviceIDFrom, string DeviceIDTo) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,705,0); }
	};
	class CMD_Component_2_DT : public PreformedCommand {
	public:
		CMD_Component_2_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,705,0); }
	};
	class CMD_Component_2_Cat : public PreformedCommand {
	public:
		CMD_Component_2_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,705,0); }
	};
	class CMD_DVR : public PreformedCommand {
	public:
		CMD_DVR(long DeviceIDFrom, long DeviceIDTo) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,706,0); }
	};
	class CMD_DVR_DL : public PreformedCommand {
	public:
		CMD_DVR_DL(long DeviceIDFrom, string DeviceIDTo) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,706,0); }
	};
	class CMD_DVR_DT : public PreformedCommand {
	public:
		CMD_DVR_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,706,0); }
	};
	class CMD_DVR_Cat : public PreformedCommand {
	public:
		CMD_DVR_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,706,0); }
	};
	class CMD_TV_Theater : public PreformedCommand {
	public:
		CMD_TV_Theater(long DeviceIDFrom, long DeviceIDTo) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,707,0); }
	};
	class CMD_TV_Theater_DL : public PreformedCommand {
	public:
		CMD_TV_Theater_DL(long DeviceIDFrom, string DeviceIDTo) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,707,0); }
	};
	class CMD_TV_Theater_DT : public PreformedCommand {
	public:
		CMD_TV_Theater_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,707,0); }
	};
	class CMD_TV_Theater_Cat : public PreformedCommand {
	public:
		CMD_TV_Theater_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,707,0); }
	};
	class CMD_Discover_New_Devices : public PreformedCommand {
	public:
		CMD_Discover_New_Devices(long DeviceIDFrom, long DeviceIDTo) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,709,0); }
	};
	class CMD_Discover_New_Devices_DL : public PreformedCommand {
	public:
		CMD_Discover_New_Devices_DL(long DeviceIDFrom, string DeviceIDTo) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,709,0); }
	};
	class CMD_Discover_New_Devices_DT : public PreformedCommand {
	public:
		CMD_Discover_New_Devices_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,709,0); }
	};
	class CMD_Discover_New_Devices_Cat : public PreformedCommand {
	public:
		CMD_Discover_New_Devices_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,709,0); }
	};
	...
	public:
		CMD_Delete_Device(long DeviceIDFrom, long DeviceIDTo,int iPK_Device) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,711,1,2,StringUtils::itos(iPK_Device).c_str()); }
	};
	class CMD_Delete_Device_DL : public PreformedCommand {
	public:
		CMD_Delete_Device_DL(long DeviceIDFrom, string DeviceIDTo,int iPK_Device) { m_pMessage = new Message(DeviceIDFrom, DeviceIDTo, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,711,1,2,StringUtils::itos(iPK_Device).c_str()); }
	};
	class CMD_Delete_Device_DT : public PreformedCommand {
	public:
		CMD_Delete_Device_DT(long DeviceIDFrom, long MasterDevice, eBroadcastLevel eB,int iPK_Device) { m_pMessage = new Message(DeviceIDFrom, MasterDevice, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,711,1,2,StringUtils::itos(iPK_Device).c_str()); }
	};
	class CMD_Delete_Device_Cat : public PreformedCommand {
	public:
		CMD_Delete_Device_Cat(long DeviceIDFrom, long DeviceCategory, bool bIncludeChildren, eBroadcastLevel eB,int iPK_Device) { m_pMessage = new Message(DeviceIDFrom, DeviceCategory, bIncludeChildren, eB, MESSAGETYPE_COMMAND, PRIORITY_NORMAL,711,1,2,StringUtils::itos(iPK_Device).c_str()); }
	};
}
#endif
