...
class PLCBUS_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	PLCBUS_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_PLCBUS_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	PLCBUS_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class PLCBUS_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_PLCBUS_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "PLCBUS"; } ;
...
class PLCBUS_Command : public Command_Impl
{
public:
	PLCBUS_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new PLCBUS_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_PLCBUS_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	PLCBUS_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~PLCBUS_Command() {};
	PLCBUS_Event *GetEvents() { return (PLCBUS_Event *) m_pEvent; };
	PLCBUS_Data *GetData() { return (PLCBUS_Data *) m_pData; };
	const char *GetClassName() { return "PLCBUS_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_PLCBUS_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_PLCBUS_CONST; };
