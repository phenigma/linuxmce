#ifndef Clock_Screen_SaverBase_h
#define Clock_Screen_SaverBase_h
...
class Clock_Screen_Saver_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	Clock_Screen_Saver_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_Clock_Screen_Saver_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	Clock_Screen_Saver_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class Clock_Screen_Saver_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual ~Clock_Screen_Saver_Data() {};
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_Clock_Screen_Saver_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "Clock_Screen_Saver"; } ;
...
class Clock_Screen_Saver_Command : public Command_Impl
{
public:
	Clock_Screen_Saver_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new Clock_Screen_Saver_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new Clock_Screen_Saver_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_Clock_Screen_Saver_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	Clock_Screen_Saver_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~Clock_Screen_Saver_Command() {};
	Clock_Screen_Saver_Event *GetEvents() { return (Clock_Screen_Saver_Event *) m_pEvent; };
	Clock_Screen_Saver_Data *GetData() { return (Clock_Screen_Saver_Data *) m_pData; };
	const char *GetClassName() { return "Clock_Screen_Saver_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_Clock_Screen_Saver_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_Clock_Screen_Saver_CONST; };
