#ifndef External_Media_IdentifierBase_h
#define External_Media_IdentifierBase_h
...
class External_Media_Identifier_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	External_Media_Identifier_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_External_Media_Identifier_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	External_Media_Identifier_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
	...
	*/
	...
	virtual void Media_Identified(string sMRL,string sID,int iPK_Device,int iValue,string sFormat,char *pImage,int iImage_Size)
	{
...
class External_Media_Identifier_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual ~External_Media_Identifier_Data() {};
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_External_Media_Identifier_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "External_Media_Identifier"; } ;
...
class External_Media_Identifier_Command : public Command_Impl
{
public:
	External_Media_Identifier_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new External_Media_Identifier_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new External_Media_Identifier_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_External_Media_Identifier_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	External_Media_Identifier_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~External_Media_Identifier_Command() {};
	External_Media_Identifier_Event *GetEvents() { return (External_Media_Identifier_Event *) m_pEvent; };
	External_Media_Identifier_Data *GetData() { return (External_Media_Identifier_Data *) m_pData; };
	const char *GetClassName() { return "External_Media_Identifier_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_External_Media_Identifier_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_External_Media_Identifier_CONST; };
	...
	//Event accessors
	void EVENT_Media_Identified(string sMRL,string sID,int iPK_Device,int iValue,string sFormat,char *pImage,int iImage_Size) { GetEvents()->Media_Identified(sMRL.c_str(),sID.c_str(),iPK_Device,iValue,sFormat.c_str(),pImage,iImage_Size); }
