#ifndef icpdasbridgeBase_h
#define icpdasbridgeBase_h
...
class icpdasbridge_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	icpdasbridge_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_icpdasbridge_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	icpdasbridge_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class icpdasbridge_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_icpdasbridge_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "icpdasbridge"; } ;
...
class icpdasbridge_Command : public Command_Impl
{
public:
	icpdasbridge_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new icpdasbridge_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_icpdasbridge_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	icpdasbridge_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~icpdasbridge_Command() {};
	icpdasbridge_Event *GetEvents() { return (icpdasbridge_Event *) m_pEvent; };
	icpdasbridge_Data *GetData() { return (icpdasbridge_Data *) m_pData; };
	const char *GetClassName() { return "icpdasbridge_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_icpdasbridge_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_icpdasbridge_CONST; };
