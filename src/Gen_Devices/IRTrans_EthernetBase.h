#ifndef IRTrans_EthernetBase_h
#define IRTrans_EthernetBase_h
...
class IRTrans_Ethernet_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	IRTrans_Ethernet_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_IRTrans_Ethernet_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT) {};
	IRTrans_Ethernet_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class IRTrans_Ethernet_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_IRTrans_Ethernet_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "IRTrans_Ethernet"; } ;
...
class IRTrans_Ethernet_Command : public Command_Impl
{
public:
	IRTrans_Ethernet_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new IRTrans_Ethernet_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new IRTrans_Ethernet_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_IRTrans_Ethernet_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	IRTrans_Ethernet_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~IRTrans_Ethernet_Command() {};
	IRTrans_Ethernet_Event *GetEvents() { return (IRTrans_Ethernet_Event *) m_pEvent; };
	IRTrans_Ethernet_Data *GetData() { return (IRTrans_Ethernet_Data *) m_pData; };
	const char *GetClassName() { return "IRTrans_Ethernet_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_IRTrans_Ethernet_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_IRTrans_Ethernet_CONST; };
