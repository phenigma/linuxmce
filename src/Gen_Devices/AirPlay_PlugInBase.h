#ifndef AirPlay_PlugInBase_h
#define AirPlay_PlugInBase_h
...
class AirPlay_PlugIn_Event : public Event_Impl
{
public:
	...
	* @brief Constructors
	*/
	AirPlay_PlugIn_Event(int DeviceID, string ServerAddress, bool bConnectEventHandler=true) :
		Event_Impl(DeviceID, DEVICETEMPLATE_AirPlay_PlugIn_CONST, ServerAddress, bConnectEventHandler, SOCKET_TIMEOUT_PLUGIN) {};
	AirPlay_PlugIn_Event(class ClientSocket *pOCClientSocket, int DeviceID) : Event_Impl(pOCClientSocket, DeviceID) {};
...
class AirPlay_PlugIn_Data : public DeviceData_Impl
{
public:
	...
	*/
	virtual int GetPK_DeviceList() { return DEVICETEMPLATE_AirPlay_PlugIn_CONST; } ;

	/**
	* @brief Returns the description of the device
	*/
	virtual const char *GetDeviceDescription() { return "AirPlay_PlugIn"; } ;
...
class AirPlay_PlugIn_Command : public Command_Impl
{
public:
	AirPlay_PlugIn_Command(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL)
	...
	{
		m_pData=NULL;
		m_pEvent = new AirPlay_PlugIn_Event(m_dwPK_Device, m_sHostName, !m_bLocalMode);
		...
		if( m_bLocalMode )
		{
			m_pData = new AirPlay_PlugIn_Data();
			return true;
		}
		...
		m_pcRequestSocket = new Event_Impl(m_dwPK_Device, DEVICETEMPLATE_AirPlay_PlugIn_CONST,m_sHostName);
		if( m_iInstanceID )
		{
	...
	AirPlay_PlugIn_Command(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter) : Command_Impl(pPrimaryDeviceCommand, pData, pEvent, pRouter) {};
	virtual ~AirPlay_PlugIn_Command() {};
	AirPlay_PlugIn_Event *GetEvents() { return (AirPlay_PlugIn_Event *) m_pEvent; };
	AirPlay_PlugIn_Data *GetData() { return (AirPlay_PlugIn_Data *) m_pData; };
	const char *GetClassName() { return "AirPlay_PlugIn_Command"; };
	virtual int PK_DeviceTemplate_get() { return DEVICETEMPLATE_AirPlay_PlugIn_CONST; };
	static int PK_DeviceTemplate_get_static() { return DEVICETEMPLATE_AirPlay_PlugIn_CONST; };
