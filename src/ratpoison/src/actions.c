...
static user_command user_commands[] =
  { /*@begin (tag required for genrpbindings) */
    ...
    {"desktop",         cmd_desktop,       arg_STRING},
    ...
    {"keybindings", cmd_keybindings,    arg_STRING},
    {"keystodesktop",    cmd_keystodesktop,   arg_STRING},
...
initialize_default_keybindings (void)
{
  ...
  add_keybinding (XK_d, 0, "desktop", map);
  add_keybinding (XK_d, RP_CONTROL_MASK, "desktop", map);
  add_keybinding (XK_D, 0, "desktop off", map);
  add_keybinding (XK_D, RP_CONTROL_MASK, "desktop off", map);
