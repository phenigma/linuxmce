========================================================================
       Windows CE APPLICATION : UpdateBinary
========================================================================


AppWizard has created this UpdateBinary application for you.  

This file contains a summary of what you will find in each of the files that
make up your UpdateBinary application.
...
UpdateBinary.ico
    ...
    This icon is included by the main resource file UpdateBinary.rc.
...
StdAfx.h, StdAfx.cpp
    ...
    named UpdateBinary.pch and a precompiled types file named StdAfx.obj.
