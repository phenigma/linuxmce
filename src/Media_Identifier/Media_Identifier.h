...
*/
//<-dceag-d-b->
#ifndef Media_Identifier_h
#define Media_Identifier_h

//	DCE Implemenation for #2311 Media Identifier

#include "Gen_Devices/Media_IdentifierBase.h"
//<-dceag-d-e->

//<-dceag-decl-b->
namespace DCE
{
	class Media_Identifier : public Media_Identifier_Command
	{
//<-dceag-decl-e->
...
public:
		...
		Media_Identifier(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL);
		virtual ~Media_Identifier();
...
//<-dceag-const2-b->
		...
		Media_Identifier(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter);
//<-dceag-const2-e->
