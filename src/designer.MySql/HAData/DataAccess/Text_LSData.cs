namespace HAData.DataAccess {
	...
	public class Text_LSData : MyDataSet {
		...
		public Text_LSData(MySqlConnection conn,MySqlTransaction trans) {
		...
		protected static void CreateCommands(MySqlConnection Conn, MySqlTransaction Trans, ref MySqlCommand LoadCommand, ref MySqlCommand InsertCommand, ref MySqlCommand UpdateCommand, ref MySqlCommand DeleteCommand) {
			if(LoadCommand == null) {
				...
				LoadCommand = new MySqlCommand("sp_Select_Text_LS", Conn);
			...
			if(InsertCommand == null) {
				// Create the command since it's null
				InsertCommand = new MySqlCommand("sp_Insert_Text_LS", Conn);
			...
			if(UpdateCommand == null) {
				// Create the command since it's null
				UpdateCommand = new MySqlCommand("sp_Update_Text_LS", Conn);
			...
			{
				DeleteCommand = new MySqlCommand("sp_Delete_Text_LS", Conn);
		...
		protected static void CreateCommands(MySqlDataAdapter odbcda,MySqlConnection Conn, MySqlTransaction Trans, ref MySqlCommand LoadCommand, ref MySqlCommand InsertCommand, ref MySqlCommand UpdateCommand, ref MySqlCommand DeleteCommand) {
				LoadCommand = new MySqlCommand("SELECT FK_Text,FK_Language,Description FROM Text_LS", Conn);
				LoadCommand.Transaction = Trans;
		...
		public static DataRowCollection LoadText_LSWithWhere(ref MyDataSet ds, MySqlConnection conn, MySqlTransaction trans, string WhereClause) // marker:2
		{
		...
		public static DataRow LoadNoCacheText_LS(ref MyDataSet ds, MySqlConnection conn, MySqlTransaction trans, System.Int32 FK_Text, System.Int32 FK_Language)
		{
			DataRow dr = null;
			if( ds==null )
			{
		...
		public static DataRow LoadText_LS(ref MyDataSet ds, MySqlConnection conn, MySqlTransaction trans, System.Int32 FK_Text, System.Int32 FK_Language)  // marker:3
		{
			DataRow dr = null;
			if( ds==null )
			{
		...
		public static DataRowCollection LoadText_LS_FirstPK(ref MyDataSet ds, MySqlConnection conn, MySqlTransaction trans,System.Int32 FK_Text)
		{
			DataRowCollection dr;
			if( ds==null )
			{
			...
			MySqlDataAdapter sqlda = new MySqlDataAdapter();
				...
				LoadCommand = new MySqlCommand("sp_Select_Text_LS_FirstPK", conn);
		...
		public Text_LSData LoadAll() {
			...
			// Create the command since it's null
			m_DSCommand.SelectCommand = new MySqlCommand("SELECT * FROM Text_LS", m_Connection);
		...
		public static DataRowCollection LoadAll(ref MyDataSet ds, MySqlConnection conn, MySqlTransaction trans) {
			...
			if( conn==null )
				conn = HADataConfiguration.GetMySqlConnection();
			MySqlDataAdapter sqlda = new MySqlDataAdapter();
			MySqlCommand LoadCommand = new MySqlCommand("SELECT * FROM Text_LS", conn);
		...
		public static bool UpdateText_LS(ref MyDataSet ds, int CurUserID,MySqlConnection OdbcConn,MySqlTransaction Trans)
		{
	...
	public class Text_LSDataReader
	{
		...
		public Text_LSDataReader(MySqlDataReader d)
		{
			dr=d;
		}
		public Text_LSDataReader(MySqlCommand cmd)
		{
			dr = cmd.ExecuteReader();
		}

		public Text_LSDataReader(MySqlCommand cmd,bool Cache)
		{
			dr = cmd.ExecuteReader();
			bCache=Cache;
			if( bCache )
		...
		public Text_LSDataReader(string sSQL,MySqlConnection conn)
		{
			if( conn==null )
			{
				conn = HADataConfiguration.GetMySqlConnection();
		...
		public Text_LSDataReader(string sSQL,MySqlConnection conn,MySqlTransaction trans,bool Cache)
		{
			if( conn==null )
			{
				conn = HADataConfiguration.GetMySqlConnection();
	...
	public class Text_LSTable : DataTable
	{
		...
		{
			MySqlDataAdapter sqlda = new MySqlDataAdapter();
			MySqlCommand LoadCommand = new MySqlCommand("SELECT FK_Text,FK_Language,Description FROM Text_LS", conn);
			LoadCommand.CommandType = CommandType.Text;
			if( trans!=null )
				LoadCommand.Transaction = trans;
