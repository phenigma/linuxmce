namespace HAData.DataAccess {
	...
	public class Command_CommandParameterData : MyDataSet {
		...
		public Command_CommandParameterData(MySqlConnection conn,MySqlTransaction trans) {
		...
		protected static void CreateCommands(MySqlConnection Conn, MySqlTransaction Trans, ref MySqlCommand LoadCommand, ref MySqlCommand InsertCommand, ref MySqlCommand UpdateCommand, ref MySqlCommand DeleteCommand) {
			if(LoadCommand == null) {
				...
				LoadCommand = new MySqlCommand("sp_Select_Command_CommandParameter", Conn);
				LoadCommand.CommandType = CommandType.StoredProcedure;
				LoadCommand.Transaction = Trans;

				LoadCommand.Parameters.Add(new MySqlParameter(FK_COMMAND_PARM, MySqlDbType.Int32,4));
				LoadCommand.Parameters.Add(new MySqlParameter(FK_COMMANDPARAMETER_PARM, MySqlDbType.Int32,4));
			}

			if(InsertCommand == null) {
				// Create the command since it's null
				InsertCommand = new MySqlCommand("sp_Insert_Command_CommandParameter", Conn);
			...
			if(UpdateCommand == null) {
				// Create the command since it's null
				UpdateCommand = new MySqlCommand("sp_Update_Command_CommandParameter", Conn);
			...
			{
				DeleteCommand = new MySqlCommand("sp_Delete_Command_CommandParameter", Conn);
				DeleteCommand.CommandType = CommandType.StoredProcedure;
				DeleteCommand.Transaction = Trans;

				DeleteCommand.Parameters.Add(FK_COMMAND_PARM, MySqlDbType.Int32,4, FK_COMMAND_FIELD);
		...
		protected static void CreateCommands(MySqlDataAdapter odbcda,MySqlConnection Conn, MySqlTransaction Trans, ref MySqlCommand LoadCommand, ref MySqlCommand InsertCommand, ref MySqlCommand UpdateCommand, ref MySqlCommand DeleteCommand) {
				LoadCommand = new MySqlCommand("SELECT FK_Command,FK_CommandParameter,Description FROM Command_CommandParameter", Conn);
				LoadCommand.Transaction = Trans;
		...
		public static DataRowCollection LoadCommand_CommandParameterWithWhere(ref MyDataSet ds, MySqlConnection conn, MySqlTransaction trans, string WhereClause) // marker:2
		{
		...
		public static DataRow LoadNoCacheCommand_CommandParameter(ref MyDataSet ds, MySqlConnection conn, MySqlTransaction trans, System.Int32 FK_Command, System.Int32 FK_CommandParameter)
		{
			DataRow dr = null;
			if( ds==null )
			{
		...
		public static DataRow LoadCommand_CommandParameter(ref MyDataSet ds, MySqlConnection conn, MySqlTransaction trans, System.Int32 FK_Command, System.Int32 FK_CommandParameter)  // marker:3
		{
			DataRow dr = null;
			if( ds==null )
			{
		...
		public static DataRowCollection LoadCommand_CommandParameter_FirstPK(ref MyDataSet ds, MySqlConnection conn, MySqlTransaction trans,System.Int32 FK_Command)
		{
			DataRowCollection dr;
			if( ds==null )
			{
			...
			MySqlDataAdapter sqlda = new MySqlDataAdapter();
				...
				LoadCommand = new MySqlCommand("sp_Select_Command_CommandParameter_FirstPK", conn);
		...
		public Command_CommandParameterData LoadAll() {
			...
			// Create the command since it's null
			m_DSCommand.SelectCommand = new MySqlCommand("SELECT * FROM Command_CommandParameter", m_Connection);
		...
		public static DataRowCollection LoadAll(ref MyDataSet ds, MySqlConnection conn, MySqlTransaction trans) {
			...
			if( conn==null )
				conn = HADataConfiguration.GetMySqlConnection();
			MySqlDataAdapter sqlda = new MySqlDataAdapter();
			MySqlCommand LoadCommand = new MySqlCommand("SELECT * FROM Command_CommandParameter", conn);
		...
		public static bool UpdateCommand_CommandParameter(ref MyDataSet ds, int CurUserID,MySqlConnection OdbcConn,MySqlTransaction Trans)
		{
	...
	public class Command_CommandParameterDataReader
	{
		...
		public Command_CommandParameterDataReader(MySqlDataReader d)
		{
			dr=d;
		}
		public Command_CommandParameterDataReader(MySqlCommand cmd)
		{
			dr = cmd.ExecuteReader();
		}

		public Command_CommandParameterDataReader(MySqlCommand cmd,bool Cache)
		{
			dr = cmd.ExecuteReader();
			bCache=Cache;
			if( bCache )
		...
		public Command_CommandParameterDataReader(string sSQL,MySqlConnection conn)
		{
			if( conn==null )
			{
				conn = HADataConfiguration.GetMySqlConnection();
		...
		public Command_CommandParameterDataReader(string sSQL,MySqlConnection conn,MySqlTransaction trans,bool Cache)
		{
			if( conn==null )
			{
				conn = HADataConfiguration.GetMySqlConnection();
	...
	public class Command_CommandParameterTable : DataTable
	{
		...
		{
			MySqlDataAdapter sqlda = new MySqlDataAdapter();
			MySqlCommand LoadCommand = new MySqlCommand("SELECT FK_Command,FK_CommandParameter,Description FROM Command_CommandParameter", conn);
			LoadCommand.CommandType = CommandType.Text;
			if( trans!=null )
				LoadCommand.Transaction = trans;
