namespace HAData.DataAccess {
	...
	public class DesignObjData : MyDataSet {
		...
		public DesignObjData(MySqlConnection conn,MySqlTransaction trans) {
		...
		protected static void CreateParameters(MySqlParameterCollection Params, bool IsInsert) {
			Params.Add(new MySqlParameter(PK_DESIGNOBJ_PARM, MySqlDbType.Int32,4));
			...
			Params.Add(new MySqlParameter(FK_DESIGNOBJCATEGORY_PARM, MySqlDbType.Int32,4));
			Params.Add(new MySqlParameter(FK_DESIGNOBJ_INCLUDEIFOTHERINCLUDED_PARM, MySqlDbType.Int32,4));
			Params.Add(new MySqlParameter(PRIORITY_PARM, MySqlDbType.Byte,1));
			Params.Add(new MySqlParameter(CANTGOBACK_PARM, MySqlDbType.Bit,1));
			Params.Add(new MySqlParameter(COMMANDSPROCESSEDATSERVER_PARM, MySqlDbType.Bit,1));
			Params.Add(new MySqlParameter(TIMEOUTSECONDS_PARM, MySqlDbType.Int16,2));
			Params.Add(new MySqlParameter(ANIMATE_PARM, MySqlDbType.Bit,1));
		...
		protected static void CreateCommands(MySqlConnection Conn, MySqlTransaction Trans, ref MySqlCommand LoadCommand, ref MySqlCommand InsertCommand, ref MySqlCommand UpdateCommand, ref MySqlCommand DeleteCommand) {
			if(LoadCommand == null) {
				...
				LoadCommand = new MySqlCommand("sp_Select_DesignObj", Conn);
				LoadCommand.CommandType = CommandType.StoredProcedure;
				LoadCommand.Transaction = Trans;

				LoadCommand.Parameters.Add(new MySqlParameter(PK_DESIGNOBJ_PARM, MySqlDbType.Int32,4));
			}

			if(InsertCommand == null) {
				// Create the command since it's null
				InsertCommand = new MySqlCommand("sp_Insert_DesignObj", Conn);
			...
			if(UpdateCommand == null) {
				// Create the command since it's null
				UpdateCommand = new MySqlCommand("sp_Update_DesignObj", Conn);
			...
			{
				DeleteCommand = new MySqlCommand("sp_Delete_DesignObj", Conn);
				DeleteCommand.CommandType = CommandType.StoredProcedure;
				DeleteCommand.Transaction = Trans;

				DeleteCommand.Parameters.Add(PK_DESIGNOBJ_PARM, MySqlDbType.Int32,4, PK_DESIGNOBJ_FIELD);
		...
		protected static void CreateCommands(MySqlDataAdapter odbcda,MySqlConnection Conn, MySqlTransaction Trans, ref MySqlCommand LoadCommand, ref MySqlCommand InsertCommand, ref MySqlCommand UpdateCommand, ref MySqlCommand DeleteCommand) {
				LoadCommand = new MySqlCommand("SELECT PK_DesignObj,Description,Define,FK_DesignObjType,FK_DesignObjCategory,FK_DesignObj_IncludeIfOtherIncluded,Priority,CantGoBack,CommandsProcessedAtServer,TimeoutSeconds,Animate,FK_StabilityStatus FROM DesignObj", Conn);
				LoadCommand.Transaction = Trans;
		...
		public static DataRowCollection LoadDesignObjWithWhere(ref MyDataSet ds, MySqlConnection conn, MySqlTransaction trans, string WhereClause) // marker:2
		{
		...
		public static DataRow LoadNoCacheDesignObj(ref MyDataSet ds, MySqlConnection conn, MySqlTransaction trans, System.Int32 PK_DesignObj)
		{
			DataRow dr = null;
			if( ds==null )
			{
		...
		public static DataRow LoadDesignObj(ref MyDataSet ds, MySqlConnection conn, MySqlTransaction trans, System.Int32 PK_DesignObj)  // marker:3
		{
			DataRow dr = null;
			if( ds==null )
			{
		...
		public DesignObjData LoadAll() {
			...
			// Create the command since it's null
			m_DSCommand.SelectCommand = new MySqlCommand("SELECT * FROM DesignObj", m_Connection);
		...
		public static DataRowCollection LoadAll(ref MyDataSet ds, MySqlConnection conn, MySqlTransaction trans) {
			...
			if( conn==null )
				conn = HADataConfiguration.GetMySqlConnection();
			MySqlDataAdapter sqlda = new MySqlDataAdapter();
			MySqlCommand LoadCommand = new MySqlCommand("SELECT * FROM DesignObj", conn);
		...
		public static bool UpdateDesignObj(ref MyDataSet ds, int CurUserID,MySqlConnection OdbcConn,MySqlTransaction Trans)
		{
	...
	public class DesignObjDataReader
	{
		...
		public DesignObjDataReader(MySqlDataReader d)
		{
			dr=d;
		}
		public DesignObjDataReader(MySqlCommand cmd)
		{
			dr = cmd.ExecuteReader();
		}

		public DesignObjDataReader(MySqlCommand cmd,bool Cache)
		{
			dr = cmd.ExecuteReader();
			bCache=Cache;
			if( bCache )
		...
		public DesignObjDataReader(string sSQL,MySqlConnection conn)
		{
			if( conn==null )
			{
				conn = HADataConfiguration.GetMySqlConnection();
		...
		public DesignObjDataReader(string sSQL,MySqlConnection conn,MySqlTransaction trans,bool Cache)
		{
			if( conn==null )
			{
				conn = HADataConfiguration.GetMySqlConnection();
	...
	public class DesignObjTable : DataTable
	{
		...
		{
			MySqlDataAdapter sqlda = new MySqlDataAdapter();
			MySqlCommand LoadCommand = new MySqlCommand("SELECT PK_DesignObj,Description,Define,FK_DesignObjType,FK_DesignObjCategory,FK_DesignObj_IncludeIfOtherIncluded,Priority,CantGoBack,CommandsProcessedAtServer,TimeoutSeconds,Animate,FK_StabilityStatus FROM DesignObj", conn);
			LoadCommand.CommandType = CommandType.Text;
			if( trans!=null )
				LoadCommand.Transaction = trans;
