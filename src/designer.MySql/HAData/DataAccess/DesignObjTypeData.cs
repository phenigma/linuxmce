namespace HAData.DataAccess {
	...
	public class DesignObjTypeData : MyDataSet {
		...
		public DesignObjTypeData(MySqlConnection conn,MySqlTransaction trans) {
		...
		protected static void CreateParameters(MySqlParameterCollection Params, bool IsInsert) {
			Params.Add(new MySqlParameter(PK_DESIGNOBJTYPE_PARM, MySqlDbType.Int32,4));
			...
			Params.Add(new MySqlParameter(CANCLICK_PARM, MySqlDbType.Int16,2));
			Params.Add(new MySqlParameter(CONTAINSTEXT_PARM, MySqlDbType.Int16,2));
		...
		protected static void CreateCommands(MySqlConnection Conn, MySqlTransaction Trans, ref MySqlCommand LoadCommand, ref MySqlCommand InsertCommand, ref MySqlCommand UpdateCommand, ref MySqlCommand DeleteCommand) {
			if(LoadCommand == null) {
				...
				LoadCommand = new MySqlCommand("sp_Select_DesignObjType", Conn);
				LoadCommand.CommandType = CommandType.StoredProcedure;
				LoadCommand.Transaction = Trans;

				LoadCommand.Parameters.Add(new MySqlParameter(PK_DESIGNOBJTYPE_PARM, MySqlDbType.Int32,4));
			}

			if(InsertCommand == null) {
				// Create the command since it's null
				InsertCommand = new MySqlCommand("sp_Insert_DesignObjType", Conn);
			...
			if(UpdateCommand == null) {
				// Create the command since it's null
				UpdateCommand = new MySqlCommand("sp_Update_DesignObjType", Conn);
			...
			{
				DeleteCommand = new MySqlCommand("sp_Delete_DesignObjType", Conn);
				DeleteCommand.CommandType = CommandType.StoredProcedure;
				DeleteCommand.Transaction = Trans;

				DeleteCommand.Parameters.Add(PK_DESIGNOBJTYPE_PARM, MySqlDbType.Int32,4, PK_DESIGNOBJTYPE_FIELD);
		...
		protected static void CreateCommands(MySqlDataAdapter odbcda,MySqlConnection Conn, MySqlTransaction Trans, ref MySqlCommand LoadCommand, ref MySqlCommand InsertCommand, ref MySqlCommand UpdateCommand, ref MySqlCommand DeleteCommand) {
				LoadCommand = new MySqlCommand("SELECT PK_DesignObjType,Description,Define,CanClick,ContainsText FROM DesignObjType", Conn);
				LoadCommand.Transaction = Trans;
		...
		public static DataRowCollection LoadDesignObjTypeWithWhere(ref MyDataSet ds, MySqlConnection conn, MySqlTransaction trans, string WhereClause) // marker:2
		{
			...
			string sSQL = "SELECT PK_DesignObjType, Description, Define, CanClick, ContainsText FROM DesignObjType WHERE " + WhereClause;
		...
		public static DataRow LoadNoCacheDesignObjType(ref MyDataSet ds, MySqlConnection conn, MySqlTransaction trans, System.Int32 PK_DesignObjType)
		{
			DataRow dr = null;
			if( ds==null )
			{
		...
		public static DataRow LoadDesignObjType(ref MyDataSet ds, MySqlConnection conn, MySqlTransaction trans, System.Int32 PK_DesignObjType)  // marker:3
		{
			DataRow dr = null;
			if( ds==null )
			{
		...
		public DesignObjTypeData LoadAll() {
			...
			// Create the command since it's null
			m_DSCommand.SelectCommand = new MySqlCommand("SELECT * FROM DesignObjType", m_Connection);
		...
		public static DataRowCollection LoadAll(ref MyDataSet ds, MySqlConnection conn, MySqlTransaction trans) {
			...
			if( conn==null )
				conn = HADataConfiguration.GetMySqlConnection();
			MySqlDataAdapter sqlda = new MySqlDataAdapter();
			MySqlCommand LoadCommand = new MySqlCommand("SELECT * FROM DesignObjType", conn);
		...
		public static bool UpdateDesignObjType(ref MyDataSet ds, int CurUserID,MySqlConnection OdbcConn,MySqlTransaction Trans)
		{
	...
	public class DesignObjTypeDataReader
	{
		...
		public DesignObjTypeDataReader(MySqlDataReader d)
		{
			dr=d;
		}
		public DesignObjTypeDataReader(MySqlCommand cmd)
		{
			dr = cmd.ExecuteReader();
		}

		public DesignObjTypeDataReader(MySqlCommand cmd,bool Cache)
		{
			dr = cmd.ExecuteReader();
			bCache=Cache;
			if( bCache )
		...
		public DesignObjTypeDataReader(string sSQL,MySqlConnection conn)
		{
			if( conn==null )
			{
				conn = HADataConfiguration.GetMySqlConnection();
		...
		public DesignObjTypeDataReader(string sSQL,MySqlConnection conn,MySqlTransaction trans,bool Cache)
		{
			if( conn==null )
			{
				conn = HADataConfiguration.GetMySqlConnection();
	...
	public class DesignObjTypeTable : DataTable
	{
		...
		{
			MySqlDataAdapter sqlda = new MySqlDataAdapter();
			MySqlCommand LoadCommand = new MySqlCommand("SELECT PK_DesignObjType,Description,Define,CanClick,ContainsText FROM DesignObjType", conn);
			LoadCommand.CommandType = CommandType.Text;
			if( trans!=null )
				LoadCommand.Transaction = trans;
