...
//	DCE Implemenation for #2255 YouTube Player
...
namespace DCE
{
	class YouTube_Player : public YouTube_Player_Command
	{
//<-dceag-decl-e->
...
public:
		...
		YouTube_Player(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL);
		virtual ~YouTube_Player();
...
//<-dceag-const2-b->
		...
		YouTube_Player(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter);
//<-dceag-const2-e->
