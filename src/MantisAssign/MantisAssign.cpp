...
int MantisAssign::DoIt(int iPK_DHCPDevice,int iPK_DeviceTemplate,string sIPAddress,string sMacAddress,int PK_Device_ControlledVia,string sDeviceData,int iPK_Device_RelatedTo,int iPK_Room)
{
	cerr << "MantisAssign::DoIt called with: iPK_DHCPDevice=" << iPK_DHCPDevice << "; iPK_DeviceTemplate=" << iPK_DeviceTemplate
...
void MantisAssign::CreateChildrenByCategory(int iPK_Device,int iPK_DeviceCategory)
{
...
void MantisAssign::CreateChildrenByTemplate(int iPK_Device,int iPK_DeviceTemplate)
{
	PlutoSqlResult result;
	MYSQL_ROW row;
...
void MantisAssign::ConfirmRelations(int PK_Device,bool bRecurseChildren,bool bOnlyAddDevicesOnCore)
{
...
int MantisAssign::FindControlledViaCandidate(int iPK_Device,int iPK_DeviceTemplate,int iPK_Device_RelatedTo)
{
...
int MantisAssign::FindControlledViaCandidate(int iPK_Device,int iPK_DeviceTemplate,int iPK_Device_RelatedTo,PlutoSqlResult &result)
{
	MYSQL_ROW row;
	map<int,int> mapDeviceTree;
...
void MantisAssign::AssignDeviceData(int PK_Device,int PK_DeviceData,string sValue)
{
