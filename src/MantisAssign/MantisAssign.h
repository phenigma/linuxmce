#ifndef MantisAssign_h
#define MantisAssign_h

#include "PlutoUtils/MySQLHelper.h"

class MantisAssign : public MySqlHelper
{
	int m_iPK_Installation;
public:
	bool m_bDontInstallPackages,m_bInstallPackagesInBackground;

	MantisAssign(int PK_Installation,string host, string user, string pass, string db_name, int port=3306) 
