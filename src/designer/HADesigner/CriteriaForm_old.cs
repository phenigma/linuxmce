...
namespace HADesigner
{
	...
	/// </summary>
	public class CriteriaForm_old : System.Windows.Forms.Form
	{
		...
		public CriteriaForm_old(CriteriaList criteriaList)
		{
		...
		public CriteriaForm_old(int intCriteria_DID)
		{
			m_CriteriaList = criteriaList;
			//m_NestingParameter = m_CriteriaList.m_NestingParameter;
			//
		...
		static void Main() 
		{
			...
			HADesignObjFilter haof = new HADesignObjFilter();
