...
#include "../../qOrbiter_src/datamodels/usermodel.h"
...
static const char qt_meta_stringdata_UserModel[] = {
    "UserModel\0\0handleItemChange()\0"
};
...
const QMetaObjectExtraData UserModel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject UserModel::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_UserModel,
      qt_meta_data_UserModel, &staticMetaObjectExtraData }
};
