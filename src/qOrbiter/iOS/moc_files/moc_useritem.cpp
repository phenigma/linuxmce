...
#include "../../qOrbiter_src/datamodels/useritem.h"
...
static const char qt_meta_stringdata_UserItem[] = {
    "UserItem\0\0imageChanged()\0"
};
...
const QMetaObjectExtraData UserItem::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject UserItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_UserItem,
      qt_meta_data_UserItem, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &UserItem::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UserItem))
