...
TelecomScenarioItem:: TelecomScenarioItem( const QString &name, const QString &label, const QString &parameter, const QString &scommand,  const QString &gotoScreen , QImage img, QObject *parent):
