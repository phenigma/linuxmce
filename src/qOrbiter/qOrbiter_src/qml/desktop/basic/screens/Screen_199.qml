...
Item {
	...
	function onActivate4735() 
	{
	 // Calling Command 741 (Goto Screen) with CommandGroup_Parameters from 16597
		setCurrentScreen("Screen_200.qml")
	}
	StyledText {
		x: 1444
	...
	ButtonSq {
		...
		clickHandler.onClicked: onActivate4735()
	}
