// UI1 Screen Get Capture Card Port (247)
...
Item {
	...
	function onActivate5328() 
	{
	 // Calling Command 741 (Goto Screen) with CommandGroup_Parameters from 17303
		manager.sendDceMessage(srouterip + " "+deviceid + " -300 1 741 159 \"245\" ")
	}
	StyledText {
		x: 1444
	...
	ButtonSq {
		...
		buttontext: "Done"
		clickHandler.onClicked: onActivate5328()
	}
	function onActivate5187() 
	{
	 // Calling Command 5 (Goto DesignObj) with CommandGroup_Parameters from 17307
		manager.sendDceMessage(srouterip + " "+deviceid + " -300 1 5 3 \"5332\" ")
	}
