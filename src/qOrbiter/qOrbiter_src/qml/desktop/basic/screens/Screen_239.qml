...
Item {
	...
	function onActivate5200() 
	{
	 // Calling Command 741 (Goto Screen) with CommandGroup_Parameters from 17221
		setCurrentScreen("Screen_236.qml")
	}
	StyledText {
		x: 1444
	...
	ButtonSq {
		...
		buttontext: "Next ->"
		clickHandler.onClicked: onActivate5200()
	}
