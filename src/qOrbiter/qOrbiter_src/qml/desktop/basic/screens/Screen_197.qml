...
Item {
	...
	function onActivate4598() 
	{
	 // Calling Command 5 (Goto DesignObj) with CommandGroup_Parameters from 17115
		manager.sendDceMessage(srouterip + " "+deviceid + " -300 1 5 3 \"5139\" ")
	}
	StyledText {
		x: 1444
		y: 755
		height: 211
		width: 237
		textLabel: "Yes, control my receiver"
	}
	ButtonSq {
		id: button4598_2280
		x: 1444
		...
		buttontext: "Yes, control my receiver"
		clickHandler.onClicked: onActivate4598()
	}
	function onActivate4686() 
	{
	 // Calling Command 741 (Goto Screen) with CommandGroup_Parameters from 16466
		manager.sendDceMessage(srouterip + " "+deviceid + " -300 1 741 159 \"201\" ")
	}
	StyledText {
		x: 1444
	...
	ButtonSq {
		...
		height: 158
		buttonbackground: "skins/Basic/Buttons/next.png"
		buttontext: "No receiver"
		clickHandler.onClicked: onActivate4686()
	}
}