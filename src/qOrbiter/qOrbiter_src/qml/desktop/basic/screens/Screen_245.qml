// UI1 Screen Choose Provider for Device (245)
...
Item {
	...
	function onActivate5329() 
	{
	 // Calling Command 741 (Goto Screen) with CommandGroup_Parameters from 17304
		manager.sendDceMessage(srouterip + " "+deviceid + " -300 1 741 159 \"239\" ")
	}
	StyledText {
		x: 1444
	...
	ButtonSq {
		...
		buttontext: "Done"
		clickHandler.onClicked: onActivate5329()
	}
	function onActivate5337() 
	{
	}
