...
Item {
	...
	function onActivate3450() 
	{
	 // Calling Command 103 (Random) with CommandGroup_Parameters from 18221
		manager.sendDceMessage(srouterip + " "+deviceid + " -106 1 103 ")
	}
	StyledText {
		x: 1680
		y: 720
	...
	ButtonSq {
		...
		buttontext: "Random"
		clickHandler.onClicked: onActivate3450()
	}
