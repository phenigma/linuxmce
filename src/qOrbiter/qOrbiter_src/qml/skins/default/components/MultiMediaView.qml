        ...
        states: [
            State {
                ...
                PropertyChanges {
                    ...
                    currentCellHeight:manager.isProfile ? appStyle.scaleX(18) : appStyle.scaleX(14)
            ...
            State {
                ...
                PropertyChanges {
                    ...
                    currentCellWidth:appStyle.scaleY(25) //manager.isProfile ? appStyle.scaleX(10) : appStyle.scaleX(14.25)
                }
            },
            State {
                name: "music-video"
