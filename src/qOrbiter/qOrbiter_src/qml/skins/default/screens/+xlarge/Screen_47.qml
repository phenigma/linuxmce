    ...
    Item{
        ...
        LargeStyledButton{
            ...
            Keys.onPressed: {
                ...
                case Qt.Key_Right:
                case Qt.Key_Up:
                case Qt.Key_Down:typeSelection.forceActiveFocus(); break;
                case Qt.Key_Enter:
                case Qt.Key_Go: attribfilter.setSelectionStatus("file"); innerContent.state="selection"
                }
            }
