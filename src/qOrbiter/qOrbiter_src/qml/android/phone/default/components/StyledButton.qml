...
Item{
    ...
    property string phil:useHandler ? dceHandler.item.pressed ? "yellow" : "black" :  fly_trap.pressed ? skinStyle.button_system_color_hover: skinStyle.button_system_color
