...
QtObject{
    ...
    //skin description
    property string skincreator: "Thomas Cherryhomes"
    property string skinname: "data"
    property string skindir: "data"
    property string skindescription: "Android skin compliant with HIG"
    property string skinversion: "1.0"
    property string skinvariation: "ASUS Transformer TF700T"
