// UI1 Screen Myth_playback recording (96)
...
Item {
	...
	function onActivate4286() 
	{
	 // Calling Command 28 (Simulate Keypress) with CommandGroup_Parameters from 15949
		manager.sendDceMessage(srouterip + " "+deviceid + " -304 1 28 26 \"153\" 50 \"O\" ")
	}
	ButtonSq {
		id: button4286_1225
		x: 1680
		...
		buttontext: ""
		clickHandler.onClicked: onActivate4286()
	}
	function onActivate4287() 
	{
	 // Calling Command 28 (Simulate Keypress) with CommandGroup_Parameters from 15955
		manager.sendDceMessage(srouterip + " "+deviceid + " -300 1 28 26 \"154\" 50 \"Pause/Play\" ")
	}
	ButtonSq {
		id: button4287_1226
		x: 1440
		...
		width: 240
		height: 180
		buttonbackground: "skins/Basic/Buttons/Media/pause.png"
		buttontext: ""
		clickHandler.onClicked: onActivate4287()
	}
