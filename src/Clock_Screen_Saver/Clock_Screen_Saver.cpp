...
Clock_Screen_Saver::Clock_Screen_Saver(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter)
	: Clock_Screen_Saver_Command(pPrimaryDeviceCommand, pData, pEvent, pRouter)
//<-dceag-const2-e->
{
}
...
//<-dceag-getconfig-b->
bool Clock_Screen_Saver::GetConfig()
{
	if( !Clock_Screen_Saver_Command::GetConfig() )
		return false;
//<-dceag-getconfig-e->
...
bool Clock_Screen_Saver::Register()
//<-dceag-reg-e->
{
...
//<-dceag-createinst-b->
Clock_Screen_Saver_Command *Create_Clock_Screen_Saver(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter)
{
	return new Clock_Screen_Saver(pPrimaryDeviceCommand, pData, pEvent, pRouter);
}
//<-dceag-createinst-e->
...
*/
//<-dceag-cmdch-b->
void Clock_Screen_Saver::ReceivedCommandForChild(DeviceData_Impl *pDeviceData_Impl,string &sCMD_Result,Message *pMessage)
//<-dceag-cmdch-e->
{
...
*/
//<-dceag-cmduk-b->
void Clock_Screen_Saver::ReceivedUnknownCommand(string &sCMD_Result,Message *pMessage)
//<-dceag-cmduk-e->
{
...
void Clock_Screen_Saver::SomeFunction()
{
