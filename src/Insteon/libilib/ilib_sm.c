/*
 * $RCSfile: ilib_sm.c,v $  $Revision: 1.1 $  $Name:  $
 * $Id: ilib_sm.c,v 1.1 2006/10/06 03:03:50 bpaauwe Exp $
 * $Author: bpaauwe $
 * $Date: 2006/10/06 03:03:50 $
 * ----------------------------------------------------------------------------
 *
...
ilib_t *ilib_open(int method, char *dev)
{
	...
	switch (method) {
		...
		case USE_SERIAL:
			...
			break;
		case USE_LIBHID:
			fprintf(stderr, "Method USE_LIBHID not supported in this build.\n");
			break;
		case USE_LIBUSB:
			fprintf(stderr, "Method USE_LIBUSB not supported in this build.\n");
			break;
		default:
