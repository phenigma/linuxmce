...
function Action_Ask() {
	...
	/usr/pluto/bin/MessageSend $DCERouter 0 $OrbiterIDList 1 741 159 53 9 "New updates available. Would you like to install them next time you start Linux MCE ?|Yes|No" 137 "$Action_Yes|$Action_No" || exit 1
}
