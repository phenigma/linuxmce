...
wVersion = MAKEWORD( 1, 1 );
    ...
    try
    {
        ...
        bAppError = qWebBrowser->setupLMCE(PK_Device);
            ...
            {
                    bAppError = true;
                    if( qWebBrowser->m_pBrowser->m_pEvent && qWebBrowser->m_pBrowser->m_pEvent->m_pClientSocket && qWebBrowser->m_pBrowser->m_pEvent->m_pClientSocket->m_eLastError==ClientSocket::cs_err_CannotConnect )
                    {
                            bAppError = false;
                            bReload = false;
            ...
            if( qWebBrowser->m_pBrowser->m_bReload )
                    bReload=true;
            delete qWebBrowser->m_pBrowser;
