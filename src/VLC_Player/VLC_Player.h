...
//	DCE Implemenation for #2302 VLC Player

#include "Gen_Devices/VLC_PlayerBase.h"
//<-dceag-d-e->
...
public:
		...
		VLC_Player(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL);
		virtual ~VLC_Player();
...
//<-dceag-const2-b->
		...
		VLC_Player(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter);
//<-dceag-const2-e->
