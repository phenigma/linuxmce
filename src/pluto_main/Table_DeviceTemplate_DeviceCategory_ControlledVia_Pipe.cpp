...
return m_FK_Pipe;}
long int Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::FK_Command_Input_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_FK_Command_Input;}
long int Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::FK_Command_Output_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
return m_ToChild;}
long int Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::psc_id_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_psc_id;}
long int Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::psc_batch_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_psc_batch;}
long int Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::psc_user_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_psc_user;}
short int Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::psc_frozen_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_psc_frozen;}
string Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::psc_mod_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::FK_Command_Input_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_FK_Command_Input = val; is_modified=true; is_null[2]=false;}
void Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::FK_Command_Output_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::psc_id_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_psc_id = val; is_modified=true; is_null[5]=false;}
void Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::psc_batch_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_psc_batch = val; is_modified=true; is_null[6]=false;}
void Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::psc_user_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_psc_user = val; is_modified=true; is_null[7]=false;}
void Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::psc_frozen_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_psc_frozen = val; is_modified=true; is_null[8]=false;}
void Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::psc_mod_set(string val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_psc_mod = val; is_modified=true; is_null[9]=false;}

		
bool Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::FK_Command_Input_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[2];}
bool Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::FK_Command_Output_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[3];}
bool Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::ToChild_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[4];}
bool Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::psc_id_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[5];}
bool Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::psc_batch_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[6];}
bool Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::psc_user_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[7];}
bool Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::psc_frozen_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return is_null[8];}

			
void Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::FK_Command_Input_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[2]=val;}
void Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::FK_Command_Output_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[3]=val;}
void Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::ToChild_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[4]=val;}
void Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::psc_id_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[5]=val;}
void Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::psc_batch_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[6]=val;}
void Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::psc_user_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

is_null[7]=val;}
void Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe::psc_frozen_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
