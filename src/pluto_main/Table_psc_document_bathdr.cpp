...
void Database_pluto_main::Commit_psc_document_bathdr(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow)
{
...
long int Row_psc_document_bathdr::PK_psc_document_bathdr_get(){PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_MySqlMutex);

return m_PK_psc_document_bathdr;}
string Row_psc_document_bathdr::IPAddress_get(){PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_MySqlMutex);

return m_IPAddress;}
string Row_psc_document_bathdr::date_get(){PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_MySqlMutex);

return m_date;}
string Row_psc_document_bathdr::comments_get(){PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_MySqlMutex);

return m_comments;}

		
void Row_psc_document_bathdr::PK_psc_document_bathdr_set(long int val){PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_MySqlMutex);

m_PK_psc_document_bathdr = val; is_modified=true; is_null[0]=false;}
void Row_psc_document_bathdr::IPAddress_set(string val){PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_MySqlMutex);

m_IPAddress = val; is_modified=true; is_null[1]=false;}
void Row_psc_document_bathdr::date_set(string val){PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_MySqlMutex);

m_date = val; is_modified=true; is_null[2]=false;}
void Row_psc_document_bathdr::comments_set(string val){PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_MySqlMutex);

m_comments = val; is_modified=true; is_null[3]=false;}

		
bool Row_psc_document_bathdr::IPAddress_isNull() {PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_MySqlMutex);

return is_null[1];}
bool Row_psc_document_bathdr::date_isNull() {PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_MySqlMutex);

return is_null[2];}
bool Row_psc_document_bathdr::comments_isNull() {PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_MySqlMutex);

return is_null[3];}

			
void Row_psc_document_bathdr::IPAddress_setNull(bool val){PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_MySqlMutex);
is_null[1]=val;
is_modified=true;
}
void Row_psc_document_bathdr::date_setNull(bool val){PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_MySqlMutex);
is_null[2]=val;
is_modified=true;
}
void Row_psc_document_bathdr::comments_setNull(bool val){PLUTO_SAFETY_LOCK_ERRORSONLY(sl,table->database->m_MySqlMutex);
is_null[3]=val;
is_modified=true;
}
