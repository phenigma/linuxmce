...
class DECLSPECIFIER Table_Device_DeviceData : public TableBase , DoubleLongKeyBase
{
private:
...
class DECLSPECIFIER Row_Device_DeviceData : public TableRow, public SerializeClass
	{
