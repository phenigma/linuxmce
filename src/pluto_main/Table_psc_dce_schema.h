...
class DECLSPECIFIER Table_psc_dce_schema : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_psc_dce_schema(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
class DECLSPECIFIER Row_psc_dce_schema : public TableRow, public SerializeClass
	{
