...
class DECLSPECIFIER Table_Schema : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_Schema(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
	~Table_Schema();
...
class DECLSPECIFIER Row_Schema : public TableRow, public SerializeClass
	{
