...
class DECLSPECIFIER Table_Command_CommandParameter : public TableBase , DoubleLongKeyBase
{
private:
...
public:
	Table_Command_CommandParameter(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
class DECLSPECIFIER Row_Command_CommandParameter : public TableRow, public SerializeClass
	{
