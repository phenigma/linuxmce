...
Commit_Array(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Broadcast* tblBroadcast;
Commit_Broadcast(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Button* tblButton;
Commit_Button(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_CachedScreens* tblCachedScreens;
Commit_CachedScreens(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_CannedEvents* tblCannedEvents;
Commit_CannedEvents(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_CannedEvents_CriteriaParmList* tblCannedEvents_CriteriaParmList;
Commit_CannedEvents_CriteriaParmList(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_City* tblCity;
Commit_City(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_CommMethod* tblCommMethod;
Commit_CommMethod(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Command* tblCommand;
Commit_Command(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_CommandCategory* tblCommandCategory;
Commit_CommandCategory(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_CommandGroup* tblCommandGroup;
Commit_CommandGroup(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_CommandGroup_Command* tblCommandGroup_Command;
Commit_CommandGroup_Command(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_CommandGroup_Command_CommandParameter* tblCommandGroup_Command_CommandParameter;
Commit_CommandGroup_Command_CommandParameter(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_CommandGroup_D* tblCommandGroup_D;
Commit_CommandGroup_D(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_CommandGroup_D_Command* tblCommandGroup_D_Command;
Commit_CommandGroup_D_Command(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_CommandGroup_D_Command_CommandParameter* tblCommandGroup_D_Command_CommandParameter;
Commit_CommandGroup_D_Command_CommandParameter(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_CommandGroup_EntertainArea* tblCommandGroup_EntertainArea;
Commit_CommandGroup_EntertainArea(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_CommandGroup_Room* tblCommandGroup_Room;
Commit_CommandGroup_Room(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_CommandParameter* tblCommandParameter;
Commit_CommandParameter(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Command_CommandParameter* tblCommand_CommandParameter;
Commit_Command_CommandParameter(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Command_Pipe* tblCommand_Pipe;
Commit_Command_Pipe(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_ConfigType* tblConfigType;
Commit_ConfigType(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_ConfigType_File* tblConfigType_File;
Commit_ConfigType_File(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_ConfigType_Setting* tblConfigType_Setting;
Commit_ConfigType_Setting(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_ConfigType_Token* tblConfigType_Token;
Commit_ConfigType_Token(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_ConnectorType* tblConnectorType;
Commit_ConnectorType(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Country* tblCountry;
Commit_Country(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Criteria* tblCriteria;
Commit_Criteria(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_CriteriaList* tblCriteriaList;
Commit_CriteriaList(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_CriteriaList_CriteriaParmList* tblCriteriaList_CriteriaParmList;
Commit_CriteriaList_CriteriaParmList(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_CriteriaParm* tblCriteriaParm;
Commit_CriteriaParm(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_CriteriaParmList* tblCriteriaParmList;
Commit_CriteriaParmList(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_CriteriaParmNesting* tblCriteriaParmNesting;
Commit_CriteriaParmNesting(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DHCPDevice* tblDHCPDevice;
Commit_DHCPDevice(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DHCPDevice_DeviceData* tblDHCPDevice_DeviceData;
Commit_DHCPDevice_DeviceData(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DataGrid* tblDataGrid;
Commit_DataGrid(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DesignObj* tblDesignObj;
Commit_DesignObj(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DesignObjCategory* tblDesignObjCategory;
Commit_DesignObjCategory(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DesignObjParameter* tblDesignObjParameter;
Commit_DesignObjParameter(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DesignObjType* tblDesignObjType;
Commit_DesignObjType(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DesignObjType_DesignObjParameter* tblDesignObjType_DesignObjParameter;
Commit_DesignObjType_DesignObjParameter(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DesignObjVariation* tblDesignObjVariation;
Commit_DesignObjVariation(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DesignObjVariation_DesignObj* tblDesignObjVariation_DesignObj;
Commit_DesignObjVariation_DesignObj(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DesignObjVariation_DesignObjParameter* tblDesignObjVariation_DesignObjParameter;
Commit_DesignObjVariation_DesignObjParameter(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DesignObjVariation_Text* tblDesignObjVariation_Text;
Commit_DesignObjVariation_Text(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DesignObjVariation_Text_Skin_Language* tblDesignObjVariation_Text_Skin_Language;
Commit_DesignObjVariation_Text_Skin_Language(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DesignObjVariation_Zone* tblDesignObjVariation_Zone;
Commit_DesignObjVariation_Zone(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Device* tblDevice;
Commit_Device(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceCategory* tblDeviceCategory;
Commit_DeviceCategory(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceCategory_DeviceData* tblDeviceCategory_DeviceData;
Commit_DeviceCategory_DeviceData(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceCategory_Event* tblDeviceCategory_Event;
Commit_DeviceCategory_Event(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceCommandGroup* tblDeviceCommandGroup;
Commit_DeviceCommandGroup(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceCommandGroup_Command* tblDeviceCommandGroup_Command;
Commit_DeviceCommandGroup_Command(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceCommandGroup_DeviceCommandGroup_Parent* tblDeviceCommandGroup_DeviceCommandGroup_Parent;
Commit_DeviceCommandGroup_DeviceCommandGroup_Parent(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceData* tblDeviceData;
Commit_DeviceData(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceGroup* tblDeviceGroup;
Commit_DeviceGroup(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceTemplate* tblDeviceTemplate;
Commit_DeviceTemplate(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceTemplate_AV* tblDeviceTemplate_AV;
Commit_DeviceTemplate_AV(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceTemplate_DSPMode* tblDeviceTemplate_DSPMode;
Commit_DeviceTemplate_DSPMode(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceTemplate_DesignObj* tblDeviceTemplate_DesignObj;
Commit_DeviceTemplate_DesignObj(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceTemplate_DeviceCategory_ControlledVia* tblDeviceTemplate_DeviceCategory_ControlledVia;
Commit_DeviceTemplate_DeviceCategory_ControlledVia(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceTemplate_DeviceCategory_ControlledVia_Pipe* tblDeviceTemplate_DeviceCategory_ControlledVia_Pipe;
Commit_DeviceTemplate_DeviceCategory_ControlledVia_Pipe(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceTemplate_DeviceCommandGroup* tblDeviceTemplate_DeviceCommandGroup;
Commit_DeviceTemplate_DeviceCommandGroup(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceTemplate_DeviceData* tblDeviceTemplate_DeviceData;
Commit_DeviceTemplate_DeviceData(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceTemplate_DeviceTemplate_ControlledVia* tblDeviceTemplate_DeviceTemplate_ControlledVia;
Commit_DeviceTemplate_DeviceTemplate_ControlledVia(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe* tblDeviceTemplate_DeviceTemplate_ControlledVia_Pipe;
Commit_DeviceTemplate_DeviceTemplate_ControlledVia_Pipe(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceTemplate_DeviceTemplate_Related* tblDeviceTemplate_DeviceTemplate_Related;
Commit_DeviceTemplate_DeviceTemplate_Related(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceTemplate_Event* tblDeviceTemplate_Event;
Commit_DeviceTemplate_Event(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceTemplate_InfraredGroup* tblDeviceTemplate_InfraredGroup;
Commit_DeviceTemplate_InfraredGroup(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceTemplate_Input* tblDeviceTemplate_Input;
Commit_DeviceTemplate_Input(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceTemplate_MediaType* tblDeviceTemplate_MediaType;
Commit_DeviceTemplate_MediaType(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceTemplate_MediaType_DesignObj* tblDeviceTemplate_MediaType_DesignObj;
Commit_DeviceTemplate_MediaType_DesignObj(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceTemplate_Output* tblDeviceTemplate_Output;
Commit_DeviceTemplate_Output(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_DeviceTemplate_PageSetup* tblDeviceTemplate_PageSetup;
Commit_DeviceTemplate_PageSetup(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Device_Command* tblDevice_Command;
Commit_Device_Command(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Device_CommandGroup* tblDevice_CommandGroup;
Commit_Device_CommandGroup(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Device_DeviceData* tblDevice_DeviceData;
Commit_Device_DeviceData(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Device_DeviceGroup* tblDevice_DeviceGroup;
Commit_Device_DeviceGroup(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Device_Device_Pipe* tblDevice_Device_Pipe;
Commit_Device_Device_Pipe(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Device_Device_Related* tblDevice_Device_Related;
Commit_Device_Device_Related(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Device_EntertainArea* tblDevice_EntertainArea;
Commit_Device_EntertainArea(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Device_HouseMode* tblDevice_HouseMode;
Commit_Device_HouseMode(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Device_MRU* tblDevice_MRU;
Commit_Device_MRU(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Device_Orbiter* tblDevice_Orbiter;
Commit_Device_Orbiter(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Device_QuickStart* tblDevice_QuickStart;
Commit_Device_QuickStart(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Device_StartupScript* tblDevice_StartupScript;
Commit_Device_StartupScript(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Device_Users* tblDevice_Users;
Commit_Device_Users(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Direction* tblDirection;
Commit_Direction(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Directory* tblDirectory;
Commit_Directory(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Distro* tblDistro;
Commit_Distro(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Document* tblDocument;
Commit_Document(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Document_Comment* tblDocument_Comment;
Commit_Document_Comment(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_EntertainArea* tblEntertainArea;
Commit_EntertainArea(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Event* tblEvent;
Commit_Event(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_EventCategory* tblEventCategory;
Commit_EventCategory(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_EventHandler* tblEventHandler;
Commit_EventHandler(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_EventParameter* tblEventParameter;
Commit_EventParameter(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Event_EventParameter* tblEvent_EventParameter;
Commit_Event_EventParameter(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_FAQ* tblFAQ;
Commit_FAQ(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Firewall* tblFirewall;
Commit_Firewall(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Floorplan* tblFloorplan;
Commit_Floorplan(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_FloorplanObjectType* tblFloorplanObjectType;
Commit_FloorplanObjectType(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_FloorplanObjectType_Color* tblFloorplanObjectType_Color;
Commit_FloorplanObjectType_Color(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_FloorplanType* tblFloorplanType;
Commit_FloorplanType(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_HorizAlignment* tblHorizAlignment;
Commit_HorizAlignment(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_HouseMode* tblHouseMode;
Commit_HouseMode(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Household* tblHousehold;
Commit_Household(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Household_Installation* tblHousehold_Installation;
Commit_Household_Installation(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Icon* tblIcon;
Commit_Icon(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Image* tblImage;
Commit_Image(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_InfraredGroup* tblInfraredGroup;
Commit_InfraredGroup(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_InfraredGroup_Command* tblInfraredGroup_Command;
Commit_InfraredGroup_Command(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_InfraredGroup_Command_Preferred* tblInfraredGroup_Command_Preferred;
Commit_InfraredGroup_Command_Preferred(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_InstallWizard* tblInstallWizard;
Commit_InstallWizard(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_InstallWizard_Distro* tblInstallWizard_Distro;
Commit_InstallWizard_Distro(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Installation* tblInstallation;
Commit_Installation(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Installation_RepositorySource_URL* tblInstallation_RepositorySource_URL;
Commit_Installation_RepositorySource_URL(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Installation_Users* tblInstallation_Users;
Commit_Installation_Users(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Language* tblLanguage;
Commit_Language(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_License* tblLicense;
Commit_License(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Licensing* tblLicensing;
Commit_Licensing(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Manufacturer* tblManufacturer;
Commit_Manufacturer(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_MediaType* tblMediaType;
Commit_MediaType(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_MediaType_Broadcast* tblMediaType_Broadcast;
Commit_MediaType_Broadcast(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_MediaType_DesignObj* tblMediaType_DesignObj;
Commit_MediaType_DesignObj(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_News* tblNews;
Commit_News(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_OperatingSystem* tblOperatingSystem;
Commit_OperatingSystem(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Orbiter* tblOrbiter;
Commit_Orbiter(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Orbiter_Users_PasswordReq* tblOrbiter_Users_PasswordReq;
Commit_Orbiter_Users_PasswordReq(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Orbiter_Variable* tblOrbiter_Variable;
Commit_Orbiter_Variable(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Package* tblPackage;
Commit_Package(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_PackageType* tblPackageType;
Commit_PackageType(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Package_Compat* tblPackage_Compat;
Commit_Package_Compat(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Package_Device* tblPackage_Device;
Commit_Package_Device(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Package_Directory* tblPackage_Directory;
Commit_Package_Directory(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Package_Directory_File* tblPackage_Directory_File;
Commit_Package_Directory_File(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Package_Package* tblPackage_Package;
Commit_Package_Package(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Package_Source* tblPackage_Source;
Commit_Package_Source(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Package_Source_Compat* tblPackage_Source_Compat;
Commit_Package_Source_Compat(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Package_Users* tblPackage_Users;
Commit_Package_Users(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Package_Version* tblPackage_Version;
Commit_Package_Version(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_PageSetup* tblPageSetup;
Commit_PageSetup(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_PaidLicense* tblPaidLicense;
Commit_PaidLicense(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_ParameterType* tblParameterType;
Commit_ParameterType(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_PhoneLineType* tblPhoneLineType;
Commit_PhoneLineType(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Pipe* tblPipe;
Commit_Pipe(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_QuickStartCategory* tblQuickStartCategory;
Commit_QuickStartCategory(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_QuickStartTemplate* tblQuickStartTemplate;
Commit_QuickStartTemplate(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Region* tblRegion;
Commit_Region(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_RemoteControl* tblRemoteControl;
Commit_RemoteControl(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_RemoteMapping* tblRemoteMapping;
Commit_RemoteMapping(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_RepositorySource* tblRepositorySource;
Commit_RepositorySource(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_RepositorySource_URL* tblRepositorySource_URL;
Commit_RepositorySource_URL(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_RepositoryType* tblRepositoryType;
Commit_RepositoryType(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Room* tblRoom;
Commit_Room(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_RoomType* tblRoomType;
Commit_RoomType(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Room_Users* tblRoom_Users;
Commit_Room_Users(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Schema* tblSchema;
Commit_Schema(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_SetupStep* tblSetupStep;
Commit_SetupStep(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Size* tblSize;
Commit_Size(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Skin* tblSkin;
Commit_Skin(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_StabilityStatus* tblStabilityStatus;
Commit_StabilityStatus(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_StartupScript* tblStartupScript;
Commit_StartupScript(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Style* tblStyle;
Commit_Style(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_StyleVariation* tblStyleVariation;
Commit_StyleVariation(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_System* tblSystem;
Commit_System(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Template* tblTemplate;
Commit_Template(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Text* tblText;
Commit_Text(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_TextCategory* tblTextCategory;
Commit_TextCategory(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Text_LS* tblText_LS;
Commit_Text_LS(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Text_LS_AltVersions* tblText_LS_AltVersions;
Commit_Text_LS_AltVersions(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_UI* tblUI;
Commit_UI(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_UnknownDevices* tblUnknownDevices;
Commit_UnknownDevices(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_UserMode* tblUserMode;
Commit_UserMode(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Users* tblUsers;
Commit_Users(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Variable* tblVariable;
Commit_Variable(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_Version* tblVersion;
Commit_Version(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_VertAlignment* tblVertAlignment;
Commit_VertAlignment(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_constants_batdet* tblpsc_constants_batdet;
Commit_psc_constants_batdet(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_constants_bathdr* tblpsc_constants_bathdr;
Commit_psc_constants_bathdr(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_constants_batuser* tblpsc_constants_batuser;
Commit_psc_constants_batuser(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_constants_repset* tblpsc_constants_repset;
Commit_psc_constants_repset(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_constants_schema* tblpsc_constants_schema;
Commit_psc_constants_schema(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_constants_tables* tblpsc_constants_tables;
Commit_psc_constants_tables(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_dce_batdet* tblpsc_dce_batdet;
Commit_psc_dce_batdet(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_dce_bathdr* tblpsc_dce_bathdr;
Commit_psc_dce_bathdr(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_dce_batuser* tblpsc_dce_batuser;
Commit_psc_dce_batuser(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_dce_repset* tblpsc_dce_repset;
Commit_psc_dce_repset(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_dce_schema* tblpsc_dce_schema;
Commit_psc_dce_schema(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_dce_tables* tblpsc_dce_tables;
Commit_psc_dce_tables(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_designer_batdet* tblpsc_designer_batdet;
Commit_psc_designer_batdet(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_designer_bathdr* tblpsc_designer_bathdr;
Commit_psc_designer_bathdr(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_designer_batuser* tblpsc_designer_batuser;
Commit_psc_designer_batuser(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_designer_repset* tblpsc_designer_repset;
Commit_psc_designer_repset(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_designer_schema* tblpsc_designer_schema;
Commit_psc_designer_schema(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_designer_tables* tblpsc_designer_tables;
Commit_psc_designer_tables(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_document_batdet* tblpsc_document_batdet;
Commit_psc_document_batdet(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_document_bathdr* tblpsc_document_bathdr;
Commit_psc_document_bathdr(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_document_batuser* tblpsc_document_batuser;
Commit_psc_document_batuser(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_document_repset* tblpsc_document_repset;
Commit_psc_document_repset(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_document_schema* tblpsc_document_schema;
Commit_psc_document_schema(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_document_tables* tblpsc_document_tables;
Commit_psc_document_tables(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_ir_batdet* tblpsc_ir_batdet;
Commit_psc_ir_batdet(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_ir_bathdr* tblpsc_ir_bathdr;
Commit_psc_ir_bathdr(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_ir_batuser* tblpsc_ir_batuser;
Commit_psc_ir_batuser(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_ir_repset* tblpsc_ir_repset;
Commit_psc_ir_repset(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_ir_schema* tblpsc_ir_schema;
Commit_psc_ir_schema(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_ir_tables* tblpsc_ir_tables;
Commit_psc_ir_tables(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_local_batdet* tblpsc_local_batdet;
Commit_psc_local_batdet(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_local_bathdr* tblpsc_local_bathdr;
Commit_psc_local_bathdr(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_local_batuser* tblpsc_local_batuser;
Commit_psc_local_batuser(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_local_repset* tblpsc_local_repset;
Commit_psc_local_repset(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_local_schema* tblpsc_local_schema;
Commit_psc_local_schema(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_local_tables* tblpsc_local_tables;
Commit_psc_local_tables(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_website_batdet* tblpsc_website_batdet;
Commit_psc_website_batdet(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_website_bathdr* tblpsc_website_bathdr;
Commit_psc_website_bathdr(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_website_batuser* tblpsc_website_batuser;
Commit_psc_website_batuser(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_website_repset* tblpsc_website_repset;
Commit_psc_website_repset(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_website_schema* tblpsc_website_schema;
Commit_psc_website_schema(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
class Table_psc_website_tables* tblpsc_website_tables;
Commit_psc_website_tables(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow);
public:
