...
class DECLSPECIFIER Table_psc_document_repset : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_psc_document_repset(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
class DECLSPECIFIER Row_psc_document_repset : public TableRow, public SerializeClass
	{
