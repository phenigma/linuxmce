...
class DECLSPECIFIER Table_psc_document_bathdr : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_psc_document_bathdr(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
class DECLSPECIFIER Row_psc_document_bathdr : public TableRow, public SerializeClass
	{
...
void comments_setNull(bool val);
		...
		void psc_document_batdet_FK_psc_document_bathdr_getrows(vector <class Row_psc_document_batdet*> *rows);
void psc_document_batdet_FK_psc_document_bathdr_orig_getrows(vector <class Row_psc_document_batdet*> *rows);
void psc_document_batdet_FK_psc_document_bathdr_auth_getrows(vector <class Row_psc_document_batdet*> *rows);
void psc_document_batdet_FK_psc_document_bathdr_unauth_getrows(vector <class Row_psc_document_batdet*> *rows);
void psc_document_batuser_FK_psc_document_bathdr_getrows(vector <class Row_psc_document_batuser*> *rows);


		// Setup binary serialization
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_PK_psc_document_bathdr+ m_IPAddress+ m_date+ m_comments;
		}
	private:
