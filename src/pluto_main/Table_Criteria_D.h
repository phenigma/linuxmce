...
class DECLSPECIFIER Table_Criteria_D : public TableBase , SingleLongKeyBase
{
private:
...
class DECLSPECIFIER Row_Criteria_D : public TableRow, public SerializeClass
	{
...
void StyleVariation_FK_Criteria_D_getrows(vector <class Row_StyleVariation*> *rows);
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_PK_Criteria_D+ m_FK_CriteriaParmNesting_D+ m_FK_CriteriaList+ m_Description+ m_Define+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod+ m_psc_restrict;
		}
	private:
