...
class DECLSPECIFIER Table_FloorplanObjectType_Color : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_FloorplanObjectType_Color(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
class DECLSPECIFIER Row_FloorplanObjectType_Color : public TableRow, public SerializeClass
	{
...
void psc_restrict_setNull(bool val);
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_PK_FloorplanObjectType_Color+ m_FK_FloorplanObjectType+ m_Description+ m_Define+ m_Color+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod+ m_psc_restrict;
		}
	private:
