...
class DECLSPECIFIER Table_psc_dce_batdet : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_psc_dce_batdet(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
class DECLSPECIFIER Row_psc_dce_batdet : public TableRow, public SerializeClass
	{
...
long int m_Deleted;
long int m_Modified;
long int m_FK_psc_dce_bathdr_orig;
long int m_FK_psc_dce_bathdr_auth;
long int m_FK_psc_dce_bathdr_unauth;
...
long int FK_psc_dce_bathdr_orig_get();
long int FK_psc_dce_bathdr_auth_get();
long int FK_psc_dce_bathdr_unauth_get();
...
void FK_psc_dce_bathdr_orig_set(long int val);
void FK_psc_dce_bathdr_auth_set(long int val);
...
class Row_psc_dce_bathdr* FK_psc_dce_bathdr_orig_getrow();
class Row_psc_dce_bathdr* FK_psc_dce_bathdr_auth_getrow();
class Row_psc_dce_bathdr* FK_psc_dce_bathdr_unauth_getrow();
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_PK_psc_dce_batdet+ m_FK_psc_dce_bathdr+ m_Tablename+ m_New+ m_Deleted+ m_Modified+ m_FK_psc_dce_bathdr_orig+ m_FK_psc_dce_bathdr_auth+ m_FK_psc_dce_bathdr_unauth;
		}
	private:
...
string FK_psc_dce_bathdr_orig_asSQL();
string FK_psc_dce_bathdr_auth_asSQL();
string FK_psc_dce_bathdr_unauth_asSQL();
