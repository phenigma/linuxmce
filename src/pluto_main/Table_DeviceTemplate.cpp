...
mysql_real_escape_string(table->database->m_pMySQL, buf, m_CommandLine.c_str(), (unsigned long) m_CommandLine.size());
string s=string()+"\""+buf+"\"";
delete buf;
return s;
}
...
mysql_real_escape_string(table->database->m_pMySQL, buf, m_DestinationDir.c_str(), (unsigned long) m_DestinationDir.size());
string s=string()+"\""+buf+"\"";
delete buf;
return s;
}
...
char *buf = new char[201];
mysql_real_escape_string(table->database->m_pMySQL, buf, m_ConfigureScript.c_str(), (unsigned long) m_ConfigureScript.size());
string s=string()+"\""+buf+"\"";
delete buf;
return s;
}
...
char *buf = new char[201];
mysql_real_escape_string(table->database->m_pMySQL, buf, m_ManufacturerURL.c_str(), (unsigned long) m_ManufacturerURL.size());
string s=string()+"\""+buf+"\"";
delete buf;
return s;
}
...
char *buf = new char[101];
mysql_real_escape_string(table->database->m_pMySQL, buf, m_InternalURLSuffix.c_str(), (unsigned long) m_InternalURLSuffix.size());
string s=string()+"\""+buf+"\"";
delete buf;
return s;
}
