...
class DLL_EXPORT Table_Event_EventParameter : public TableBase , DoubleLongKeyBase
{
private:
...
class Row_EventParameter* FK_EventParameter_getrow();
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_FK_Event+ m_FK_EventParameter+ m_Description+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod;
		}
	private:
