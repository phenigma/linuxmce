...
class DECLSPECIFIER Table_Device_EntertainArea : public TableBase , DoubleLongKeyBase
{
private:
...
class DECLSPECIFIER Row_Device_EntertainArea : public TableRow, public SerializeClass
	{
