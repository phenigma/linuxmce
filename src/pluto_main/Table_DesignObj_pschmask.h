...
#ifndef __Table_DesignObj_pschmask_H__
#define __Table_DesignObj_pschmask_H__

#include "TableRow.h"
#include "Database_pluto_main.h"
#include "PlutoUtils/MultiThreadIncludes.h"
#include "Define_DesignObj_pschmask.h"
...
class DECLSPECIFIER Table_DesignObj_pschmask : public TableBase , DoubleLongKeyBase
{
private:
...
public:
	Table_DesignObj_pschmask(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
	~Table_DesignObj_pschmask();

private:		
	friend class Row_DesignObj_pschmask;
	struct Key
	{
		friend class Row_DesignObj_pschmask;
		long int pk_psc_id;
long int pk_psc_batch;
		...
		Key(class Row_DesignObj_pschmask *pRow);
	};
	struct Key_Less
	{			
		bool operator()(const Table_DesignObj_pschmask::Key &key1, const Table_DesignObj_pschmask::Key &key2) const;
	};	
...
public:				
	...
	bool GetRows(string where_statement,vector<class Row_DesignObj_pschmask*> *rows);
	class Row_DesignObj_pschmask* AddRow();
	Database_pluto_main *Database_pluto_main_get() { return database; }
	
		
	class Row_DesignObj_pschmask* GetRow(long int in_psc_id, long int in_psc_batch);
	

private:	
	
		
	class Row_DesignObj_pschmask* FetchRow(DoubleLongKey &key);
		
			
};

class DECLSPECIFIER Row_DesignObj_pschmask : public TableRow, public SerializeClass
	{
		friend struct Table_DesignObj_pschmask::Key;
		friend class Table_DesignObj_pschmask;
	private:
		Table_DesignObj_pschmask *table;
		
		short int m_PK_DesignObj;
short int m_Description;
short int m_Define;
short int m_FK_DesignObjType;
short int m_FK_DesignObjCategory;
short int m_FK_DesignObj_IncludeIfOtherIncluded;
...
short int m_FK_DesignObj_SubstForSkin;
short int m_FK_Skin_SubstForSkin;
long int m_psc_id;
...
long int m_psc_restrict;
	...
	public:
		short int PK_DesignObj_get();
short int Description_get();
short int Define_get();
short int FK_DesignObjType_get();
short int FK_DesignObjCategory_get();
short int FK_DesignObj_IncludeIfOtherIncluded_get();
...
short int FK_DesignObj_SubstForSkin_get();
short int FK_Skin_SubstForSkin_get();
long int psc_id_get();
...
long int psc_restrict_get();
		...
		void PK_DesignObj_set(short int val);
void Description_set(short int val);
void Define_set(short int val);
void FK_DesignObjType_set(short int val);
void FK_DesignObjCategory_set(short int val);
void FK_DesignObj_IncludeIfOtherIncluded_set(short int val);
...
void FK_DesignObj_SubstForSkin_set(short int val);
void FK_Skin_SubstForSkin_set(short int val);
...
bool KeepGraphicInCache_isNull();
...
bool CanGoBackToSameScreen_isNull();
...
void KeepGraphicInCache_setNull(bool val);
...
void CanGoBackToSameScreen_setNull(bool val);
...
void psc_restrict_setNull(bool val);
		...
		Row_DesignObj_pschmask(Table_DesignObj_pschmask *pTable);
	
		bool IsDeleted(){return is_deleted;};
		bool IsModified(){return is_modified;};			
		class Table_DesignObj_pschmask *Table_DesignObj_pschmask_get() { return table; };
