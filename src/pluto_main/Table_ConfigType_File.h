...
class DECLSPECIFIER Table_ConfigType_File : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_ConfigType_File(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
private:	
	...
	class Row_ConfigType_File* FetchRow(SingleLongKey &key);
		
			
};

class DECLSPECIFIER Row_ConfigType_File : public TableRow, public SerializeClass
	{
...
void ConfigType_Token_pschist_FK_ConfigType_File_getrows(vector <class Row_ConfigType_Token_pschist*> *rows);
void ConfigType_Token_pschmask_FK_ConfigType_File_getrows(vector <class Row_ConfigType_Token_pschmask*> *rows);
