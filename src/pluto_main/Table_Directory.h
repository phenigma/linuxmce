...
class DECLSPECIFIER Table_Directory : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_Directory(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
	~Table_Directory();
...
class DECLSPECIFIER Row_Directory : public TableRow, public SerializeClass
	{
