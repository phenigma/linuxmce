...
return m_FK_Event;}
long int Row_EventHandler::TimedEvent_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Row_EventHandler::TimedEvent_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
return is_null[1];}
bool Row_EventHandler::TimedEvent_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
is_null[1]=val;}
void Row_EventHandler::TimedEvent_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
