...
CreateTable_DHCPDevice();
CreateTable_DHCPDevice_DeviceData();
...
CreateTable_InfraredGroup_Command();
CreateTable_InfraredGroup_Command_Preferred();
...
CreateTable_MediaType_DesignObj();
CreateTable_News();
...
CreateTable_psc_constants_batuser();
...
CreateTable_psc_designer_batuser();
...
CreateTable_psc_document_batuser();
...
CreateTable_psc_website_batuser();
