...
class DECLSPECIFIER Table_DeviceCategory_Event : public TableBase , DoubleLongKeyBase
{
private:
...
public:
	Table_DeviceCategory_Event(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
class DECLSPECIFIER Row_DeviceCategory_Event : public TableRow, public SerializeClass
	{
