...
class DLL_EXPORT Table_psc_constants_batuser : public TableBase , SingleLongKeyBase
{
private:
...
public:
	...
	Table_psc_constants_batuser(Database_pluto_main *pDatabase):database(pDatabase), m_Mutex("psc_constants_batuser")
	{
...
class DLL_EXPORT Row_psc_constants_batuser : public TableRow, public SerializeClass
	{
