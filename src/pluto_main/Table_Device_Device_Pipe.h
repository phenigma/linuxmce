...
class DECLSPECIFIER Table_Device_Device_Pipe : public TableBase , TripleLongKeyBase
{
private:
...
public:
	Table_Device_Device_Pipe(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
class DECLSPECIFIER Row_Device_Device_Pipe : public TableRow, public SerializeClass
	{
