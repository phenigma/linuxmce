...
#ifndef __Table_DeviceTemplate_pschist_H__
#define __Table_DeviceTemplate_pschist_H__

#include "TableRow.h"
#include "Database_pluto_main.h"
#include "PlutoUtils/MultiThreadIncludes.h"
#include "Define_DeviceTemplate_pschist.h"
...
class DECLSPECIFIER Table_DeviceTemplate_pschist : public TableBase , DoubleLongKeyBase
{
private:
...
public:
	Table_DeviceTemplate_pschist(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
	~Table_DeviceTemplate_pschist();

private:		
	friend class Row_DeviceTemplate_pschist;
	struct Key
	{
		friend class Row_DeviceTemplate_pschist;
		long int pk_psc_id;
long int pk_psc_batch;
		...
		Key(class Row_DeviceTemplate_pschist *pRow);
	};
	struct Key_Less
	{			
		bool operator()(const Table_DeviceTemplate_pschist::Key &key1, const Table_DeviceTemplate_pschist::Key &key2) const;
	};	
...
public:				
	...
	bool GetRows(string where_statement,vector<class Row_DeviceTemplate_pschist*> *rows);
	class Row_DeviceTemplate_pschist* AddRow();
	Database_pluto_main *Database_pluto_main_get() { return database; }
	
		
	class Row_DeviceTemplate_pschist* GetRow(long int in_psc_id, long int in_psc_batch);
	

private:	
	
		
	class Row_DeviceTemplate_pschist* FetchRow(DoubleLongKey &key);
		
			
};

class DECLSPECIFIER Row_DeviceTemplate_pschist : public TableRow, public SerializeClass
	{
		friend struct Table_DeviceTemplate_pschist::Key;
		friend class Table_DeviceTemplate_pschist;
	private:
		Table_DeviceTemplate_pschist *table;
...
void FK_PnpLevel_set(short int val);
...
void FK_Document_setNull(bool val);
		...
		Row_DeviceTemplate_pschist(Table_DeviceTemplate_pschist *pTable);
	
		bool IsDeleted(){return is_deleted;};
		bool IsModified(){return is_modified;};			
		class Table_DeviceTemplate_pschist *Table_DeviceTemplate_pschist_get() { return table; };
