#ifndef __Table_CannedEvents_CriteriaParmList_H__
#define __Table_CannedEvents_CriteriaParmList_H__
...
class DECLSPECIFIER Table_CannedEvents_CriteriaParmList : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_CannedEvents_CriteriaParmList(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
	~Table_CannedEvents_CriteriaParmList();

private:		
	friend class Row_CannedEvents_CriteriaParmList;
	struct Key
	{
		friend class Row_CannedEvents_CriteriaParmList;
		long int pk_PK_CannedEvents_CriteriaParmList;

		
		Key(long int in_PK_CannedEvents_CriteriaParmList);
	
		Key(class Row_CannedEvents_CriteriaParmList *pRow);
	};
	struct Key_Less
	{			
...
public:				
	bool Commit();
	bool GetRows(string where_statement,vector<class Row_CannedEvents_CriteriaParmList*> *rows);
	class Row_CannedEvents_CriteriaParmList* AddRow();
	Database_pluto_main *Database_pluto_main_get() { return database; }
	
		
	class Row_CannedEvents_CriteriaParmList* GetRow(long int in_PK_CannedEvents_CriteriaParmList);
...
class DECLSPECIFIER Row_CannedEvents_CriteriaParmList : public TableRow, public SerializeClass
	{
		friend struct Table_CannedEvents_CriteriaParmList::Key;
		friend class Table_CannedEvents_CriteriaParmList;
	private:
		Table_CannedEvents_CriteriaParmList *table;
...
void psc_restrict_setNull(bool val);
		...
		Row_CannedEvents_CriteriaParmList(Table_CannedEvents_CriteriaParmList *pTable);
	
		bool IsDeleted(){return is_deleted;};
		bool IsModified(){return is_modified;};			
		class Table_CannedEvents_CriteriaParmList *Table_CannedEvents_CriteriaParmList_get() { return table; };
...
void CriteriaParm_D_FK_CannedEvents_CriteriaParmList_getrows(vector <class Row_CriteriaParm_D*> *rows);
