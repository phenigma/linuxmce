...
class Row_License* FK_License_getrow();
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_PK_PaidLicense+ m_FK_Device+ m_UseWithoutLicense+ m_ValidUntil+ m_FK_Package+ m_FK_License+ m_ReferenceNumber+ m_Username+ m_Password+ m_Key+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod;
		}
	private:
