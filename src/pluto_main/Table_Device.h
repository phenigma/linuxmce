...
void CommandGroup_Command_pschist_FK_Device_getrows(vector <class Row_CommandGroup_Command_pschist*> *rows);
void CommandGroup_Command_pschmask_FK_Device_getrows(vector <class Row_CommandGroup_Command_pschmask*> *rows);
...
void Device_CommandGroup_pschist_FK_Device_getrows(vector <class Row_Device_CommandGroup_pschist*> *rows);
void Device_CommandGroup_pschmask_FK_Device_getrows(vector <class Row_Device_CommandGroup_pschmask*> *rows);
void Device_Command_pschist_FK_Device_getrows(vector <class Row_Device_Command_pschist*> *rows);
void Device_Command_pschmask_FK_Device_getrows(vector <class Row_Device_Command_pschmask*> *rows);
void Device_DeviceData_FK_Device_getrows(vector <class Row_Device_DeviceData*> *rows);
void Device_DeviceData_pschist_FK_Device_getrows(vector <class Row_Device_DeviceData_pschist*> *rows);
void Device_DeviceData_pschmask_FK_Device_getrows(vector <class Row_Device_DeviceData_pschmask*> *rows);
void Device_DeviceGroup_FK_Device_getrows(vector <class Row_Device_DeviceGroup*> *rows);
void Device_DeviceGroup_pschist_FK_Device_getrows(vector <class Row_Device_DeviceGroup_pschist*> *rows);
void Device_DeviceGroup_pschmask_FK_Device_getrows(vector <class Row_Device_DeviceGroup_pschmask*> *rows);
...
void Device_Device_Pipe_pschist_FK_Device_From_getrows(vector <class Row_Device_Device_Pipe_pschist*> *rows);
void Device_Device_Pipe_pschist_FK_Device_To_getrows(vector <class Row_Device_Device_Pipe_pschist*> *rows);
void Device_Device_Pipe_pschmask_FK_Device_From_getrows(vector <class Row_Device_Device_Pipe_pschmask*> *rows);
void Device_Device_Pipe_pschmask_FK_Device_To_getrows(vector <class Row_Device_Device_Pipe_pschmask*> *rows);
...
void Device_Device_Related_pschist_FK_Device_getrows(vector <class Row_Device_Device_Related_pschist*> *rows);
void Device_Device_Related_pschist_FK_Device_Related_getrows(vector <class Row_Device_Device_Related_pschist*> *rows);
void Device_Device_Related_pschmask_FK_Device_getrows(vector <class Row_Device_Device_Related_pschmask*> *rows);
void Device_Device_Related_pschmask_FK_Device_Related_getrows(vector <class Row_Device_Device_Related_pschmask*> *rows);
void Device_EntertainArea_FK_Device_getrows(vector <class Row_Device_EntertainArea*> *rows);
void Device_EntertainArea_pschist_FK_Device_getrows(vector <class Row_Device_EntertainArea_pschist*> *rows);
void Device_EntertainArea_pschmask_FK_Device_getrows(vector <class Row_Device_EntertainArea_pschmask*> *rows);
void Device_HouseMode_FK_Device_getrows(vector <class Row_Device_HouseMode*> *rows);
void Device_HouseMode_pschist_FK_Device_getrows(vector <class Row_Device_HouseMode_pschist*> *rows);
void Device_HouseMode_pschmask_FK_Device_getrows(vector <class Row_Device_HouseMode_pschmask*> *rows);
void Device_MRU_FK_Device_getrows(vector <class Row_Device_MRU*> *rows);
void Device_MRU_pschist_FK_Device_getrows(vector <class Row_Device_MRU_pschist*> *rows);
void Device_MRU_pschmask_FK_Device_getrows(vector <class Row_Device_MRU_pschmask*> *rows);
void Device_Orbiter_FK_Device_getrows(vector <class Row_Device_Orbiter*> *rows);
void Device_Orbiter_pschist_FK_Device_getrows(vector <class Row_Device_Orbiter_pschist*> *rows);
void Device_Orbiter_pschmask_FK_Device_getrows(vector <class Row_Device_Orbiter_pschmask*> *rows);
void Device_QuickStart_FK_Device_getrows(vector <class Row_Device_QuickStart*> *rows);
void Device_QuickStart_pschist_FK_Device_getrows(vector <class Row_Device_QuickStart_pschist*> *rows);
void Device_QuickStart_pschmask_FK_Device_getrows(vector <class Row_Device_QuickStart_pschmask*> *rows);
void Device_StartupScript_FK_Device_getrows(vector <class Row_Device_StartupScript*> *rows);
void Device_StartupScript_pschist_FK_Device_getrows(vector <class Row_Device_StartupScript_pschist*> *rows);
void Device_StartupScript_pschmask_FK_Device_getrows(vector <class Row_Device_StartupScript_pschmask*> *rows);
void Device_Users_FK_Device_getrows(vector <class Row_Device_Users*> *rows);
void Device_Users_pschist_FK_Device_getrows(vector <class Row_Device_Users_pschist*> *rows);
void Device_Users_pschmask_FK_Device_getrows(vector <class Row_Device_Users_pschmask*> *rows);
void Device_pschist_FK_Device_ControlledVia_getrows(vector <class Row_Device_pschist*> *rows);
void Device_pschist_FK_Device_RouteTo_getrows(vector <class Row_Device_pschist*> *rows);
void Device_pschmask_FK_Device_ControlledVia_getrows(vector <class Row_Device_pschmask*> *rows);
void Device_pschmask_FK_Device_RouteTo_getrows(vector <class Row_Device_pschmask*> *rows);
void Package_Device_FK_Device_getrows(vector <class Row_Package_Device*> *rows);
void Package_Device_pschist_FK_Device_getrows(vector <class Row_Package_Device_pschist*> *rows);
void Package_Device_pschmask_FK_Device_getrows(vector <class Row_Package_Device_pschmask*> *rows);
void PaidLicense_FK_Device_getrows(vector <class Row_PaidLicense*> *rows);
void PaidLicense_pschist_FK_Device_getrows(vector <class Row_PaidLicense_pschist*> *rows);
void PaidLicense_pschmask_FK_Device_getrows(vector <class Row_PaidLicense_pschmask*> *rows);
...
void UnknownDevices_pschist_FK_Device_PC_getrows(vector <class Row_UnknownDevices_pschist*> *rows);
void UnknownDevices_pschmask_FK_Device_PC_getrows(vector <class Row_UnknownDevices_pschmask*> *rows);
