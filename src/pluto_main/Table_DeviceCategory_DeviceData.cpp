...
long int Row_DeviceCategory_DeviceData::FK_DeviceCategory_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_FK_DeviceCategory;}
long int Row_DeviceCategory_DeviceData::FK_DeviceData_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_FK_DeviceData;}
string Row_DeviceCategory_DeviceData::IK_DeviceData_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_IK_DeviceData;}
short int Row_DeviceCategory_DeviceData::Required_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_Required;}
short int Row_DeviceCategory_DeviceData::SetByDevice_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_SetByDevice;}
short int Row_DeviceCategory_DeviceData::AllowedToModify_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_AllowedToModify;}
string Row_DeviceCategory_DeviceData::Description_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_Description;}
short int Row_DeviceCategory_DeviceData::ShowInWizard_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

return m_ShowInWizard;}
short int Row_DeviceCategory_DeviceData::ShortDescription_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Row_DeviceCategory_DeviceData::FK_DeviceData_set(long int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_FK_DeviceData = val; is_modified=true; is_null[1]=false;}
void Row_DeviceCategory_DeviceData::IK_DeviceData_set(string val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_IK_DeviceData = val; is_modified=true; is_null[2]=false;}
void Row_DeviceCategory_DeviceData::Required_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_Required = val; is_modified=true; is_null[3]=false;}
void Row_DeviceCategory_DeviceData::SetByDevice_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_SetByDevice = val; is_modified=true; is_null[4]=false;}
void Row_DeviceCategory_DeviceData::AllowedToModify_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Row_DeviceCategory_DeviceData::ShowInWizard_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);

m_ShowInWizard = val; is_modified=true; is_null[7]=false;}
void Row_DeviceCategory_DeviceData::ShortDescription_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
bool Row_DeviceCategory_DeviceData::IK_DeviceData_isNull() {PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Row_DeviceCategory_DeviceData::IK_DeviceData_setNull(bool val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
values_list_comma_separated = values_list_comma_separated + pRow->FK_DeviceCategory_asSQL()+", "+pRow->FK_DeviceData_asSQL()+", "+pRow->IK_DeviceData_asSQL()+", "+pRow->Required_asSQL()+", "+pRow->SetByDevice_asSQL()+", "+pRow->AllowedToModify_asSQL()+", "+pRow->Description_asSQL()+", "+pRow->ShowInWizard_asSQL()+", "+pRow->ShortDescription_asSQL()+", "+pRow->psc_id_asSQL()+", "+pRow->psc_batch_asSQL()+", "+pRow->psc_user_asSQL()+", "+pRow->psc_frozen_asSQL();
		...
		string query = "insert into DeviceCategory_DeviceData (`FK_DeviceCategory`, `FK_DeviceData`, `IK_DeviceData`, `Required`, `SetByDevice`, `AllowedToModify`, `Description`, `ShowInWizard`, `ShortDescription`, `psc_id`, `psc_batch`, `psc_user`, `psc_frozen`) values ("+
...
bool Table_DeviceCategory_DeviceData::GetRows(string where_statement,vector<class Row_DeviceCategory_DeviceData*> *rows)
{
	...
	if( StringUtils::StartsWith(where_statement,"where ",true) || StringUtils::StartsWith(where_statement,"join ",true) )
		query = "select * from DeviceCategory_DeviceData " + where_statement;
	else if( StringUtils::StartsWith(where_statement,"select ",true) )
		query = where_statement;
	else
		query = "select * from DeviceCategory_DeviceData where " + where_statement;
