...
class DECLSPECIFIER Table_DeviceTemplate_DSPMode : public TableBase , DoubleLongKeyBase
{
private:
...
public:
	Table_DeviceTemplate_DSPMode(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
private:	
	...
	class Row_DeviceTemplate_DSPMode* FetchRow(DoubleLongKey &key);
		
			
};

class DECLSPECIFIER Row_DeviceTemplate_DSPMode : public TableRow, public SerializeClass
	{
...
class Row_Command* FK_Command_getrow();
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_FK_DeviceTemplate+ m_FK_Command+ m_OrderNo+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod+ m_psc_restrict;
		}
	private:
