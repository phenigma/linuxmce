...
class DECLSPECIFIER Table_CriteriaList : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_CriteriaList(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
	~Table_CriteriaList();
...
private:	
	...
	class Row_CriteriaList* FetchRow(SingleLongKey &key);
		
			
};

class DECLSPECIFIER Row_CriteriaList : public TableRow, public SerializeClass
	{
