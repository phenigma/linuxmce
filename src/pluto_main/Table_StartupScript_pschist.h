...
#ifndef __Table_StartupScript_pschist_H__
#define __Table_StartupScript_pschist_H__

#include "TableRow.h"
#include "Database_pluto_main.h"
#include "PlutoUtils/MultiThreadIncludes.h"
#include "Define_StartupScript_pschist.h"
...
class DECLSPECIFIER Table_StartupScript_pschist : public TableBase , DoubleLongKeyBase
{
private:
...
public:
	Table_StartupScript_pschist(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
	~Table_StartupScript_pschist();

private:		
	friend class Row_StartupScript_pschist;
	struct Key
	{
		friend class Row_StartupScript_pschist;
		long int pk_psc_id;
long int pk_psc_batch;
		...
		Key(class Row_StartupScript_pschist *pRow);
	};
	struct Key_Less
	{			
		bool operator()(const Table_StartupScript_pschist::Key &key1, const Table_StartupScript_pschist::Key &key2) const;
	};	
...
public:				
	...
	bool GetRows(string where_statement,vector<class Row_StartupScript_pschist*> *rows);
	class Row_StartupScript_pschist* AddRow();
	Database_pluto_main *Database_pluto_main_get() { return database; }
	
		
	class Row_StartupScript_pschist* GetRow(long int in_psc_id, long int in_psc_batch);
	

private:	
	
		
	class Row_StartupScript_pschist* FetchRow(DoubleLongKey &key);
		
			
};

class DECLSPECIFIER Row_StartupScript_pschist : public TableRow, public SerializeClass
	{
		friend struct Table_StartupScript_pschist::Key;
		friend class Table_StartupScript_pschist;
	private:
		Table_StartupScript_pschist *table;
...
void psc_restrict_setNull(bool val);
		...
		Row_StartupScript_pschist(Table_StartupScript_pschist *pTable);
	
		bool IsDeleted(){return is_deleted;};
		bool IsModified(){return is_modified;};			
		class Table_StartupScript_pschist *Table_StartupScript_pschist_get() { return table; };
