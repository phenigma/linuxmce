...
void Database_pluto_main::Commit_DeviceTemplate_DeviceData(bool bDeleteFailedModifiedRow,bool bDeleteFailedInsertRow)
{
...
mysql_real_escape_string(table->database->m_pMySQL, buf, m_ShortDescription.c_str(), (unsigned long) min(25,m_ShortDescription.size()));
string s=string()+"\""+buf+"\"";
delete[] buf;
return s;
}
