...
class DECLSPECIFIER Table_Installation_RepositorySource_URL : public TableBase , DoubleLongKeyBase
{
private:
...
public:
	Table_Installation_RepositorySource_URL(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
private:	
	...
	class Row_Installation_RepositorySource_URL* FetchRow(DoubleLongKey &key);
		
			
};

class DECLSPECIFIER Row_Installation_RepositorySource_URL : public TableRow, public SerializeClass
	{
