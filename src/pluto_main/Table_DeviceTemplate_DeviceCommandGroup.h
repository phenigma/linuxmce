...
class DLL_EXPORT Table_DeviceTemplate_DeviceCommandGroup : public TableBase , DoubleLongKeyBase
{
private:
...
class Row_DeviceCommandGroup* FK_DeviceCommandGroup_getrow();
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_FK_DeviceTemplate+ m_FK_DeviceCommandGroup+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod;
		}
	private:
