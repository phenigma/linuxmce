...
class DECLSPECIFIER Table_EventCategory : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_EventCategory(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
	~Table_EventCategory();
...
class DECLSPECIFIER Row_EventCategory : public TableRow, public SerializeClass
	{
