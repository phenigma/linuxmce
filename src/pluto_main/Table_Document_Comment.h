...
class DECLSPECIFIER Table_Document_Comment : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_Document_Comment(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
class DECLSPECIFIER Row_Document_Comment : public TableRow, public SerializeClass
	{
...
class Row_Users* FK_Users_getrow();
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_PK_Document_Comment+ m_FK_Document+ m_FK_Users+ m_Comment+ m_Date+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod+ m_psc_restrict;
		}
	private:
