...
class DECLSPECIFIER Table_DeviceTemplate_DesignObj : public TableBase , DoubleLongKeyBase
{
private:
...
class DECLSPECIFIER Row_DeviceTemplate_DesignObj : public TableRow, public SerializeClass
	{
...
class Row_DesignObj* FK_DesignObj_getrow();
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_FK_DeviceTemplate+ m_FK_DesignObj+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod+ m_psc_restrict;
		}
	private:
