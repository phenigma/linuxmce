#ifndef __Define_psc_website_bathdr_H__
#define __Define_psc_website_bathdr_H__
...
#define PSC_WEBSITE_BATHDR_COMMENTS_TABLE_FIELD "psc_website_bathdr.comments"
