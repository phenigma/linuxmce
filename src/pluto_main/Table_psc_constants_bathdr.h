...
class DECLSPECIFIER Table_psc_constants_bathdr : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_psc_constants_bathdr(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
private:	
	...
	class Row_psc_constants_bathdr* FetchRow(SingleLongKey &key);
		
			
};

class DECLSPECIFIER Row_psc_constants_bathdr : public TableRow, public SerializeClass
	{
...
void comments_setNull(bool val);
		...
		void psc_constants_batdet_FK_psc_constants_bathdr_getrows(vector <class Row_psc_constants_batdet*> *rows);
void psc_constants_batdet_FK_psc_constants_bathdr_orig_getrows(vector <class Row_psc_constants_batdet*> *rows);
void psc_constants_batdet_FK_psc_constants_bathdr_auth_getrows(vector <class Row_psc_constants_batdet*> *rows);
void psc_constants_batdet_FK_psc_constants_bathdr_unauth_getrows(vector <class Row_psc_constants_batdet*> *rows);
void psc_constants_batuser_FK_psc_constants_bathdr_getrows(vector <class Row_psc_constants_batuser*> *rows);


		// Setup binary serialization
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_PK_psc_constants_bathdr+ m_IPAddress+ m_date+ m_comments;
		}
	private:
