...
class DECLSPECIFIER Table_DeviceTemplate_Input : public TableBase , DoubleLongKeyBase
{
private:
...
class DECLSPECIFIER Row_DeviceTemplate_Input : public TableRow, public SerializeClass
	{
