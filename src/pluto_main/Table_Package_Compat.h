...
class DECLSPECIFIER Table_Package_Compat : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_Package_Compat(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
class DECLSPECIFIER Row_Package_Compat : public TableRow, public SerializeClass
	{
