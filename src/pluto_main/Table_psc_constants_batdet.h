...
class DECLSPECIFIER Table_psc_constants_batdet : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_psc_constants_batdet(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
class DECLSPECIFIER Row_psc_constants_batdet : public TableRow, public SerializeClass
	{
