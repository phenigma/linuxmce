...
void psc_frozen_setNull(bool val);
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_PK_Licensing+ m_Description+ m_RequiresPayment+ m_RecommendsPayment+ m_FreeTrial+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod;
		}
	private:
