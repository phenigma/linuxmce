...
void DeviceTemplate_pschist_FK_Licensing_getrows(vector <class Row_DeviceTemplate_pschist*> *rows);
void DeviceTemplate_pschmask_FK_Licensing_getrows(vector <class Row_DeviceTemplate_pschmask*> *rows);
