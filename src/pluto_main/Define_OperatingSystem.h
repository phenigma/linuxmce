#ifndef __Define_OperatingSystem_H__
#define __Define_OperatingSystem_H__

#define OPERATINGSYSTEM_Linux_CONST 1
#define OPERATINGSYSTEM_Windows_CONST 2
#define OPERATINGSYSTEM_Symbian_CONST 3
#define OPERATINGSYSTEM_Ubuntu_Linux_CONST 4

#define OPERATINGSYSTEM_TABLE "OperatingSystem"
#define OPERATINGSYSTEM_PK_OPERATINGSYSTEM_FIELD "PK_OperatingSystem"
#define OPERATINGSYSTEM_PK_OPERATINGSYSTEM_TABLE_FIELD "OperatingSystem.PK_OperatingSystem"
#define OPERATINGSYSTEM_DESCRIPTION_FIELD "Description"
