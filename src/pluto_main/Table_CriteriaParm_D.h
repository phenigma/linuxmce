...
class DECLSPECIFIER Table_CriteriaParm_D : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_CriteriaParm_D(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
class DECLSPECIFIER Row_CriteriaParm_D : public TableRow, public SerializeClass
	{
...
class Row_CannedEvents_CriteriaParmList* FK_CannedEvents_CriteriaParmList_getrow();
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_PK_CriteriaParm+ m_FK_CriteriaParmNesting_D+ m_FK_CriteriaParmList+ m_Operator+ m_Value+ m_FK_CannedEvents_CriteriaParmList+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod+ m_psc_restrict;
		}
	private:
