...
class DECLSPECIFIER Table_DeviceCommandGroup_DeviceCommandGroup_Parent : public TableBase , DoubleLongKeyBase
{
private:
...
public:
	Table_DeviceCommandGroup_DeviceCommandGroup_Parent(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
class DECLSPECIFIER Row_DeviceCommandGroup_DeviceCommandGroup_Parent : public TableRow, public SerializeClass
	{
