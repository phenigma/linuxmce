...
return m_is_sup;}
short int Row_psc_ir_batuser::no_pass_get(){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
...
void Row_psc_ir_batuser::no_pass_set(short int val){PLUTO_SAFETY_LOCK(M, table->m_Mutex);
