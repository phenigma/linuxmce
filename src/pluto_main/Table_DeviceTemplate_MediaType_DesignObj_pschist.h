...
#ifndef __Table_DeviceTemplate_MediaType_DesignObj_pschist_H__
#define __Table_DeviceTemplate_MediaType_DesignObj_pschist_H__

#include "TableRow.h"
#include "Database_pluto_main.h"
#include "PlutoUtils/MultiThreadIncludes.h"
#include "Define_DeviceTemplate_MediaType_DesignObj_pschist.h"
...
class DECLSPECIFIER Table_DeviceTemplate_MediaType_DesignObj_pschist : public TableBase , DoubleLongKeyBase
{
private:
...
public:
	Table_DeviceTemplate_MediaType_DesignObj_pschist(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
	~Table_DeviceTemplate_MediaType_DesignObj_pschist();

private:		
	friend class Row_DeviceTemplate_MediaType_DesignObj_pschist;
	struct Key
	{
		friend class Row_DeviceTemplate_MediaType_DesignObj_pschist;
		long int pk_psc_id;
long int pk_psc_batch;
		...
		Key(class Row_DeviceTemplate_MediaType_DesignObj_pschist *pRow);
	};
	struct Key_Less
	{			
		bool operator()(const Table_DeviceTemplate_MediaType_DesignObj_pschist::Key &key1, const Table_DeviceTemplate_MediaType_DesignObj_pschist::Key &key2) const;
	};	
...
public:				
	...
	bool GetRows(string where_statement,vector<class Row_DeviceTemplate_MediaType_DesignObj_pschist*> *rows);
	class Row_DeviceTemplate_MediaType_DesignObj_pschist* AddRow();
	Database_pluto_main *Database_pluto_main_get() { return database; }
	
		
	class Row_DeviceTemplate_MediaType_DesignObj_pschist* GetRow(long int in_psc_id, long int in_psc_batch);
	

private:	
	
		
	class Row_DeviceTemplate_MediaType_DesignObj_pschist* FetchRow(DoubleLongKey &key);
		
			
};

class DECLSPECIFIER Row_DeviceTemplate_MediaType_DesignObj_pschist : public TableRow, public SerializeClass
	{
		friend struct Table_DeviceTemplate_MediaType_DesignObj_pschist::Key;
		friend class Table_DeviceTemplate_MediaType_DesignObj_pschist;
	private:
		Table_DeviceTemplate_MediaType_DesignObj_pschist *table;
...
short int m_FK_Screen_FileList;
long int m_FK_DesignObj_Guide_pschist;
...
short int m_FK_Screen_OSD;
short int m_FK_Screen_Alt;
short int m_FK_Screen_Alt_OSD;
...
short int FK_Screen_FileList_get();
long int FK_DesignObj_Guide_pschist_get();
...
short int FK_Screen_OSD_get();
short int FK_Screen_Alt_get();
short int FK_Screen_Alt_OSD_get();
...
void FK_Screen_FileList_set(short int val);
void FK_DesignObj_Guide_pschist_set(long int val);
...
void FK_Screen_OSD_set(short int val);
void FK_Screen_Alt_set(short int val);
void FK_Screen_Alt_OSD_set(short int val);
...
void UIVersion_setNull(bool val);
		...
		Row_DeviceTemplate_MediaType_DesignObj_pschist(Table_DeviceTemplate_MediaType_DesignObj_pschist *pTable);
	
		bool IsDeleted(){return is_deleted;};
		bool IsModified(){return is_modified;};			
		class Table_DeviceTemplate_MediaType_DesignObj_pschist *Table_DeviceTemplate_MediaType_DesignObj_pschist_get() { return table; };
