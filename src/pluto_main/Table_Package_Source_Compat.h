...
class DLL_EXPORT Table_Package_Source_Compat : public TableBase , SingleLongKeyBase
{
private:
...
public:
	...
	Table_Package_Source_Compat(Database_pluto_main *pDatabase):database(pDatabase), m_Mutex("Package_Source_Compat")
	{
...
class DLL_EXPORT Row_Package_Source_Compat : public TableRow, public SerializeClass
	{
