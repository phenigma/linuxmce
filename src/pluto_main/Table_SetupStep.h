...
class DECLSPECIFIER Table_SetupStep : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_SetupStep(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
	~Table_SetupStep();
...
class DECLSPECIFIER Row_SetupStep : public TableRow, public SerializeClass
	{
