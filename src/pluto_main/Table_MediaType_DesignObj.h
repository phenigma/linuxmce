...
class Row_Skin* FK_Skin_getrow();
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_PK_MediaType_DesignObj+ m_FK_MediaType+ m_FK_DesignObj+ m_FK_DesignObj_Popup+ m_FK_DesignObj_FileList+ m_FK_DesignObj_FileList_Popup+ m_FK_DesignObj_Guide+ m_FK_DesignObj_OSD+ m_FK_DesignObj_Alt+ m_FK_DesignObj_Alt_Popup+ m_FK_DesignObj_Alt_OSD+ m_Description+ m_FK_Skin+ m_UIVersion+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod+ m_psc_restrict;
		}
	private:
