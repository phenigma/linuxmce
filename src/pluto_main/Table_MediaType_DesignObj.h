...
class Row_DesignObj* FK_DesignObj_FileList_getrow();
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_PK_MediaType_DesignObj+ m_FK_MediaType+ m_FK_DesignObj+ m_FK_DesignObj_Popup+ m_FK_DesignObj_FileList+ m_FK_DesignObj_FileList_Popup+ m_Description+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod;
		}
	private:
