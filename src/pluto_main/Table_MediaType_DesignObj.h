...
class DECLSPECIFIER Table_MediaType_DesignObj : public TableBase , SingleLongKeyBase
{
private:
...
private:		
	...
	{
		friend class Row_MediaType_DesignObj;
		long int pk_PK_MediaType_DesignObj;

		
		Key(long int in_PK_MediaType_DesignObj);
...
public:				
	...
	class Row_MediaType_DesignObj* GetRow(long int in_PK_MediaType_DesignObj);
	

private:	
	
		
	class Row_MediaType_DesignObj* FetchRow(SingleLongKey &key);
...
class Row_Skin* FK_Skin_getrow();
		...
		void RemoteControl_FK_MediaType_DesignObj_getrows(vector <class Row_RemoteControl*> *rows);
void RemoteControl_pschist_FK_MediaType_DesignObj_getrows(vector <class Row_RemoteControl_pschist*> *rows);
void RemoteControl_pschmask_FK_MediaType_DesignObj_getrows(vector <class Row_RemoteControl_pschmask*> *rows);
