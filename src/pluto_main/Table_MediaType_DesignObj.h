...
class DLL_EXPORT Table_MediaType_DesignObj : public TableBase , DoubleLongKeyBase
{
private:
...
public:
	...
	Table_MediaType_DesignObj(Database_pluto_main *pDatabase):database(pDatabase), m_Mutex("MediaType_DesignObj")
	{
...
class DLL_EXPORT Row_MediaType_DesignObj : public TableRow, public SerializeClass
	{
