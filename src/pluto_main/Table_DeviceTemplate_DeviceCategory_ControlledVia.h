...
class DECLSPECIFIER Table_DeviceTemplate_DeviceCategory_ControlledVia : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_DeviceTemplate_DeviceCategory_ControlledVia(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
private:	
	...
	class Row_DeviceTemplate_DeviceCategory_ControlledVia* FetchRow(SingleLongKey &key);
		
			
};

class DECLSPECIFIER Row_DeviceTemplate_DeviceCategory_ControlledVia : public TableRow, public SerializeClass
	{
...
void DeviceTemplate_DeviceCategory_ControlledVia_Pipe_pschist_FK_DeviceTemplate_DeviceCategory_ControlledVia_getrows(vector <class Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe_pschist*> *rows);
void DeviceTemplate_DeviceCategory_ControlledVia_Pipe_pschmask_FK_DeviceTemplate_DeviceCategory_ControlledVia_getrows(vector <class Row_DeviceTemplate_DeviceCategory_ControlledVia_Pipe_pschmask*> *rows);


		// Setup binary serialization
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_PK_DeviceTemplate_DeviceCategory_ControlledVia+ m_FK_DeviceTemplate+ m_FK_DeviceCategory+ m_Description+ m_RerouteMessagesToParent+ m_AutoCreateChildren+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod+ m_psc_restrict;
		}
	private:
