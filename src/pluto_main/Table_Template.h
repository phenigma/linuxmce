...
class DECLSPECIFIER Table_Template : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_Template(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
	~Table_Template();
...
class DECLSPECIFIER Row_Template : public TableRow, public SerializeClass
	{
