...
#define MEDIATYPE_EK_ATTRIBUTE_DEFAULTSORT_FIELD "EK_Attribute_DefaultSort"
#define MEDIATYPE_EK_ATTRIBUTE_DEFAULTSORT_TABLE_FIELD "MediaType.EK_Attribute_DefaultSort"
