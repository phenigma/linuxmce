...
class DECLSPECIFIER Table_PhoneLineType : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_PhoneLineType(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
	~Table_PhoneLineType();
...
private:	
	...
	class Row_PhoneLineType* FetchRow(SingleLongKey &key);
		
			
};

class DECLSPECIFIER Row_PhoneLineType : public TableRow, public SerializeClass
	{
...
void psc_frozen_setNull(bool val);
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_PK_PhoneLineType+ m_Description+ m_Define+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod;
		}
	private:
