...
class DECLSPECIFIER Table_DesignObjVariation_Text : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_DesignObjVariation_Text(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
class DECLSPECIFIER Row_DesignObjVariation_Text : public TableRow, public SerializeClass
	{
...
void DesignObjVariation_Text_Skin_Language_pschist_FK_DesignObjVariation_Text_getrows(vector <class Row_DesignObjVariation_Text_Skin_Language_pschist*> *rows);
void DesignObjVariation_Text_Skin_Language_pschmask_FK_DesignObjVariation_Text_getrows(vector <class Row_DesignObjVariation_Text_Skin_Language_pschmask*> *rows);


		// Setup binary serialization
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_PK_DesignObjVariation_Text+ m_FK_DesignObjVariation+ m_FK_Text+ m_FK_Text_OverrideFromHeader+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod+ m_psc_restrict;
		}
	private:
