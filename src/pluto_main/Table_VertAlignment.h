...
class DECLSPECIFIER Table_VertAlignment : public TableBase , SingleLongKeyBase
{
private:
...
private:	
	...
	class Row_VertAlignment* FetchRow(SingleLongKey &key);
		
			
};

class DECLSPECIFIER Row_VertAlignment : public TableRow, public SerializeClass
	{
...
void DesignObjVariation_Text_Skin_Language_pschist_FK_VertAlignment_getrows(vector <class Row_DesignObjVariation_Text_Skin_Language_pschist*> *rows);
void DesignObjVariation_Text_Skin_Language_pschmask_FK_VertAlignment_getrows(vector <class Row_DesignObjVariation_Text_Skin_Language_pschmask*> *rows);
void StyleVariation_FK_VertAlignment_getrows(vector <class Row_StyleVariation*> *rows);
void StyleVariation_pschist_FK_VertAlignment_getrows(vector <class Row_StyleVariation_pschist*> *rows);
void StyleVariation_pschmask_FK_VertAlignment_getrows(vector <class Row_StyleVariation_pschmask*> *rows);
