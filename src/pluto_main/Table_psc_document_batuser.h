...
class DECLSPECIFIER Table_psc_document_batuser : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_psc_document_batuser(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
class DECLSPECIFIER Row_psc_document_batuser : public TableRow, public SerializeClass
	{
...
void no_pass_set(short int val);
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_PK_psc_document_batuser+ m_FK_psc_document_bathdr+ m_psc_user+ m_is_sup+ m_no_pass;
		}
	private:
