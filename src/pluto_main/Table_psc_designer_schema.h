...
class DECLSPECIFIER Table_psc_designer_schema : public TableBase , SingleLongKeyBase
{
private:
...
class DECLSPECIFIER Row_psc_designer_schema : public TableRow, public SerializeClass
	{
