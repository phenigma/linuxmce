...
class DLL_EXPORT Table_Button : public TableBase , SingleLongKeyBase
{
private:
...
void DesignObjVariation_Zone_FK_Button_getrows(vector <class Row_DesignObjVariation_Zone*> *rows);
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_PK_Button+ m_Description+ m_Define+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod;
		}
	private:
