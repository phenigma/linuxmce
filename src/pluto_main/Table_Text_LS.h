...
class DECLSPECIFIER Table_Text_LS : public TableBase , DoubleLongKeyBase
{
private:
...
public:
	Table_Text_LS(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
	~Table_Text_LS();
...
class DECLSPECIFIER Row_Text_LS : public TableRow, public SerializeClass
	{
