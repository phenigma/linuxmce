...
void Row_MediaType_DesignObj::Delete()
{
	...
	if (!is_deleted)
		...
		{
			DoubleLongKey key(pRow->m_FK_MediaType,pRow->m_FK_DesignObj);
...
Table_MediaType_DesignObj::Key::Key(long int in_FK_MediaType, long int in_FK_DesignObj)
{
...
values_list_comma_separated = values_list_comma_separated + pRow->FK_MediaType_asSQL()+", "+pRow->FK_DesignObj_asSQL()+", "+pRow->psc_id_asSQL()+", "+pRow->psc_batch_asSQL()+", "+pRow->psc_user_asSQL()+", "+pRow->psc_frozen_asSQL();

	
		string query = "insert into MediaType_DesignObj (`FK_MediaType`, `FK_DesignObj`, `psc_id`, `psc_batch`, `psc_user`, `psc_frozen`) values ("+
...
string condition;
condition = condition + "`FK_MediaType`=" + tmp_FK_MediaType+" AND "+"`FK_DesignObj`=" + tmp_FK_DesignObj;
	
			
		
string update_values_list;
update_values_list = update_values_list + "`FK_MediaType`="+pRow->FK_MediaType_asSQL()+", `FK_DesignObj`="+pRow->FK_DesignObj_asSQL()+", `psc_id`="+pRow->psc_id_asSQL()+", `psc_batch`="+pRow->psc_batch_asSQL()+", `psc_user`="+pRow->psc_user_asSQL()+", `psc_frozen`="+pRow->psc_frozen_asSQL();
