...
cout << "CommandGroup_D_Command::Commit " << update_values_list << " " << condition << endl;
	string sql = "select * FROM CommandGroup_D_Command where " + condition;
	...
	if( res )
	{
		...
		while ((row = mysql_fetch_row(res)) != NULL)
		{
			...
			cout << "CommandGroup_D_Command::Commit " << st << endl;
		}
	}							
		if (mysql_query(database->m_pMySQL, query.c_str()))
		{	
