...
class DECLSPECIFIER Table_psc_ir_repset : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_psc_ir_repset(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
	~Table_psc_ir_repset();
...
class DECLSPECIFIER Row_psc_ir_repset : public TableRow, public SerializeClass
	{
