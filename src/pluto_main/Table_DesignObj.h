...
void DesignObjVariation_DesignObj_pschist_FK_DesignObj_InsteadOf_getrows(vector <class Row_DesignObjVariation_DesignObj_pschist*> *rows);
void DesignObjVariation_DesignObj_pschist_FK_DesignObj_Up_getrows(vector <class Row_DesignObjVariation_DesignObj_pschist*> *rows);
void DesignObjVariation_DesignObj_pschist_FK_DesignObj_Down_getrows(vector <class Row_DesignObjVariation_DesignObj_pschist*> *rows);
void DesignObjVariation_DesignObj_pschist_FK_DesignObj_Left_getrows(vector <class Row_DesignObjVariation_DesignObj_pschist*> *rows);
void DesignObjVariation_DesignObj_pschist_FK_DesignObj_Right_getrows(vector <class Row_DesignObjVariation_DesignObj_pschist*> *rows);
...
void DesignObjVariation_DesignObj_pschmask_FK_DesignObj_InsteadOf_getrows(vector <class Row_DesignObjVariation_DesignObj_pschmask*> *rows);
void DesignObjVariation_DesignObj_pschmask_FK_DesignObj_Up_getrows(vector <class Row_DesignObjVariation_DesignObj_pschmask*> *rows);
void DesignObjVariation_DesignObj_pschmask_FK_DesignObj_Down_getrows(vector <class Row_DesignObjVariation_DesignObj_pschmask*> *rows);
void DesignObjVariation_DesignObj_pschmask_FK_DesignObj_Left_getrows(vector <class Row_DesignObjVariation_DesignObj_pschmask*> *rows);
void DesignObjVariation_DesignObj_pschmask_FK_DesignObj_Right_getrows(vector <class Row_DesignObjVariation_DesignObj_pschmask*> *rows);
