...
void DeviceTemplate_MediaType_DesignObj_FK_DesignObj_OSD_getrows(vector <class Row_DeviceTemplate_MediaType_DesignObj*> *rows);
void DeviceTemplate_MediaType_DesignObj_FK_DesignObj_Alt_getrows(vector <class Row_DeviceTemplate_MediaType_DesignObj*> *rows);
...
void MediaType_DesignObj_FK_DesignObj_Guide_getrows(vector <class Row_MediaType_DesignObj*> *rows);
