...
class DECLSPECIFIER Table_CriteriaParmNesting_D : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_CriteriaParmNesting_D(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
private:	
	...
	class Row_CriteriaParmNesting_D* FetchRow(SingleLongKey &key);
		
			
};

class DECLSPECIFIER Row_CriteriaParmNesting_D : public TableRow, public SerializeClass
	{
...
void Criteria_D_FK_CriteriaParmNesting_D_getrows(vector <class Row_Criteria_D*> *rows);
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_PK_CriteriaParmNesting_D+ m_FK_CriteriaParmNesting_D_Parent+ m_IsAnd+ m_IsNot+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod+ m_psc_restrict;
		}
	private:
