...
class DECLSPECIFIER Table_CommandGroup_EntertainArea : public TableBase , DoubleLongKeyBase
{
private:
...
public:
	Table_CommandGroup_EntertainArea(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
class DECLSPECIFIER Row_CommandGroup_EntertainArea : public TableRow, public SerializeClass
	{
