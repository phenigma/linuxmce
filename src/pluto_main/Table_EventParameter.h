...
class DECLSPECIFIER Table_EventParameter : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_EventParameter(Database_pluto_main *pDatabase):database(pDatabase)
	{
	};
...
class DECLSPECIFIER Row_EventParameter : public TableRow, public SerializeClass
	{
