...
while ($romName = <STDIN>)
{
	...
	$agent->get("http://www.gamefaqs.com/search/index.html?platform=10&game=".uri_escape($romName)."&contrib=0&genre=0&region=0&date=0&developer=&publisher=&dist=0&sort=0&link=0&res=0&title=0");
