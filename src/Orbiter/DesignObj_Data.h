...
public:
	...
	bool ChildOf( DesignObj_Data *pObj_Parent ) { if( m_pParentObject==pObj_Parent ) return true;  else if( !m_pParentObject ) return false; else return m_pParentObject->ChildOf(pObj_Parent); }
