...
#define GL2D_EFFECT_SLIDE_FROM_LEFT 		(GL2D_UNIQUE_EFFECT+3)
#define GL2D_EFFECT_FADES_FROM_TOP 			(GL2D_UNIQUE_EFFECT+4)
#define GL2D_EFFECT_FADES_FROM_UNDERNEATH	(GL2D_UNIQUE_EFFECT+5)
