...
namespace FileUtils
{
	...
	string GetMidFileChecksum( string sFileName, int Bytes ); /** < returns the checksum of the Bytes in the middle of the file for a quick check if a file has changed */
