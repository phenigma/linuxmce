...
Moxi_PVR::Moxi_PVR(int DeviceID, string ServerAddress,bool bConnectEventHandler,bool bLocalMode,class Router *pRouter)
	: Moxi_PVR_Command(DeviceID, ServerAddress,bConnectEventHandler,bLocalMode,pRouter)
//<-dceag-const-e->
{
}

void Moxi_PVR::setOwner(IDeviceClientSmartHome *p)
{
	pOwner = p;
}
...
Moxi_PVR::Moxi_PVR(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter)
	: Moxi_PVR_Command(pPrimaryDeviceCommand, pData, pEvent, pRouter)
//<-dceag-const2-e->
{
}
...
//<-dceag-getconfig-b->
bool Moxi_PVR::GetConfig()
{
	if( !Moxi_PVR_Command::GetConfig() )
		return false;
//<-dceag-getconfig-e->
...
//<-dceag-createinst-b->
Moxi_PVR_Command *Create_Moxi_PVR(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter)
{
	return new Moxi_PVR(pPrimaryDeviceCommand, pData, pEvent, pRouter);
}
//<-dceag-createinst-e->
...
*/
//<-dceag-cmdch-b->
void Moxi_PVR::ReceivedCommandForChild(DeviceData_Impl *pDeviceData_Impl,string &sCMD_Result,Message *pMessage)
//<-dceag-cmdch-e->
{
...
*/
//<-dceag-cmduk-b->
void Moxi_PVR::ReceivedUnknownCommand(string &sCMD_Result,Message *pMessage)
//<-dceag-cmduk-e->
{
...
void Moxi_PVR::CMD_Simulate_Keypress(string sPK_Button,string sName,string &sCMD_Result,Message *pMessage)
//<-dceag-c28-e->
{
...
void Moxi_PVR::CMD_Play_Media(int iPK_MediaType,int iStreamID,string sMediaPosition,string sMediaURL,string &sCMD_Result,Message *pMessage)
//<-dceag-c37-e->
{
...
void Moxi_PVR::CMD_Stop_Media(int iStreamID,string *sMediaPosition,string &sCMD_Result,Message *pMessage)
//<-dceag-c38-e->
{
...
void Moxi_PVR::CMD_Pause_Media(int iStreamID,string &sCMD_Result,Message *pMessage)
//<-dceag-c39-e->
{
...
void Moxi_PVR::CMD_Restart_Media(int iStreamID,string &sCMD_Result,Message *pMessage)
//<-dceag-c40-e->
{
...
void Moxi_PVR::CMD_Change_Playback_Speed(int iStreamID,int iMediaPlaybackSpeed,bool bReport,string &sCMD_Result,Message *pMessage)
//<-dceag-c41-e->
{
...
void Moxi_PVR::CMD_Jump_to_Position_in_Stream(string sValue_To_Assign,int iStreamID,string &sCMD_Result,Message *pMessage)
//<-dceag-c42-e->
{
...
void Moxi_PVR::CMD_Skip_Fwd_ChannelTrack_Greater(string &sCMD_Result,Message *pMessage)
//<-dceag-c63-e->
{
//	cout << "Need to implement command #63 - Skip Fwd - Channel/Track Greater" << endl;
	pOwner->CMD_sendKey("head0", "chanup");
}
...
void Moxi_PVR::CMD_Skip_Back_ChannelTrack_Lower(string &sCMD_Result,Message *pMessage)
//<-dceag-c64-e->
{
//	cout << "Need to implement command #64 - Skip Back - Channel/Track Lower" << endl;
	pOwner->CMD_sendKey("head0", "chandn");
}
...
void Moxi_PVR::CMD_Jump_Position_In_Playlist(string sValue_To_Assign,string &sCMD_Result,Message *pMessage)
//<-dceag-c65-e->
{
...
void Moxi_PVR::CMD_Pause(string &sCMD_Result,Message *pMessage)
//<-dceag-c92-e->
{
//	cout << "Need to implement command #92 - Pause" << endl;
	pOwner->CMD_sendKey("head0", "pause");
}
...
void Moxi_PVR::CMD_Stop(bool bEject,string &sCMD_Result,Message *pMessage)
//<-dceag-c95-e->
{
//	cout << "Need to implement command #95 - Stop" << endl;
//	cout << "Parm #203 - Eject=" << bEject << endl;
	pOwner->CMD_sendKey("head0", "stop");
}
...
void Moxi_PVR::CMD_Guide(string &sCMD_Result,Message *pMessage)
//<-dceag-c126-e->
{
//	cout << "Need to implement command #126 - Guide" << endl;
	pOwner->CMD_sendKey("head0", "guide");
}
...
void Moxi_PVR::CMD_Play(string &sCMD_Result,Message *pMessage)
//<-dceag-c139-e->
{
//	cout << "Need to implement command #139 - Play" << endl;
	pOwner->CMD_sendKey("head0", "play");
}
...
void Moxi_PVR::CMD_EnterGo(string &sCMD_Result,Message *pMessage)
//<-dceag-c190-e->
{
	cout << "Need to implement command #190 - Enter/Go" << endl;
//	pOwner->CMD_sendKey("head0", "");
}
...
void Moxi_PVR::CMD_Move_Up(string &sCMD_Result,Message *pMessage)
//<-dceag-c200-e->
{
//	cout << "Need to implement command #200 - Move Up" << endl;
	pOwner->CMD_sendKey("head0", "up");
}
...
void Moxi_PVR::CMD_Move_Down(string &sCMD_Result,Message *pMessage)
//<-dceag-c201-e->
{
//	cout << "Need to implement command #201 - Move Down" << endl;
	pOwner->CMD_sendKey("head0", "down");
}
...
void Moxi_PVR::CMD_Move_Left(string &sCMD_Result,Message *pMessage)
//<-dceag-c202-e->
{
//	cout << "Need to implement command #202 - Move Left" << endl;
	pOwner->CMD_sendKey("head0", "left");
}
...
void Moxi_PVR::CMD_Move_Right(string &sCMD_Result,Message *pMessage)
//<-dceag-c203-e->
{
//	cout << "Need to implement command #203 - Move Right" << endl;
	pOwner->CMD_sendKey("head0", "right");
}
...
void Moxi_PVR::CMD_0(string &sCMD_Result,Message *pMessage)
//<-dceag-c204-e->
{
...
void Moxi_PVR::CMD_1(string &sCMD_Result,Message *pMessage)
//<-dceag-c205-e->
{
...
void Moxi_PVR::CMD_2(string &sCMD_Result,Message *pMessage)
//<-dceag-c206-e->
{
...
void Moxi_PVR::CMD_3(string &sCMD_Result,Message *pMessage)
//<-dceag-c207-e->
{
...
void Moxi_PVR::CMD_4(string &sCMD_Result,Message *pMessage)
//<-dceag-c208-e->
{
...
void Moxi_PVR::CMD_5(string &sCMD_Result,Message *pMessage)
//<-dceag-c209-e->
{
...
void Moxi_PVR::CMD_6(string &sCMD_Result,Message *pMessage)
//<-dceag-c210-e->
{
...
void Moxi_PVR::CMD_7(string &sCMD_Result,Message *pMessage)
//<-dceag-c211-e->
{
...
void Moxi_PVR::CMD_8(string &sCMD_Result,Message *pMessage)
//<-dceag-c212-e->
{
...
void Moxi_PVR::CMD_9(string &sCMD_Result,Message *pMessage)
//<-dceag-c213-e->
{
...
void Moxi_PVR::CMD_Back_Prior_Menu(string &sCMD_Result,Message *pMessage)
//<-dceag-c240-e->
{
...
void Moxi_PVR::CMD_Start_Streaming(int iPK_MediaType,int iStreamID,string sMediaPosition,string sMediaURL,string sStreamingTargets,string &sCMD_Result,Message *pMessage)
//<-dceag-c249-e->
{
...
void Moxi_PVR::CMD_Report_Playback_Position(int iStreamID,string *sText,string *sMediaPosition,string &sCMD_Result,Message *pMessage)
//<-dceag-c259-e->
{
...
void Moxi_PVR::CMD_Set_Media_Position(int iStreamID,string sMediaPosition,string &sCMD_Result,Message *pMessage)
//<-dceag-c412-e->
{
...
void Moxi_PVR::CMD_Menu(string sText,string &sCMD_Result,Message *pMessage)
//<-dceag-c548-e->
{
