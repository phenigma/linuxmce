...
//	DCE Implemenation for #1871 Moxi PVR

#include "Gen_Devices/Moxi_PVRBase.h"
//<-dceag-d-e->

#include "IDeviceClientSmartHome.h"

//<-dceag-decl-b->
namespace DCE
{
	class Moxi_PVR : public Moxi_PVR_Command
	{
//<-dceag-decl-e->
		// Private member variables
		IDeviceClientSmartHome *pOwner;
...
public:
		...
		Moxi_PVR(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL);
		virtual ~Moxi_PVR();
...
//<-dceag-const-e->
		...
		void setOwner(IDeviceClientSmartHome *p);

//<-dceag-const2-b->
		// The following constructor is only used if this a class instance embedded within a DCE Device.  In that case, it won't create it's own connection to the router
		// You can delete this whole section and put an ! after dceag-const2-b tag if you don't want this constructor.  Do the same in the implementation file
		Moxi_PVR(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter);
//<-dceag-const2-e->
