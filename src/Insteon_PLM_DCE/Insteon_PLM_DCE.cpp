...
Insteon_PLM_DCE::Insteon_PLM_DCE(int DeviceID, string ServerAddress,bool bConnectEventHandler,bool bLocalMode,class Router *pRouter)
	: Insteon_PLM_DCE_Command(DeviceID, ServerAddress,bConnectEventHandler,bLocalMode,pRouter)
//<-dceag-const-e->
{
	myInsteonAPI = new InsteonAPI::InsteonAPI(this);
	myDeviceID=DeviceID;
...
Insteon_PLM_DCE::Insteon_PLM_DCE(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter)
	: Insteon_PLM_DCE_Command(pPrimaryDeviceCommand, pData, pEvent, pRouter)
//<-dceag-const2-e->
{
}

//<-dceag-dest-b->
Insteon_PLM_DCE::~Insteon_PLM_DCE()
//<-dceag-dest-e-> 
{
...
//<-dceag-getconfig-b->
bool Insteon_PLM_DCE::GetConfig()
{
	if( !Insteon_PLM_DCE_Command::GetConfig() )
		return false;
//<-dceag-getconfig-e->
	...
	myInsteonAPI->init(port.c_str());
	return true;
}

//<-dceag-reg-b->
// This function will only be used if this device is loaded into the DCE Router's memory space as a plug-in.  Otherwise Connect() will be called from the main()
bool Insteon_PLM_DCE::Register()
//<-dceag-reg-e->
{
...
//<-dceag-createinst-b->
Insteon_PLM_DCE_Command *Create_Insteon_PLM_DCE(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter)
{
	return new Insteon_PLM_DCE(pPrimaryDeviceCommand, pData, pEvent, pRouter);
}
//<-dceag-createinst-e->
...
*/
//<-dceag-cmdch-b->
void Insteon_PLM_DCE::ReceivedCommandForChild(DeviceData_Impl *pDeviceData_Impl,string &sCMD_Result,Message *pMessage)
//<-dceag-cmdch-e->
{
	sCMD_Result = "UNHANDLED CHILD";
	const char* strID = pDeviceData_Impl->m_mapParameters_Find(DEVICEDATA_PortChannel_Number_CONST).c_str();
	unsigned char* NodeID = str_id_to_hex((char*)strID);
...
*/
//<-dceag-cmduk-b->
void Insteon_PLM_DCE::ReceivedUnknownCommand(string &sCMD_Result,Message *pMessage)
//<-dceag-cmduk-e->
{
...
void Insteon_PLM_DCE::SomeFunction()
{
...
void Insteon_PLM_DCE::CMD_Download_Configuration(string sText,string &sCMD_Result,Message *pMessage)
//<-dceag-c757-e->
{
...
void Insteon_PLM_DCE::CMD_Send_Command_To_Child(string sID,int iPK_Command,string sParameters,string &sCMD_Result,Message *pMessage)
//<-dceag-c760-e->
{
...
void Insteon_PLM_DCE::CMD_StatusReport(string sArguments,string &sCMD_Result,Message *pMessage)
//<-dceag-c788-e->
{
