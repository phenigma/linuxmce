...
//	DCE Implemenation for #1858 Sound Bridge

#include "Gen_Devices/Sound_BridgeBase.h"
//<-dceag-d-e->

//<-dceag-decl-b->
namespace DCE
{
	class Sound_Bridge : public Sound_Bridge_Command
	{
//<-dceag-decl-e->
...
public:
		...
		Sound_Bridge(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL);
		virtual ~Sound_Bridge();
...
//<-dceag-const2-b->
		...
		Sound_Bridge(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter);
//<-dceag-const2-e->
