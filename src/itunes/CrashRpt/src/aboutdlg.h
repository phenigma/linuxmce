   ...
   LRESULT OnLicenseClick(WORD /*wNotifyCode*/, WORD wID, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
	{
      ...
      hrsrc = FindResource(GetModuleHandle(_T("Pluto iTunes Media Connector")), MAKEINTRESOURCE(IDR_LICENSE), "TEXT");

      hgres = LoadResource(GetModuleHandle(_T("Pluto iTunes Media Connector")), hrsrc);
