#ifndef __Define_psc_media_bathdr_H__
#define __Define_psc_media_bathdr_H__
...
#define PSC_MEDIA_BATHDR_IPADDRESS_FIELD "IPAddress"
#define PSC_MEDIA_BATHDR_IPADDRESS_TABLE_FIELD "psc_media_bathdr.IPAddress"
