...
class DECLSPECIFIER Table_psc_media_batdet : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_psc_media_batdet(Database_pluto_media *pDatabase):database(pDatabase)
	{
	};
...
class DECLSPECIFIER Row_psc_media_batdet : public TableRow, public SerializeClass
	{
