...
void FK_MediaSource_set(long int val);
...
void psc_restrict_setNull(bool val);
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_EK_MediaType+ m_FK_MediaSource+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod+ m_psc_restrict;
		}
	private:
		void SetDefaultValues();
		
		string EK_MediaType_asSQL();
string FK_MediaSource_asSQL();
string psc_id_asSQL();
