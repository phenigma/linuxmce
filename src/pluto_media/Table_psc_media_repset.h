...
class DECLSPECIFIER Table_psc_media_repset : public TableBase , SingleLongKeyBase
{
private:
...
class DECLSPECIFIER Row_psc_media_repset : public TableRow, public SerializeClass
	{
