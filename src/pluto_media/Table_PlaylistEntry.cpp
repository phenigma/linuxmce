...
values_list_comma_separated = values_list_comma_separated + pRow->PK_PlaylistEntry_asSQL()+", "+pRow->FK_Playlist_asSQL()+", "+pRow->FK_File_asSQL()+", "+pRow->FK_Bookmark_asSQL()+", "+pRow->Path_asSQL()+", "+pRow->Filename_asSQL()+", "+pRow->Order_asSQL()+", "+pRow->Duration_asSQL()+", "+pRow->psc_id_asSQL()+", "+pRow->psc_batch_asSQL()+", "+pRow->psc_user_asSQL()+", "+pRow->psc_frozen_asSQL()+", "+pRow->psc_restrict_asSQL();

	
		string query = "insert into PlaylistEntry (`PK_PlaylistEntry`, `FK_Playlist`, `FK_File`, `FK_Bookmark`, `Path`, `Filename`, `Order`, `Duration`, `psc_id`, `psc_batch`, `psc_user`, `psc_frozen`, `psc_restrict`) values ("+
...
update_values_list = update_values_list + "`PK_PlaylistEntry`="+pRow->PK_PlaylistEntry_asSQL()+", `FK_Playlist`="+pRow->FK_Playlist_asSQL()+", `FK_File`="+pRow->FK_File_asSQL()+", `FK_Bookmark`="+pRow->FK_Bookmark_asSQL()+", `Path`="+pRow->Path_asSQL()+", `Filename`="+pRow->Filename_asSQL()+", `Order`="+pRow->Order_asSQL()+", `Duration`="+pRow->Duration_asSQL()+", `psc_id`="+pRow->psc_id_asSQL()+", `psc_batch`="+pRow->psc_batch_asSQL()+", `psc_user`="+pRow->psc_user_asSQL()+", `psc_frozen`="+pRow->psc_frozen_asSQL()+", `psc_restrict`="+pRow->psc_restrict_asSQL();
