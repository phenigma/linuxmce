...
class DECLSPECIFIER Table_SearchToken_Attribute : public TableBase , DoubleLongKeyBase
{
private:
...
public:
	Table_SearchToken_Attribute(Database_pluto_media *pDatabase):database(pDatabase)
	{
	};
...
private:	
	...
	class Row_SearchToken_Attribute* FetchRow(DoubleLongKey &key);
		
			
};

class DECLSPECIFIER Row_SearchToken_Attribute : public TableRow, public SerializeClass
	{
...
class Row_Attribute* FK_Attribute_getrow();
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_FK_SearchToken+ m_FK_Attribute+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod+ m_psc_restrict;
		}
	private:
