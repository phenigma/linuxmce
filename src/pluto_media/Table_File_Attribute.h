...
class Row_AttributeType* FK_AttributeType_getrow();
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_FK_File+ m_FK_Attribute+ m_Track+ m_Section+ m_FK_AttributeType+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod+ m_psc_restrict;
		}
	private:
