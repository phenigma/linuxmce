...
class DLL_EXPORT Table_File_Attribute : public TableBase , DoubleLongKeyBase
{
private:
...
public:
	...
	Table_File_Attribute(Database_pluto_media *pDatabase):database(pDatabase), m_Mutex("File_Attribute")
	{
...
class DLL_EXPORT Row_File_Attribute : public TableRow, public SerializeClass
	{
...
class Row_Attribute* FK_Attribute_getrow();
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_FK_File+ m_FK_Attribute+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod;
		}
	private:
