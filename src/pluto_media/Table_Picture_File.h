...
public:
	Table_Picture_File(Database_pluto_media *pDatabase):database(pDatabase)
	{
	};
	~Table_Picture_File();
...
class Row_File* FK_File_getrow();
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_FK_Picture+ m_FK_File+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod+ m_psc_restrict;
		}
	private:
