...
class DECLSPECIFIER Table_SearchToken : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_SearchToken(Database_pluto_media *pDatabase):database(pDatabase)
	{
	};
	~Table_SearchToken();
...
private:	
	...
	class Row_SearchToken* FetchRow(SingleLongKey &key);
		
			
};

class DECLSPECIFIER Row_SearchToken : public TableRow, public SerializeClass
	{
...
void psc_restrict_setNull(bool val);
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_PK_SearchToken+ m_Token+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod+ m_psc_restrict;
		}
	private:
