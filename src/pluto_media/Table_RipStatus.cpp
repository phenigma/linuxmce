...
values_list_comma_separated = values_list_comma_separated + pRow->PK_RipStatus_asSQL()+", "+pRow->EK_Device_asSQL()+", "+pRow->Slot_asSQL()+", "+pRow->FK_Disc_asSQL()+", "+pRow->Type_asSQL()+", "+pRow->RipJob_asSQL()+", "+pRow->DateTime_asSQL()+", "+pRow->Status_asSQL()+", "+pRow->Message_asSQL()+", "+pRow->psc_id_asSQL()+", "+pRow->psc_batch_asSQL()+", "+pRow->psc_user_asSQL()+", "+pRow->psc_frozen_asSQL()+", "+pRow->psc_restrict_asSQL();

	
		string query = "insert into RipStatus (`PK_RipStatus`, `EK_Device`, `Slot`, `FK_Disc`, `Type`, `RipJob`, `DateTime`, `Status`, `Message`, `psc_id`, `psc_batch`, `psc_user`, `psc_frozen`, `psc_restrict`) values ("+
...
update_values_list = update_values_list + "`PK_RipStatus`="+pRow->PK_RipStatus_asSQL()+", `EK_Device`="+pRow->EK_Device_asSQL()+", `Slot`="+pRow->Slot_asSQL()+", `FK_Disc`="+pRow->FK_Disc_asSQL()+", `Type`="+pRow->Type_asSQL()+", `RipJob`="+pRow->RipJob_asSQL()+", `DateTime`="+pRow->DateTime_asSQL()+", `Status`="+pRow->Status_asSQL()+", `Message`="+pRow->Message_asSQL()+", `psc_id`="+pRow->psc_id_asSQL()+", `psc_batch`="+pRow->psc_batch_asSQL()+", `psc_user`="+pRow->psc_user_asSQL()+", `psc_frozen`="+pRow->psc_frozen_asSQL()+", `psc_restrict`="+pRow->psc_restrict_asSQL();
...
pRow->m_DateTime = string(row[6],lengths[6]);
}
...
pRow->m_Status = string(row[7],lengths[7]);
}
...
pRow->m_Message = string(row[8],lengths[8]);
}
