...
class DECLSPECIFIER Table_Type_AttributeType : public TableBase , DoubleLongKeyBase
{
private:
...
class DECLSPECIFIER Row_Type_AttributeType : public TableRow, public SerializeClass
	{
...
class Row_AttributeType* FK_AttributeType_getrow();
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_FK_Type+ m_FK_AttributeType+ m_Identifier+ m_CombineAsOne+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod+ m_psc_restrict;
		}
	private:
