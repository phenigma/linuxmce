...
class DECLSPECIFIER Table_psc_media_bathdr : public TableBase , SingleLongKeyBase
{
private:
...
class DECLSPECIFIER Row_psc_media_bathdr : public TableRow, public SerializeClass
	{
