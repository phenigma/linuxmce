...
class DECLSPECIFIER Table_psc_media_schema : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_psc_media_schema(Database_pluto_media *pDatabase):database(pDatabase)
	{
	};
...
class DECLSPECIFIER Row_psc_media_schema : public TableRow, public SerializeClass
	{
