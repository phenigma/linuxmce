...
extern int hdhomerun_device_get_tuner_program(struct hdhomerun_device_t *hd, uint16_t *pprogram_number, char **poptions);
...
extern int hdhomerun_device_set_tuner_program(struct hdhomerun_device_t *hd, uint16_t program_number, const char *options);
