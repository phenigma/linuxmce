...
extern "C" {
	class Command_Impl *RegisterAsPlugIn(class Router *pRouter,int PK_Device,Logger *pPlutoLogger)
	{
		...
		Moxi_Orbiter *pMoxi_Orbiter = new Moxi_Orbiter(PK_Device, "localhost",true,false,pRouter);
...
int main(int argc, char* argv[]) 
{
	...
	try
	{
		Moxi_Orbiter *pMoxi_Orbiter = new Moxi_Orbiter(PK_Device, sRouter_IP,true,bLocalMode);
