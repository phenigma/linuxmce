...
#include "Gen_Devices/Moxi_OrbiterBase.h"
//<-dceag-d-e->

//<-dceag-decl-b->
namespace DCE
{
	class Moxi_Orbiter : public Moxi_Orbiter_Command
	{
//<-dceag-decl-e->
		// Private member variables
		int m_PK_Device_MoxiMD;
...
public:
		...
		Moxi_Orbiter(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL);
...
//<-dceag-const2-b->
		...
		Moxi_Orbiter(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter);
//<-dceag-const2-e->
