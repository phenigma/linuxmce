...
Moxi_Orbiter::Moxi_Orbiter(int DeviceID,  int PK_DeviceTemplate, string ServerAddress)
	: Orbiter(DeviceID, PK_DeviceTemplate, ServerAddress, "", false, 0, 0, false)
{
}
...
void Moxi_Orbiter::SomeFunction()
{
