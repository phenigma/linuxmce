...
class DECLSPECIFIER Table_psc_security_bathdr : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_psc_security_bathdr(Database_pluto_security *pDatabase):database(pDatabase)
	{
	};
...
class DECLSPECIFIER Row_psc_security_bathdr : public TableRow, public SerializeClass
	{
