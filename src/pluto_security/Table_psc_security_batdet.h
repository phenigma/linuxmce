...
class DECLSPECIFIER Table_psc_security_batdet : public TableBase , SingleLongKeyBase
{
private:
...
public:
	Table_psc_security_batdet(Database_pluto_security *pDatabase):database(pDatabase)
	{
	};
...
class DECLSPECIFIER Row_psc_security_batdet : public TableRow, public SerializeClass
	{
