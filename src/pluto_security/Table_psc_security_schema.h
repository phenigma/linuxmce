...
class DLL_EXPORT Table_psc_security_schema : public TableBase , SingleLongKeyBase
{
private:
...
public:
	...
	Table_psc_security_schema(Database_pluto_security *pDatabase):database(pDatabase), m_Mutex("psc_security_schema")
	{
...
class DLL_EXPORT Row_psc_security_schema : public TableRow, public SerializeClass
	{
