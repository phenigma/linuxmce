...
class DECLSPECIFIER Table_psc_security_tables : public TableBase , SingleLongKeyBase
{
private:
...
class DECLSPECIFIER Row_psc_security_tables : public TableRow, public SerializeClass
	{
