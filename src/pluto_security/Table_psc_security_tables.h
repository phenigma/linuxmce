...
public:
	...
	Table_psc_security_tables(Database_pluto_security *pDatabase):database(pDatabase), m_Mutex("psc_security_tables")
	{
...
void last_psc_batch_setNull(bool val);
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_PK_psc_security_tables+ m_Tablename+ m_filter+ m_frozen+ m_last_psc_id+ m_last_psc_batch;
		}
	private:
