...
*/
//<-dceag-d-b->
#ifndef SmartQ_Media_Plugin_h
#define SmartQ_Media_Plugin_h

//	DCE Implemenation for #2101 SmartQ PlugIn

#include "Gen_Devices/SmartQ_Media_PluginBase.h"
//<-dceag-d-e->
...
namespace DCE
{
	class SmartQ_Media_Plugin : public SmartQ_Media_Plugin_Command, public MediaHandlerBase 
	{
//<-dceag-decl-e->
		// Private member variables

	  pluto_pthread_mutex_t m_SmartQMediaMutex; // protect us from ourselves.
...
public:
		...
		SmartQ_Media_Plugin(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL);
		virtual ~SmartQ_Media_Plugin();
...
public:
	/** Mandatory implementations */
		...
		SmartQMediaStream *ConvertToSmartQMediaStream(MediaStream *pMediaStream, string callerIdMessage = "");
...
//<-dceag-const2-b->
		...
		SmartQ_Media_Plugin(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter);
//<-dceag-const2-e->
