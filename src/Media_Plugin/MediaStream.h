...
namespace DCE
{
    ...
    */
    ...
    public:
		...
		int m_iTrackOrSection; /** Gets sent to Orbiter in set now playing and becomes the seek value for the tracks/media sections grid, or if -1, m_iDequeMediaFile_Pos is used */
