...
public:
	Table_Users(Database_pluto_telecom *pDatabase):database(pDatabase)
	{
	};
	~Table_Users();
...
public:				
	...
	class Row_Users* GetRow(long int in_EK_Users);
...
void SyncSettings_set(string val);
...
bool psc_restrict_isNull();
		...
		void SyncSettings_setNull(bool val);
...
void psc_restrict_setNull(bool val);
		...
		void SetupSerialization(int iSC_Version) {
			StartSerializeList() + m_EK_Users+ m_SyncSettings+ m_psc_id+ m_psc_batch+ m_psc_user+ m_psc_frozen+ m_psc_mod+ m_psc_restrict;
		}
	private:
		void SetDefaultValues();
		
		string EK_Users_asSQL();
string SyncSettings_asSQL();
string psc_id_asSQL();
