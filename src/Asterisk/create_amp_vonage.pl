...
my $DECLARED_NUMBER;
my $DECLARED_HOST = "sphone.vopr.vonage.net";
...
$TRUNK_VARS{'peerdetails'} ="allow=alaw&ulaw&g729\n";
$TRUNK_VARS{'peerdetails'}.="auth=md5\n";
$TRUNK_VARS{'peerdetails'}.="defaultexpirey=120\n";
...
$TRUNK_VARS{'userconfig'} ="allow=alaw&ulaw&g729\n";
$TRUNK_VARS{'userconfig'}.="auth=md5\n";
$TRUNK_VARS{'userconfig'}.="defaultexpirey=120\n";
...
$TRUNK_VARS{'userconfig'}.="port=5061\n";

$TRUNK_VARS{'register'}="$DECLARED_USERNAME:$DECLARED_USERPASSWD\@$DECLARED_HOST:5061";
