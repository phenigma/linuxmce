...
$TRUNK_VARS{'peerdetails'}.="fromdomain=sip.broadvoice.com\n";
$TRUNK_VARS{'peerdetails'}.="host=sip.broadvoice.com\n";
...
$TRUNK_VARS{'userconfig'}.="host=bs01.e-fon.ch\n";
...
$TRUNK_VARS{'userconfig'}.="host=sip.broadvoice.com\n";
$TRUNK_VARS{'userconfig'}.="dtmfmode=rfc2283\n";
...
$TRUNK_VARS{'register'}="$DECLARED_USERNAME\@sip.broadvoice.com:$DECLARED_USERPASSWD:$DECLARED_USERNAME\@sip.broadvoice.com";
