...
my $DECLARED_NUMBER;
my $DECLARED_HOST = "switch.nufone.net";
...
$TRUNK_VARS{'outcid'}=$1."-".$2."-".$3 if($DECLARED_NUMBER=~/^(\d{3})(\d{3})(\d{4})$/);
$TRUNK_VARS{'maxchans'}="";
$TRUNK_VARS{'dialrules'}=$DECLARED_PREFIX."|.";
$TRUNK_VARS{'autopop'}="";
$TRUNK_VARS{'dialoutprefix'}="";
$TRUNK_VARS{'channelid'}="nufone-out";
$TRUNK_VARS{'peerdetails'} ="host=switch-1.nufone.net\n";
