...
$TRUNK_VARS{'peerdetails'}.="host=sipgate.co.uk\n";
...
$TRUNK_VARS{'peerdetails'}.="fromdomain=sipgate.co.uk\n";
...
$TRUNK_VARS{'userconfig'}.="host=sipgate.co.uk\n";
...
$TRUNK_VARS{'userconfig'}.="fromdomain=sipgate.co.uk\n";
...
$TRUNK_VARS{'register'}="$DECLARED_USERNAME:$DECLARED_USERPASSWD\@sipgate.co.uk/$DECLARED_USERNAME";
