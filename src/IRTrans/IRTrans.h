...
//<-dceag-const-e->
		...
		virtual void OnQuit() { g_pPlutoLogger->Write(LV_STATUS,"IRTrans will quit"); m_bQuit_VL = true; m_bQuit_set(true); Command_Impl::OnQuit(); };
		virtual void OnReload() { g_pPlutoLogger->Write(LV_STATUS,"IRTrans will reload"); m_bQuit_VL = true; m_bQuit_set(true); Command_Impl::OnQuit(); }
