...
installCorrectNvidiaDriver() {
	...
	if [[ "$preferred_driver" == "nvidia-gxl-260" ]] && [[ "$current_driver" == "nvidia-current" ]]; then
		markUp="0"
	fi
	if [[ "$markUp" == "1" ]]; then
