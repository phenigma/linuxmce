//
// C++ Interface: AirPlay_Streamer_Plugin
//
// Description:
//
//
...
namespace DCE
{
	...
	class AirPlayMediaStream : public MediaStream
	{
		...
		public:
			...
			AirPlayMediaStream(class AirPlay_Streamer_Plugin *pHuluPlugIn, class MediaHandlerInfo *pMediaHandlerInfo, int iPK_MediaProvider,MediaDevice *pMediaDevice, int PK_Users,enum SourceType sourceType,int iStreamID);
