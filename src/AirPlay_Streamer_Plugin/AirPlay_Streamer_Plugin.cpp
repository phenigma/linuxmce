...
//<-dceag-getconfig-b->
bool AirPlay_Streamer_Plugin::GetConfig()
{
	if( !AirPlay_Streamer_Plugin_Command::GetConfig() )
		return false;
//<-dceag-getconfig-e->
...
//<-dceag-createinst-b->
AirPlay_Streamer_Plugin_Command *Create_AirPlay_Streamer_Plugin(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter)
{
	return new AirPlay_Streamer_Plugin(pPrimaryDeviceCommand, pData, pEvent, pRouter);
}
//<-dceag-createinst-e->
...
*/
//<-dceag-cmdch-b->
void AirPlay_Streamer_Plugin::ReceivedCommandForChild(DeviceData_Impl *pDeviceData_Impl,string &sCMD_Result,Message *pMessage)
//<-dceag-cmdch-e->
{
