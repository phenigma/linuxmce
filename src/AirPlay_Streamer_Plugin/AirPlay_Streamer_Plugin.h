...
*/
//<-dceag-d-b->
#ifndef AirPlay_Streamer_Plugin_h
#define AirPlay_Streamer_Plugin_h

//	DCE Implemenation for #2252 AirPlay Streamer Plugin
...
public:
		...
		AirPlay_Streamer_Plugin(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL);
		virtual ~AirPlay_Streamer_Plugin();
...
//<-dceag-const2-b->
		...
		AirPlay_Streamer_Plugin(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter);
//<-dceag-const2-e->
