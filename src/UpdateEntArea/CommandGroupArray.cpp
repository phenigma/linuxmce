...
CommandGroup *CommandGroupArray::FindCommandGroupByTemplate(Row_Room *pRow_Room,int PK_Template,string sDescription,int PK_Icon,int TemplateParm1,int TemplateParm2,int *PK_CommandGroup)
{
	...
	pRow_CommandGroup->FK_Installation_set( pRow_Room->FK_Installation_get() );
	...
	g_pPlutoLogger->Write(LV_STATUS,"Added room %d %s ea: %d %s hint: %s",
...
CommandGroup *CommandGroupArray::FindCommandGroupByTemplate(Row_EntertainArea *pRow_EntertainArea,int PK_Template,string sDescription,int PK_Icon,int TemplateParm1,int TemplateParm2,int *PK_CommandGroup)
{
	...
	pRow_CommandGroup->FK_Template_set(PK_Template);
	pRow_CommandGroup->Description_set(sDescription);
	pRow_CommandGroup->FK_Installation_set( pRow_EntertainArea->FK_Room_getrow()->FK_Installation_get() );
	pRow_CommandGroup->FK_Array_set( m_PK_Array );
	pRow_CommandGroup->FK_Icon_set( PK_Icon );
	pRow_CommandGroup->TemplateParm1_set(TemplateParm1);
	pRow_CommandGroup->TemplateParm2_set(TemplateParm2);
