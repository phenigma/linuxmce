...
Install(
   ...
   IN const char* const lpTo OPTIONAL,                    // Email:to
   IN const char* const lpSubject OPTIONAL                // Email:subject
   );
...
AddFile(
   IN LPVOID lpState,                           // State from Install()
   IN const char* const lpFile,                           // File name
   IN const char* const lpDesc                            // File desc
   );
