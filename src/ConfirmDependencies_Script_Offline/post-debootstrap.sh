...
mkdir -p "$DIR"
SCRIPTS="ConfirmDependencies_Debian.sh Initial_Config.sh Initial_Config_Core.sh Initial_Config_MD.sh Common.sh Download_Direct.sh Download_SVN.sh Download_CVS.sh"
for S in $SCRIPTS; do
