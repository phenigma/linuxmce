...
mkdir -p "$DIR"
SCRIPTS="Initial_Config.sh Initial_Config_Core.sh Initial_Config_MD.sh Initial_Config_Finish.sh Common.sh Download_Direct.sh Download_SVN.sh Download_CVS.sh"
for S in $SCRIPTS; do
