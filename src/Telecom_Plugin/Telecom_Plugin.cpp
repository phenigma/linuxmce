...
class DataGridTable *Telecom_Plugin::SpeedDialGrid(string GridID,string Parms,void *ExtraData,int *iPK_Variable,string *sValue_To_Assign,class Message *pMessage)
{
	...
	string sql_buff = "SELECT CommandGroup.Description, CommandGroup_Command_CommandParameter.FK_CommandParameter, CommandGroup_Command_CommandParameter.IK_CommandParameter";
