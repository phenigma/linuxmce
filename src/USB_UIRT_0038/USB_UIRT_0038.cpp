...
//<-dceag-getconfig-e->
	...
	{
		m_mapCodesToButtons["4326ABF050F1"] = make_pair ("power",0);
		m_mapCodesToButtons["412F8DF050F1"] = make_pair ("stop",0);
		m_mapCodesToButtons["412E96F050F1"] = make_pair ("record",0);
		m_mapCodesToButtons["43248DF050F1"] = make_pair ("pause",0);
		m_mapCodesToButtons["412E97F050F1"] = make_pair ("play",0);
		m_mapCodesToButtons["3F2C38F050F1"] = make_pair ("rewind",0);
		m_mapCodesToButtons["412E93F050F1"] = make_pair ("fastforward",0);
		m_mapCodesToButtons["412F8FF050F1"] = make_pair ("skipback",0);
		m_mapCodesToButtons["412F8EF050F1"] = make_pair ("skipfwd",0);
		m_mapCodesToButtons["412F52F050F1"] = make_pair ("back",0);
		m_mapCodesToButtons["432688F050F1"] = make_pair ("up",0);
		m_mapCodesToButtons["4324AAF050F1"] = make_pair ("info",0);
		m_mapCodesToButtons["432450F050F1"] = make_pair ("left",0);
		m_mapCodesToButtons["412F53F050F1"] = make_pair ("ok",0);
		m_mapCodesToButtons["412F50F050F1"] = make_pair ("right",0);
		m_mapCodesToButtons["432488F050F1"] = make_pair ("down",0);
		m_mapCodesToButtons["43249CF050F1"] = make_pair ("volup",0);
		m_mapCodesToButtons["412F9CF050F1"] = make_pair ("voldn",0);
		m_mapCodesToButtons["412FABF050F1"] = make_pair ("start",0);
		m_mapCodesToButtons["412F9FF050F1"] = make_pair ("chup",0);
		m_mapCodesToButtons["412F9EF050F1"] = make_pair ("chdown",0);
		m_mapCodesToButtons["4326AAF050F1"] = make_pair ("mute",0);
		m_mapCodesToButtons["412E5CF350F1"] = make_pair ("recorded_tv",0);
		m_mapCodesToButtons["412E5BF050F1"] = make_pair ("guide",0);
		m_mapCodesToButtons["3F2C5EF050F1"] = make_pair ("live_tv",0);
		m_mapCodesToButtons["412E5FF050F1"] = make_pair ("menu",0);
		m_mapCodesToButtons["4325A0F050F1"] = make_pair ("1",0);
		m_mapCodesToButtons["4323A0F050F1"] = make_pair ("2",0);
		m_mapCodesToButtons["4321A0F050F1"] = make_pair ("3",0);
		m_mapCodesToButtons["4322A3F050F1"] = make_pair ("4",0);
		m_mapCodesToButtons["412EA3F050F1"] = make_pair ("5",0);
		m_mapCodesToButtons["4322A2F050F1"] = make_pair ("6",0);
		m_mapCodesToButtons["4320A2F050F1"] = make_pair ("7",0);
		m_mapCodesToButtons["4324AFF050F1"] = make_pair ("8",0);
		m_mapCodesToButtons["412FAFF050F1"] = make_pair ("9",0);
		m_mapCodesToButtons["450CA0F050F1"] = make_pair ("0",0);
		m_mapCodesToButtons["412FACF050F1"] = make_pair ("clear",0);
		m_mapCodesToButtons["412FADF050F1"] = make_pair ("enter",0);
		m_mapCodesToButtons["7B717F3EFFFF"] = make_pair ("text",0);
		m_mapCodesToButtons["7D717F3EFFFF"] = make_pair ("red",0);
		m_mapCodesToButtons["B9C5FDF9FCFF"] = make_pair ("green",0);
		m_mapCodesToButtons["6C717F3EFFFF"] = make_pair ("yellow",0);
		m_mapCodesToButtons["A7C5FDF9FCFF"] = make_pair ("blue",0);

		m_mapCodesToButtons["4326AAF040F1"] = make_pair ("power",0);
		m_mapCodesToButtons["412F8CF040F1"] = make_pair ("stop",0);
		m_mapCodesToButtons["412E97F040F1"] = make_pair ("record",0);
		m_mapCodesToButtons["43248CF040F1"] = make_pair ("pause",0);
		m_mapCodesToButtons["412E96F040F1"] = make_pair ("play",0);
		m_mapCodesToButtons["3F2C39F040F1"] = make_pair ("rewind",0);
		m_mapCodesToButtons["412E92F040F1"] = make_pair ("fastforward",0);
		m_mapCodesToButtons["412F8EF040F1"] = make_pair ("skipback",0);
		m_mapCodesToButtons["412F8FF040F1"] = make_pair ("skipfwd",0);
		m_mapCodesToButtons["412F53F040F1"] = make_pair ("back",0);
		m_mapCodesToButtons["432689F040F1"] = make_pair ("up",0);
		m_mapCodesToButtons["4324ABF040F1"] = make_pair ("info",0);
		m_mapCodesToButtons["432451F040F1"] = make_pair ("left",0);
		m_mapCodesToButtons["412F52F040F1"] = make_pair ("ok",0);
		m_mapCodesToButtons["412F51F040F1"] = make_pair ("right",0);
		m_mapCodesToButtons["432489F040F1"] = make_pair ("down",0);
		m_mapCodesToButtons["43249DF040F1"] = make_pair ("volup",0);
		m_mapCodesToButtons["412F9DF040F1"] = make_pair ("voldn",0);
		m_mapCodesToButtons["412FAAF040F1"] = make_pair ("start",0);
		m_mapCodesToButtons["412F9EF040F1"] = make_pair ("chup",0);
		m_mapCodesToButtons["412F9FF040F1"] = make_pair ("chdown",0);
		m_mapCodesToButtons["4326ABF040F1"] = make_pair ("mute",0);
		m_mapCodesToButtons["412E5DF340F1"] = make_pair ("recorded_tv",0);
		m_mapCodesToButtons["412E5AF040F1"] = make_pair ("guide",0);
		m_mapCodesToButtons["3F2C5FF040F1"] = make_pair ("live_tv",0);
		m_mapCodesToButtons["412E5EF040F1"] = make_pair ("menu",0);
		m_mapCodesToButtons["4325A1F040F1"] = make_pair ("1",0);
		m_mapCodesToButtons["4323A1F040F1"] = make_pair ("2",0);
		m_mapCodesToButtons["4321A1F040F1"] = make_pair ("3",0);
		m_mapCodesToButtons["4322A2F040F1"] = make_pair ("4",0);
		m_mapCodesToButtons["412EA2F040F1"] = make_pair ("5",0);
		m_mapCodesToButtons["4322A3F040F1"] = make_pair ("6",0);
		m_mapCodesToButtons["4320A3F040F1"] = make_pair ("7",0);
		m_mapCodesToButtons["4324AEF040F1"] = make_pair ("8",0);
		m_mapCodesToButtons["412FAEF040F1"] = make_pair ("9",0);
		m_mapCodesToButtons["450CA1F040F1"] = make_pair ("0",0);
		m_mapCodesToButtons["412FADF040F1"] = make_pair ("clear",0);
		m_mapCodesToButtons["412FACF040F1"] = make_pair ("enter",0);
		m_mapCodesToButtons["7B719F3FFFFF"] = make_pair ("text",0);
		m_mapCodesToButtons["7D719F3FFFFF"] = make_pair ("red",0);
		m_mapCodesToButtons["B9C57DFEFCFF"] = make_pair ("green",0);
		m_mapCodesToButtons["6C719F3FFFFF"] = make_pair ("yellow",0);
		m_mapCodesToButtons["A7C57DFEFCFF"] = make_pair ("blue",0);
			...
			pDevice->m_dwPK_DeviceCategory==DEVICECATEGORY_USBUIRT_Remote_Controls_CONST )
		{
			...
			if( SendCommand(CMD_Get_Device_Data_Cat) && sConfiguration.size() )
			{
				...
				for(size_t s=0;s<vectCodes.size();++s)
				{
					...
					{
						string sCode = StringUtils::Tokenize(vectCodes[s]," ",pos);
						m_mapCodesToButtons[sCode] = make_pair (sButton,pDevice->m_dwPK_Device);
						// Jon -- sCode will the code in whatever format you want.  sButton is the button name it corresponds to
						LoggerWrapper::GetInstance()->Write(LV_STATUS,"Code: %s will fire button %s",sCode.c_str(),sButton.c_str());
					}
				}
