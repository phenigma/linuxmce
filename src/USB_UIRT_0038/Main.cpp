...
#define  VERSION "2.0.0.37"
const char *g_szCompile_Date="Thu Feb 16 04:39:11 2006";
int g_SvnRevision=7420;
...
int main(int argc, char* argv[]) 
{
	...
	try
	{
		if( sLogger=="dcerouter" )
			g_pPlutoLogger = new ServerLogger(PK_Device, USB_UIRT_0038::PK_DeviceTemplate_get_static(), sRouter_IP);
