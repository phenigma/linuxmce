...
namespace DCE
{
	class MAME_Player : public MAME_Player_Command, public AlarmEvent
	{
//<-dceag-decl-e->
		// Private member variables
private:
		pluto_pthread_mutex_t m_MAMEMutex;
		unsigned long m_iMAMEWindowId;
		DeviceData_Base *m_pDevice_MAME_Plugin;
...
public:
		...
		MAME_Player(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL);
		virtual ~MAME_Player();
