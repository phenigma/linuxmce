...
namespace DCE
{
	...
	class VideoLanMediaStream : public MediaStream
	{
		...
		public:
			VideoLanMediaStream(class VideoLan_PlugIn *pVideoLanPlugin, class MediaHandlerInfo *pMediaHandlerInfo, MediaDevice *pMediaDevice, int PK_DesignObj_Remote, int PK_Users,enum SourceType sourceType,int iStreamID);
