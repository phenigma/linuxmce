...
MODULE_DESCRIPTION("ADC WM8739 init Driver");
MODULE_AUTHOR("T. Adachi <tadachi@tadachi-net.com>"); 
MODULE_LICENSE("GPL");
...
#ifndef I2C_DRIVERID_WM8739
#define I2C_DRIVERID_WM8739 I2C_DRIVERID_EXP0
#endif
