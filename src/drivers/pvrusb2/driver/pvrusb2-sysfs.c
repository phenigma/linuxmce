/*
 *
 *  $Id: pvrusb2-sysfs.c 2288 2009-05-02 03:35:18Z isely $
 *
...
#ifdef PVR2_ENABLE_NO_DEV_NAME_API
	snprintf(class_dev->bus_id, BUS_ID_SIZE, "%s",
...
#endif
#ifdef PVR2_ENABLE_OLD_SYSFS_HOTPLUG
