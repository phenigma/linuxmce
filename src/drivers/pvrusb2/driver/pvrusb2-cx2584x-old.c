/*
 *
 *  $Id: pvrusb2-cx2584x-old.c 1509 2007-01-19 06:30:10Z isely $
 *
...
static void set_input(struct pvr2_v4l_cx2584x *ctxt)
{
	...
	case PVR2_CVAL_INPUT_TV:
		v = CX25840_TUNER;
		break;
	case PVR2_CVAL_INPUT_RADIO: // wm8775 routes this similar to composite
	case PVR2_CVAL_INPUT_COMPOSITE:
		v = CX25840_COMPOSITE0;
		break;
	...
	pvr2_i2c_client_cmd(ctxt->client,AUDC_SET_INPUT,&v);
}
