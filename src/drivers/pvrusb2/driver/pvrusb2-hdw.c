/*
 *
 *  $Id: pvrusb2-hdw.c 2360 2009-11-01 04:06:45Z isely $
 *
...
static int ctlchg;
#ifdef PVR2_ENABLE_INITUSBRESET
...
#else /* PVR2_ENABLE_CX2341XMOD */

static const char *control_values_srate[] = {
	[PVR2_CVAL_SRATE_48]   = "48 kHz",
	[PVR2_CVAL_SRATE_44_1] = "44.1 kHz",
	[PVR2_CVAL_SRATE_32]   = "32 kHz",
};

static const char *control_values_audiobitrate[] = {
	[PVR2_CVAL_AUDIOBITRATE_384] = "384 kbps",
	[PVR2_CVAL_AUDIOBITRATE_320] = "320 kbps",
	[PVR2_CVAL_AUDIOBITRATE_256] = "256 kbps",
	[PVR2_CVAL_AUDIOBITRATE_224] = "224 kbps",
	[PVR2_CVAL_AUDIOBITRATE_192] = "192 kbps",
	[PVR2_CVAL_AUDIOBITRATE_160] = "160 kbps",
	[PVR2_CVAL_AUDIOBITRATE_128] = "128 kbps",
	[PVR2_CVAL_AUDIOBITRATE_112] = "112 kbps",
	[PVR2_CVAL_AUDIOBITRATE_96]  = "96 kbps",
	[PVR2_CVAL_AUDIOBITRATE_80]  = "80 kbps",
	[PVR2_CVAL_AUDIOBITRATE_64]  = "64 kbps",
	[PVR2_CVAL_AUDIOBITRATE_56]  = "56 kbps",
	[PVR2_CVAL_AUDIOBITRATE_48]  = "48 kbps",
	[PVR2_CVAL_AUDIOBITRATE_32]  = "32 kbps",
	[PVR2_CVAL_AUDIOBITRATE_VBR] = "VBR",
};


static const char *control_values_mpegaudiomode[] = {
	[PVR2_CVAL_MPEGAUDIOMODE_STEREO]       = "Stereo",
	[PVR2_CVAL_MPEGAUDIOMODE_JOINT_STEREO] = "Joint Stereo",
	[PVR2_CVAL_MPEGAUDIOMODE_DUAL]         = "Dual",
	[PVR2_CVAL_MPEGAUDIOMODE_MONO]         = "Mono",
};


static const char *control_values_streamtype[] = {
	[PVR2_CVAL_STREAMTYPE_PS] = "MPEG-2 Program Stream",
	[PVR2_CVAL_STREAMTYPE_TS] = "MPEG-2 Transport Stream",
	[PVR2_CVAL_STREAMTYPE_SS] = "MPEG-1 System Stream",
	[PVR2_CVAL_STREAMTYPE_DVD] = "MPEG-2 DVD-compatible Stream",
	[PVR2_CVAL_STREAMTYPE_VCD] = "MPEG-1 VCD-compatible Stream",
	[PVR2_CVAL_STREAMTYPE_SVCD] = "MPEG-2 SVCD-compatible Stream",
	[PVR2_CVAL_STREAMTYPE_DVDS1] = "DVD S1 Stream",
	[PVR2_CVAL_STREAMTYPE_DVDS2] = "DVD S2 Stream",
	[PVR2_CVAL_STREAMTYPE_PESAV] = "PES A/V Stream",
	[PVR2_CVAL_STREAMTYPE_PESV] = "PES Video Stream",
	[PVR2_CVAL_STREAMTYPE_PESA] = "PES Audio Stream",
};


static const char *control_values_aspect[] = {
	[PVR2_CVAL_ASPECT_1X1] = "1x1",
	[PVR2_CVAL_ASPECT_4X3] = "4x3",
	[PVR2_CVAL_ASPECT_16X9] = "16x9",
	[PVR2_CVAL_ASPECT_221X1] = "2.21x1",
};


static const char *control_values_vbr[] = {
	[PVR2_CVAL_VBR_VARIABLE] = "Variable Bitrate",
	[PVR2_CVAL_VBR_CONSTANT] = "Constant Bitrate",
};


static const char *control_values_audiomodeextension[] = {
	[PVR2_CVAL_AUDIOMODEEXTENSION_BOUND_4]  = "Bound 4",
	[PVR2_CVAL_AUDIOMODEEXTENSION_BOUND_8]  = "Bound 8",
	[PVR2_CVAL_AUDIOMODEEXTENSION_BOUND_12] = "Bound 12",
	[PVR2_CVAL_AUDIOMODEEXTENSION_BOUND_16] = "Bound 16",
};


static const char *control_values_audioemphasis[] = {
	[PVR2_CVAL_AUDIOEMPHASIS_NONE]  = "No Emphasis",
	[PVR2_CVAL_AUDIOEMPHASIS_50_15] = "50/15 us",
	[PVR2_CVAL_AUDIOEMPHASIS_CCITT] = "CCITT J17",
};
#endif
...
static int ctrl_cx2341x_set(struct pvr2_ctrl *cptr,int m,int v)
{
	...
	c1.value = v;
#ifdef PVR2_ENABLE_CX2341XOLD
	ret = cx2341x_ext_ctrls(&hdw->enc_ctl_state, &cs,
				VIDIOC_S_EXT_CTRLS);
	/* Act like all changes are unsafe for older versions of the
	   cx2341x module. */
...
VCREATE_FUNCS(audiomodeextension)
VCREATE_FUNCS(mpegaudiomode)
VCREATE_FUNCS(audiobitrate)
VCREATE_FUNCS(audiocrc)
VCREATE_FUNCS(audioemphasis)
VCREATE_FUNCS(streamtype)
VCREATE_FUNCS(aspect)
VCREATE_FUNCS(pulldown)
VCREATE_FUNCS(vbr)
...
static const struct pvr2_ctl_info control_defs[] = {
	{
		...
		.v4l_id = V4L2_CID_PVR_AUDIOMODEEXTENSION,
		.desc = "Audio Stereo Mode Extension",
		.name = "mpeg_audio_mode_extension",
		.default_value = PVR2_CVAL_AUDIOMODEEXTENSION_BOUND_4,
		DEFREF(audiomodeextension),
		DEFENUM(control_values_audiomodeextension),
	},{
		.v4l_id = V4L2_CID_PVR_MPEGAUDIOMODE,
		.desc = "Audio Stereo Mode",
		.name = "mpeg_audio_mode",
		.default_value = PVR2_CVAL_MPEGAUDIOMODE_STEREO,
		DEFREF(mpegaudiomode),
		DEFENUM(control_values_mpegaudiomode),
	},{
		.v4l_id = V4L2_CID_PVR_AUDIOBITRATE,
		.desc = "Audio Layer II Bitrate",
		.name = "audio_bitrate",
		...
		.v4l_id = V4L2_CID_PVR_STREAMTYPE,
		.desc = "Stream Type",
		.name = "stream_type",
		.default_value = PVR2_CVAL_STREAMTYPE_DVD,
		DEFREF(streamtype),
		DEFENUM(control_values_streamtype),
	},{
		.v4l_id = V4L2_CID_PVR_ASPECT,
		.desc = "Video Aspect",
		.name = "video_aspect",
		.default_value = PVR2_CVAL_ASPECT_4X3,
		DEFREF(aspect),
		DEFENUM(control_values_aspect),
	},{
		.v4l_id = V4L2_CID_PVR_PULLDOWN,
		.desc = "Video Pulldown",
		.name = "video_pulldown",
		.default_value = 0,
		DEFREF(pulldown),
		...
		.desc = "Video Bitrate Mode",
		.name = "video_bitrate_mode",
		.default_value = 0,
		DEFREF(vbr),
		DEFENUM(control_values_vbr),
	},{
		...
		.desc = "Video Peak Bitrate",
		.name = "video_bitrate_peak",
		.default_value = 6000000,
		DEFREF(videopeak),
		DEFINT(500000,20000000),
	},{
		.desc = "Audio Encoding Layer",
		.name = "audio_layer",
		.default_value = 2,
		DEFREF(audiolayer),
		DEFINT(0,3),
...
#ifndef PVR2_ENABLE_NOSETTOGGLE
...
#ifdef PVR2_ENABLE_STDEEPROMHACK
...
#ifdef PVR2_ENABLE_STDADJ
// This is a mapping of additional standards to support if certain
// standards are already present.
static const struct pvr2_std_hack std_hacks[] = {
	{
		// Devices which are NTSC-M capable are also marked as
		// NTSC-Mj capable on the device's sticker, and Mauro
		// reports that PAL-M should work here as well.
		.pat = V4L2_STD_NTSC_M,
		.std = V4L2_STD_NTSC_M_JP|V4L2_STD_PAL_M,
	},{
...
static void pvr2_hdw_setup_std(struct pvr2_hdw *hdw)
{
	...
	{
		unsigned int idx;
		for (idx = 0; idx < ARRAY_SIZE(std_hacks); idx++) {
		...
		std2 &= ~hdw->std_mask_eeprom;
	}

	if (std2) {
		bcnt = pvr2_std_id_to_str(buf,sizeof(buf),std2);
		pvr2_trace(PVR2_TRACE_STD,
			   "Based on hardware available list,"
			   " also supporting: %.*s",
			   bcnt,buf);
...
#ifdef PVR2_ENABLE_V4L2SUBDEV_THRASH2
...
static void pvr2_hdw_remove_usb_stuff(struct pvr2_hdw *hdw)
{
	...
	/* If we don't do this, then there will be a dangling struct device
	   ...
	   core... */
#ifdef PVR2_ENABLE_V4L2SUBDEV_DISCONNECT
...
static int pvr2_hdw_commit_execute(struct pvr2_hdw *hdw)
{
	...
	if (hdw->std_dirty) {
		...
		if (gop_size != hdw->enc_ctl_state.video_gop_size) {
			...
			c1.value = gop_size;
#ifdef PVR2_ENABLE_CX2341XOLD
			cx2341x_ext_ctrls(&hdw->enc_ctl_state, &cs,
					  VIDIOC_S_EXT_CTRLS);
#else
	...
	disruptive_change =
		(hdw->std_dirty ||
		 ...
		 hdw->audiocrc_dirty ||
		 hdw->audiomodeextension_dirty ||
		 hdw->mpegaudiomode_dirty ||
		 hdw->audioemphasis_dirty ||
		 hdw->streamtype_dirty ||
		 hdw->aspect_dirty ||
		 hdw->pulldown_dirty ||
#endif
		 hdw->srate_dirty ||
				...
				void *read_data,unsigned int read_len)
{
	...
	if (write_len) {
		...
		usb_fill_bulk_urb(hdw->ctl_write_urb,
				  ...
				  hdw);
#ifdef PVR2_ENABLE_OLD_URBASYNC
...
#endif
{
	...
	/* Older implementation could only match against driver id. */
	if (match_type != 1) return -EINVAL;
	req.i2c_id = match_chip;
#else
#ifdef PVR2_ENABLE_OLD2REGISTER_ACCESS
...
#ifdef PVR2_ENABLE_OLDREGISTER_ACCESS
			if (cp->client->driver->id != match_chip) {
				continue;
			}
#else
#ifdef PVR2_ENABLE_OLD2REGISTER_ACCESS
