/*
 *
 *  $Id: pvrusb2-hdw.h 2352 2009-11-01 02:26:17Z isely $
 *
...
#define V4L2_CID_PVR_AUDIOMODEEXTENSION (V4L2_CID_PRIVATE_BASE+8)
#define V4L2_CID_PVR_MPEGAUDIOMODE  (V4L2_CID_PRIVATE_BASE+9)
#define V4L2_CID_PVR_STREAMTYPE     (V4L2_CID_PRIVATE_BASE+10)
#define V4L2_CID_PVR_ASPECT         (V4L2_CID_PRIVATE_BASE+11)
#define V4L2_CID_PVR_PULLDOWN       (V4L2_CID_PRIVATE_BASE+12)
#endif
