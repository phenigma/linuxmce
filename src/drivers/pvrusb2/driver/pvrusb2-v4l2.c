/*
 *
 *  $Id: pvrusb2-v4l2.c 2345 2009-10-12 03:11:00Z isely $
 *
...
#ifndef PVR2_ENABLE_V4L_PRINT_IOCTL
static const char *get_cmd_code(int cmd)
{
	...
	case VIDIOC_S_FMT:
		return "VIDIOC_S_FMT";
#ifdef PVR2_ENABLE_REGISTER_ACCESS
#ifdef CONFIG_VIDEO_ADV_DEBUG
	case VIDIOC_INT_S_REGISTER:
		return "VIDIOC_INT_S_REGISTER";
	case VIDIOC_INT_G_REGISTER:
		return "VIDIOC_INT_G_REGISTER";
#endif
#endif
	case VIDIOC_QBUF:
		return "VIDIOC_QBUF";
 ...
 *
 */
#ifdef PVR2_ENABLE_OLD_V4L_INODE1
static int pvr2_v4l2_do_ioctl(struct inode *inode, struct file *file,
			      unsigned int cmd, void *arg)
#else
#ifdef PVR2_ENABLE_OLD_V4L_INODE2
...
#endif
{
...
#ifdef PVR2_ENABLE_V4L_PRINT_IOCTL
	if (pvrusb2_debug & PVR2_TRACE_V4LIOCTL) {
		v4l_print_ioctl(pvr2_hdw_get_driver_name(hdw),cmd);
	}
#else
	pvr2_trace(PVR2_TRACE_V4LIOCTL,
		   "pvr2_v4l2_do_ioctl cmd=%s (%d or 0x%x)",get_cmd_code(cmd),
		   cmd,cmd);
#endif
	...
	{
		u64 val;
#ifdef PVR2_ENABLE_OLD2REGISTER_ACCESS
		struct v4l2_register *req = (struct v4l2_register *)arg;
#else
		struct v4l2_dbg_register *req = (struct v4l2_dbg_register *)arg;
#endif
		if (cmd == VIDIOC_DBG_S_REGISTER) val = req->val;
#ifdef PVR2_ENABLE_OLDREGISTER_ACCESS
		ret = pvr2_hdw_register_access(
			hdw,1,req->i2c_id,req->reg,
...
#else
		pvr2_trace(PVR2_TRACE_V4LIOCTL,
			   "pvr2_v4l2_do_ioctl failure, ret=%d cmd=%d (0x%x)",
			   ret,cmd,cmd);
#endif
	} else {
		pvr2_trace(PVR2_TRACE_V4LIOCTL,
...
#ifdef PVR2_ENABLE_OLD_V4L_INODE2
#ifndef PVR2_ENABLE_OLD_V4L_INODE1
static int pvr2_v4l2_old_do_ioctl(struct inode *inode, struct file *file,
				  unsigned int cmd, void *arg)
{
	return pvr2_v4l2_do_ioctl(file, cmd, arg);
}
...
{
#ifdef PVR2_ENABLE_OLD_V4L_DEVNUM
	int num = dip->devbase.minor & 0x1f;
#else
...
{
	if (!dip) return;
#ifdef PVR2_ENABLE_DEV_PARENT
#ifdef PVR2_ENABLE_DEV_PARENT_OLD
	if (!dip->devbase.dev) return;
	dip->devbase.dev = NULL;
#else
...
#else
#ifdef PVR2_ENABLE_DEV_PARENT_OLD
	device_move(&dip->devbase.class_dev, NULL);
#else
	device_move(&dip->devbase.dev, NULL);
#endif
#endif
#endif
}
...
#ifdef PVR2_ENABLE_OLD_V4L_FILEOPS
...
#else
	return video_usercopy(inode, file, cmd, arg, pvr2_v4l2_old_do_ioctl);
#endif
#else
...
#ifdef PVR2_ENABLE_V4L1HARDWARE
#define VID_HARDWARE_PVRUSB2    38  /* FIXME : need a good value */

#endif
static struct video_device vdev_template = {
#ifdef PVR2_ENABLE_OLD_MODULE_OWNER
	.owner      = THIS_MODULE,
#endif
#ifdef PVR2_ENABLE_V4L_TYPE
