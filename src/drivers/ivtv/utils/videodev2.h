...
{
        __u16   service_set;
        /* service_lines[0][...] specifies lines 0-23 of the odd field
           service_lines[1][...] specifies lines 0-23 of the even field */
...
{
        __u32   id;
        __u32   field;          /* 0: odd field, 1: even field */
        __u32   line;           /* 0-23 */
...
struct v4l2_format
{
	...
	union
	{
		...
		struct v4l2_sliced_vbi_format	sliced;  // V4L2_BUF_TYPE_SLICED_VBI_CAPTURE/OUTPUT
