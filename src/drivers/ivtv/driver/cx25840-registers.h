...
RDS_I_High,
RDS_Q_Low,
number_of_registers} cx25840_register;
// 12 bit settings 6 bit value 8 bit value....
#define MASK8(s,l) (((1<<l)-1)<<s)

#define CX25840_TAG(args...)               { char text[]= { args, 0 }; DEBUG( 1, "%s", text ); }
#define WI2C(len,i2caddr,args...)          { u8 bytes[]= { args }; execute_wi2c( client, i2caddr, bytes, sizeof( bytes ) ); }

#define CX25840_DELAY(utime)               execute_settings(client); usleep( utime );

#define CX25840_END                        
#define CX25840_EXECUTE                    execute_settings(client);

#define CX25840__SEQUENCE_6BIT(set, value)     update_setting(client,set,value);
#define CX25840__SEQUENCE_14BIT(set, value)    update_setting(client,set,value);
#define CX25840__SEQUENCE_22BIT(set, value)    update_setting(client,set,value);
#define CX25840__SEQUENCE_30BIT(set, value)    update_setting(client,set,value);
#define CX25840__SEQUENCE_32BIT(set, value)    update_setting(client,set,value);
