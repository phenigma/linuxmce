...
static inline int cx25840_loadfw(struct i2c_client *client)
{
	return cx25840_loadfw_hp(client);
}
#else
#define FWFILE "/lib/modules/v4l-cx25840.fw"
struct firmware {
	size_t size;
	u8 *data;
};
...
static inline int cx25840_loadfw(struct i2c_client *client)
{
	return cx25840_loadfw_nohp(client);
}
#endif
