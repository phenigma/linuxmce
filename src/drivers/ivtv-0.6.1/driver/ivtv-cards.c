...
static const struct ivtv_card ivtv_card_pvr250 = {
	...
	.audio_inputs = {
		{ IVTV_CARD_INPUT_AUD_TUNER,  IVTV_MSP34XX_IN1_DA },
		{ IVTV_CARD_INPUT_LINE_IN1,   IVTV_MSP34XX_IN1    },
		{ IVTV_CARD_INPUT_LINE_IN2,   IVTV_MSP34XX_IN3    },
	},
	.radio_input = { IVTV_CARD_INPUT_AUD_TUNER, IVTV_MSP34XX_IN2 },
...
static const struct ivtv_card ivtv_card_pvr350_v1 = {
	...
	.audio_inputs = {
		{ IVTV_CARD_INPUT_AUD_TUNER,  IVTV_MSP34XX_MONO },
		{ IVTV_CARD_INPUT_LINE_IN1,   IVTV_MSP34XX_IN1  },
		{ IVTV_CARD_INPUT_LINE_IN2,   IVTV_MSP34XX_IN3  },
	},
	.radio_input = { IVTV_CARD_INPUT_AUD_TUNER, IVTV_MSP34XX_IN2 },
...
static const struct ivtv_card ivtv_card_pvr150 = {
	...
	.hw_all = IVTV_HW_WM8775 | IVTV_HW_CX25840 |
	          IVTV_HW_TVEEPROM | IVTV_HW_TUNER,
	.video_inputs = {
		{ IVTV_CARD_INPUT_VID_TUNER,  0, IVTV_CX25840_COMPOSITE7 },
		{ IVTV_CARD_INPUT_SVIDEO1,    1, IVTV_CX25840_SVIDEO1    },
		{ IVTV_CARD_INPUT_COMPOSITE1, 1, IVTV_CX25840_COMPOSITE3 },
		{ IVTV_CARD_INPUT_SVIDEO2,    2, IVTV_CX25840_SVIDEO2    },
		{ IVTV_CARD_INPUT_COMPOSITE2, 2, IVTV_CX25840_COMPOSITE4 },
	},
	.audio_inputs = {
		{ IVTV_CARD_INPUT_AUD_TUNER,
		  IVTV_CX25840_AUDIO8, IVTV_WM8775_AIN2 },
		{ IVTV_CARD_INPUT_LINE_IN1,
		  IVTV_CX25840_AUDIO_SERIAL, IVTV_WM8775_AIN2 },
		{ IVTV_CARD_INPUT_LINE_IN2,
		  IVTV_CX25840_AUDIO_SERIAL, IVTV_WM8775_AIN3 },
	},
	.radio_input = { IVTV_CARD_INPUT_AUD_TUNER,
	       		 IVTV_CX25840_AUDIO_SERIAL, IVTV_WM8775_AIN4 },
...
static const struct ivtv_card ivtv_card_pg600 = {
	...
	.video_inputs = {
		{ IVTV_CARD_INPUT_VID_TUNER,  0, IVTV_CX25840_COMPOSITE2 },
		{ IVTV_CARD_INPUT_SVIDEO1,    1,
		  IVTV_CX25840_SVIDEO_LUMA3 | IVTV_CX25840_SVIDEO_CHROMA4 },
		{ IVTV_CARD_INPUT_COMPOSITE1, 1, IVTV_CX25840_COMPOSITE1 },
	},
	.audio_inputs = {
		{ IVTV_CARD_INPUT_AUD_TUNER,  IVTV_CX25840_AUDIO5       },
		{ IVTV_CARD_INPUT_LINE_IN1,   IVTV_CX25840_AUDIO_SERIAL },
	},
	.tuners = {
		{ .std = V4L2_STD_625_50, .tuner = TUNER_PHILIPS_FQ1216ME },
		{ .std = V4L2_STD_ALL, .tuner = TUNER_PHILIPS_FQ1286 },
...
static const struct ivtv_card ivtv_card_avc2410 = {
	...
	.audio_inputs = {
		{ IVTV_CARD_INPUT_AUD_TUNER,
		  IVTV_MSP34XX_IN1_DA, IVTV_CS53L32A_IN0 },
		{ IVTV_CARD_INPUT_LINE_IN1,
		  IVTV_MSP34XX_IN1, IVTV_CS53L32A_IN2 },
	},
...
static const struct ivtv_card ivtv_card_avc2010 = {
	...
	.audio_inputs = {
		{ IVTV_CARD_INPUT_LINE_IN1,   IVTV_CS53L32A_IN2 },
	},
...
static const struct ivtv_card ivtv_card_tg5000tv = {
	...
	.gpio_audio_input  = { .mask = 0xffff, .tuner  = 0x8000, .linein = 0x00a0 },
	.gpio_audio_mute   = { .mask = 0x6000, .mute   = 0x6000 },
	.gpio_audio_mode   = { .mask = 0xb000, .mono   = 0x4000, .stereo = 0x0000,
			      .lang1 = 0x0000, .lang2  = 0x0000, .both   = 0x0000 },
	.tuners = {
...
static const struct ivtv_card ivtv_card_cx23416gyc = {
	...
	.gpio_video_input  = { .mask = 0x0020, .tuner  = 0x0000, .linein = 0x0020 },
...
static const struct ivtv_card ivtv_card_gotview_pci_dvd = {
	...
	.audio_inputs = {
		{ IVTV_CARD_INPUT_AUD_TUNER,  AUDIO_TUNER },
		{ IVTV_CARD_INPUT_LINE_IN1,   AUDIO_EXTERN },
	},
...
static const struct ivtv_card ivtv_card_gotview_pci_dvd2 = {
	...
	.audio_inputs = {
		{ IVTV_CARD_INPUT_AUD_TUNER,  IVTV_CX25840_AUDIO5,       0 },
		{ IVTV_CARD_INPUT_LINE_IN1,   IVTV_CX25840_AUDIO_SERIAL, 1 },
	},
	.radio_input = { IVTV_CARD_INPUT_AUD_TUNER, IVTV_CX25840_AUDIO_SERIAL, 2 },
