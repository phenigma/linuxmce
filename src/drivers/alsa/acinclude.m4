...
AC_ARG_WITH(cards,
  ...
  [                          serial-u16550, mpu401, serialmidi, loopback, ]
  [                          portman2x4, pcsp, ad1848-lib, cs4231-lib, adlib, ]
  ...
  [                          au8820, au8830, azt3328, bt87x, ca0106, cmipci, ]
  [                          cs4281, cs46xx, cs5535audio, darla20, gina20, ]
...
AC_ARG_WITH(card_options,
  ...
  [                          pcm-xrun-debug, ac97-power-save, sb16-csp, ]
  [                          bt87x-overclock, cs46xx-new-dsp, ]
  [                          fm801-tea575x-bool, powermac-auto-drc ],
  cards="$withval", cards="all")
