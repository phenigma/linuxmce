	...
	: Job(pJobHandler,"RipJob",iPK_Orbiter,pCommand_Impl)
{
	...
	LoggerWrapper::GetInstance()->Write(LV_STATUS, "RipJob::RipJob %p %d drive %d slot %d %s / %s", m_iID, m_pDisk_Drive_Functions ? m_pDisk_Drive_Functions->m_dwPK_Device_get() : 0,
