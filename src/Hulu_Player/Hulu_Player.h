...
namespace DCE
{
	class Hulu_Player : public Hulu_Player_Command
	{
//<-dceag-decl-e->
...
public:
		...
		Hulu_Player(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL);
		virtual ~Hulu_Player();
...
//<-dceag-const2-b->
		...
		Hulu_Player(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter);
//<-dceag-const2-e->
