...
*/
//<-dceag-d-b->
#ifndef AirPlay_Streamer_h
#define AirPlay_Streamer_h

//	DCE Implemenation for #2246 AirPlay Streamer
...
public:
		...
		AirPlay_Streamer(int DeviceID, string ServerAddress,bool bConnectEventHandler=true,bool bLocalMode=false,class Router *pRouter=NULL);
		virtual ~AirPlay_Streamer();
...
//<-dceag-const2-b->
		...
		AirPlay_Streamer(Command_Impl *pPrimaryDeviceCommand, DeviceData_Impl *pData, Event_Impl *pEvent, Router *pRouter);
//<-dceag-const2-e->
