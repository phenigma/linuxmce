...
#define Media_Plugin_VERSION "testing"
...
int main( int argc, char* argv[] ) 
{
	...
	if ( bError )
	{
		cout << "Media_Plugin, v." << Media_Plugin_VERSION << endl
			<< "A Pluto DCE Device. See www.plutohome.com/dce for details." << endl
			<< "Usage: Media_Plugin [-r Router's IP] [-d My Device ID] [-l dce_router|stdout|null|filename]" << endl
