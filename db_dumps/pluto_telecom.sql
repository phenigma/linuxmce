...
INSERT INTO `Line_HouseMode` (`PK_Line_HouseMode`, `ID`, `Type`, `EK_HouseMode`, `Routing`, `psc_id`, `psc_batch`, `psc_user`, `psc_frozen`, `psc_mod`, `psc_restrict`) VALUES (1,99992,'SIP',3,'prompt',1,NULL,NULL,0,'2005-12-05 09:11:14',NULL),(2,99992,'SIP',2,'ring,5232',2,NULL,NULL,0,'2005-12-05 10:41:56',NULL),(3,99992,'SIP',6,'voicemail,33129',3,NULL,NULL,0,'2005-12-05 10:41:56',NULL),(4,99992,'SIP',5,'ring,',4,NULL,NULL,0,'2005-12-05 09:11:14',NULL),(5,99992,'SIP',4,'ring,5232',5,NULL,NULL,0,'2005-12-05 10:41:56',NULL),(6,99992,'SIP',1,'transfer,5553344',6,NULL,NULL,0,'2005-12-04 19:58:09',NULL);
...
INSERT INTO `PriorityCallers` (`PK_PriorityCallers`, `EK_Users`, `PhoneNumber`, `psc_id`, `psc_batch`, `psc_user`, `psc_frozen`, `psc_mod`, `psc_restrict`) VALUES (8,33136,'345345',NULL,NULL,NULL,0,'2007-03-14 16:09:59',NULL);
...
INSERT INTO `psc_telecom_repset` (`PK_psc_telecom_repset`, `Setting`, `Value`) VALUES (1,'schema','3');
...
INSERT INTO `psc_telecom_schema` (`PK_psc_telecom_schema`, `Value`) VALUES (2,'ALTER TABLE `Contact` ADD COLUMN `JobDescription` VARCHAR (60) DEFAULT NULL AFTER `Company`, ADD COLUMN `Email` VARCHAR (60) DEFAULT NULL AFTER `Title`'),(3,'ALTER TABLE `Contact` ADD COLUMN `EntryID` VARCHAR (60) DEFAULT NULL AFTER `Email`');
...
-- Dump completed on 2008-03-27 17:58:52
