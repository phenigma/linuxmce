...
INSERT INTO `ProviderType` (`PK_ProviderType`, `Description`, `Define`, `psc_id`, `psc_batch`, `psc_user`, `psc_frozen`, `psc_mod`, `psc_restrict`) VALUES (1,'Cable',NULL,1,NULL,NULL,0,'2005-12-25 07:04:59',NULL),(2,'Cable Digital',NULL,2,NULL,NULL,0,'2005-12-25 07:04:59',NULL),(3,'Satellite',NULL,3,NULL,NULL,0,'2005-12-25 07:04:59',NULL),(4,'Local Broadcast',NULL,4,NULL,NULL,0,'2005-12-25 07:04:59',NULL);
...
INSERT INTO `ProviderType_pschist` (`PK_ProviderType`, `Description`, `Define`, `psc_id`, `psc_batch`, `psc_user`, `psc_frozen`, `psc_mod`, `psc_restrict`, `psc_toc`) VALUES (1,'Cable',NULL,1,0,NULL,0,'2005-12-25 07:04:59',NULL,0),(2,'Cable Digital',NULL,2,0,NULL,0,'2005-12-25 07:04:59',NULL,0),(3,'Satellite',NULL,3,0,NULL,0,'2005-12-25 07:04:59',NULL,0),(4,'Local Broadcast',NULL,4,0,NULL,0,'2005-12-25 07:04:59',NULL,0);
...
INSERT INTO `ProviderType_pschmask` (`PK_ProviderType`, `Description`, `Define`, `psc_id`, `psc_batch`, `psc_user`, `psc_frozen`, `psc_mod`, `psc_restrict`) VALUES (1,1,1,1,0,1,1,1,1),(1,1,1,2,0,1,1,1,1),(1,1,1,3,0,1,1,1,1),(1,1,1,4,0,1,1,1,1);
...
INSERT INTO `Provider_pschmask` (`PK_Provider`, `Description`, `FK_ProviderType`, `psc_id`, `psc_batch`, `psc_user`, `psc_frozen`, `psc_mod`, `psc_restrict`) VALUES (1,1,1,1,0,1,1,1,1),(1,1,1,2,0,1,1,1,1),(1,1,1,3,0,1,1,1,1),(1,1,1,4,0,1,1,1,1),(1,1,1,5,0,1,1,1,1),(1,1,1,6,0,1,1,1,1),(1,1,1,7,0,1,1,1,1),(1,1,1,8,0,1,1,1,1),(1,1,1,9,0,1,1,1,1),(1,1,1,10,0,1,1,1,1),(1,1,1,11,0,1,1,1,1),(1,1,1,12,0,1,1,1,1),(1,1,1,13,0,1,1,1,1),(1,1,1,14,0,1,1,1,1),(1,1,1,15,0,1,1,1,1),(1,1,1,16,0,1,1,1,1),(1,1,1,17,0,1,1,1,1),(1,1,1,18,0,1,1,1,1),(1,1,1,19,0,1,1,1,1),(1,1,1,20,0,1,1,1,1),(1,1,1,21,0,1,1,1,1),(1,1,1,22,0,1,1,1,1),(1,1,1,23,0,1,1,1,1),(NULL,NULL,NULL,24,1,NULL,NULL,NULL,NULL),(NULL,NULL,NULL,25,2,NULL,NULL,NULL,NULL);
...
INSERT INTO `psc_myth_batdet` (`PK_psc_myth_batdet`, `FK_psc_myth_bathdr`, `Tablename`, `New`, `Deleted`, `Modified`, `FK_psc_myth_bathdr_orig`, `FK_psc_myth_bathdr_auth`, `FK_psc_myth_bathdr_unauth`) VALUES (1,1,'DTV_Channel',3,0,0,1,0,0),(2,1,'PostalCode_Provider',1,0,0,1,0,0),(3,1,'Provider',1,0,0,1,0,0),(4,2,'DTV_Channel',8,0,0,2,0,0),(5,2,'PostalCode_Provider',1,0,0,2,0,0),(6,2,'Provider',1,0,0,2,0,0),(7,2,'DTV_Channel',0,0,3,2,0,0),(8,2,'PostalCode_Provider',0,0,1,2,0,0),(9,3,'PostalCode_Provider',0,2,0,3,0,0),(10,3,'Provider',0,2,0,3,0,0);
...
INSERT INTO `psc_myth_bathdr` (`PK_psc_myth_bathdr`, `IPAddress`, `date`, `comments`) VALUES (1,'65.172.233.171','2006-05-29 02:44:35',''),(2,'68.183.156.190','2006-06-16 20:38:33',''),(3,'193.77.90.224','2006-08-25 10:43:05','');
...
INSERT INTO `psc_myth_batuser` (`PK_psc_myth_batuser`, `FK_psc_myth_bathdr`, `psc_user`, `is_sup`, `no_pass`) VALUES (1,1,0,1,0),(2,2,0,1,0),(3,3,0,1,0);
...
INSERT INTO `psc_myth_repset` (`PK_psc_myth_repset`, `Setting`, `Value`) VALUES (1,'schema','1');
...
INSERT INTO `psc_myth_tables` (`PK_psc_myth_tables`, `Tablename`, `filter`, `frozen`, `anonymous`, `last_psc_id`, `last_psc_batch`) VALUES (1,'PostalCode_Provider',NULL,0,0,35,3),(2,'Provider',NULL,0,0,25,3),(3,'ProviderType',NULL,0,0,0,0),(4,'DTV_Channel',NULL,0,0,11,2),(5,'Picture',NULL,0,0,0,0);
...
-- Dump completed on 2008-03-28 22:14:27
